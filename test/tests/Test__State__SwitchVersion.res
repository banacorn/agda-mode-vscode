...
describe("State__SwitchVersion", () => {
  ...
  describe("SelectionParsing", () => {
    describe(
      ...
      () => {
        it(
          "should parse open folder action",
          () => {
            let actual = SelectionParsing.parseSelection(
        ...
        it(
          "should parse download ALS action",
          () => {
            let actual = SelectionParsing.parseSelection(
        ...
        it(
          "should parse switch to target with detail",
          () => {
        ...
        it(
          "should parse switch to target without detail",
          () => {
        ...
        it(
          "should handle ALS target selection",
          () => {
            let actual = SelectionParsing.parseSelection(
              "$(squirrel)  Agda v2.6.4 Language Server v1.2.3",
              Some("lsp://localhost:4096"),
            )
            Assert.deepStrictEqual(
              actual,
              SelectionParsing.SwitchToEndpoint("lsp://localhost:4096"),
            )
          },
        )
      },
  ...
  describe("ItemCreation", () => {
    ...
    describe(
      ...
      () => {
        it(
          ...
          () => {
            let actual = ItemCreation.createDownloadItem(
              false,
    ...
    describe(
      ...
      () => {
        it(
          ...
          () => {
            let actual = ItemCreation.createAgdaItem(
              "2.6.4",
              "/usr/bin/agda",
              false,
    ...
    describe(
      ...
      () => {
        it(
          "should create ALS item for TCP connection",
          () => {
            let mockUrl = {
              "protocol": "lsp:",
              "hostname": "localhost",
        ...
        it(
          "should create ALS item for pipe connection",
          () => {
            let method = Connection__Transport.ViaPipe("/path/to/als", [])
    ...
    describe(
      ...
      () => {
        it(
          ...
          () => {
            let mockError = Connection__Endpoint.Error.NotAgdaOrALS(
              Connection__URI.parse("/bad/path"),
              "invalid output",
            )
