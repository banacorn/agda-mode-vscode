...
- #261: Fix GitHub release assets' API schema
- #271: Fix #254: Force refresh semantic tokens after highlighting is generated by [@vic0103520](https://github.com/vic0103520)
- #265: Replace @datastructures-js/binary-search-tree with an iterative fork implementation
- Web platform issues:
...
- #255: Entries are forcibly added to agdaMode.connection.paths again 
