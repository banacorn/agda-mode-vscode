...
external onNewListener:
  ([@bs.as "newListener"] _, listener2(eventName, listener('a))) => t =
  "on";

[@bs.send.pipe: t]
external onNewListener2:
  ([@bs.as "newListener"] _, listener2(eventName, listener2('a, 'b))) => t =
  "on";

[@bs.send.pipe: t]
external onNewListener3:
  ([@bs.as "newListener"] _, listener2(eventName, listener3('a, 'b, 'c))) =>
  t =
  "on";

[@bs.send.pipe: t]
external onceNewListener:
  ([@bs.as "newListener"] _, listener2(eventName, listener('a))) => t =
  "once";
...
[@bs.send.pipe: t]
external onRemoveListener: ([@bs.as "removeListener"] _, listener(unit)) => t =
  "on";

[@bs.send.pipe: t]
external onceRemoveListener:
  ([@bs.as "removeListener"] _, listener(unit)) => t =
  "once";
...
[@bs.send.pipe: t]
external addListener3: (eventName, listener3('a, 'b, 'c)) => t =
  "addListener";
...
[@bs.send.pipe: t]
external prependListener2: (eventName, listener2('a, 'b)) => t =
  "prependListener";

[@bs.send.pipe: t]
external prependListener3: (eventName, listener3('a, 'b, 'c)) => t =
  "prependListener";
...
[@bs.send.pipe: t]
external prependOnceListener: (eventName, listener('a)) => t =
  "prependOnceListener";

[@bs.send.pipe: t]
external prependOnceListener2: (eventName, listener2('a, 'b)) => t =
  "prependOnceListener";

[@bs.send.pipe: t]
external prependOnceListener3: (eventName, listener3('a, 'b, 'c)) => t =
  "prependOnceListener";
...
[@bs.send.pipe: t]
external rawListeners2: eventName => array(listener2('a, 'b)) =
  "rawListeners";

[@bs.send.pipe: t]
external rawListeners3: eventName => array(listener3('a, 'b, 'c)) =
  "rawListeners";
