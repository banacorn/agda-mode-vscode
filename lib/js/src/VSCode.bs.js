...
function classify(v) {
  if ((function (a) { return a instanceof Array})(v)) {
    return /* Singular */Caml_chrome_debugger.variant("Singular", 0, [v]);
  } else {
    return /* Plural */Caml_chrome_debugger.variant("Plural", 1, [v]);
  }
}
...
function classify$3(v) {
  if (typeof v === "string") {
    return /* String */Caml_chrome_debugger.variant("String", 1, [v]);
  } else {
    return /* DocumentFilter */Caml_chrome_debugger.variant("DocumentFilter", 0, [v]);
  }
}
...
function classify$4(v) {
  if ((function (a) { return a.then === undefined })(v)) {
    return /* Resolved */Caml_chrome_debugger.variant("Resolved", 0, [v]);
  } else {
    return /* Promised */Caml_chrome_debugger.variant("Promised", 1, [v]);
  }
}
...
function classify$5(v) {
  if ((function (a) { return a.targetRange === undefined})(v)) {
    return /* Location */Caml_chrome_debugger.variant("Location", 0, [v]);
  } else {
    return /* LocationLink */Caml_chrome_debugger.variant("LocationLink", 1, [v]);
  }
}
...
function make$2(func) {
  return {
          provideDefinition: func
        };
}

function makeWithLocation(func) {
  return {
          provideDefinition: (function (doc, point, token) {
              return Belt_Option.map(Curry._3(func, doc, point, token), (function (x) {
                            return x;
                          }));
            })
        };
...
function makeWithLocations(func) {
  return {
          provideDefinition: (function (doc, point, token) {
              return Belt_Option.map(Curry._3(func, doc, point, token), (function (x) {
                            return x;
...
function makeWithLocationLinks(func) {
  return {
          provideDefinition: (function (doc, point, token) {
              return Belt_Option.map(Curry._3(func, doc, point, token), locationLinks);
            })
        };
}
...
var DefinitionProvider = {
  make: make$2,
  makeWithLocation: makeWithLocation,
  makeWithLocations: makeWithLocations,
  makeWithLocationLinks: makeWithLocationLinks
};
