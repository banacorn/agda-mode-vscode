      ...
      switch (tag) {
        ...
        default:
          throw {
                ...
                _1: "[Header] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });
...
var decode$1 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      ...
      throw {
            RE_EXN_ID: Json_decode.DecodeError,
            _1: "[Prompt] Unknown constructor: " + tag,
            Error: new Error()
          };
    });
...
var decode$2 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Body.Emacs] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });
...
var decode$3 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Body] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });
...
var decode$4 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      ...
      throw {
            RE_EXN_ID: Json_decode.DecodeError,
            _1: "[View.Position] Unknown constructor: " + tag,
            Error: new Error()
          };
    });
...
var decode$5 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      ...
      throw {
            RE_EXN_ID: Json_decode.DecodeError,
            _1: "[View.Interval] Unknown constructor: " + tag,
            Error: new Error()
          };
    });
...
var decode$6 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[View.Range] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });
...
var decode$7 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[View.Link] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$7(range) {
  if (range.TAG) {
    return Json_encode.object_({
                hd: [
                  "tag",
...
var decode$8 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[EventToView.InputMethod] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });
...
var decode$9 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[EventToView] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$9(text) {
  if (typeof text === "number") {
    return Json_encode.object_({
                hd: [
                  "tag",
...
var decode$11 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[RequestOrEventToView] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$11(payload) {
  if (payload.TAG) {
    return Json_encode.object_({
                hd: [
                  "tag",
...
var decode$12 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Response] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$12(result) {
  if (result) {
    return Json_encode.object_({
                hd: [
                  "tag",
...
var decode$13 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Event.InputMethod] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$13($$char) {
  if ($$char.TAG) {
    return Json_encode.object_({
                hd: [
                  "tag",
...
var decode$14 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Response.EventFromView] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$14(action) {
...
var decode$15 = Util$AgdaModeVscode.Decode.sum(function (tag) {
      switch (tag) {
        case "Event" :
            return {
                    TAG: 0,
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[ResponseOrEventFromView] Unknown constructor: " + tag,
                Error: new Error()
              };
      }
    });

function encode$15(payload) {
  if (payload.TAG) {
    return Json_encode.object_({
                hd: [
                  "tag",
