...
var decode$8 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "PromptUpdate" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (text) {
                                          return /* PromptUpdate */Caml_chrome_debugger.variant("PromptUpdate", 1, [text]);
                                        }), Json_decode.string, param);
                          })]);
          default:
            throw [
        ...
        if (tag === "Prompt") {
          return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Json_decode.tuple4(Json_decode.string, (function (param) {
                                                    return Json_decode.optional(Json_decode.string, param);
                                                  }), (function (param) {
                                                    return Json_decode.optional(Json_decode.string, param);
                                                  }), (function (param) {
...
var decode$11 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          case "PromptInterrupted" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* PromptInterrupted */1]);
          case "PromptSuccess" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
