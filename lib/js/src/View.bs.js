...
var decode$1 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          case "AllGoalsWarnings" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* AllGoalsWarnings */0]);
          case "Error" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* Error */2]);
          case "GoalType" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* GoalType */1]);
          default:
            throw [
                  Json_decode.DecodeError,
