...
var decode$1 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "ContextOrConstraints" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* ContextOrConstraints */0]);
          case "Error" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* Error */3]);
          case "GoalType" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* GoalType */2]);
          case "Others" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* Others */4]);
          default:
            throw [
                  Json_decode.DecodeError,
