...
var decode$1 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          case "Error" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (text) {
                                          return /* Error */Caml_chrome_debugger.variant("Error", 2, [text]);
                                        }), Json_decode.string, param);
                          })]);
          case "GoalType" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (text) {
                                          return /* GoalType */Caml_chrome_debugger.variant("GoalType", 1, [text]);
                                        }), Json_decode.string, param);
                          })]);
          case "Nothing" :
          ...
          case "Query" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          return /* Query */Caml_chrome_debugger.variant("Query", 3, [
                                                    param[0],
                                                    param[1]
                                                  ]);
                                        }), (function (param) {
