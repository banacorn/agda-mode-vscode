...
var decode$1 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          case "Error" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* Error */1]);
          case "GoalType" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* GoalType */0]);
          default:
            throw [
                  Json_decode.DecodeError,
...
var decode$2 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "Emacs" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (param) {
                                          return /* Emacs */Caml_chrome_debugger.variant("Emacs", 2, [
                                                    param[0],
                                                    param[1],
                                                    param[2]
                                                  ]);
