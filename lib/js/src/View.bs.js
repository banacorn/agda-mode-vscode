...
var decode$1 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        ...
        throw [
              Json_decode.DecodeError,
              "[Prompt] Unknown constructor: " + tag
            ];
      }));
...
function encode$5(param) {
  return Json_encode.object_(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                ...
                /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* tuple */[
                      "contents",
                      Json_encode.pair(encode$4, encode$4, /* tuple */[
                            param.start,
                            param.end_
                          ])
                    ],
...
var decode$9 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "PromptIMUpdate" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (text) {
                                          return /* PromptIMUpdate */Caml_chrome_debugger.variant("PromptIMUpdate", 1, [text]);
                                        }), Json_decode.string, param);
                          })]);
          case "PromptInterrupt" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* PromptInterrupt */0]);
          default:
            throw [
                  Json_decode.DecodeError,
    ...
    case /* Display */0 :
        return Json_encode.object_(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* tuple */[
                            "contents",
                            Json_encode.pair(encode, encode$3, /* tuple */[
                                  text[0],
                                  text[1]
                                ])
                          ],
...
var decode$10 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        if (tag === "Prompt") {
          return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                        return Json_decode.map((function (param) {
                                      return /* Prompt */Caml_chrome_debugger.simpleVariant("Prompt", [
                                                param[0],
                                                param[1]
                                              ]);
                                    }), (function (param) {
...
var decode$12 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          case "PromptInterrupted" :
              return /* TagOnly */Caml_chrome_debugger.variant("TagOnly", 1, [/* PromptInterrupted */0]);
          case "PromptSuccess" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
...
var decode$14 = Util$AgdaModeVscode.Decode.sum((function (tag) {
        switch (tag) {
          ...
          case "PromptChange" :
              return /* Contents */Caml_chrome_debugger.variant("Contents", 0, [(function (param) {
                            return Json_decode.map((function (text) {
                                          return /* PromptChange */Caml_chrome_debugger.variant("PromptChange", 1, [text]);
                                        }), Json_decode.string, param);
                          })]);
          default:
            throw [
