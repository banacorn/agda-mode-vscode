    ...
    if (useSemanticHighlighting && isCurrentFile) {
      return Caml_option.some($$Promise.map(Curry._1(Decoration$AgdaModeVscode.Module.SemanticHighlighting.get, state.decoration), (function (tokensRef) {
                        ...
                        Belt_Array.forEach(tokensRef.contents, (function (param) {
                                builder.push(Curry._1(Decoration$AgdaModeVscode.SemanticToken.SingleLineRange.toVsCodeRange, param.range), Curry._1(Highlighting__Agda$AgdaModeVscode.Aspect.TokenType.toString, param.type_), Belt_Option.map(param.modifiers, (function (xs) {
