...
function onActivateExtension(callback) {
  var visible = Belt_Array.keep(Belt_Array.map(Vscode.window.visibleTextEditors, (function (editor) {
              return editor.document.fileName;
            })), isAgda).length !== 0;
  var shouldAcitvateView = visible && !ViewController$AgdaModeVscode.isActivated(undefined);
...
function onDeactivateExtension(callback) {
  var openedCount = Registry$AgdaModeVscode.size(undefined);
