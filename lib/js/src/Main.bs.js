...
function initialize(channels, extensionPath, globalStorageUri, editor, fileName) {
  ...
  var state = State$AgdaModeVscode.make(channels, globalStorageUri, extensionPath, editor);
...
function activateWithoutContext(subscriptions, extensionPath, globalStorageUri) {
  ...
  subscribeMany(onTriggerCommand(async function (command, editor) {
            ...
            if (exit === 1) {
              ...
              if (match === undefined) {
                var state = initialize(channels, extensionPath, globalStorageUri, editor, fileName);
...
function activate(context) {
  ...
  return activateWithoutContext(subscriptions, extensionPath, globalStorageUri);
}
