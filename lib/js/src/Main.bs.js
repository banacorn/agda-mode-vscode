...
function Impl(Editor) {
  ...
  var activate = function (context) {
    console.log("[ extention ] activate 0");
    var eventEmitter = Event$AgdaModeVscode.make(undefined);
    console.log("[ extention ] activate 1");
    console.log("[ extention ] activate 2");
    console.log("[ extention ] activate 3 ");
    ...
    var makeAndAddToRegistry = function (editor, fileName) {
      var dispatcher = Curry._4(Dispatcher.make, extentionPath, editor, (function (param) {
              Curry._1(Registry.forceDestroy, fileName);
    ...
    Belt_Array.forEach(Command$AgdaModeVscode.names, (function (param) {
            var name = param[1];
            var command = param[0];
            return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, name, (function (editor, fileName) {
                              if (!isAgda(fileName)) {
...
function activate(context) {
  ...
  Belt_Array.forEach(Command$AgdaModeVscode.names, (function (param) {
          var name = param[1];
          var command = param[0];
          return Editor$AgdaModeVscode.addToSubscriptions(Editor$AgdaModeVscode.registerCommand(name, (function (editor, fileName) {
                            if (!isAgda(fileName)) {
                              return $$Promise.resolved(undefined);
                            }
                            console.log("[ command ] " + name);
