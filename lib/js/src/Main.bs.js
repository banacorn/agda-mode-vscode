...
function Impl(Editor) {
  var States = States$AgdaModeVscode.Impl(Editor);
  ...
  var activate = function (context) {
    ...
    Curry._2(Editor.addToSubscriptions, Curry._1(Editor.onDidChangeActivation, (function (prev, next) {
                Belt_Option.forEach(Belt_Option.flatMap(prev, States.getByEditor), (function (dispatcher) {
                        return Curry._1(State.hide, dispatcher.state);
                      }));
                return Belt_Option.forEach(Belt_Option.flatMap(next, States.getByEditor), (function (dispatcher) {
    ...
    return Belt_Array.forEach(Command$AgdaModeVscode.names, (function (param) {
                  ...
                  return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, name, (function (editor) {
                                      ...
                                      switch (command) {
                                        case /* Load */0 :
                                            Belt_Option.forEach(Curry._1(Editor.getFileName, editor), (function (fileName) {
                                                    ...
                                                    var pair = Curry._3(Dispatcher.make, extentionPath, editor, (function (param) {
                                                            Curry._1(States.forceDestroy, fileName);
                                    ...
                                    return $$Promise.get(tmp, (function (param) {
                                                  return Belt_Option.forEach(Curry._1(States.getByEditor, editor), (function (dispatcher) {
