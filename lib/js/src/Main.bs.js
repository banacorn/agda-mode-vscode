...
function initialize(debugChan, extensionPath, globalStoragePath, editor, fileName) {
  ...
  subscribe(Editor$AgdaModeVscode.Provider.registerDefinitionProvider(function (fileName, position) {
            ...
            if (fileName === currentFileName) {
              return Decoration$AgdaModeVscode.lookupSrcLoc(state.decoration, offset);
            }
            
          }));
  var tokenTypes = Highlighting__Agda$AgdaModeVscode.Aspect.TokenType.enumurate;
  var tokenModifiers = Highlighting__Agda$AgdaModeVscode.Aspect.TokenModifier.enumurate;
  var provideDocumentSemanticTokens = function ($$document, _cancel) {
    ...
    if (useSemanticHighlighting && isCurrentFile) {
      return Caml_option.some($$Promise.map(Curry._1(Decoration$AgdaModeVscode.Module.SemanticHighlighting.get, state.decoration), (function (tokensRef) {
                        ...
                        Belt_Array.forEach(tokensRef.contents, (function (param) {
                                builder.push(Curry._1(Highlighting__SemanticToken$AgdaModeVscode.Module.SingleLineRange.toVsCodeRange, param.range), Curry._1(Highlighting__Agda$AgdaModeVscode.Aspect.TokenType.toString, param.type_), Belt_Option.map(param.modifiers, (function (xs) {
