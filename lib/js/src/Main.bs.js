...
function registerDocumentSemanticTokensProvider(param) {
  ...
  var provideDocumentSemanticTokens = function ($$document, _cancel) {
    ...
    if (useSemanticHighlighting) {
      return Belt_Option.map(Registry$AgdaModeVscode.get(fileName), (function (state) {
                    return $$Promise.map(Curry._1(Decoration$AgdaModeVscode.Module.SemanticHighlighting.get, state.decoration), (function (tokensRef) {
