...
function initialize(debugChan, extensionPath, globalStoragePath, editor, fileName) {
  ...
  var state = State$AgdaModeVscode.make(debugChan, globalStoragePath, extensionPath, editor, panel);
  ...
  subscribe(WebviewPanel$AgdaModeVscode.onEvent(state.panel, (function ($$event) {
...
exports.DebugBufferSingleton = DebugBufferSingleton;
