...
function initialize1(param) {
  if (Registry$AgdaModeVscode.isEmpty(undefined)) {
    ...
    return $$Promise.resolved(Belt_Option.map(LSP$AgdaModeVscode.isConnected(undefined), (function (version) {
                      return [
                              [],
                              version
                            ];
...
function initialize2(debugChan, extensionPath, editor, fileName, lspConnectionResult) {
  ...
  var useAgdaLanguageServer = lspConnectionResult !== undefined ? (console.log("[LSP] Server version: " + lspConnectionResult[1]), true) : false;
  ...
  var xs = onTriggerCommand(function (command, editor) {
        ...
        return $$Promise.flatMap($$Promise.flatMap(typeof command === "number" && (command === 2 || command === 1) ? $$Promise.flatMap(Registry$AgdaModeVscode.removeAndDestroy(fileName), finalize) : $$Promise.resolved(undefined), (function (param) {
                          ...
                          if (match$1 !== undefined) {
                            ...
                            return $$Promise.map(initialize1(undefined), (function (param) {
...
exports.initialize1 = initialize1;
