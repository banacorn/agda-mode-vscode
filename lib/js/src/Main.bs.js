...
function initialize(debugChan, extensionPath, globalStoragePath, editor, fileName) {
  ...
  subscribe(Editor$AgdaModeVscode.Provider.registerSemnaticTokenProvider((function (fileName, pushToken) {
              ...
              var tokens = Decoration$AgdaModeVscode.generateSemanticTokens(state.decoration, state.editor);
              Belt_Array.forEach(Belt_Array.slice(tokens, 0, 10), (function (param) {
