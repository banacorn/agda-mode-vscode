...
function initiateConnection(devMode) {
  ...
  if (Registry$AgdaModeVscode.isEmpty(undefined)) {
    return $$Promise.flatMapError($$Promise.mapOk($$Promise.flatMapOk(Connection$AgdaModeVscode.LSP.find(devMode), (function (handle) {
                          console.log("[LSP] Found server " + Curry._1(Connection$AgdaModeVscode.LSP.Module.Handle.toString, handle));
                          return Connection$AgdaModeVscode.LSP.start(devMode);
                        })), (function (version) {
