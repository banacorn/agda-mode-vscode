...
function activateWithoutContext(disposables, extensionPath) {
  ...
  disposables.push(onDidChangeActivation(function (prev, next) {
            Belt_Option.forEach(Belt_Option.flatMap(prev, Registry$AgdaModeVscode.getByEditor), State$AgdaModeVscode.View.hide);
            return Belt_Option.forEach(Belt_Option.flatMap(next, Registry$AgdaModeVscode.getByEditor), (function (state) {
                          Belt_Option.forEach(next, (function (editor) {
                                  state.editor = editor;
                                  State$AgdaModeVscode.View.show(state);
  ...
  var makeAndAddToRegistry = function (editor, fileName) {
    ...
    state.subscriptions.push(ViewController$AgdaModeVscode.onEvent(state.view, (function ($$event) {
