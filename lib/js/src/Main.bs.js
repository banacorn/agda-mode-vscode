...
var Platform$AgdaModeVscode = require("./Platform.bs.js");
...
function activate(context) {
  ...
  var platformTestCommand = Vscode.commands.registerCommand("agda-mode.test-platform", (function () {
          Platform$AgdaModeVscode.testPlatformDetection();
          var env = Platform$AgdaModeVscode.getEnvironment();
          Vscode.window.showInformationMessage("Platform detection: " + env + " environment");
        }));
  subscriptions.push(platformTestCommand);
