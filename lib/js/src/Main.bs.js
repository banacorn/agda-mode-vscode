...
function makeAndAddToRegistry(debugChan, extensionPath, editor, fileName) {
  ...
  var state = State$AgdaModeVscode.make(debugChan, editor, view);
...
function activateWithoutContext(subscriptions, extensionPath) {
  ...
  var x$2 = Registry$AgdaModeVscode.onActivate(function (param) {
        Vscode.commands.executeCommand("setContext", "agdaMode", true);
        
      });
  subscriptions.push(x$2);
  var x$3 = Registry$AgdaModeVscode.onDeactivate(function (param) {
