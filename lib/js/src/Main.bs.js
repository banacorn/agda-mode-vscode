...
function onOpenEditor(callback) {
  ...
  return Curry._1(Vscode.window.onDidChangeActiveTextEditor, (function (next) {
                Core__Option.forEach(next, callback);
              }));
}

function onCloseDocument(callback) {
  return Curry._1(Vscode.workspace.onDidCloseTextDocument, callback);
}
...
function initialize(debugChan, extensionPath, globalStoragePath, editor, fileName) {
  ...
  subscribe(Curry._1(Vscode.window.onDidChangeTextEditorSelection, (function ($$event) {
  ...
  subscribe(Curry._1(Vscode.workspace.onDidChangeTextDocument, (function ($$event) {
...
function activateWithoutContext(subscriptions, extensionPath, globalStoragePath) {
  ...
  var x$1 = Curry._1(Vscode.workspace.onDidChangeTextDocument, (function ($$event) {
  ...
  var x$2 = Curry._1(Vscode.workspace.onDidCloseTextDocument, (function ($$document) {
          var fileName = Parser$AgdaModeVscode.filepath($$document.fileName);
          if (isAgda(fileName)) {
