...
function initialize(debugChan, extensionPath, globalStoragePath, editor, fileName) {
  ...
  var provideDocumentSemanticTokens = function ($$document, _cancel) {
    ...
    if (useSemanticHighlighting && isCurrentFile) {
      return Caml_option.some($$Promise.map(Curry._1(Decoration$AgdaModeVscode.Module.SemanticHighlighting.get, state.decoration), (function (tokens) {
                        ...
                        Belt_Array.forEach(tokens.contents, (function (param) {
