...
function Impl(Editor) {
  ...
  var handle = function (highlightings) {
    if (typeof highlightings === "number") {
      if (highlightings === /* Apply */0) {
        return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  Curry._1(Task.timeStart, ">>> Apply decorations"),
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              var receivedNewHighlighting = state.decorations.highlightings.length !== 0;
                              var receivedNewTempFilePaths = state.decorations.tempFilePaths.length !== 0;
                              if (receivedNewHighlighting || receivedNewTempFilePaths) {
                                Curry._1(Task.Decoration.removeAppliedDecorations, state.decorations);
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          Curry._1(Task.timeEnd, ">>> Apply decorations"),
                          /* [] */0
                        ])
                    ])
                ]);
