...
function Impl(Editor) {
  ...
  var pointingAt = function (cursor, state) {
    ...
    var cursorOffset = Curry._2(Editor.offsetAtPoint, Curry._1(Editor.getDocument, state.editor), cursor$1);
        ...
        case /* UpdateRange */0 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 7, [(function (state) {
                              return Curry._2(Task.Goal.updateRanges, state.goals, Curry._1(Editor.getDocument, state.editor));
                            })]),
                      /* [] */0
                    ]);
        case /* Next */1 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                  var $$document = Curry._1(Editor.getDocument, state.editor);
                                  var nextGoal = {
                                    contents: undefined
                                  };
                                  var cursorOffset = Curry._2(Editor.offsetAtPoint, $$document, Curry._1(Editor.getCursorPosition, state.editor));
                                  ...
                                  if (offset !== undefined) {
                                    Curry._2(Editor.setCursorPosition, state.editor, Curry._2(Editor.pointAtOffset, $$document, offset));
      ...
      switch (indices.tag | 0) {
        ...
        case /* Modify */1 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                  var $$document = Curry._1(Editor.getDocument, state.editor);
                                  var content = Curry._2(Task.Goal.getContent, goal, $$document);
                                  return $$Promise.map(Curry._3(Task.Goal.setContent, goal, $$document, Curry._1(f, content)), (function (param) {
                                                if (param) {
                                                  return /* [] */0;
                                                } else {
                                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                            Curry._2(Task.display, /* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Failed to modify the content of goal #" + String(goal.index)])),
                                                            /* [] */0
                                                          ]);
                                                }
                                              }));
        ...
        case /* SetCursor */2 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 7, [(function (state) {
                              var $$document = Curry._1(Editor.getDocument, state.editor);
                              var point = Curry._2(Editor.pointAtOffset, $$document, offset);
        ...
        case /* RemoveBoundaryAndDestroy */4 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                  var $$document = Curry._1(Editor.getDocument, state.editor);
                                  var innerRange = Curry._2(Task.Goal.getInnerRange, goal$1, $$document);
                                  var outerRange = Curry._2(Editor.$$Range.make, Curry._2(Editor.pointAtOffset, $$document, goal$1.range[0]), Curry._2(Editor.pointAtOffset, $$document, goal$1.range[1]));
                                  var content = $$String.trim(Curry._2(Editor.getTextInRange, $$document, innerRange));
                                  return $$Promise.map(Curry._3(Editor.replaceText, $$document, outerRange, content), (function (param) {
                                                if (param) {
                                                  Curry._1(Task.Goal.destroy, goal$1);
                                                  return /* [] */0;
                                                } else {
                                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                            Curry._2(Task.display, /* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Unable to remove the boundary of goal #" + String(goal$1.index)])),
                                                            /* [] */0
                                                          ]);
                                                }
                                              }));
        ...
        case /* ReplaceWithLines */5 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              ...
                              var start = Curry._2(Editor.pointAtOffset, $$document, goal$2.range[0]);
                              var startLineNo = Curry._1(Editor.Point.line, start);
                              var startLineRange = Curry._2(Editor.rangeForLine, $$document, startLineNo);
                              var start$1 = Curry._1(Editor.$$Range.start, startLineRange);
                              var end_ = Curry._2(Editor.pointAtOffset, $$document, goal$2.range[1]);
                              var rangeToBeReplaced = Curry._2(Editor.$$Range.make, start$1, end_);
                              return $$Promise.map(Curry._3(Editor.replaceText, $$document, rangeToBeReplaced, indentedLines), (function (param) {
                                            if (param) {
                                              Curry._1(Task.Goal.destroy, goal$2);
                                              return /* [] */0;
                                            } else {
                                              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                        Curry._2(Task.display, /* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Unable to replace the lines of goal #" + String(goal$2.index)])),
                                                        /* [] */0
                                                      ]);
                                            }
                                          }));
        ...
        case /* ReplaceWithLambda */6 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              ...
                              var rewriteRange$1 = Curry._2(Editor.$$Range.make, Curry._2(Editor.pointAtOffset, $$document, rewriteRange[0]), Curry._2(Editor.pointAtOffset, $$document, rewriteRange[1]));
                              return $$Promise.map(Curry._3(Editor.replaceText, $$document, rewriteRange$1, rewriteText), (function (param) {
                                            if (param) {
                                              Curry._1(Task.Goal.destroy, goal$3);
                                              return /* [] */0;
                                            } else {
                                              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                        Curry._2(Task.display, /* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Unable to replace the lines of goal #" + String(goal$3.index)])),
                                                        /* [] */0
                                                      ]);
                                            }
                                          }));
