...
function pointingAt(cursor, state) {
  var cursor$1 = cursor !== undefined ? Caml_option.valFromOption(cursor) : state.editor.selection.end;
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    ...
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                ...
                                var cursorOffset = $$document.offsetAt(state.editor.selection.end);
                                ...
                                state.editor.selection = new Vscode.Selection(point, point);
      ...
      case /* Instantiate */0 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                            ...
                            return $$Promise.map(Goal$AgdaModeVscode.makeMany(state.editor, indices$1), (function (goals) {
                                          state.goals = goals;
                                          return /* [] */0;
                                        }));
                          })]),
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    ...
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                ...
                                return $$Promise.map(Goal$AgdaModeVscode.setContent(goal, $$document, Curry._1(f, content)), (function (param) {
                                              if (param) {
                                                return /* [] */0;
                                              } else {
                                                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                          Task$AgdaModeVscode.display(/* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Failed to modify the content of goal #" + String(goal.index)])),
                                                          /* [] */0
                                                        ]);
                                              }
                                            }));
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    ...
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                ...
                                return $$Promise.map(Editor$AgdaModeVscode.$$Text.replace($$document, outerRange, content), (function (param) {
                                              if (param) {
                                                Goal$AgdaModeVscode.destroy(goal$1);
                                                return /* [] */0;
                                              } else {
                                                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                          Task$AgdaModeVscode.display(/* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Unable to remove the boundary of goal #" + String(goal$1.index)])),
                                                          /* [] */0
                                                        ]);
                                              }
                                            }));
      ...
      case /* ReplaceWithLines */5 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                            ...
                            return $$Promise.map(Editor$AgdaModeVscode.$$Text.replace($$document, rangeToBeReplaced, indentedLines), (function (param) {
                                          if (param) {
                                            Goal$AgdaModeVscode.destroy(goal$2);
                                            return /* [] */0;
                                          } else {
                                            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      Task$AgdaModeVscode.display(/* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Unable to replace the lines of goal #" + String(goal$2.index)])),
                                                      /* [] */0
                                                    ]);
                                          }
                                        }));
      ...
      case /* ReplaceWithLambda */6 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                            ...
                            return $$Promise.map(Editor$AgdaModeVscode.$$Text.replace($$document, rewriteRange$1, rewriteText), (function (param) {
                                          if (param) {
                                            Goal$AgdaModeVscode.destroy(goal$3);
                                            return /* [] */0;
                                          } else {
                                            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      Task$AgdaModeVscode.display(/* Error */Caml_chrome_debugger.variant("Error", 3, ["Goal-related Error"]), /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Unable to replace the lines of goal #" + String(goal$3.index)])),
                                                      /* [] */0
                                                    ]);
                                          }
                                        }));
