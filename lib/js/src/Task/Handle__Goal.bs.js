...
var next_0 = {
  ...
  _0: (function (state) {
      ...
      return $$Promise.resolved(jumpToOffset(offset));
    }),
  [Symbol.for("name")]: "WithStateP"
};
...
function $$case(localWithContent, localEmpty, $$global) {
  return {
          hd: {
            TAG: 5,
            _0: (function (state) {
                ...
                if (content === "") {
                  ...
                  return $$Promise.resolved(Curry._2(localWithContent, goal, content));
                }
              }),
            [Symbol.for("name")]: "WithStateP"
          },
...
function caseSimple(local, $$global) {
  return {
          hd: {
            TAG: 5,
            _0: (function (state) {
...
function replaceWithLambda(goal, lines) {
  return {
          TAG: 5,
          _0: (function (state) {
              var $$document = state.editor.document;
...
function replaceWithLines(goal, lines) {
  return {
          TAG: 5,
          _0: (function (state) {
              var $$document = state.editor.document;
...
function removeBoundaryAndDestroy(goal) {
  return {
          hd: {
            TAG: 5,
            _0: (function (state) {
