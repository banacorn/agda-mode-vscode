...
function change(self, input) {
  return EditorIM$AgdaModeVscode.deviseChange(self, previous.contents, input);
}
                  ...
                  hd: {
                    ...
                    _0: (function (state) {
                        ...
                        if (EditorIM$AgdaModeVscode.isActivated(state.editorIM)) {
                          ...
                          return $$Promise.resolved(handle(PromptIM$AgdaModeVscode.update2(state.promptIM, input)));
                    ...
                    _0: (function (state) {
                        if (!EditorIM$AgdaModeVscode.isActivated(state.editorIM)) {
                          if (PromptIM$AgdaModeVscode.isActivated(state.promptIM)) {
                            return $$Promise.resolved(handle(PromptIM$AgdaModeVscode.insertChar2(state.promptIM, $$char)));
                          } else {
                  ...
                  hd: {
                    ...
                    _0: (function (state) {
                        if (EditorIM$AgdaModeVscode.isActivated(state.editorIM)) {
                          ...
                          return $$Promise.resolved(handle(PromptIM$AgdaModeVscode.chooseSymbol(state.promptIM, symbol)));
                        } else {
                          return $$Promise.resolved(/* [] */0);
                        }
                      }),
