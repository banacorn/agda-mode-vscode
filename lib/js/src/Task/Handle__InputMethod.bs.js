...
function handlePromptIMOutput(output) {
  var handle = function (kind) {
    if (typeof kind === "number") {
      if (kind === /* Activate */0) {
        return {
    ...
    var match = Belt_Array.get(kind._0, 0);
    if (match !== undefined) {
      return {
              hd: {
                TAG: 2,
  ...
  return Belt_List.concatMany(Belt_Array.map(output, handle));
}
          ...
          return {
                  hd: {
                    ...
                    _0: (function (state) {
                        ...
                        } else if (PromptIM$AgdaModeVscode.isActivated(state.promptIM)) {
                          return $$Promise.resolved(handlePromptIMOutput(PromptIM$AgdaModeVscode.update2(state.promptIM, input)));
                    ...
                    _0: (function (state) {
                        if (!EditorIM$AgdaModeVscode.isActivated(state.editorIM)) {
                          if (PromptIM$AgdaModeVscode.isActivated(state.promptIM)) {
                            return $$Promise.resolved(handlePromptIMOutput(PromptIM$AgdaModeVscode.insertChar2(state.promptIM, $$char)));
                          } else {
                  ...
                  hd: {
                    ...
                    _0: (function (state) {
                        if (EditorIM$AgdaModeVscode.isActivated(state.editorIM)) {
                          ...
                          return $$Promise.resolved(handlePromptIMOutput(PromptIM$AgdaModeVscode.chooseSymbol(state.promptIM, symbol)));
                        } else {
                          return $$Promise.resolved(/* [] */0);
                        }
                      }),
...
exports.handlePromptIMOutput = handlePromptIMOutput;
