            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              ...
                              var activateQueryIM = function (param) {
                                ...
                                Curry._2(QueryIM.activate, state.queryIM, input$2);
                                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                          /* ViewEvent */Caml_chrome_debugger.variant("ViewEvent", 2, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 2, [/* Activate */0])]),
                                          /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              ...
                              var result = Curry._2(QueryIM.update, state.queryIM, input$1);
                              if (result !== undefined) {
                                return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              /* ViewEvent */Caml_chrome_debugger.variant("ViewEvent", 2, [/* QueryUpdate */Caml_chrome_debugger.variant("QueryUpdate", 1, [result[0]])]),
                                              /* :: */Caml_chrome_debugger.simpleVariant("::", [
        ...
        case /* InsertChar */2 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              ...
                              var result = Curry._2(QueryIM.insertChar, state.queryIM, $$char);
                              if (result !== undefined) {
                                return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              /* ViewEvent */Caml_chrome_debugger.variant("ViewEvent", 2, [/* QueryUpdate */Caml_chrome_debugger.variant("QueryUpdate", 1, [result[0]])]),
                                              /* :: */Caml_chrome_debugger.simpleVariant("::", [
        ...
        case /* ChooseSymbol */3 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              ...
                              return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* ViewEvent */Caml_chrome_debugger.variant("ViewEvent", 2, [/* QueryUpdate */Caml_chrome_debugger.variant("QueryUpdate", 1, [symbol])]),
                                            /* [] */0
                                          ]));
                            })]),
                      /* [] */0
