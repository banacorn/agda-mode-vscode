    ...
    if (typeof $$char === "number") {
      switch ($$char) {
                      ...
                      /* WithState */Caml_chrome_debugger.variant("WithState", 6, [(function (state) {
                              if (state.inputMethod.activated) {
                                ...
                                return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              /* SendEventToView */Caml_chrome_debugger.variant("SendEventToView", 2, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 1, [/* Deactivate */1])]),
                                              /* [] */0
                                            ]));
                              }
                              ...
                              return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendEventToView */Caml_chrome_debugger.variant("SendEventToView", 2, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 1, [/* Activate */0])]),
                                            /* [] */0
                                          ]));
                            })]),
                      /* [] */0
        ...
        case /* MoveUp */2 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 6, [(function (state) {
                              Curry._2(InputMethod.moveUp, state.inputMethod, state.editor);
                              return $$Promise.resolved(/* [] */0);
                            })]),
                      /* [] */0
                    ]);
        case /* MoveRight */3 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 6, [(function (state) {
                              Curry._2(InputMethod.moveRight, state.inputMethod, state.editor);
                              return $$Promise.resolved(/* [] */0);
                            })]),
                      /* [] */0
                    ]);
        case /* MoveDown */4 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 6, [(function (state) {
                              Curry._2(InputMethod.moveDown, state.inputMethod, state.editor);
                              return $$Promise.resolved(/* [] */0);
                            })]),
                      /* [] */0
                    ]);
        case /* MoveLeft */5 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithState */Caml_chrome_debugger.variant("WithState", 6, [(function (state) {
                              Curry._2(InputMethod.moveLeft, state.inputMethod, state.editor);
                              return $$Promise.resolved(/* [] */0);
                            })]),
                      /* [] */0
                    ]);
      ...
      switch ($$char.tag | 0) {
        case /* Update */0 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* SendEventToView */Caml_chrome_debugger.variant("SendEventToView", 2, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 1, [/* Update */Caml_chrome_debugger.simpleVariant("Update", [
                                  $$char[0],
                                  $$char[1],
                                  $$char[2]
                                ])])]),
