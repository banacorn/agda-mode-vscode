...
function handleEditorIMOutput(output) {
  ...
  return Belt_List.fromArray(Belt_Array.map(output, handle));
}
...
function handle(self, output) {
  var handle$1 = function (kind) {
    if (typeof kind === "number") {
      ...
      EditorIM$AgdaModeVscode.deactivate(self);
      return {
              hd: {
                TAG: 2,
                _0: {
      ...
      case /* MoveUp */1 :
          return {
                  hd: {
                    TAG: 8,
                    _0: (function (state) {
                        return $$Promise.map(EditorIM$AgdaModeVscode.run(state.editorIM, Caml_option.some(state.editor), {
                                        TAG: 2,
                                        _0: /* BrowseUp */0,
                  ...
                  hd: {
                    ...
                    _0: (function (state) {
                        ...
                        return $$Promise.map(change(state.promptIM, input), (function (param) {
                                      return handle(partial_arg, param);
                                    }));
                      }),
                    [Symbol.for("name")]: "WithStateP"
                  },
