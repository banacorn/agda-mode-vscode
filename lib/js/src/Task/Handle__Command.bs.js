                  ...
                  hd: {
                    ...
                    _0: (function (state) {
                        if (IM$AgdaModeVscode.isActivated(state.editorIM) || IM$AgdaModeVscode.isActivated(state.promptIM)) {
                          return $$Promise.resolved(Handle__InputMethod$AgdaModeVscode.deactivate(state));
                        } else {
                          return $$Promise.resolved({
                                      hd: {
                                        TAG: 2,
          ...
          switch ($$event.TAG | 0) {
            ...
            case /* PromptChange */1 :
                ...
                if (typeof offset === "number") {
                  ...
                  if (offset.TAG) {
                    ...
                    return {
                            hd: {
                              TAG: 8,
                              _0: (function (state) {
                                  return Handle__InputMethod$AgdaModeVscode.activatePromptIM(state, input);
                                }),
                              [Symbol.for("name")]: "WithStateP"
                            },
                            tl: /* [] */0
                  ...
                  var offset$1 = offset._0;
                  return {
                          hd: {
                            TAG: 8,
                            _0: (function (state) {
                                return Handle__InputMethod$AgdaModeVscode.select(state, offset$1);
                              }),
                            [Symbol.for("name")]: "WithStateP"
                          },
                          tl: /* [] */0
