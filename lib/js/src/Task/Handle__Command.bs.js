  ...
  var handle = function (command) {
    ...
    if (typeof command === "number") {
      switch (command) {
        ...
        case /* Compile */4 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* Compile */1]),
                      /* [] */0
                    ]);
        case /* ToggleDisplayOfImplicitArguments */5 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ToggleDisplayOfImplicitArguments */2]),
                      /* [] */0
                    ]);
        case /* ShowConstraints */6 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ShowConstraints */3]),
                      /* [] */0
                    ]);
        case /* ShowGoals */7 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ShowGoals */4]),
                      /* [] */0
                    ]);
        case /* NextGoal */8 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
