  ...
  var handle = function (command) {
    if (typeof command === "number") {
      switch (command) {
        ...
        case /* WhyInScope */8 :
            var header$1 = "Scope info";
            var placeholder = "name:";
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* WhyInScope */Caml_chrome_debugger.variant("WhyInScope", 12, [
                                                    expr,
                                                    goal
                                                  ])]),
                                            /* [] */0
                              ...
                              Curry._4(Task.query, header$1, placeholder, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* WhyInScopeGlobal */Caml_chrome_debugger.variant("WhyInScopeGlobal", 13, [expr])]),
                                                /* [] */0
                                              ]);
                                    }))
                            ])]),
      ...
      switch (command.tag | 0) {
        case /* InferType */0 :
            ...
            var header$2 = Command$AgdaModeVscode.toString(/* InferType */Caml_chrome_debugger.variant("InferType", 0, [normalization]));
        ...
        case /* EventFromView */3 :
            ...
            if ($$char.tag) {
              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* SaveCursor */3]),
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 6, [/* ChooseSymbol */Caml_chrome_debugger.variant("ChooseSymbol", 2, [$$char[0]])])]),
                            /* :: */Caml_chrome_debugger.simpleVariant("::", [
              ...
              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* SaveCursor */3]),
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 6, [/* InsertChar */Caml_chrome_debugger.variant("InsertChar", 1, [$$char[0]])])]),
                            /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* RestoreCursor */4]),
                                /* [] */0
                              ])
        ...
        case /* ModuleContents */4 :
            var normalization$3 = command[0];
            var header$3 = "Module contents";
            var placeholder$2 = "module name:";
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ModuleContents */Caml_chrome_debugger.variant("ModuleContents", 8, [
                                                    normalization$3,
                                                    expr,
                                                    goal
                                                  ])]),
                              ...
                              (function (goal) {
                                  return Curry._4(Task.query, header$3, placeholder$2, undefined, (function (expr) {
                                                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                          /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ModuleContents */Caml_chrome_debugger.variant("ModuleContents", 8, [
                                                                  normalization$3,
                                                                  expr,
                              ...
                              Curry._4(Task.query, header$3, placeholder$2, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ModuleContentsGlobal */Caml_chrome_debugger.variant("ModuleContentsGlobal", 9, [
                                                        normalization$3,
                                                        expr
                                                      ])]),
                                                /* [] */0
        ...
        case /* ComputeNormalForm */5 :
            var computeMode = command[0];
            var header$4 = "Evaluate term to normal form";
            var placeholder$3 = "expression to normalize:";
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ComputeNormalForm */Caml_chrome_debugger.variant("ComputeNormalForm", 10, [
                                                    computeMode,
                                                    expr,
                                                    goal
                                                  ])]),
                              ...
                              (function (goal) {
                                  return Curry._4(Task.query, header$4, placeholder$3, undefined, (function (expr) {
                                                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                          /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ComputeNormalForm */Caml_chrome_debugger.variant("ComputeNormalForm", 10, [
                                                                  computeMode,
                                                                  expr,
                              ...
                              Curry._4(Task.query, header$4, placeholder$3, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ComputeNormalFormGlobal */Caml_chrome_debugger.variant("ComputeNormalFormGlobal", 11, [
                                                        computeMode,
                                                        expr
                                                      ])]),
                                                /* [] */0
