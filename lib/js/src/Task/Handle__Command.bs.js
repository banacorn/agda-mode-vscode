  ...
  var handle = function (normalization) {
    if (typeof normalization === "number") {
      switch (normalization) {
        ...
        case /* NextGoal */2 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* Next */0]),
                      /* [] */0
                    ]);
        case /* PreviousGoal */3 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* Previous */1]),
                      /* [] */0
                    ]);
        case /* Auto */4 :
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetPointedOr */Caml_chrome_debugger.variant("GetPointedOr", 1, [
                              (function (goal) {
                              ...
                              /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                  /* Debug */Caml_chrome_debugger.variant("Debug", 6, ["TODO: query the user"]),
                                  /* [] */0
                                ])
                            ])]),
                      /* [] */0
      ...
      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetPointedOr */Caml_chrome_debugger.variant("GetPointedOr", 1, [
                        (function (goal) {
                            return $$Promise.resolved(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                          /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 0, [/* GoalType */Caml_chrome_debugger.variant("GoalType", 1, [
                                                  normalization$1,
                                                  goal
                                                ])]),
                                          /* [] */0
