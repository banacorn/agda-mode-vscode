    ...
    if (typeof command === "number") {
      ...
      switch (command.tag | 0) {
        ...
        case /* ComputeNormalForm */4 :
            var query = Curry._4(Task.query, "Compute normal form", "expression to normalize:", undefined, (function (expr) {
                    return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              /* Debug */Caml_chrome_debugger.variant("Debug", 8, ["ComputeNormalForm " + expr]),
                              /* [] */0
                            ]);
                  }));
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* Debug */Caml_chrome_debugger.variant("Debug", 8, ["ComputeNormalFormGlobal " + Command$AgdaModeVscode.ComputeMode.toString(command[0])]),
                          /* [] */0
                        ])
                    ]);
        case /* InputMethod */5 :
