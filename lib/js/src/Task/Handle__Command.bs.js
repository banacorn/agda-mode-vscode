...
var Handle__Temp$AgdaModeVscode = require("./Handle__Temp.bs.js");
...
function dispatchCommand(state, _command) {
  while(true) {
    ...
    if (typeof command === "number") {
      switch (command) {
        case /* Load */0 :
            return $$Promise.flatMap($$Promise.flatMap(Task$AgdaModeVscode.display(state, {
                                TAG: 0,
                                _0: "Loading ...",
                                [Symbol.for("name")]: "Plain"
                      ...
                      return function (param) {
                        ...
                        return $$Promise.flatMap(Vscode.window.showTextDocument($$document, options), (function (param) {
                                      return Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, /* Load */0);
                                    }));
                      }
                      }($$document)));
        case /* Quit */1 :
        ...
        case /* Refresh */3 :
            ...
            Handle__Decoration$AgdaModeVscode.refresh(state);
            return $$Promise.resolved(undefined);
        case /* Compile */4 :
            return Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, /* Compile */1);
        case /* ToggleDisplayOfImplicitArguments */5 :
            return Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, /* ToggleDisplayOfImplicitArguments */2);
        case /* ShowConstraints */6 :
            return Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, /* ShowConstraints */3);
        case /* ShowGoals */7 :
            return Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, /* ShowGoals */4);
        case /* NextGoal */8 :
        ...
        case /* Give */10 :
            return Handle__Goal$AgdaModeVscode.$$case(state, (function (goal, param) {
                          return Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, {
                                      TAG: 3,
                                      _0: goal,
                      ...
                      return function (goal) {
                        return Task$AgdaModeVscode.prompt(state, header, {
                                    body: undefined,
                      ...
                      }(header)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* Refine */11 :
        ...
        case /* WhyInScope */14 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function (goal, expr) {
                      ...
                      }(header,placeholder)), Task$AgdaModeVscode.prompt(state, header, {
                            body: undefined,
                            placeholder: placeholder,
                            value: undefined
                          }, (function (expr) {
        ...
        case /* Escape */15 :
            if (IM$AgdaModeVscode.isActivated(state.editorIM) || IM$AgdaModeVscode.isActivated(state.promptIM)) {
              ...
              return Task$AgdaModeVscode.viewEvent(state, /* PromptInterrupt */0);
            }
      ...
      switch (command.TAG | 0) {
        case /* SolveConstraints */0 :
            ...
            return Handle__Goal$AgdaModeVscode.caseSimple(state, (function(normalization){
                      ...
                      }(normalization)), Handle__Temp$AgdaModeVscode.sendAgdaRequest(dispatchCommand$1, state, {
                            TAG: 1,
                            _0: normalization,
        ...
        case /* ElaborateAndGive */2 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(normalization$2){
                      ...
                      }(header,normalization$2)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* HelperFunctionType */3 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(normalization$3){
                      ...
                      }(header,normalization$3)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* InferType */4 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(normalization$4){
                      ...
                      }(header,normalization$4,placeholder$1)), Task$AgdaModeVscode.prompt(state, header, {
                            body: undefined,
                            placeholder: placeholder$1,
                            value: undefined
        ...
        case /* Context */5 :
            ...
            return Handle__Goal$AgdaModeVscode.caseSimple(state, (function(normalization$5){
                      ...
                      }(normalization$5)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* GoalType */6 :
            ...
            return Handle__Goal$AgdaModeVscode.caseSimple(state, (function(normalization$6){
                      ...
                      }(normalization$6)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* GoalTypeAndContext */7 :
            ...
            return Handle__Goal$AgdaModeVscode.caseSimple(state, (function(normalization$7){
                      ...
                      }(normalization$7)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        ...
        case /* GoalTypeContextAndInferredType */9 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(normalization$8){
                      ...
                      }(normalization$8)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* GoalTypeContextAndCheckedType */10 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(normalization$9){
                      ...
                      }(header,normalization$9)), Task$AgdaModeVscode.displayOutOfGoalError(state));
        case /* ModuleContents */11 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(normalization$10){
                      ...
                      }(header,normalization$10,placeholder$2)), Task$AgdaModeVscode.prompt(state, header, {
                            body: undefined,
                            placeholder: placeholder$2,
                            value: undefined
        ...
        case /* ComputeNormalForm */12 :
            ...
            return Handle__Goal$AgdaModeVscode.$$case(state, (function(computeMode){
                      ...
                      }(header,computeMode,placeholder$3)), Task$AgdaModeVscode.prompt(state, header, {
                            body: undefined,
                            placeholder: placeholder$3,
                            value: undefined
