  ...
  var handle = function (command) {
    ...
    if (typeof command === "number") {
        ...
        case /* WhyInScope */8 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* WhyInScope */Caml_chrome_debugger.variant("WhyInScope", 13, [
                                                    expr,
                                                    goal
                                                  ])]),
                                            /* [] */0
                              ...
                              Curry._4(Task.query, header, placeholder, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* WhyInScopeGlobal */Caml_chrome_debugger.variant("WhyInScopeGlobal", 14, [expr])]),
                                                /* [] */0
                                              ]);
                                    }))
                            ])]),
      ...
      switch (command.tag | 0) {
        ...
        case /* EventFromView */3 :
            ...
            if ($$char.tag) {
              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* SaveCursor */3]),
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 7, [/* ChooseSymbol */Caml_chrome_debugger.variant("ChooseSymbol", 2, [$$char[0]])])]),
                            /* :: */Caml_chrome_debugger.simpleVariant("::", [
              ...
              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* SaveCursor */3]),
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 7, [/* InsertChar */Caml_chrome_debugger.variant("InsertChar", 1, [$$char[0]])])]),
                            /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* RestoreCursor */4]),
                                /* [] */0
                              ])
        ...
        case /* GoalTypeContextAndCheckedType */4 :
            var normalization$3 = command[0];
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* GoalTypeContextAndCheckedType */Caml_chrome_debugger.variant("GoalTypeContextAndCheckedType", 8, [
                                                    normalization$3,
                                                    expr,
                                                    goal
                                                  ])]),
        ...
        case /* ModuleContents */5 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ModuleContents */Caml_chrome_debugger.variant("ModuleContents", 9, [
                                                    normalization$4,
                                                    expr,
                                                    goal
                                                  ])]),
                              ...
                              Curry._4(Task.query, header, placeholder$2, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ModuleContentsGlobal */Caml_chrome_debugger.variant("ModuleContentsGlobal", 10, [
                                                        normalization$4,
                                                        expr
                                                      ])]),
                                                /* [] */0
        ...
        case /* ComputeNormalForm */6 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal2 */Caml_chrome_debugger.variant("LocalOrGlobal2", 6, [
                              (function (goal, expr) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ComputeNormalForm */Caml_chrome_debugger.variant("ComputeNormalForm", 11, [
                                                    computeMode,
                                                    expr,
                                                    goal
                                                  ])]),
                              ...
                              Curry._4(Task.query, header, placeholder$3, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 1, [/* ComputeNormalFormGlobal */Caml_chrome_debugger.variant("ComputeNormalFormGlobal", 12, [
                                                        computeMode,
                                                        expr
                                                      ])]),
                                                /* [] */0
