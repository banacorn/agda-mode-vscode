            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetPointedOr */Caml_chrome_debugger.variant("GetPointedOr", 3, [
                              (function (goal, expr) {
                                  if (expr !== undefined) {
                                    return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 0, [/* InferType */Caml_chrome_debugger.variant("InferType", 3, [
                                                      normalization$1,
                                                      expr,
                                                      goal
                                                    ])]),
                              ...
                              Curry._4(Task.query, header, placeholder, undefined, (function (expr) {
                                      return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 0, [/* InferTypeGlobal */Caml_chrome_debugger.variant("InferTypeGlobal", 4, [
                                                        normalization$1,
                                                        expr
                                                      ])]),
                                                /* [] */0
        ...
        case /* GoalType */1 :
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetPointedOr */Caml_chrome_debugger.variant("GetPointedOr", 3, [
                              (function (goal, param) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* SendRequest */Caml_chrome_debugger.variant("SendRequest", 0, [/* GoalType */Caml_chrome_debugger.variant("GoalType", 5, [
                                                    normalization$2,
                                                    goal
                                                  ])]),
                                            /* [] */0
