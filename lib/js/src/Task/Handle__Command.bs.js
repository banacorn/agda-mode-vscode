      ...
      case /* Escape */15 :
          return {
                  hd: {
                    TAG: 8,
                    _0: (function (state) {
                        if (EditorIM$AgdaModeVscode.isActivated(state.editorIM) || EditorIM$AgdaModeVscode.isActivated(state.promptIM)) {
                          return $$Promise.resolved(Handle__InputMethod$AgdaModeVscode.IM.deactivate(state));
                        } else {
                          return $$Promise.resolved({
                                      hd: {
                                        TAG: 2,
            ...
            case /* PromptChange */1 :
                ...
                return {
                        hd: {
                          TAG: 8,
                          _0: (function (state) {
                              return Handle__InputMethod$AgdaModeVscode.promptChange(state, input);
                            }),
                          [Symbol.for("name")]: "WithStateP"
                        },
                        tl: /* [] */0
