    ...
    switch (task.tag | 0) {
      ...
      case /* SendRequest */2 :
          ...
          return $$Promise.flatMap(Curry._2(State.sendRequest, state, task[0]), (function (connection) {
                        ...
                        var destructor = Curry._1(connection[0].emitter.on, (function (connError) {
                                if (connError.tag) {
                                  console.log("connection error ");
                                  console.log(Process$AgdaMode.$$Error.toString(connError[0]));
                                  return Curry._1(resolve, undefined);
                                }
                                var match = connError[0];
                                if (!match) {
                                  return Curry._1(resolve, undefined);
                                }
                                ...
                                if (parseError.tag) {
                                  ...
                                  console.log(Parser$AgdaModeVscode.$$Error.toString(parseError[0]));
                                  return Curry._1(resolve, undefined);
                                }
                                console.log(Response$AgdaModeVscode.toString(parseError[0]));
                                var tasks = Curry._1(TaskResponse.handle, undefined);
                                return Belt_List.forEach(tasks, (function (param) {
                                              return Curry._1(self.taskEmitter.emit, param);
                                            }));
                              }));
