  ...
  var make = function (state) {
    ...
    var runTasksInQueues = function (param) {
      ...
      if (nextTask !== undefined) {
        return $$Promise.get(runTask(state, nextTask), (function (newTasks) {
      ...
      if (nextCommand !== undefined) {
        return $$Promise.get(runTask(state, /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 1, [nextCommand])), (function (newTasks) {
                      return Belt_List.forEach(newTasks, (function (param) {
                                    return Curry._1(self.taskEmitter.emit, param);
                                  }));
                    }));
      } else {
