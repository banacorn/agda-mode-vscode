...
function Impl(Editor) {
  ...
  var runTask = function (self, state, task) {
    ...
    switch (task.tag | 0) {
      case /* DispatchCommand */0 :
          ...
          return $$Promise.resolved(/* Derived */Caml_chrome_debugger.simpleVariant("Derived", [Curry._1(TaskCommand.dispatch, command)]));
      case /* SendRequest */1 :
  ...
  var make = function (state) {
    ...
    Curry._1(onAddCommand.on, (function (command) {
            queue.contents.push(/* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [command]));
