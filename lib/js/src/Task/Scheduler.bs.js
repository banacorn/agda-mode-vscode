...
function Impl(Editor) {
  ...
  var sendRequest = function (state, request) {
    ...
    var handler = function (error) {
      ...
      var otherTasks = Belt_Array.keep(Belt_List.toArray(Curry._1(ResponseHandler.handle, error$1[0])), (function (task) {
    ...
    if (request.tag) {
      return $$Promise.map(Curry._2(State.sendRequestToView, state, request[0]), (function (param) {
  ...
  var runTask = function (state, task) {
    ...
    switch (task.tag | 0) {
      ...
      case /* ViewReq */1 :
          ...
          return sendRequests(state, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* View */Caml_chrome_debugger.variant("View", 1, [task[0]]),
                        /* [] */0
                      ]));
      case /* ViewRes */2 :
          var response = task[0];
