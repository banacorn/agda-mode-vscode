...
function Impl(Editor) {
  ...
  var sendRequest = function (state, request) {
    ...
    return $$Promise.map($$Promise.flatMap(Curry._2(State.sendRequestToView, state, request[0]), (function (response) {
                      return $$Promise.flatMap($$Promise.map($$Promise.map(Curry._1(callback, response), Belt_List.toArray), filterReqeusts), (function (param) {
                                    return Runner$AgdaModeVscode.pushMany(runner, param);
                                  }));
                    })), (function (param) {
                  return derivedRequests.contents;
                }));
