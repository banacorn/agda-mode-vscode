...
function Impl(Editor) {
  ...
  var displayHeaderOnly = function (header) {
    return /* ViewEvent */Caml_chrome_debugger.variant("ViewEvent", 2, [/* Display */Caml_chrome_debugger.variant("Display", 0, [
                  header,
                  /* Nothing */0
                ])]);
  ...
  var timeStart = function (label) {
    return /* WithState */Caml_chrome_debugger.variant("WithState", 7, [(function (param) {
                  console.time(label);
                  ...
                  /* ViewRequest */Caml_chrome_debugger.variant("ViewRequest", 3, [
                      ...
                      (function (response) {
                          ...
                          if (typeof response === "number") {
                            if (response !== 0) {
                              var partial_arg = /* Error */Caml_chrome_debugger.variant("Error", 3, ["Prompt Cancelled"]);
                            ...
                            tasks = Curry._1(callbackOnPromptSuccess, response[0]);
                          }
  ...
  return {
          ...
          display: display,
          displayHeaderOnly: displayHeaderOnly,
