...
function Impl(Editor) {
  ...
  var toString = function (cmd) {
    ...
    switch (cmd.tag | 0) {
      ...
      case /* Decoration */4 :
          ...
          switch (tmp) {
            case /* StopAddingIndirectly */0 :
                return "Decoration[StopAddingIndirectly]";
            case /* RemoveAll */1 :
                return "Decoration[RemoveAll]";
            case /* Refresh */2 :
  ...
  var query = function (header, body, placeholder, value, callbackOnQuerySuccess) {
