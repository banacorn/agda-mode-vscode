...
function Impl(Editor) {
  ...
  var display$prime = function (header, message) {
    if (message !== undefined) {
      return /* ViewReq */Caml_chrome_debugger.variant("ViewReq", 2, [
                /* Plain */Caml_chrome_debugger.variant("Plain", 0, [
                    header,
  ...
  var afterQuery = function (callbackOnQuerySuccess, result) {
    if (typeof result !== "number") {
      if (result.tag) {
        ...
        return Curry._1(callbackOnQuerySuccess, result[0]);
      }
    }
    if (result === /* Success */0) {
      return /* [] */0;
                      ...
                      (function (response) {
                          ...
                          if (typeof response === "number") {
                            ...
                            tasks = response.tag ? (
                              ...
                              ) : Curry._1(callbackOnQuerySuccess, response[0]);
                          }
