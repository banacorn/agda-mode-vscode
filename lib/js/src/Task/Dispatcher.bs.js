...
function Impl(Editor) {
        ...
        case /* SendRequest */1 :
            if (TaskQueue$AgdaModeVscode.agdaIsOccupied(queue)) {
              ...
              $$Promise.map($$Promise.flatMap(sendAgdaRequest((function (tasks) {
                              return TaskQueue$AgdaModeVscode.addTasksToAgda(queue, tasks);
                      ...
                      return TaskQueue$AgdaModeVscode.addTasksToFront(queue, tasks);
                    }));
              keepRunning = $$Promise.resolved(true);
            }
            break;
            ...
            if (TaskQueue$AgdaModeVscode.viewIsOccupied(queue)) {
              ...
              $$Promise.map($$Promise.flatMap(Curry._2(Task.State.sendRequestToView, state, task[0]), (function (response) {
                          if (response !== undefined) {
                            ...
                            return TaskQueue$AgdaModeVscode.releaseView(queue);
                          } else {
  ...
  var make = function (state) {
    return {
            blocking: TaskQueue$AgdaModeVscode.make((function (param, param$1) {
                    return executeTask(state, param, param$1);
                  })),
            critical: TaskQueue$AgdaModeVscode.make((function (param, param$1) {
                    return executeTask(state, param, param$1);
                  }))
          };
  };
  var dispatchCommand = function (self, command) {
    ...
    switch (exit) {
      case 1 :
          return TaskQueue$AgdaModeVscode.addTasksToBack(self.blocking, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [command]),
                        /* [] */0
                      ]));
      case 2 :
          return TaskQueue$AgdaModeVscode.addTasksToBack(self.critical, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [command]),
                        /* [] */0
                      ]));
