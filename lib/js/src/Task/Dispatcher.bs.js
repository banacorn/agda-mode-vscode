    ...
    var classifyTask = function (task) {
      ...
      switch (task.tag | 0) {
        ...
        case /* Debug */7 :
            ...
            var tasks$4 = /* :: */Caml_chrome_debugger.simpleVariant("::", [
                tasks_000,
                /* [] */0
              ]);
            Runner$AgdaModeVscode.pushAndRun(self.runner, tasks$4);
            return $$Promise.resolved(true);
  ...
  var dispatchCommand = function (self, state, command) {
    ...
    if (typeof command === "number" && command >= 8) {
      if (state.inputMethod.activated) {
        return addTasks(self, /* :: */Caml_chrome_debugger.simpleVariant("::", [
