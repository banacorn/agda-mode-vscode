...
function Impl(Editor) {
  ...
  var sendAgdaRequest = function (addToAgdaQueue, addToDeferredQueue, state, request) {
    ...
    var handler = function (error) {
      ...
      if (match) {
        ...
        return Curry._1(addToAgdaQueue, Curry._1(ResponseHandler.handle, response$2));
      }
      Curry._1(log, ">>| ");
        ...
        case /* AgdaRequest */1 :
            if (TaskQueue$AgdaModeVscode.Agda.isOccupied(queue)) {
              ...
              $$Promise.map($$Promise.flatMap(sendAgdaRequest((function (tasks) {
                      ...
                      return TaskQueue$AgdaModeVscode.addToTheFront(queue, deferredTasks$1);
                    }));
              keepRunning = $$Promise.resolved(true);
            }
            break;
  ...
  var make = function (extentionPath, editor, removeFromRegistry) {
