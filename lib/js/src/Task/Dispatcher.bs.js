  ...
  var executeTask = function (self, state, task) {
    ...
    switch (task.tag | 0) {
      ...
      case /* AddHighlightings */4 :
          Belt_Array.forEach(Belt_Array.keep(task[0], (function (annotation) {
                      return Belt_Array.some(annotation.aspects, Response$AgdaModeVscode.Aspect.shouldHighlight);
                    })), (function (annotation) {
                  console.log(Response$AgdaModeVscode.Highlighting.toString(annotation));
