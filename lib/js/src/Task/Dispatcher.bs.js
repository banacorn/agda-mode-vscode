...
function Impl(Editor) {
  ...
  var sendAgdaRequest = function (addToAgdaQueue, addToDeferredQueue, state, request) {
    ...
    return $$Promise.tap($$Promise.flatMap($$Promise.mapOk(Curry._1(Task.State.connect, state), (function (connection) {
                          ...
                          var filepath = Belt_Option.getWithDefault(Curry._1(Editor.getFileName, $$document), "");
                          ...
                          var encoded = Curry._7(Task.$$Request.encode, $$document, version, filepath, backend, libraryPath, highlightingMethod, request);
        ...
        case /* AgdaRequest */1 :
            if (Curry._1(TaskQueue.Agda.isOccupied, queue)) {
              ...
              keepRunning = $$Promise.map($$Promise.flatMap(sendAgdaRequest((function (tasks) {
                      ...
                      var deferredTasks$2 = Curry._1(Editor.Config.getSemanticHighlighting, undefined) ? deferredTasks$1 : /* :: */Caml_chrome_debugger.simpleVariant("::", [
  ...
  var make = function (extentionPath, editor, removeFromRegistry, eventEmitter) {
    ...
    var definitionProvider = function (fileName, point) {
      var currentFileName = Curry._1(Editor.getFileName, Curry._1(Editor.getDocument, state.editor));
      if (Caml_obj.caml_equal(fileName, currentFileName)) {
        return Curry._2(Task.Decoration.lookupSrcLoc, state.decorations, point);
      }
    ...
    var disposables = Curry._2(Editor.registerProvider, definitionProvider, hoverProvider);
    ...
    var documentSemanticTokensProvider = function (fileName, push) {
      var useSemanticHighlighting = Curry._1(Editor.Config.getSemanticHighlighting, undefined);
      console.log("useSemanticHighlighting");
      var currentFileName = Curry._1(Editor.getFileName, Curry._1(Editor.getDocument, state.editor));
      if (useSemanticHighlighting && Caml_obj.caml_equal(fileName, currentFileName)) {
        return Caml_option.some(Curry._3(Task.Decoration.generateSemanticTokens, editor, state.decorations.highlightings, push));
      }
      
    };
    var disposables$1 = Curry._2(Editor.registerTestingProvider, documentSemanticTokensProvider, /* tuple */[
          tokenTypes,
          tokenModifiers
        ]);
