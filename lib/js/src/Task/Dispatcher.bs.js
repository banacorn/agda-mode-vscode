  ...
  var sendAgdaRequest = function (addToAgdaQueue, addToDeferredQueue, state, request) {
    ...
    var handler = function (error) {
      ...
      if (match) {
        ...
        var exit = 0;
        if (typeof response$2 === "number") {
          exit = 1;
        } else {
          switch (response$2.tag | 0) {
        ...
        switch (exit) {
          ...
          case 2 :
              Curry._1(log, "~~~ " + Response$AgdaModeVscode.toString(response$2));
              var tasks$1 = Curry._1(ResponseHandler.handle, response$2);
              return Curry._2(addToDeferredQueue, -1, tasks$1);
      ...
      switch (task.tag | 0) {
        ...
        case /* AgdaRequest */1 :
            if (Curry._1(TaskQueue.Agda.isOccupied, queue)) {
              ...
              var deferredTasks = [];
              keepRunning = $$Promise.map($$Promise.flatMap($$Promise.tap(sendAgdaRequest((function (tasks) {
                              ...
                              deferredTasks.push(/* tuple */[
                                    ...
                                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                        /* Decoration */Caml_chrome_debugger.variant("Decoration", 4, [/* StopAddingIndirectly */0]),
                                        /* [] */0
                                      ])
                                  ]);
