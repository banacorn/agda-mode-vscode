    ...
    switch (task.tag | 0) {
      ...
      case /* AddHighlightings */4 :
          Belt_Array.forEach(Belt_Array.keep(task[0], (function (annotation) {
                      return Belt_Array.some(annotation.aspects, Highlighting$AgdaModeVscode.Aspect.shouldHighlight);
                    })), (function (annotation) {
                  console.log(Highlighting$AgdaModeVscode.toString(annotation));
