...
function Impl(Editor) {
  ...
  var destroy$prime = function (self) {
    self.queues = MultiQueue$AgdaModeVscode.make(undefined);
    return $$Promise.resolved(undefined);
  };
  var Runner = {
    make: make,
  ...
  var destroy$prime$1 = function (self) {
    return $$Promise.flatMap(destroy$prime(self.critical), (function (param) {
                  return destroy$prime(self.blocking);
                }));
  };
  return {
