...
function Impl(Editor) {
  ...
  var log$1 = function (queues) {
    ...
    return Curry._1(log, strings.join("\n"));
  };
  ...
  var executeTask = function (self, state, task) {
    ...
    switch (task.tag | 0) {
      ...
      case /* ViewReq */2 :
          var request = task[0];
          if (typeof request !== "number" && !request.tag) {
            var match = request[1];
            if (typeof match !== "number" && match.tag) {
              ...
              var request$1 = /* Plain */Caml_chrome_debugger.variant("Plain", 0, [
                  request_000,
                  request_001
                ]);
      ...
      case /* ViewEvent */3 :
          var $$event = task[0];
          var tasks$1 = typeof $$event === "number" ? (
              $$event !== 0 ? /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Terminate */0,
                    /* [] */0
                  ]) : /* [] */0
            ) : /* :: */Caml_chrome_debugger.simpleVariant("::", [
                /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* InputMethod */Caml_chrome_debugger.variant("InputMethod", 4, [/* InsertChar */Caml_chrome_debugger.variant("InsertChar", 1, [$$event[0][0]])])]),
                /* [] */0
              ]);
  ...
  var kickStart = function (self, state) {
    if (!self.busyCritical) {
      var task = getNextTask$2(self);
      if (task !== undefined) {
        self.busyCritical = true;
        $$Promise.get(executeTask(self, state, task), (function (keepRunning) {
    ...
    if (!self.busyCritical) {
      return Belt_Option.forEach(getNextTask$1(self), (function (task) {
