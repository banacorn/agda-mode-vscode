...
function make(extentionPath, editor, removeFromRegistry, chan) {
  ...
  subscribe(Vscode.window.onDidChangeTextEditorSelection(function ($$event) {
            ...
            return $$Promise.get($$Promise.flatMap(EditorIM$AgdaModeVscode.run(state.editorIM, Caml_option.some(editor), input), (function (param) {
                              return Handle__InputMethod$AgdaModeVscode.handleEditorIMOutput(state, param);
                            })), (function (param) {
