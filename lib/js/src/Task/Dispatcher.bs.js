...
function make(extentionPath, editor, removeFromRegistry, chan) {
  ...
  subscribe(Vscode.window.onDidChangeTextEditorSelection(function ($$event) {
            ...
            return $$Promise.get($$Promise.map(EditorIM$AgdaModeVscode.run(state.editorIM, editor, input), Handle__InputMethod$AgdaModeVscode.handleEditorIMOutput), (function (actions) {
