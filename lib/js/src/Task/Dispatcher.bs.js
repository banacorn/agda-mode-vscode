...
function Impl(Editor) {
  ...
  var addTasks = function (self, resource, tasks) {
    ...
    var queues = self.blockedQueues;
    if (queues) {
      self.blockedQueues = go(queues);
      return ;
    } else {
        ...
        case /* SendRequest */0 :
            if (blockedBy(self, /* Agda */0)) {
              ...
              $$Promise.get(sendAgdaRequest((function (param) {
                          return addTasks(self, /* Agda */0, param);
        ...
        case /* ViewReq */1 :
            ...
            if (blockedBy(self, /* View */1)) {
              ...
              return $$Promise.map(Curry._2(Task.State.sendRequestToView, state, task[0]), (function (response) {
                            addTasks(self, /* View */1, Curry._1(callback, response));
