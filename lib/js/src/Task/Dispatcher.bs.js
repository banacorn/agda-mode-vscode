...
function Impl(Editor) {
  ...
  var add = function (queues, source) {
  ...
  var concatTasks = function (queues, target, tasks) {
    var concatenated = {
      contents: false
    };
    return Belt_List.keepMap(queues, (function (param) {
  ...
  var spawnQueue = function (self, source) {
    self.queues = add(self.queues, source);
  ...
  var addTasksToQueue = function (self, target, tasks) {
    self.queues = concatTasks(self.queues, target, tasks);
  ...
  var dispatchCommand = function (self, state, command) {
    if (typeof command === "number" && command >= 8) {
      if (state.inputMethod.activated) {
        addTasksToQueue(self, /* Command */2, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* InputSymbol */Caml_chrome_debugger.variant("InputSymbol", 4, [/* Deactivate */1])]),
                /* [] */0
              ]));
        return kickStart(self, state);
      } else {
