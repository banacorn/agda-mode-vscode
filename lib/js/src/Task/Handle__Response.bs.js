  ...
  var handle$1 = function (info) {
    ...
    switch (info.tag | 0) {
      ...
      case /* GiveAction */4 :
          ...
          var index = info[0];
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetIndexedOr */Caml_chrome_debugger.variant("GetIndexedOr", 4, [
                            index,
                            (function (goal) {
                                var tasks;
                                ...
                                return $$Promise.resolved(List.concat(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                  tasks,
