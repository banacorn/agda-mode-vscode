  ...
  var handle$1 = function (indices) {
    ...
    switch (indices.tag | 0) {
      ...
      case /* InteractionPoints */3 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* Instantiate */Caml_chrome_debugger.variant("Instantiate", 0, [indices[0]])]),
      ...
      case /* GiveAction */4 :
          ...
          var index = indices[0];
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetIndexedOr */Caml_chrome_debugger.variant("GetIndexedOr", 6, [
                            index,
                            (function (goal, param) {
                                var tasks;
                                ...
                                return List.concat(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              ...
                                              /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* RemoveBoundaryAndDestroy */Caml_chrome_debugger.variant("RemoveBoundaryAndDestroy", 2, [goal])]),
                                                      /* [] */0
                                                    ]),
                                                  /* [] */0
                                                ])
      ...
      case /* MakeCase */5 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* GetPointedOr */Caml_chrome_debugger.variant("GetPointedOr", 5, [
                            (function (goal, param) {
                                var tasks = Curry._1(CommandHandler.handle, /* Load */0);
                                if (makeCaseType) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* ReplaceWithLambda */Caml_chrome_debugger.variant("ReplaceWithLambda", 4, [
                                                    goal,
                                                    lines
                                                  ])]),
                                            tasks
                                  ...
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* Goal */Caml_chrome_debugger.variant("Goal", 4, [/* ReplaceWithLines */Caml_chrome_debugger.variant("ReplaceWithLines", 3, [
                                                    goal,
                                                    lines
                                                  ])]),
                                            tasks
