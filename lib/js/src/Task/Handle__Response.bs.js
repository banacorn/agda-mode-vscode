  ...
  var handle = function (payload) {
    ...
    switch (payload.tag | 0) {
      ...
      case /* HelperFunction */14 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 7, [(function (param) {
  ...
  var handle$1 = function (response) {
    ...
    switch (response.tag | 0) {
      ...
      case /* InteractionPoints */4 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* Instantiate */Caml_chrome_debugger.variant("Instantiate", 0, [response[0]])]),
                    /* :: */Caml_chrome_debugger.simpleVariant("::", [
      ...
      case /* GiveAction */5 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* GetIndexedOr */Caml_chrome_debugger.variant("GetIndexedOr", 7, [
                            index,
                            (function (goal, param) {
                                var tasks;
                                ...
                                return List.concat(/* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              ...
                                              /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                      /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* RemoveBoundaryAndDestroy */Caml_chrome_debugger.variant("RemoveBoundaryAndDestroy", 2, [goal])]),
                                                      /* [] */0
                                                    ]),
                                                  /* [] */0
                                                ])
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* LocalOrGlobal */Caml_chrome_debugger.variant("LocalOrGlobal", 5, [
                            (function (goal) {
                                if (makeCaseType) {
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* ReplaceWithLambda */Caml_chrome_debugger.variant("ReplaceWithLambda", 4, [
                                                    goal,
                                                    lines
                                                  ])]),
                                            /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                  ...
                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                            /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* ReplaceWithLines */Caml_chrome_debugger.variant("ReplaceWithLines", 3, [
                                                    goal,
                                                    lines
                                                  ])]),
                                            /* :: */Caml_chrome_debugger.simpleVariant("::", [
