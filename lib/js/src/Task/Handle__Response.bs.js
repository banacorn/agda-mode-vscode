  ...
  var handle$1 = function (response) {
    ...
    switch (response.tag | 0) {
      ...
      case /* GiveAction */5 :
          ...
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 6, [/* GetIndexedOr */Caml_chrome_debugger.variant("GetIndexedOr", 8, [
                            index,
                            (function (goal, param) {
                                var tasks;
                            ...
                            var solveOne = function (param) {
                              ...
                              if (goal !== undefined) {
                                return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                          ...
                                          /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                              /* Goal */Caml_chrome_debugger.variant("Goal", 6, [/* SetCursor */Caml_chrome_debugger.variant("SetCursor", 2, [goal.range[0]])]),
                                              /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                  /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 0, [/* Give */5]),
                                                  /* [] */0
                                                ])
                                            ])
                                        ]);
