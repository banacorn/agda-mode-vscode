  ...
  var handle$1 = function (info) {
    ...
    switch (info.tag | 0) {
      ...
      case /* InteractionPoints */3 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* Instantiate */Caml_chrome_debugger.variant("Instantiate", 0, [info[0]])]),
                    /* [] */0
                  ]);
      case /* GiveAction */4 :
          var give = info[1];
          var index = info[0];
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* Goal */Caml_chrome_debugger.variant("Goal", 5, [/* GetIndexedOr */Caml_chrome_debugger.variant("GetIndexedOr", 4, [
                            index,
                            (function (goal, param) {
                                var tasks;
