  ...
  var handle = function (body) {
    ...
    switch (body.tag | 0) {
      case /* Constraints */0 :
          ...
          if (body$1 !== undefined) {
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      Curry._3(Task.displayEmacs, /* ContextOrConstraints */0, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Constraints"]), body$1),
                      /* [] */0
                    ]);
          } else {
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
      ...
      case /* Time */2 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Time"]), body[0]),
                    /* [] */0
                  ]);
      case /* Error */3 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* AllGoalsWarnings */1, /* Error */Caml_chrome_debugger.variant("Error", 3, ["Error"]), body[0]),
                    /* [] */0
                  ]);
      case /* Intro */4 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Error"]), body[0]),
                    /* [] */0
                  ]);
      case /* Auto */5 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Success */Caml_chrome_debugger.variant("Success", 1, ["Auto"]), body[0]),
                    /* [] */0
                  ]);
      case /* ModuleContents */6 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Module Contents"]), body[0]),
                    /* [] */0
                  ]);
      case /* SearchAbout */7 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
      ...
      case /* WhyInScope */8 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Scope info"]), body[0]),
                    /* [] */0
                  ]);
      case /* NormalForm */9 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Normal form"]), body[0]),
                    /* [] */0
                  ]);
      case /* GoalType */10 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Goal Type"]), body[0]),
                    /* [] */0
                  ]);
      case /* CurrentGoal */11 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
      ...
      case /* Context */13 :
          return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    Curry._3(Task.displayEmacs, /* Others */5, /* Plain */Caml_chrome_debugger.variant("Plain", 0, ["Context"]), body[0]),
                    /* [] */0
                  ]);
