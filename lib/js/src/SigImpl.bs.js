...
function registerProvider(defnProvider) {
  ...
  var definitionProvider = VSCode$AgdaModeVscode.DefinitionProvider.makeWithLocations((function (textDocument, point, param) {
          return Belt_Option.map(Curry._2(defnProvider, textDocument.fileName, point), (function (result) {
                        return $$Promise.map(result, (function (pairs) {
                                      return Belt_Array.map(pairs, (function (param) {
