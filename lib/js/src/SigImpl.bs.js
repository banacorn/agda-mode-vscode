...
function registerProvider(defnProvider) {
  ...
  var definitionProvider = VSCode$AgdaModeVscode.DefinitionProvider.makeWithLocation((function (textDocument, point, param) {
          return Belt_Option.map(Curry._2(defnProvider, textDocument.fileName, point), (function (param) {
                        return new Vscode.Location(Vscode.Uri.file(param[0]), param[1]);
                      }));
        }));
