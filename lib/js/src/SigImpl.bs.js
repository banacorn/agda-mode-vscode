...
function fromAgdaOffset(editor, offset) {
  ...
  while(true) {
    ...
    var match = codeUnitEndingOffset(editor, offset$1);
    var current = match[1];
    var offset$2 = match[0];
    if (offset === current) {
      return offset$2;
    }
    var match$1 = codeUnitEndingOffset(editor, (offset$2 + offset | 0) - current | 0);
    var nextOffset = match$1[0];
    if (current === match$1[1]) {
      return nextOffset;
    }
    _offset = nextOffset;
    continue ;
