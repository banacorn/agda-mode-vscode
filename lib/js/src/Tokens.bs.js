...
function toString$3(xs) {
  var end = xs._0;
  if (end !== 0) {
    return "┣━━━━━┫" + String(end) + " ━━" + deltaToString(xs._1) + toString$2(xs._2);
  } else {
    return "┣━" + deltaToString(xs._1) + toString$2(xs._2);
  }
}
...
function totalDelta$2(xs) {
  ...
  if (typeof tail !== "object") {
    ...
    return totalDelta$1(tail);
  }
}

function removedIntervals$1(xs) {
  var end = xs._0;
  if (end !== 0) {
    return Belt_Array.concatMany([
                [[
                ...
                removedIntervals(xs._2)
              ]);
  } else {
    return removedIntervals(xs._2);
  }
}

function applyChange(xs, change) {
  var end = xs._0;
  if (end !== 0) {
    return {
            TAG: "Head",
...
var Intervals = {
  ...
  Tail: Tail,
  empty: Intervals_empty,
  toString: toString$3,
  totalDelta: totalDelta$2,
  removedIntervals: removedIntervals$1,
