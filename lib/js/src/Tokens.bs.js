...
function applyChangeAux(_xs, deltaBefore, translation, _change) {
  while(true) {
    var change = _change;
    var xs = _xs;
    if (change !== undefined) {
      ...
      switch (changeRemovalStart.TAG) {
            ...
            switch (changeRemovalEnd.TAG) {
              case "Before" :
                  ...
                  return {
                          ...
                          _3: applyChangeAux(xs, delta$1, translation, undefined),
                          [Symbol.for("name")]: "Replace"
                        };
              case "InInsertion" :
        ...
        case "InInsertion" :
            switch (changeRemovalEnd.TAG) {
              ...
              case "InInsertion" :
                  var changeEnd$1 = changeRemovalEnd._0;
                  var delta$3 = delta(change);
                  applyChangeAux(tail, delta$3, translation, undefined);
                  if (end >= changeEnd$1) {
                    _change = change;
                    _xs = {
                      TAG: "Replace",
                  ...
                  var part1Delta$1 = changeEnd$1 - end | 0;
                  _change = change;
                  _xs = {
                    TAG: "Replace",
                    _0: start,
                    _1: end,
                    _2: (deltaBefore + part1Delta$1 | 0) - translation | 0,
                    _3: {
                      TAG: "Replace",
                      _0: end,
                      _1: end,
                  ...
                  continue ;
              case "After" :
                  var delta$4 = (changeRemovalEnd._0 - end | 0) - change.removed | 0;
                  var change$p_offset$1 = (end + deltaAfter$1 | 0) + delta$4 | 0;
                  var change$p_removed$1 = change.removed + delta$4 | 0;
                  ...
                  return {
                          ...
                          _3: applyChangeAux(tail, deltaAfter$1 + delta$4 | 0, translation + delta$4 | 0, change$p$1),
                          [Symbol.for("name")]: "Replace"
                        };
