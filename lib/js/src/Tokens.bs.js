...
function applyEdit(self, editor, $$event) {
  ...
  var $$document = editor.document;
  var tokens = AVLTree$AgdaModeVscode.toArray(self.agdaTokens);
  ...
  var aspects = convert([], tokens, 0, self.deltas, 0);
  var match = fromAspects(editor, aspects);
  Resource$AgdaModeVscode.set(self.vscodeTokens, match[1]);
}
