...
function applyChangeAux(xs, deltaBefore, translation, change) {
  if (change !== undefined) {
    if (typeof xs !== "object") {
    ...
    if (typeof changeRemovalStart !== "object") {
      if (typeof changeRemovalEnd !== "object") {
        var delta$1 = delta(change);
        return {
                TAG: "Replace",
                _0: start,
                _1: end,
                _2: deltaAfter$1 + delta$1 | 0,
                _3: applyChangeAux(tail, delta$1, translation, undefined),
                [Symbol.for("name")]: "Replace"
              };
      }
      ...
      return {
              ...
              _3: applyChangeAux(tail, deltaAfter$1 + delta$2 | 0, translation + delta$2 | 0, change$p),
              [Symbol.for("name")]: "Replace"
            };
    } else {
      if (changeRemovalStart.TAG !== "Before") {
        if (typeof changeRemovalEnd !== "object" || changeRemovalEnd.TAG === "Before") {
          return Js_exn.raiseError("Not a possible case");
        } else {
          return {
                  TAG: "Replace",
                  ...
                  _1: end,
                  _2: deltaAfter$1,
                  _3: applyChangeAux(tail, deltaAfter$1, translation, change),
                  [Symbol.for("name")]: "Replace"
                };
        }
      }
      ...
      if (typeof changeRemovalEnd !== "object") {
        ...
        return {
                ...
                _3: applyChangeAux(tail, delta$3, translation, undefined),
                [Symbol.for("name")]: "Replace"
              };
      }
      if (changeRemovalEnd.TAG === "Before") {
        ...
        return {
                ...
                _2: deltaBefore + delta$4 | 0,
                _3: {
                  TAG: "Replace",
                  _0: start,
                  _1: end,
                  _2: deltaAfter$1 + delta$4 | 0,
                  _3: applyChangeAux(tail, delta$4, translation, undefined),
                  [Symbol.for("name")]: "Replace"
                },
                [Symbol.for("name")]: "Replace"
              };
      }
      var delta$5 = ((changeStart - end | 0) + deltaBefore | 0) - deltaAfter$1 | 0;
      var change$p_offset$1 = (end + deltaAfter$1 | 0) + delta$5 | 0;
      var change$p_removed$1 = change.removed + delta$5 | 0;
      ...
      return {
              ...
              _0: changeStart,
              _1: end,
              _2: deltaAfter$1 + delta$5 | 0,
              _3: applyChangeAux(tail, deltaAfter$1 + delta$5 | 0, translation + delta$5 | 0, change$p$1),
              [Symbol.for("name")]: "Replace"
            };
    }
  } else {
    ...
    return {
            ...
            _0: xs._0,
            _1: xs._1,
            _2: deltaBefore + deltaAfter$2 | 0,
            _3: applyChangeAux(xs._3, deltaBefore, translation, undefined),
            [Symbol.for("name")]: "Replace"
          };
  }
}
...
function applyChangesAux(xs, changes) {
  return Core__List.reduce(changes, xs, (function (xs, change) {
                return applyChangeAux(xs, 0, 0, change);
              }));
}
...
function applyChanges(xs, changes) {
  return applyChangesAux(xs, Core__List.fromArray(preprocessChangeBatch(changes)));
}
