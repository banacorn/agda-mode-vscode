...
function applyChangeAux(xs, deltaBefore, change) {
  if (typeof xs !== "object") {
  ...
  switch (changeRemovalStart.TAG) {
    case "Before" :
        ...
        switch (changeRemovalEnd.TAG) {
          ...
          case "After" :
              var delta$3 = ((changeStart - end | 0) + deltaBefore | 0) - deltaAfter$1 | 0;
              var change$p_offset = (end + deltaAfter$1 | 0) + delta$3 | 0;
              var change$p_removed = change.removed + delta$3 | 0;
              ...
              return {
                      ...
                      _3: applyChangeAux(adjustDelta(delta$3, tail), deltaAfter$1 + delta$3 | 0, change$p),
                      [Symbol.for("name")]: "Replace"
                    };
    ...
    case "InInsertion" :
        switch (changeRemovalEnd.TAG) {
          ...
          case "After" :
              var delta$5 = (changeRemovalEnd._0 - end | 0) - change.removed | 0;
              ...
              return {
                      ...
                      _3: applyChangeAux(adjustDelta(delta$5, tail), deltaAfter$1 + delta$5 | 0, change$p$1),
                      [Symbol.for("name")]: "Replace"
                    };
        ...
        switch (changeRemovalEnd.TAG) {
          ...
          case "After" :
              return {
                      ...
                      _1: end,
                      _2: deltaAfter$1,
                      _3: applyChangeAux(tail, deltaAfter$1, change),
                      [Symbol.for("name")]: "Replace"
                    };
...
function applyChangesAux(xs, changes) {
  return Core__List.reduce(changes, xs, (function (xs, change) {
                return applyChangeAux(xs, 0, change);
              }));
}
