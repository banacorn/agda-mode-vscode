...
function insert(self, editor, tokens) {
  ...
  tokens.forEach(function (token) {
        ...
        var offsetEnd = Agda$AgdaModeVscode.OffsetConverter.convert(offsetConverter, token.end_);
        ...
        var end_ = $$document.positionAt(Agda$AgdaModeVscode.OffsetConverter.convert(offsetConverter, token.end_));
        var range$1 = new Vscode.Range(start, end_);
        self.agdaTokens.insert(offsetStart, [
              token,
              [
                offsetStart,
