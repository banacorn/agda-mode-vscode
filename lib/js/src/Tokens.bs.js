  ...
  tokens.forEach(function (token) {
        ...
        var source = Core__Option.map(token.source, (function (param) {
                ...
                if (Caml_obj.equal(filepath, currentFilepath)) {
                  return [
                          filepath,
                          Agda$AgdaModeVscode.OffsetConverter.convert(offsetConverter, agdaOffset - 1 | 0)
                        ];
                } else {
                  return [
                          filepath,
...
function rebaseTokens(self, editingFilepath) {
  var translateSourceOffset = function (vscodeOffset) {
    var _intervals = self.deltas;
    var _deltaBefore = 0;
    while(true) {
      var deltaBefore = _deltaBefore;
      var intervals = _intervals;
      if (typeof intervals !== "object") {
        return vscodeOffset + deltaBefore | 0;
      }
      var removalStart = intervals._0;
      if (vscodeOffset < removalStart) {
        return vscodeOffset + deltaBefore | 0;
      }
      if (vscodeOffset < intervals._1) {
        return removalStart + deltaBefore | 0;
      }
      _deltaBefore = intervals._2;
      _intervals = intervals._3;
      continue ;
