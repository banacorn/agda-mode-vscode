...
function toString$2(xs) {
  if (typeof xs !== "object") {
    ...
    return "━━┫" + String(xs._0) + " ━" + toString$1(xs._1) + toString$2(xs._2);
  }
}

function applyChange(start, delta, xs, change) {
  if (typeof xs !== "object") {
    if (change.rangeLength > 0) {
      ...
      return {
              ...
              _1: {
                TAG: "Moved",
                _0: delta,
                [Symbol.for("name")]: "Moved"
              },
              _2: "Nil",
              [Symbol.for("name")]: "Cons"
            };
    }
  } else {
    return xs;
...
function toString$3(xs) {
  return "┣━━━━━" + toString$1(xs._0) + toString$2(xs._1);
}

function applyChange$1(xs, change) {
  return {
          TAG: "Head",
          _0: xs._0,
          _1: applyChange(0, 0, xs._1, change),
