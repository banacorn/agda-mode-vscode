  ...
  var go = function (_accMap, _accDeltaBeforePart, _accDeltaAfterPart, _parts, _changes) {
    while(true) {
      ...
      if (changes) {
        ...
        switch (match$1) {
          case "Case1" :
              console.log("Case 1, goal #" + index.toString() + ", part: " + partToString(part));
              _changes = changes$1;
              _parts = {
                hd: [
                  index,
              ...
              continue ;
          case "Case2" :
              console.log("Case 2, goal #" + index.toString() + ", part: " + partToString(part) + ", removal: " + removalStart.toString() + "-" + removalEnd.toString());
              var tmp;
              switch (part) {
                case "LeftBoundary" :
              ...
              continue ;
          case "Case3" :
              console.log("Case 3, goal #" + index.toString() + ", part: " + partToString(part));
              var tmp$1;
              switch (part) {
                case "LeftBoundary" :
              ...
              continue ;
          case "Case4" :
              console.log("Case 4, goal #" + index.toString() + ", part: " + partToString(part) + ", removal: " + removalStart.toString() + "-" + removalEnd.toString());
              switch (part) {
                case "LeftBoundary" :
                    _changes = changes$1;
                    _parts = {
          ...
          case "Case5" :
              console.log("Case 5, goal #" + index.toString() + ", part: " + partToString(part));
              var tmp$2;
              switch (part) {
                case "LeftBoundary" :
              ...
              continue ;
          case "Case6" :
              console.log("Case 6, goal #" + index.toString() + ", part: " + partToString(part));
              var tmp$3;
              switch (part) {
                case "LeftBoundary" :
