...
function updateGoalPositionByIndex(self, editor, index, deltaStart, deltaEnd, redecorate) {
  var goal = self.goals.get(index);
  if (goal !== undefined) {
...
function addQuestionMark(map, index, delta) {
  var match = map.get(index);
  if (match !== undefined) {
    return map;
  } else {
...
async function checkAllParts(self, editor, changes) {
  ...
  var go = function (_accMap, _accDeltaBeforePart, _accDeltaAfterPart, _parts, _changes) {
    while(true) {
      ...
      if (changes) {
        ...
        console.log(" removalStart: " + removalStart.toString() + " removalEnd: " + removalEnd.toString() + " start: " + start.toString() + " end: " + end.toString());
        ...
        switch (part) {
          ...
          case "RightBoundary" :
              ...
              break;
          case "QuestionMark" :
              tmp$3 = addQuestionMark(accMap, index, accDeltaBeforePart);
              break;
      ...
      switch (part) {
        ...
        case "RightBoundary" :
            ...
            break;
        case "QuestionMark" :
            tmp$4 = addQuestionMark(accMap, index, accDeltaBeforePart);
            break;
  ...
  console.log("StateMap2: " + toString$2(map));
  var rewrites = Core__Array.filterMap(Array.from(map.entries()), (function (param) {
          ...
          if (state.TAG === "IsQuestionMark") {
            ...
            if (goal !== undefined) {
              return [
                      new Vscode.Range($$document.positionAt(goal.start), $$document.positionAt(goal.start + 1 | 0)),
                      "{!   !}"
                    ];
            } else {
              return ;
          ...
          if (typeof a !== "object") {
            ...
            if (typeof b !== "object") {
              ...
              updateGoalPositionByIndex(self, editor, index, a._0, b._0, false);
              return ;
            }
          }
