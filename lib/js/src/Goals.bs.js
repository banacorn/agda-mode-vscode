...
function make(editor, start, end, index) {
  ...
  var $$document = editor.document;
  var innerRange = new Vscode.Range($$document.positionAt(start + 2 | 0), $$document.positionAt(end - 2 | 0));
  var content = Editor$AgdaModeVscode.$$Text.get($$document, innerRange).trim();
  return {
          index: index,
          content: content,
          start: start,
...
function makeHaskellRangeFromGoalInfo(goalInfo, $$document, version, filepath) {
...
function getGoalInfoByIndex(self, index) {
  return Core__Option.map(self.goals.get(index), (function (goal) {
                return {
                        index: goal.index.toString(),
...
function getGoalIndexAndContentAtCursor(self, editor) {
  var $$document = editor.document;
  ...
  return Core__Option.flatMap(AVLTree$AgdaModeVscode.lowerBound(self.positions, cursorOffset), (function (index) {
                ...
                var goalContent = Editor$AgdaModeVscode.$$Text.get($$document, new Vscode.Range($$document.positionAt(goal.start + 2 | 0), $$document.positionAt(goal.end - 2 | 0))).trim();
                return [
                        goal.index,
                        goalContent
                      ];
...
var Module = {
  makeHaskellRangeFromGoalInfo: makeHaskellRangeFromGoalInfo,
  make: make$1,
  instantiateGoalsFromLoad: instantiateGoalsFromLoad,
  scanAllGoals: scanAllGoals,
  getGoalInfoByIndex: getGoalInfoByIndex,
  modify: modify,
  getGoalIndexAndContentAtCursor: getGoalIndexAndContentAtCursor,
...
exports.makeHaskellRangeFromGoalInfo = makeHaskellRangeFromGoalInfo;
exports.make = make$1;
exports.instantiateGoalsFromLoad = instantiateGoalsFromLoad;
exports.scanAllGoals = scanAllGoals;
exports.getGoalInfoByIndex = getGoalInfoByIndex;
exports.modify = modify;
exports.getGoalIndexAndContentAtCursor = getGoalIndexAndContentAtCursor;
