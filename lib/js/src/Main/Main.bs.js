...
function activateWithoutContext(platformDeps, subscriptions, extensionUri, globalStorageUri, memento) {
  ...
  Chan$AgdaModeVscode.on(channels_log, (function (message) {
          console.log(Log$AgdaModeVscode.toString(message));
        }));
...
function activate(platformDeps, context) {
  ...
  return activateWithoutContext(platformDeps, subscriptions, extensionUri, globalStorageUri, Memento$AgdaModeVscode.make(Caml_option.some(context.workspaceState)));
}
