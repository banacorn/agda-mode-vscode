  ...
  subscribe(Vscode.workspace.onDidChangeTextDocument(function ($$event) {
            Chan$AgdaModeVscode.emit(channels.log, {
                  ...
                  _0: {
                    ...
                    _0: {
                      capturedEditorDocumentFileName: editor.document.fileName,
                      stateEditorDocumentFileName: state.editor.document.fileName,
                      eventDocumentFileName: $$event.document.fileName,
                      capturedEditorIsStateEditor: editor === state.editor,
                      capturedDocumentIsStateDocument: editor.document === state.document,
                      eventDocumentIsStateDocument: $$event.document === state.document,
                      capturedDocumentIsEventDocument: editor.document === $$event.document
                    }
                  }
                });
