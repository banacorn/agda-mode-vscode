...
function activateWithoutContext(platformDeps, subscriptions, extensionUri, globalStorageUri, memento) {
  ...
  subscribe(Vscode.languages.registerHoverProvider([VSCode.StringOr.make({
                  TAG: "Others",
                  _0: {
                    language: "agda",
                    pattern: undefined,
            ...
            provideHover: (function ($$document, position, token) {
                ...
                switch (c) {
                  case "λ" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type λ using \\lambda or \\Gl")]));
                                      })));
                  case "₁" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type ₁ using \\_1")]));
                                      })));
                  case "ℓ" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type ℓ using \\ell")]));
                                      })));
                  case "→" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type → using \\r")]));
                                      })));
                  case "≃" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type ≃ using \\simeq")]));
                                      })));
                  case "⊥" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type ⊥ using \\bot")]));
                                      })));
                  case "𝟘" :
                      return Caml_option.some(new Promise((function (resolve, reject) {
                                        resolve(new Vscode.Hover([new Vscode.MarkdownString("Type 𝟘 using \\b0")]));
                                      })));
                  default:
                    return ;
                }
