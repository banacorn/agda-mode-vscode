...
function alreadyDownloaded2(globalStorageUri) {
...
function downloadLatestALS2(memento, globalStorageUri) {
  return async function (platform) {
    ...
    if (endpoint.TAG === "Ok") {
      return {
              TAG: "Ok",
              _0: Connection__URI$AgdaModeVscode.toString(Connection__Endpoint$AgdaModeVscode.toURI(endpoint._0))
            };
    } else {
      return {
              TAG: "Error",
