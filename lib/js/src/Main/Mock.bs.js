...
function getDownloadDescriptor(target, param) {
  return async function (param, param$1, param$2) {
    return {
            TAG: "Error",
...
function getDownloadDescriptorOfDevWASMALS(_memento, _globalStorageUri, param) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function getDownloadDescriptor$1(target, param) {
  return async function (param, param$1, param$2) {
    return {
            TAG: "Error",
            _0: "CannotFindCompatibleALSRelease"
...
function getDownloadDescriptorOfDevWASMALS$1(_memento, _globalStorageUri, param) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
var WithAgda = {
  ...
  getDownloadDescriptor: getDownloadDescriptor$1,
...
function makeWithDownloadPolicy(policy) {
  ...
  var getDownloadDescriptor = function (target, param) {
    return async function (param, param$1, param$2) {
      return {
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
