...
function makeWithLatestALSFailureAndDevALSSuccess(downloadedPath, checkedCacheFlag, checkedDownloadFlag) {
  var determinePlatform = async function () {
    return {
            TAG: "Ok",
            _0: "MacOS_Arm"
...
var Platform = {
  ...
  makeWithLatestALSFailureAndDevALSSuccess: makeWithLatestALSFailureAndDevALSSuccess,
