...
function getDownloadDescriptorOfDevWASMALS(_globalStorageUri) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function getDownloadDescriptorOfDevALS$1(_globalStorageUri, _platform) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function getDownloadDescriptorOfDevWASMALS$1(_globalStorageUri) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function makeWithDownloadPolicy(policy) {
  ...
  var getDownloadDescriptorOfDevALS = function (_globalStorageUri, _platform) {
    return Promise.resolve({
                TAG: "Error",
                _0: "CannotFindCompatibleALSRelease"
              });
  };
  var getDownloadDescriptorOfDevWASMALS = function (_globalStorageUri) {
    return Promise.resolve({
                TAG: "Error",
                _0: "CannotFindCompatibleALSRelease"
              });
