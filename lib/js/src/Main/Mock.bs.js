...
function makeWithSuccessfulDownloadAndFlags(downloadedEndpoint, checkedCacheFlag, checkedDownloadFlag) {
  var determinePlatform = async function () {
    return {
            TAG: "Ok",
            _0: "MacOS_Arm"
...
function makeWithCachedDownloadAndFlag(cachedEndpoint, checkedFlag) {
  var determinePlatform = async function () {
    return {
            TAG: "Ok",
            _0: "MacOS_Arm"
  ...
  var alreadyDownloaded = function (_globalStorageUri) {
    return function () {
      ...
      return Promise.resolve(cachedEndpoint);
    };
  };
  var alreadyDownloaded2 = function (_globalStorageUri) {
    return function () {
