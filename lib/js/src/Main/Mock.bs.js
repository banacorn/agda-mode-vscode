...
var mockDevALSDescriptorNativeAsset = {
  url: "https://github.com/agda/agda-language-server/releases/download/dev/als-dev-Agda-2.8.0-macos-arm64.zip",
  id: 0,
  node_id: "",
...
var mockDevALSDescriptorWasmAsset = {
  url: "https://github.com/agda/agda-language-server/releases/download/dev/als-dev-Agda-2.8.0-wasm.wasm",
  id: 1,
  node_id: "",
...
var mockDevALSDescriptorRelease_assets = [
  mockDevALSDescriptorNativeAsset,
  mockDevALSDescriptorWasmAsset
];

var mockDevALSDescriptorRelease = {
  url: "",
  assets_url: "",
  upload_url: "",
  html_url: "",
  ...
  assets: mockDevALSDescriptorRelease_assets,
  tarball_url: "",
  zipball_url: "",
  body: undefined
};

var mockDevALSDescriptor = {
  release: mockDevALSDescriptorRelease,
  asset: mockDevALSDescriptorNativeAsset,
...
var DownloadDescriptor = {
  ...
  mockDevALSDescriptorNativeAsset: mockDevALSDescriptorNativeAsset,
  mockDevALSDescriptorWasmAsset: mockDevALSDescriptorWasmAsset,
  mockDevALSDescriptorRelease: mockDevALSDescriptorRelease,
  mockDevALSDescriptor: mockDevALSDescriptor,
  mockWith: mockWith
};
...
function resolveDownloadChannel(target, param) {
  return async function (param, param$1, param$2) {
    return {
            TAG: "Error",
...
function resolveDownloadChannelOfDevALS(_memento, _globalStorageUri, _platform) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function resolveDownloadChannelOfLatestALS(_memento, _globalStorageUri, _platform) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function download(_globalStorageUri, _downloadDescriptor, $staropt$star) {
...
var Basic = {
  ...
  resolveDownloadChannelOfDevALS: resolveDownloadChannelOfDevALS,
  resolveDownloadChannelOfLatestALS: resolveDownloadChannelOfLatestALS,
  download: download,
...
function resolveDownloadChannel$1(target, param) {
  return async function (param, param$1, param$2) {
    return {
            TAG: "Error",
            _0: "CannotFindCompatibleALSRelease"
...
function resolveDownloadChannelOfDevALS$1(_memento, _globalStorageUri, _platform) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function resolveDownloadChannelOfLatestALS$1(_memento, _globalStorageUri, _platform) {
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
            });
...
function download$1(_globalStorageUri, _downloadDescriptor, $staropt$star) {
  $staropt$star !== undefined;
  return Promise.resolve({
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
...
var WithAgda = {
  ...
  resolveDownloadChannel: resolveDownloadChannel$1,
  getReleaseManifestFromGitHub: getReleaseManifestFromGitHub$1,
  resolveDownloadChannelOfDevALS: resolveDownloadChannelOfDevALS$1,
  resolveDownloadChannelOfLatestALS: resolveDownloadChannelOfLatestALS$1,
  download: download$1,
...
function makeWithDownloadPolicy(policy) {
  ...
  var resolveDownloadChannel = function (target, param) {
    return async function (param, param$1, param$2) {
      return {
              TAG: "Error",
              _0: "CannotFindCompatibleALSRelease"
...
function makeWithNativeFailureAndWASMSuccess(downloadedPath, checkedCacheFlag, checkedNativeDownloadFlag, checkedWasmDownloadFlag) {
  ...
  var nativeAssetName = "als-dev-Agda-2.8.0-ubuntu.zip";
  var devRelease_assets = [
    makeAsset(nativeAssetName),
  ...
  var nativeDescriptor_asset = makeAsset(nativeAssetName);
  var nativeDescriptor = {
    release: devRelease,
    asset: nativeDescriptor_asset,
    saveAsFileName: "dev-als"
  };
  var determinePlatform = async function () {
    return {
  ...
  var download = function (_globalStorageUri, source, $staropt$star) {
    $staropt$star !== undefined;
    if (source.TAG === "FromGitHub" && source._0 !== "LatestALS") {
      if (source._1.asset.name.includes("wasm")) {
        checkedWasmDownloadFlag.contents = true;
        return Promise.resolve({
                    TAG: "Ok",
                    _0: downloadedPath
                  });
      } else {
        checkedNativeDownloadFlag.contents = true;
        return Promise.resolve({
                    TAG: "Error",
                    _0: "CannotFindCompatibleALSRelease"
                  });
...
var Platform = {
  ...
  makeWithNativeFailureAndWASMSuccess: makeWithNativeFailureAndWASMSuccess,
  makeWithAgda: makeWithAgda
};

function make() {
  var inputMethod = Chan$AgdaModeVscode.make();
  var log = Chan$AgdaModeVscode.make();
  ...
  Chan$AgdaModeVscode.on(inputMethod, (function ($$event) {
          Chan$AgdaModeVscode.emit(log, {
                TAG: "InputMethod",
                _0: {
                  TAG: "EngineLog",
                  _0: $$event
...
function make$1(platformDeps, channels) {
  ...
  return State$AgdaModeVscode.make("mock-id", platformDeps, channels, mockStorageUri, mockExtensionUri, Memento$AgdaModeVscode.make(undefined), mockEditor, undefined);
}
