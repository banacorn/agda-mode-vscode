...
function make$1(tryTCP) {
  return $$Promise.flatMap($$Promise.flatMapOk(probe(tryTCP, "als"), make), (function (result) {
                if (result.TAG !== /* Ok */0) {
...
function destroy(self) {
  var self$1 = self.client;
  self$1.subscription.dispose();
  return $$Promise.map($$Promise.Js.toResult(self$1.client.stop()), (function (param) {
...
function sendRequest$1(self, request, handler) {
