...
function make(param) {
  ...
  var args = Config$AgdaModeVscode.Connection.getCommandLineOptions(undefined).concat(["--interaction"]);
  return $$Promise.tapOk($$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMapOk(getPath(undefined), (function (path) {
                    ...
                    return {
                            metadata: metadata,
                            process: Connection__Process$AgdaModeVscode.make(metadata.path, metadata.args),
