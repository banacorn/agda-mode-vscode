...
function onResponse(conn, callback) {
  ...
  var allResponsesHaveBeenHandled = match$1[1];
  var responseHandlingPromise = match$1[0];
  var listener = function (x) {
    if (x.TAG === /* Ok */0) {
      ...
      return $$Promise.get(Connection__Scheduler$AgdaModeVscode.runLast(scheduler, (function (response) {
                        return Curry._1(callback, {
                                    TAG: 0,
                                    _0: response,
                                    [Symbol.for("name")]: "Ok"
                                  });
                      })), allResponsesHaveBeenHandled);
    }
    var error = x._0;
    Curry._1(stopResponseListener, {
          TAG: 1,
  ...
  return $$Promise.flatMap($$Promise.tap(match[0], (function (param) {
