...
function make(param) {
  ...
  var setPath = function (metadata) {
    return $$Promise.map(Config$AgdaModeVscode.Connection.setAgdaPath(metadata.path), (function (param) {
                  return {
                          TAG: 0,
                          _0: metadata,
                          [Symbol.for("name")]: "Ok"
  ...
  return $$Promise.tapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(getPath(undefined), (function (path) {
                    ...
                    return $$Promise.mapError($$Promise.mapOk(Connection__Process$AgdaModeVscode.make(metadata.path, metadata.args), (function ($$process) {
                                      return {
                                              metadata: metadata,
                                              process: $$process,
