          ...
          switch (x.TAG | 0) {
            case /* Stdout */0 :
                ...
                if (Js_string.startsWith("Error:", rawText)) {
                  ...
                  return Belt_Array.forEach(Parser$AgdaModeVscode.splitToLines(rawText), (function (param) {
...
function make$1(method) {
  ...
  var args = Js_array.concat(Config$AgdaModeVscode.Connection.getCommandLineOptions(undefined), ["--interaction"]);
  return $$Promise.tapOk($$Promise.mapOk(make(method._0, args), (function (procInfo) {
                    return {
                            procInfo: procInfo,
...
function onResponse(conn, callback) {
  ...
  return $$Promise.tap(match[0], (function (param) {
                Belt_Option.forEach(listenerHandle.contents, (function (destroyListener) {
                        Curry._1(destroyListener, undefined);
                      }));
              }));
}
