...
function handleError(command, error) {
  return Core__Option.map((error == null) ? undefined : Caml_option.some(error), (function (err) {
                ...
                if (/No such file or directory/.test(message) || /command not found/.test(message) || /not found/.test(message) || /No such file or directory/.test(message) || /ENOENT/.test(message)) {
                  return {
                          TAG: "NotFound",
                          _0: command,
...
function runWithExec(path, args) {
...
function runWithExecNoBackslash(path, args) {
  return new Promise((function (resolve, param) {
                if (path === "") {
                  resolve({
                        TAG: "Error",
                ...
                if (Util$AgdaModeVscode.onUnix || !path.endsWith(".bat")) {
                ...
                var command = "\"/d/a/agda-mode-vscode/agda-mode-vscode/Agda-2.7.0-windows-latest/bin/agda\"";
                Nodechild_process.execFile(command, ["--version"], (function (error, stdout, stderr) {
                        clearTimeout(hangTimeout);
                        Core__Option.forEach(handleError(command, error), (function (err) {
                                resolve({
                                      TAG: "Error",
...
function runOld(path, args, validator) {
  return new Promise((function (resolve, param) {
                if (path === "") {
                  resolve({
                        TAG: "Error",
...
exports.runWithExec = runWithExec;
exports.runWithExecNoBackslash = runWithExecNoBackslash;
exports.runOld = runOld;
