...
async function downloadLanguageServer(repo, onDownload, fetchSpec) {
  ...
  var destPath = Nodepath.join(repo.globalStoragePath, fetchSpec.saveAsFileName);
...
async function download(fetchSpec, memento, globalStoragePath, reportProgress) {
  var repo = {
    username: "agda",
  ...
  var destPath = Nodepath.join(globalStoragePath, fetchSpec.saveAsFileName);
