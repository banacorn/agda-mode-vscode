...
async function download(globalStorageUri, channel, traceOpt, fetchFileOpt, $$fetch) {
  ...
  var error = await Connection__Download__GitHub$AgdaModeVscode.download(downloadDescriptor, globalStorageUri, reportProgress, trace, undefined, undefined, Caml_option.some(fetchFile), undefined, undefined);
  if (error.TAG !== "Ok") {
    return {
            TAG: "Error",
            _0: {
