...
async function report(name, withProgressOpt) {
  ...
  return function ($$event) {
    if (typeof $$event !== "object") {
      ...
      var increment;
      if (totalOpt !== undefined) {
        var percentageNew = $$event._0 / totalOpt * 100.0 | 0;
...
async function asFile(httpOptions, destUri, onDownload, _traceOpt, fetchOpt, readBodyOpt, writeFileOpt) {
  ...
  try {
    ...
    var uint8Array = await readBody(response$1);
