...
function toString$1($$event) {
  ...
  var accum = $$event._0;
  if (total > 10485760) {
    return "Downloading ( " + String(accum / 1048576 | 0) + " MB / " + String(total / 1048576 | 0) + " MB )";
  } else {
    return "Downloading ( " + String(accum / 1024 | 0) + " KB / " + String(total / 1024 | 0) + " MB )";
  }
}
