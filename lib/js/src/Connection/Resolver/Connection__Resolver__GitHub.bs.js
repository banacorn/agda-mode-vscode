...
function writeTimestamp(memento, timestamp) {
  return State__Type$AgdaModeVscode.Memento.update(memento, "alsReleaseCacheTimestamp", timestamp.toString());
}
...
function writeReleaseCache(memento, releases) {
  return State__Type$AgdaModeVscode.Memento.update(memento, "alsReleaseCache", releases);
}
