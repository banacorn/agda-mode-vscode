...
function addEndpointError(x, path, error) {
  x.endpoints[path] = error;
  return x;
}

function addCommandError(x, command, error) {
  x.commands[command] = error;
  return x;
}

function addDownloadError(x, error) {
...
var Construction = {
  toString: toString,
  addEndpointError: addEndpointError,
  addCommandError: addCommandError,
  addDownloadError: addDownloadError,
  make: make,
  merge: merge,
  mergeMany: mergeMany
};
