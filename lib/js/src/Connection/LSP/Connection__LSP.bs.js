...
function make(param) {
  return $$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMap(Connection__Probe$AgdaModeVscode.probe("als", (function (param) {
                    ...
                    return $$Promise.mapError(Client__LSP$LanguageServerMule.make("agda", "Agda Language Server", method), (function (e) {
                                  return {
                                          TAG: 4,
                                          _0: e,
...
function sendRequest(self, request, handler) {
  ...
  Client__LSP$LanguageServerMule.onRequest(self.client, (function (json) {
  ...
  return $$Promise.tap($$Promise.flatMapOk(sendRequestPrim(self.client, {
                      _0: request,
