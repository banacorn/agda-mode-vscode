...
var decode = Util$AgdaModeVscode.Decode.sum_(function (x) {
      switch (x) {
        case "CmdRes" :
            return {
                    TAG: 0,
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.option(Connection__LSP__Error$AgdaModeVscode.CommandErr.decode), (function (error) {
                            return {
                                    TAG: 1,
                                    _0: error,
        ...
        default:
          throw {
                ...
                _1: "[Connection.LSP.CommandRes] Unknown constructor: " + x,
                Error: new Error()
              };
      }
    });
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Json_decode.pair(Json_decode.string, (function (param) {
                                                    return Json_decode.array((function (param) {
                                                                  return Util$AgdaModeVscode.Decode.convert("Item.decode in DisplayInfoGeneric", Item$AgdaModeVscode.decode, param);
                                                                }), param);
                                                  }), param);
                                    }), param);
                      }),
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Json_decode.pair(Json_decode.$$int, (function (param) {
                                                    return Util$AgdaModeVscode.Decode.convert("Response.GiveAction.decode in ResponseGiveAction", Response$AgdaModeVscode.GiveAction.decode, param);
                                                  }), param);
                                    }), param);
                      }),
                    [Symbol.for("name")]: "Contents"
            ...
            return {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Util$AgdaModeVscode.Decode.convert("Tokens.Token.decodeResponseHighlightingInfoDirect in LSPResponse", Tokens$AgdaModeVscode.Token.decodeResponseHighlightingInfoDirect, param);
                                    }), param);
                      }),
                    [Symbol.for("name")]: "Contents"
                  };
...
function decodeCommandRes(json) {
  var response = Json$JsonCombinators.decode(json, decode);
...
function decodeResponse(json) {
  ...
  try {
    ...
    if (msg.RE_EXN_ID === Util$AgdaModeVscode.Decode.TempDecodeError) {
      return {
              TAG: 1,
              _0: {
                TAG: 3,
...
function sendRequestPrim(client, request) {
  return $$Promise.flatMapOk($$Promise.mapError(Util$AgdaModeVscode.P.toPromise(Client__LSP$LanguageServerMule.sendRequest(client, encode(request))), (function (exn) {
                    return {
                            TAG: 0,
                            _0: exn,
                ...
                if (response.TAG === /* ACK */0) {
                  return $$Promise.resolved({
                              ...
                              _0: {
                                client: client,
                                version: response._0,
                                method: Client__LSP$LanguageServerMule.getMethod(client)
                              },
                              [Symbol.for("name")]: "Ok"
                            });
                } else {
...
function destroy(self) {
  return $$Promise.mapError(Util$AgdaModeVscode.P.toPromise(Client__LSP$LanguageServerMule.destroy(self.client)), (function (e) {
                return {
                        TAG: 0,
                        _0: e,
                        [Symbol.for("name")]: "ConnectionError"
...
function sendRequest(self, request, handler) {
  ...
  var stopListeningForNotifications = Client__LSP$LanguageServerMule.onRequest(self.client, (async function (json) {
  ...
  return $$Promise.tap($$Promise.tap($$Promise.flatMapOk(sendRequestPrim(self.client, {
                ...
                Connection__Scheduler$AgdaModeVscode.runLast(scheduler, handler$1);
              }));
}
