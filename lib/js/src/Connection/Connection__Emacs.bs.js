...
function make(param) {
  var getPath = function (param) {
    ...
    return $$Promise.mapError($$Promise.mapOk(Process$AgdaModeVscode.PathSearch.run(agdaVersion, "If you know where the executable of Agda is located, please fill it in \"agdaMode.agdaPath\" in the Settings."), (function (prim) {
                      return prim.trim();
                    })), (function (e) {
                  return {
                          TAG: 0,
