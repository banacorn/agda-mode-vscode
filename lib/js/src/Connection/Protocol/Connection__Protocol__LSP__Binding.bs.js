...
var makeShim = ((LanguageClientCtor, id, name, serverOptions, clientOptions) => {
...
function make$2(id, name, serverOptions, clientOptions) {
  return makeShim(VscodeLanguageclient.LanguageClient, id, name, serverOptions, clientOptions);
}
