...
function chooseExecutableToChmod(assetPath, _target) {
  return Path.join(assetPath, "als");
}
...
exports.chooseExecutableToChmod = chooseExecutableToChmod;
