              ...
              },
              {
                ...
                _1: {
                  chooseFromReleases: (function (releases) {
                      ...
                      var release = Source__GitHub$LanguageServerMule.Release.chooseLatest(releases);
                      ...
                      var asset = Source__GitHub$LanguageServerMule.Asset.chooseByName(release.assets, expectedAssetName);
                      if (asset !== undefined) {
                        return {
                                release: release,
                                asset: asset,
