...
function chooseFromReleases(platform, releases) {
  var chooseRelease = function (releases) {
    var matched = Belt_Array.keep(releases, (function (release) {
            ...
            var lower = Util$AgdaModeVscode.Version.compare(x, "v0.2.0.0");
            var upper = Util$AgdaModeVscode.Version.compare(x, "v0.3.0.0");
    ...
    var sorted = Js_array.sortInPlaceWith(compare, matched);
