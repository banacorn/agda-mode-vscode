...
async function make(id, name, method, initializationOptions) {
  ...
  if (method.TAG === "ViaPipe") {
    serverOptions = Connection__Endpoint__Protocol__LSP__Binding$AgdaModeVscode.ServerOptions.makeWithCommand(method._0, method._1, method._2);
  } else {
    var url = method._0;
  ...
  var clientOptions = Connection__Endpoint__Protocol__LSP__Binding$AgdaModeVscode.LanguageClientOptions.make(documentSelector, synchronize, errorHandler, initializationOptions);
