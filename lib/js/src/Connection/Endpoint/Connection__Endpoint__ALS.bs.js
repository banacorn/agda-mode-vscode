...
var Connection__Protocol__LSP$AgdaModeVscode = require("../Protocol/Connection__Protocol__LSP.bs.js");
...
var decode = Json_Decode$JsonCombinators.flatMap(Json_Decode$JsonCombinators.field("tag", Json_Decode$JsonCombinators.string), (function (tag) {
        switch (tag) {
          case "CmdRes" :
              return Json_Decode$JsonCombinators.field("contents", Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.option(Connection__Error$AgdaModeVscode.CommWithALS.CommandErr.decode), (function (error) {
                                return {
                                        TAG: "Result",
                                        _0: error
                                      };
          ...
          case "CmdResACK" :
              try {
                return Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.field("contents", Json_Decode$JsonCombinators.pair(Json_Decode$JsonCombinators.string, Json_Decode$JsonCombinators.$$int)), (function (param) {
                              return {
                                      TAG: "ACK",
                                      _0: param[0],
                                      _1: String(param[1])
                ...
                if (exn.RE_EXN_ID === Json_Decode$JsonCombinators.DecodeError) {
                  return Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.field("contents", Json_Decode$JsonCombinators.string), (function (agdaVersion) {
                                return {
                                        TAG: "ACK",
                                        _0: agdaVersion,
                                        _1: undefined
          ...
          default:
            throw {
                  ...
                  _1: "[Connection.Target.ALS.CommandRes] Unknown constructor: " + tag,
                  Error: new Error()
                };
        }
      }));
...
async function sendRequestPrim(client, request) {
  var json;
  try {
    json = await Connection__Protocol__LSP$AgdaModeVscode.sendRequest(client, encode(request));
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
...
async function make(method, lspOptions, options) {
  var error;
  try {
    error = await Connection__Protocol__LSP$AgdaModeVscode.make("agda", "Agda Language Server", method, lspOptions, options);
  }
  catch (raw_error){
  ...
  var match = error$2._0;
  if (match.TAG === "ACK") {
    return {
            TAG: "Ok",
            _0: {
              client: client,
              agdaVersion: match._0,
              alsVersion: match._1,
              method: method
            }
          };
...
async function destroy(self) {
  var result;
  try {
    result = await Connection__Protocol__LSP$AgdaModeVscode.destroy(self.client);
  }
  catch (raw_exn){
    var exn = Caml_js_exceptions.internalToOCamlException(raw_exn);
    if (exn.RE_EXN_ID === Js_exn.$$Error) {
...
async function sendRequest(self, request, handler) {
  ...
  var resolve = match[1];
  var stopListeningForNotifications = Connection__Protocol__LSP$AgdaModeVscode.onRequest(self.client, (async function (json) {
