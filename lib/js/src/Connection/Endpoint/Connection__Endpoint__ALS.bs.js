...
var decode = Json_Decode$JsonCombinators.flatMap(Json_Decode$JsonCombinators.field("tag", Json_Decode$JsonCombinators.string), (function (tag) {
        switch (tag) {
          ...
          case "CmdResACK" :
              return Json_Decode$JsonCombinators.field("contents", Json_Decode$JsonCombinators.oneOf([
                              Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.pair(Json_Decode$JsonCombinators.string, Json_Decode$JsonCombinators.$$int), (function (param) {
                                      return {
                                              TAG: "ACK",
                                              _0: param[0],
                                              _1: String(param[1])
                              ...
                              Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.string, (function (agdaVersion) {
                                      return {
                                              TAG: "ACK",
                                              _0: agdaVersion,
                                              _1: undefined
