...
var decode = Json_Decode$JsonCombinators.flatMap(Json_Decode$JsonCombinators.field("tag", Json_Decode$JsonCombinators.string), (function (tag) {
        switch (tag) {
          case "CmdRes" :
              return Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.field("contents", Json_Decode$JsonCombinators.option(Connection__Error$AgdaModeVscode.CommWithALS.CommandErr.decode)), (function (error) {
                            return {
                                    TAG: "Result",
                                    _0: error
                                  };
