...
function toString(x) {
  switch (x.TAG) {
    case "NotAgdaOrALS" :
        ...
        return x._0 + ": doesn't seem to be an Agda executable or an Agda Language Server. Output received: " + outputInfo;
    case "SomethingWentWrong" :
        return x._0 + ": " + Connection__Process__Exec$AgdaModeVscode.$$Error.toString(x._1);
