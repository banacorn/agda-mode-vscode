...
function setPickedRaw(memento, rawPath) {
  if (rawPath !== undefined) {
    return Memento$AgdaModeVscode.Module.PickedConnection.set(memento, rawPath);
  } else {
    return Memento$AgdaModeVscode.Module.PickedConnection.set(memento, undefined);
  }
}
...
exports.setPickedRaw = setPickedRaw;
