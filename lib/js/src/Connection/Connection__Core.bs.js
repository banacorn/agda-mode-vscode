  ...
  switch (policy) {
    case "Yes" :
        ...
        if (platform$1 === "Web") {
          ...
          channel = s !== undefined ? Core__Option.getOr(Connection__Download$AgdaModeVscode.Channel.fromString(s), "DevALS") : "DevALS";
        }
        ...
        var rememberWasmFallbackFromSource = function (source) {
          ...
          var nativeAgdaVersion = Core__Option.map(Connection__Download$AgdaModeVscode.DownloadArtifact.parseName(descriptor.asset.name), (function (a) {
          ...
          wasmFallbackSource.contents = Core__Option.map(Connection__Download__Assets$AgdaModeVscode.wasm(descriptor.release).find(function (asset) {
                    var match = Connection__Download$AgdaModeVscode.DownloadArtifact.parseName(asset.name);
