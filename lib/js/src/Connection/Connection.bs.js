  ...
  switch (agdaVersion.TAG) {
    ...
    case "IsALSWASM" :
        ...
        try {
          ...
          Util$AgdaModeVscode.log("WASM ALS Agda version: ", conn$1.agdaVersion);
          Util$AgdaModeVscode.log("WASM ALS version: ", conn$1.alsVersion);
...
async function sendRequest(connection, $$document, request, handler) {
  ...
  switch (connection.TAG) {
    ...
    case "ALSWASM" :
        ...
        Util$AgdaModeVscode.log("conn Version: ", conn$1.agdaVersion);
        Util$AgdaModeVscode.log("Version: ", connection._3);
        Util$AgdaModeVscode.log("Sending request to WASM ALS: ", payload);
