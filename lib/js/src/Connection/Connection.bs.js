...
function start(globalStoragePath, useLSP) {
  ...
  if (conn !== undefined) {
    ...
    return $$Promise.mapError($$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMap(Connection__Probe$AgdaModeVscode.probeLSP(globalStoragePath, (function (param) {
                            ...
                            })), Connection__LSP$AgdaModeVscode.make), (function (conn) {
    ...
    return $$Promise.mapError($$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMap(Connection__Probe$AgdaModeVscode.probeEmacs(undefined), (function (param) {
                              var result = param[0];
                              if (result !== undefined) {
                                return $$Promise.resolved({
                                            TAG: 0,
                            ...
                            })), Connection__Emacs$AgdaModeVscode.make), (function (conn) {
                      singleton.contents = {
                        TAG: 0,
                        _0: conn,
                        [Symbol.for("name")]: "Emacs"
...
function sendRequest(globalStoragePath, useLSP, $$document, request, handler) {
  ...
  var match = singleton.contents;
  if (match === undefined) {
    return $$Promise.flatMapOk(start(globalStoragePath, useLSP), (function (param) {
                  return sendRequest(globalStoragePath, useLSP, $$document, request, handler);
                }));
  }
  if (match.TAG === /* Emacs */0) {
    var conn = match._0;
