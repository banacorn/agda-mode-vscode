...
var Connection__DevALS$AgdaModeVscode = require("./Download/Connection__DevALS.bs.js");
        ...
        if (path !== undefined) {
          ...
          if (resolveError.TAG === "Ok") {
            ...
            if (source.TAG === "FromGitHub") {
              ...
              wasmFallbackSource.contents = Core__Option.map(Connection__DevALS$AgdaModeVscode.allWasmAssets(descriptor.release).find(function (asset) {
