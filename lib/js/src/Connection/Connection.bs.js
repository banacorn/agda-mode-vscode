...
var Connection__Target__ALS__LSP$AgdaModeVscode = require("./Target/ALS/LSP/Connection__Target__ALS__LSP.bs.js");
...
function toStatus(conn) {
  ...
  return {
          TAG: "ALS",
          _0: conn$1.version,
          _1: Connection__Target__ALS__LSP$AgdaModeVscode.getIPCMethod(conn$1.client),
          [Symbol.for("name")]: "ALS"
        };
}
...
async function start(globalStorageUri, useALS, onDownload) {
  ...
  if (useALS) {
    ...
    var error;
    try {
      error = await Connection__Target__ALS__LSP$AgdaModeVscode.make("agda", "Agda Language Server", result, getFromConfig());
    }
    catch (raw_error){
    ...
    var method = Connection__Target__ALS__LSP$AgdaModeVscode.getIPCMethod(conn$1.client);
    singleton.contents = {
      TAG: "ALS",
      _0: conn$1,
      [Symbol.for("name")]: "ALS"
...
exports.LSP__Binding = LSP__Binding;
exports.LSP = LSP;
