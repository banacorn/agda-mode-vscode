...
async function makeWithFallback(platformDeps, memento, globalStorageUri, paths, commands, logChannel) {
  ...
  var tasks = [
    (function () {
        return tagFrom(fromPathsOrCommands(platformDeps, pathsWithSource), "FromPaths");
      }),
    (function () {
        return tagFrom(fromPathsOrCommands(platformDeps, commandsWithSource), "FromCommands");
      }),
    (function () {
