        ...
        if (path !== undefined) {
          ...
          switch (downloadOrder) {
            ...
            case "DevALS" :
                ...
                break;
            case "DevWASMALS" :
                var error = await Connection__Download$AgdaModeVscode.downloadFromURL(globalStorageUri, "https://unpkg.com/agda-wasm@0.0.1/als/2.8.0/als.wasm", "dev-wasm-als", "Agda Language Server (WASM)");
