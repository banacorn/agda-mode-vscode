...
function download(memento, globalStorageUri) {
  return async function (platform) {
    ...
    var error$1 = await Connection__Download__GitHub$AgdaModeVscode.download(target, memento, globalStoragePath, reportProgress);
    if (error$1.TAG !== "Ok") {
      return {
              TAG: "Error",
              _0: {
...
var LatestALS = {
  ...
  chooseAssetFromRelease: chooseAssetFromRelease,
  getTarget: getTarget,
  download: download,
