  ...
  switch (agdaVersion.TAG) {
    ...
    case "IsALSWASM" :
        ...
        try {
          ...
          var errorMsg = await WASMLoader$AgdaModeVscode.prepareAgdaDataDir(extension$1, wasmLoader.memfsAgdaDataDir, "/Users/banacorn/Library/Application Support/Code/User/globalStorage/banacorn.agda-mode/dev-wasm-als/agda-data.zip");
          if (errorMsg.TAG !== "Ok") {
            return {
                    TAG: "Error",
                    _0: Connection__Error$AgdaModeVscode.Establish.fromProbeError(path, "CannotMakeConnectionWithALSWASMYet")
