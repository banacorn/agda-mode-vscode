...
async function fromDownloads(attempts, platform, getDownloadPolicyFromUser, downloadLatestALS) {
  if (platform.TAG !== "Ok") {
    return {
            TAG: "Error",
            _0: {
...
async function make(memento, paths, commands, platform, getDownloadPolicyFromUser, downloadLatestALS) {
  ...
  var error = await fromDownloads(attempts._0, platform, getDownloadPolicyFromUser, downloadLatestALS);
  if (error.TAG !== "Ok") {
    return {
            TAG: "Error",
            _0: error._0,
