    ...
    case "IsALSWASM" :
        ...
        try {
          ...
          if (error$3.TAG === "Ok") {
            ...
            var apiLoader = $$exports.WasmAPILoader;
            var compiled = WebAssembly.compile(error$3._0);
            Util$AgdaModeVscode.log("exports", $$exports);
            Util$AgdaModeVscode.log("apiLoader", apiLoader);
            Util$AgdaModeVscode.log("Compiled WASM", compiled);
            Util$AgdaModeVscode.log("agdaLanguageServerFactory", $$exports.AgdaLanguageServerFactory);
            return {
                    TAG: "Ok",
                    _0: {
                      TAG: "ALSWASM",
