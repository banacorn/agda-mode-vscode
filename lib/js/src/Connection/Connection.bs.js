...
async function sendRequest(connection, $$document, memento, request, handler) {
  ...
  var error$2 = await start(memento);
  if (error$2.TAG === "Ok") {
    return await sendRequest(error$2._0, $$document, memento, request, handler);
  } else {
    return {
            TAG: "Error",
            _0: error$2._0,
