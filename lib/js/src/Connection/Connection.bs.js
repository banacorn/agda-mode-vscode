...
async function sendRequest(connection, $$document, request, handler) {
  ...
  switch (connection.TAG) {
    ...
    case "ALSWASM" :
        var clientResult = (async function(wasmSetup, document, request, handler) {
        ...
        })(connection._0, $$document, "test request", handler);
        var result = await clientResult;
        Util$AgdaModeVscode.log("WASM result:", result);
        return {
                TAG: "Ok",
                _0: undefined
              };
