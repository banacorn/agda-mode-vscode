...
async function fromDownloads(platformDeps, memento, globalStorageUri) {
  ...
  switch (policy) {
    case "Yes" :
        ...
        var downloadOrder;
        downloadOrder = platform$1 === "Web" ? "DevWASMALS" : "LatestALS";
        ...
        if (path !== undefined) {
          ...
          switch (downloadOrder) {
            ...
            case "DevALS" :
                ...
                break;
            case "DevWASMALS" :
                var error = await Connection__Download$AgdaModeVscode.downloadFromURL(globalStorageUri, "https://unpkg.com/agda-wasm@0.0.3-als.2.8.0/als/2.8.0/als.wasm", "dev-wasm-als", "Agda Language Server (WASM)");
