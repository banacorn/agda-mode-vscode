...
function start(globalStoragePath, useLSP, onDownload) {
  ...
  if (conn !== undefined) {
    ...
    return $$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMap(Connection__Probe$AgdaModeVscode.probeLSP(globalStoragePath, onDownload), (function (param) {
                      ...
                      return $$Promise.mapError($$Promise.flatMapOk($$Promise.mapError(Client__LSP$LanguageServerMule.make("agda", "Agda Language Server", method, getFromConfig(undefined)), (function (e) {
                                            return {
                                                    TAG: 0,
                                                    _0: e,
