...
function runLast(self, handler) {
  return $$Promise.flatMap(onceDone(self), (function (param) {
                ...
                return $$Promise.map(Util$AgdaModeVscode.oneByOne(Belt_Array.map(deferredLastResponses, Curry.__1(handler))), (function (param) {
