...
async function make(id, name, method, initializationOptions) {
  ...
  var serverOptions;
  serverOptions = method.TAG === "ViaPipe" ? Connection__Target__ALS__LSP__Binding$AgdaModeVscode.ServerOptions.makeWithCommand(method._0, method._1, method._2) : Connection__Target__ALS__LSP__Binding$AgdaModeVscode.ServerOptions.makeWithStreamInfo(method._0, method._1);
