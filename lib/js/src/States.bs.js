                  ...
                  return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, name, (function (editor) {
                                    ...
                                    if (typeof command === "number" && command === 0) {
                                      Belt_Option.forEach(Curry._1(Editor.getFileName, editor), (function (fileName) {
                                              ...
                                              Curry._2(Editor.addToSubscriptions, Curry._1(Editor.Disposable.make, Curry._1(state.onInputMethodAction.on, (function (action) {
                                                              Curry._2(TaskRunner.dispatchCommand, taskRunner, /* InputSymbol */Caml_chrome_debugger.variant("InputSymbol", 4, [action]));
