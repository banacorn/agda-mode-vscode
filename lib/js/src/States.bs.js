...
function Impl(Editor) {
  ...
  var destroy = function (fileName) {
    Belt_Option.forEach(Js_dict.get(dict, fileName), (function (param) {
            ...
            Curry._1(TaskRunner.destroy, param[1]);
  ...
  var destroyAll = function (param) {
    return Belt_Array.forEach(Js_dict.entries(dict), (function (param) {
                  ...
                  Curry._1(TaskRunner.destroy, match[1]);
...
function Impl$1(Editor) {
  ...
  var TaskRunner$1 = TaskRunner$AgdaModeVscode.Impl(Editor);
                  ...
                  return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, param[1], (function (editor) {
                                    if (command) {
                                      ...
                                      Belt_Option.forEach(Curry._1(Editor.getFileName, editor), (function (fileName) {
                                              ...
                                              var taskRunner = Curry._1(TaskRunner$1.make, state);
                                              Curry._2(Editor.addToSubscriptions, Curry._2(Editor.View.recv, state.view, (function (response) {
                                                          return Curry._2(TaskRunner$1.addTask, taskRunner, /* ViewRes */Caml_chrome_debugger.variant("ViewRes", 4, [response]));
                                                        })), context);
                                    ...
                                    return Belt_Option.forEach(getByEditor(editor), (function (param) {
                                                  return Curry._2(TaskRunner$1.addTask, param[1], /* DispatchCommand */Caml_chrome_debugger.variant("DispatchCommand", 1, [command]));
                                                }));
                                  })), context);
                }));
  };
