...
function Impl(Editor) {
  ...
  var make = function (context, editor, onDestroy) {
    ...
    $$Promise.get(Curry._1(State.onceDestroyed, state), onDestroy);
    return /* tuple */[
            state,
            dispatcher
          ];
  ...
  var destroy = function (param) {
    ...
    Curry._1(Dispatcher.destroy, param[1]);
...
function Impl$1(Editor) {
  ...
  var destroy$1 = function (fileName) {
    Belt_Option.forEach(Js_dict.get(dict, fileName), destroy);
...
function Impl$2(Editor) {
  ...
  var make$1 = function (context, editor, onDestroy) {
    ...
    $$Promise.get(Curry._1(State$1.onceDestroyed, state), onDestroy);
    return /* tuple */[
            state,
            dispatcher
          ];
  ...
  var destroy$1 = function (param) {
    Curry._1(State$1.destroy, param[0]);
    Curry._1(Dispatcher$1.destroy, param[1]);
  ...
  var destroy$2 = function (fileName) {
    Belt_Option.forEach(Js_dict.get(dict, fileName), destroy$1);
    return remove(fileName);
  };
  var contains = function (fileName) {
    return Belt_Option.isSome(Js_dict.get(dict, fileName));
  ...
  var activate = function (context) {
    ...
    Curry._2(Editor.addToSubscriptions, Curry._1(Editor.onDidCloseEditor, destroy$2), context);
    ...
    Curry._2(Editor.addToSubscriptions, Curry._1(Editor.onDidChangeActivation, (function (prev, next) {
                ...
                return Belt_Option.forEach(Belt_Option.flatMap(next, get), (function (param) {
                              return Curry._1(State$2.show, param[0]);
                            }));
              })), context);
                                    ...
                                    if (typeof command === "number" && command < 3) {
                                      switch (command) {
                                        ...
                                        case /* Quit */1 :
                                            break;
                                        case /* Restart */2 :
                                            Belt_Option.forEach(Curry._1(Editor.getFileName, editor), destroy$2);
                                            break;
