...
var Dispatcher2$AgdaModeVscode = require("./Task/Dispatcher2.bs.js");

function Impl(Editor) {
  var Dispatcher2 = Dispatcher2$AgdaModeVscode.Impl(Editor);
  ...
  var destroy = function (fileName) {
    Belt_Option.forEach(Js_dict.get(dict, fileName), (function (param) {
            ...
            Curry._1(Dispatcher2.destroy, param[1]);
  ...
  var destroyAll = function (param) {
    return Belt_Array.forEach(Js_dict.entries(dict), (function (param) {
                  ...
                  Curry._1(Dispatcher2.destroy, match[1]);
...
function Impl$1(Editor) {
  ...
  var Dispatcher2$1 = Dispatcher2$AgdaModeVscode.Impl(Editor);
                  ...
                  return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, name, (function (editor) {
                                    ...
                                    if (typeof command === "number" && command === 0) {
                                      Belt_Option.forEach(Curry._1(Editor.getFileName, editor), (function (fileName) {
                                              ...
                                              var taskRunner = Curry._1(Dispatcher2$1.make, state);
                                              Curry._2(Editor.addToSubscriptions, Curry._2(Editor.View.on, state.view, (function ($$event) {
                                                          Curry._3(Dispatcher2$1.dispatchCommand, taskRunner, state, /* ViewEvent */Caml_chrome_debugger.variant("ViewEvent", 3, [$$event]));
                                              ...
                                              Curry._2(Editor.addToSubscriptions, Curry._1(Editor.Disposable.make, Curry._1(state.inputMethod.onAction.on, (function (action) {
                                                              Curry._3(Dispatcher2$1.dispatchCommand, taskRunner, state, /* InputSymbol */Caml_chrome_debugger.variant("InputSymbol", 4, [action]));
                                    ...
                                    return Belt_Option.forEach(getByEditor(editor), (function (param) {
                                                  ...
                                                  if (typeof command === "number" && command >= 8) {
                                                    Curry._2(Dispatcher2$1.interrupt, runner, /* Escape */8);
                                                    return ;
                                                  } else {
                                                    Curry._3(Dispatcher2$1.dispatchCommand, runner, state, command);
                                                    return ;
                                                  }
                                                }));
                                  })), context);
