...
function Panel(Props) {
  ...
  var setInputMethodActivation = match$2[1];
  var match$3 = React.useState((function () {
          return "";
        }));
  var setInputMethodSequence = match$3[1];
          ...
          if (typeof msg === "number") {
            ...
            if (msg.tag) {
              ...
              if (typeof sequence === "number") {
                if (sequence !== 0) {
                  Curry._1(setInputMethodActivation, (function (param) {
                          return false;
                        }));
                  return $$Promise.resolved(/* Success */0);
                } else {
              ...
              var sequence$1 = sequence[0];
              Curry._1(setInputMethodSequence, (function (param) {
                      return sequence$1;
                    }));
              return $$Promise.resolved(/* Success */0);
            }
