  ...
  return React.createElement("section", {
              ...
              tabIndex: -1
                  ...
                  onInsertChar: (function ($$char) {
                      ...
                      return Curry._1(onResponse.emit, /* EventPiggyBack */Caml_chrome_debugger.variant("EventPiggyBack", 0, [/* InputMethod */Caml_chrome_debugger.simpleVariant("InputMethod", [/* InsertChar */Caml_chrome_debugger.variant("InsertChar", 0, [$$char])])]));
                    }),
                  onChooseSymbol: (function (symbol) {
                      console.log("onChooseSymbol " + symbol);
                      return Curry._1(onResponse.emit, /* EventPiggyBack */Caml_chrome_debugger.variant("EventPiggyBack", 0, [/* InputMethod */Caml_chrome_debugger.simpleVariant("InputMethod", [/* ChooseSymbol */Caml_chrome_debugger.variant("ChooseSymbol", 1, [symbol])])]));
                    })
