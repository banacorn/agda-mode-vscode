...
function Panel(Props) {
  ...
  var tmp;
  if (shouldPrank !== undefined) {
    var quotes = ["Why would you do that?"];
    ...
    tmp = React.createElement("div", {
          className: "agda-mode-body"
              ...
              id: "prank"
            }, React.createElement("blockquote", undefined, quote), React.createElement("img", {
                  src: shouldPrank
                })));
  } else {
    tmp = React.createElement(React.Fragment, undefined, React.createElement(Header$AgdaModeVscode.make, {
              header: match$1[0]
