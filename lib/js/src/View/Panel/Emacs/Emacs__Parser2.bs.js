...
function parseError(raw) {
  ...
  var hasBothErrorsAndWarnings = Belt_Option.isSome(Belt_Option.map(Belt_Array.get(lines, 0), (function (param) {
              return Js_string.match_(partial_arg, param);
            })));
  var dictionary;
  if (hasBothErrorsAndWarnings) {
    ...
    dictionary = Emacs__Parser$AgdaModeVscode.Dict.partite(lines, predicate);
  } else {
    dictionary = Emacs__Parser$AgdaModeVscode.Dict.partite(lines, (function (param) {
            if (param[1] === 0) {
              return "errors";
            }
  ...
  return Js_array.concatMany(Belt_Array.map(Js_dict.entries(Emacs__Parser$AgdaModeVscode.Dict.update(Emacs__Parser$AgdaModeVscode.Dict.update(dictionary, "errors", (function (xs) {
