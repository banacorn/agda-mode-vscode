...
function Panel(Props) {
  ...
  return React.createElement(View$AgdaModeVscode.EventFromView.Provider.make, Curry._3(View$AgdaModeVscode.EventFromView.Provider.makeProps, onEventFromView, React.createElement("section", {
