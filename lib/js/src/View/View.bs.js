                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Json_decode.pair((function (param) {
                                                    return Util$AgdaModeVscode.Decode.convert(decode, param);
                                                  }), (function (param) {
                ...
                switch (x.TAG | 0) {
                  case /* Display */0 :
                      return {
                              TAG: 0,
                              _0: "Display",
                              _1: Json_Encode$JsonCombinators.pair(encode, (function (param) {
            ...
            return {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (interval) {
                                      ...
                                      return Util$AgdaModeVscode.Decode.convert(Common$AgdaModeVscode.Interval.decode, param);
                                    }), param);
                      }),
                    [Symbol.for("name")]: "Contents"
                  };
