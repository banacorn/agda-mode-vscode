...
console.log("[AGDA-MODE] Root.res - Starting webview initialization");

var vscode = acquireVsCodeApi();

console.log("[AGDA-MODE] Root.res - Acquired VSCode API:", vscode);
...
console.log("[AGDA-MODE] Root.res - Looking for root element...");

var rootElement = document.getElementById("root");

var rootElement$1 = (rootElement == null) ? undefined : Caml_option.some(rootElement);

console.log("[AGDA-MODE] Root.res - Found root element:", rootElement$1);

if (rootElement == null) {
  console.log("[AGDA-MODE] Root.res - ERROR: Root element not found!");
} else {
  console.log("[AGDA-MODE] Root.res - Mounting React component...");
  var root = Client.createRoot(rootElement);
  console.log("[AGDA-MODE] Root.res - Created React root:", root);
  root.render(React.createElement(Panel$AgdaModeVscode.make, {
            onRequest: onRequest,
            onEventToView: onEventToView,
            onResponse: onResponse,
            onEventFromView: onEventFromView
          }));
  console.log("[AGDA-MODE] Root.res - React component mounted successfully");
}
