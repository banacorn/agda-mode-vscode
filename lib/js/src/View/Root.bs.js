...
VSCode.Api.onMessage(function (stringifiedJSON) {
      var requestOrEvent = Curry._1(View__Type$AgdaModeVscode.RequestOrEventToView.decode, JSON.parse(stringifiedJSON));
...
Chan$AgdaModeVscode.on(onResponse, (function (response) {
        vscode.postMessage(View__Type$AgdaModeVscode.ResponseOrEventFromView.encode({
                  TAG: 0,
                  _0: response,
