...
function toString$6(text) {
  switch (text.tag | 0) {
    case /* PlainText */0 :
        return "Item [PlainText] " + toString$5(text[0]);
    case /* Error */1 :
        return "Item [Error] " + toString$5(text[0]);
    case /* Warning */2 :
        return "Item [Warning] " + toString$5(text[0]);
    case /* Goal */3 :
        return "Item [Goal] " + toString$1(text[0]);
    case /* Have */4 :
        return "Item [Have] " + toString$1(text[0]);
    case /* Output */5 :
        return "Item [Output] " + toString$3(text[0]);
