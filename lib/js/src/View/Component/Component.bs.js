  ...
  return Belt_Array.keepMap(Belt_Array.mapWithIndex(__x.split(/(\?\d+)|(\_\d+[^\}\)\s]*)/), (function (i, token) {
                    ...
                    if (match !== 1) {
                      ...
                      return Belt_Option.map(Belt_Option.flatMap(Belt_Option.map(token, (function (param) {
                                          ...
                                          })), Parser$AgdaModeVscode.$$int), (function (x) {
...
function parseOfType(param) {
  return Parser$AgdaModeVscode.captures(partial_arg, (function (captured) {
                return Belt_Option.flatMap(Parser$AgdaModeVscode.at(captured, 2, parse), (function (type_) {
                              return Belt_Option.flatMap(Parser$AgdaModeVscode.at(captured, 1, parse), (function (term) {
...
function parseJustType(param) {
  return Parser$AgdaModeVscode.captures(partial_arg$1, (function (captured) {
                return Belt_Option.map(Parser$AgdaModeVscode.at(captured, 1, parse), (function (type_) {
...
function parseJustSort(param) {
  return Parser$AgdaModeVscode.captures(partial_arg$2, (function (captured) {
                return Belt_Option.map(Parser$AgdaModeVscode.at(captured, 1, parse), (function (sort) {
...
function parse$1(param) {
  return Parser$AgdaModeVscode.choice(partial_arg$3, param);
}
...
function Component$Labeled(Props) {
  ...
  return React.createElement("li", {
              className: "labeled"
                  ...
                  className: "label"
                }, label), React.createElement(Component$Expr, {
                  expr: expr
                }));
}
...
function parseOutputWithRange(param) {
  return Parser$AgdaModeVscode.captures(partial_arg$4, (function (captured) {
...
function parse$3(raw) {
  return Belt_Array.mapWithIndex(Belt_Array.keepMap(raw.split(/([^\(\)\s]+\:(?:\d+\,\d+\-\d+\,\d+|\d+\,\d+\-\d+))/), (function (x) {
                ...
                if (match !== 1) {
                  ...
                  return Belt_Option.mapWithDefault(Curry._1(View$AgdaModeVscode.$$Range.parse, token), /* Text */Caml_chrome_debugger.variant("Text", 0, [token]), (function (x) {
...
function Component$PlainText(Props) {
  var value = Props.value;
...
var PlainText = {
  toString: toString$4,
  parse: parse$3,
  make: Component$PlainText
};

function toString$5(xs) {
  return Util$AgdaModeVscode.Pretty.array(Belt_Array.map(xs[0], toString$4));
}
  ...
  if (value.tag) {
    return React.createElement("li", {
                className: "warning-error"
                  ...
                  }, "error"), React.createElement(Component$PlainText, {
                    value: value[0]
                  }));
  } else {
    return React.createElement("li", {
                className: "warning-error"
                  ...
                  }, "warning"), React.createElement(Component$PlainText, {
                    value: value[0]
                  }));
  }
}
