            ...
            return {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
                                      ...
                                      return Json_decode.pair(Common$AgdaModeVscode.Agda.$$Range.decode, Json_decode.bool, param);
                                    }), param);
                      }),
                    [Symbol.for("name")]: "Contents"
                  };
    ...
    case /* Location */3 :
        return Json_encode.object_({
                    ...
                    tl: {
                      hd: [
                        "contents",
                        Json_encode.pair(Common$AgdaModeVscode.Agda.$$Range.encode, (function (prim) {
                                return prim;
                              }), [
                              x._0,
                              x._1
  ...
  return {
          _0: Belt_Array.mapWithIndex(Belt_Array.keepMap(raw.split(/([^\(\)\s]+\:(?:\d+\,\d+\-\d+\,\d+|\d+\,\d+\-\d+))/), (function (x) {
                  ...
                  if (match !== 1) {
                    ...
                    return Belt_Option.mapWithDefault(Curry._1(Common$AgdaModeVscode.Agda.$$Range.parse, token), {
                                TAG: 0,
                                _0: token,
                                _1: undefined,
                                [Symbol.for("name")]: "PlainText"
                          ...
                          if (x._1) {
                            ...
                            return React.createElement(Component__Link$AgdaModeVscode.make, {
                                        ...
                                        key: String(i)
                                            ...
                                            className: "codicon codicon-link"
                                          }), Curry._1(Common$AgdaModeVscode.Agda.$$Range.toString, $$location));
                          }
  ...
  return Emacs__Parser$AgdaModeVscode.captures(partial_arg$4, (function (captured) {
                return Belt_Option.map(Belt_Option.flatMap(Belt_Option.flatMap(Belt_Array.get(captured, 1), (function (x) {
                              ...
                              var r = Belt_Option.flatMap(Belt_Option.flatMap(Belt_Array.get(captured, 2), (function (x) {
                                          return x;
                                        })), Common$AgdaModeVscode.Agda.$$Range.parse);
                              return {
                                      _0: oc,
                                      _1: r,
                                      [Symbol.for("name")]: "Output"
