...
var Component__Location$AgdaModeVscode = require("./Component__Location.bs.js");
...
function Component$OutputConstraint(Props) {
  ...
  var $$location$1 = Belt_Option.mapWithDefault($$location, null, (function ($$location) {
          return React.createElement(Component__Location$AgdaModeVscode.make, {
                      location: $$location,
                      abbr: true
                    });
        }));
...
function toString$3(x) {
  ...
  if ($$location !== undefined) {
    return "Output " + (toString$2(c) + (" " + Curry._1(Common$AgdaModeVscode.Agda.$$Location.toString, $$location)));
  } else {
