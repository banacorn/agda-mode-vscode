...
function toElements(x) {
  switch (x.TAG | 0) {
    case /* PlainText */0 :
        return [{
                  _0: x._0,
                  _1: RichText$AgdaModeVscode.Module.Attributes.empty,
...
function fromRichText(x) {
  return {
          _0: Belt_Array.map(x._0, fromElement),
          [Symbol.for("name")]: "Text"
        };
}

function toRichText(x) {
  return {
          _0: Belt_Array.concatMany(Belt_Array.map(x._0, toElements)),
...
function plainText$prime(s) {
  return {
          TAG: 2,
          _0: RichText$AgdaModeVscode.text(s),
          _1: undefined,
          [Symbol.for("name")]: "Unlabeled'"
        };
}
...
function Component$Item(Props) {
  ...
  var content = function (text, raw) {
    if (raw !== undefined) {
      if (revealRaw) {
        return React.createElement(Component$Text, {
  ...
  switch (item.TAG | 0) {
    ...
    case /* Unlabeled' */2 :
        var raw$2 = item._1;
        var content$1 = function (value, raw) {
          if (raw !== undefined) {
            if (revealRaw) {
              return React.createElement(RichText$AgdaModeVscode.make, {
                          value: RichText$AgdaModeVscode.text(raw)
                        });
            } else {
              return React.createElement(RichText$AgdaModeVscode.make, {
                          value: value
        ...
        return React.createElement("li", {
                    className: "unlabeled-item"
                        ...
                        className: "item-content"
                      }, content$1(item._0, raw$2)), revealRawButton(raw$2));
...
var Item = {
  ...
  plainText$prime: plainText$prime,
  error: error,
  warning: warning,
  make: Component$Item,
  decode: decode$2,
