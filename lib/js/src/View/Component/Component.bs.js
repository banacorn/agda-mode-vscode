...
function Component$Text(Props) {
  var text = Props.text;
  return React.createElement("span", undefined, Belt_Array.mapWithIndex(text[0], (function (i, plainText) {
                    if (plainText.tag) {
                      return React.createElement(Component__Range$AgdaModeVscode.make, {
                                  range: plainText[0],
                                  key: String(i)
...
function toString$6(text) {
  switch (text.tag | 0) {
    case /* Error */0 :
        return "LabeledItem [Error] " + toString$5(text[0]);
    case /* Warning */1 :
        return "LabeledItem [Warning] " + toString$5(text[0]);
    case /* Goal */2 :
        return "LabeledItem [Goal] " + toString$1(text[0]);
    case /* Have */3 :
        return "LabeledItem [Have] " + toString$1(text[0]);
    
  }
}

function Component$LabeledItem(Props) {
    ...
    case /* Error */0 :
        return React.createElement("li", {
                    className: "labeled"
                      ...
                      }, "Error"), React.createElement(Component$Text, {
                        text: payload[0]
                      }));
    case /* Warning */1 :
        return React.createElement("li", {
                    className: "labeled"
                      ...
                      }, "Warning"), React.createElement(Component$Text, {
                        text: payload[0]
                      }));
    case /* Goal */2 :
        return React.createElement("li", {
                    className: "labeled"
                        ...
                        className: "label"
                      }, "Goal"), React.createElement(Component$Expr, {
                        expr: payload[0]
                      }));
    case /* Have */3 :
        return React.createElement("li", {
                    className: "labeled"
                        ...
                        className: "label"
                      }, "Have"), React.createElement(Component$Expr, {
                        expr: payload[0]
                      }));
...
function Component$Item(Props) {
  ...
  if (item.tag) {
    ...
    return React.createElement(Component$LabeledItem, {
                payload: item[0]
              });
  }
}
