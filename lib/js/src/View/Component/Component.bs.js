...
function toString$4(s) {
  if (s.TAG) {
    return View$AgdaModeVscode.$$Range.toString(s._0);
  } else {
    return s._0;
  }
}
  ...
  return {
          _0: Belt_Array.mapWithIndex(Belt_Array.keepMap(raw.split(/([^\(\)\s]+\:(?:\d+\,\d+\-\d+\,\d+|\d+\,\d+\-\d+))/), (function (x) {
                  ...
                  if (match !== 1) {
                    ...
                    return Belt_Option.mapWithDefault(Curry._1(View$AgdaModeVscode.$$Range.parse, token), {
                                TAG: 0,
                                _0: token,
                                [Symbol.for("name")]: "PlainText"
                              }, (function (x) {
...
function Component$Text(Props) {
  var text = Props.text;
  return React.createElement("span", undefined, Belt_Array.mapWithIndex(text._0, (function (i, plainText) {
                    if (plainText.TAG) {
                      return React.createElement(Component__Range$AgdaModeVscode.make, {
                                  range: plainText._0,
                                  key: String(i)
...
function toString$6(text) {
  switch (text.TAG | 0) {
    case /* PlainText */0 :
        return "Item [PlainText] " + toString$5(text._0);
    case /* Error */1 :
        return "Item [Error] " + toString$5(text._0);
    case /* Warning */2 :
        return "Item [Warning] " + toString$5(text._0);
    case /* Goal */3 :
        return "Item [Goal] " + toString$1(text._0);
    case /* Have */4 :
        return "Item [Have] " + toString$1(text._0);
    case /* Output */5 :
        return "Item [Output] " + toString$3(text._0);
