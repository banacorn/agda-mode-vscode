...
var decode = Util$AgdaModeVscode.Decode.sum_(function (x) {
      switch (x) {
        ...
        case "Labeled" :
            return {
                    TAG: 0,
                    _0: Json_Decode$JsonCombinators.map(Json_Decode$JsonCombinators.tuple4(Json_Decode$JsonCombinators.pair(RichText$AgdaModeVscode.decode, Json_Decode$JsonCombinators.option(Json_Decode$JsonCombinators.string)), Json_Decode$JsonCombinators.option(Common$AgdaModeVscode.AgdaRange.decode), Json_Decode$JsonCombinators.string, Json_Decode$JsonCombinators.string), (function (param) {
                            var match = param[0];
                            return {
                                    TAG: 0,
                                    _0: param[2],
                ...
                switch (x.TAG | 0) {
                  case /* Labeled */0 :
                      return {
                              TAG: 0,
                              _0: "Labeled",
                              _1: Json_Encode$JsonCombinators.tuple4((function (param) {
                                      return Json_Encode$JsonCombinators.pair(RichText$AgdaModeVscode.encode, (function (param) {
