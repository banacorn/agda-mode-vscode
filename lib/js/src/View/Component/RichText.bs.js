...
function RichText$Parens2(props) {
  ...
  var openParenClassName = "component-parentheses" + (
    activated ? " activated" : ""
  );
  ...
  var closeParenClassName = "component-parentheses" + (
    activated ? " activated" : ""
  );
...
function horzItems(xs, compact) {
  return xs.map(function (element, index) {
...
function make(value) {
  return React.createElement("span", undefined, value._0.map(function (x, i) {
                  switch (x.TAG) {
                    ...
                    case "Horz" :
                        var children = horzItems(x._0, (function (index) {
                                return index === 0;
                              }));
                        return React.createElement("span", {
                                    key: String(i),
                    ...
                    case "PrHz" :
                        var payload = horzItems(x._0, (function (index) {
                                return index === 0;
                              }));
