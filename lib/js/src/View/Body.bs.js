  ...
  switch (body.tag | 0) {
    case /* Plain */0 :
        return React.createElement("div", {
                  ...
                  }, React.createElement("p", undefined, body[0]));
    case /* Emacs */1 :
        var body$1 = body[2];
        var items;
        switch (body[0]) {
          case /* ContextOrConstraints */0 :
              items = Emacs__Parser2$AgdaModeVscode.parseContextOrConstraints(body$1);
              break;
          ...
          case /* Error */3 :
              ...
              break;
          case /* Others */4 :
              items = Emacs__Parser2$AgdaModeVscode.parseOthers(body$1);
              break;
