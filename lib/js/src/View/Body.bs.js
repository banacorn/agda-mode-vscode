...
function Body(Props) {
  ...
  switch (body.tag | 0) {
    ...
    case /* Query */2 :
        var body$2 = body[0];
        var placeholder = Belt_Option.getWithDefault(body[1], "");
        var value = Belt_Option.getWithDefault(body[2], "");
        ...
        return React.createElement("div", {
                    className: "agda-mode-query"
                        ...
                        onSubmit: onSubmit$1
                      }, body$2 !== undefined ? React.createElement("p", undefined, body$2) : React.createElement(React.Fragment, undefined), React.createElement("input", {
                            ref: (function (ref) {
