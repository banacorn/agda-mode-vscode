...
function parse(raw) {
  ...
  var goal = Belt_Option.map(Belt_Option.flatMap(Js_dict.get(dictionary, "goal"), (function (line) {
              return Component$AgdaModeVscode.Expr.parse(line.join("\n").slice(5));
            })), (function (expr) {
          return /* Goal */Caml_chrome_debugger.variant("Goal", 2, [expr]);
        }));
  var have = Belt_Option.map(Belt_Option.flatMap(Js_dict.get(dictionary, "have"), (function (line) {
              return Component$AgdaModeVscode.Expr.parse(line.join("\n").slice(5));
            })), (function (expr) {
...
function Emacs__GoalType(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("ul", undefined, Belt_Option.mapWithDefault(parsed.goal, null, (function (payload) {
                        return React.createElement(Component$AgdaModeVscode.LabeledItem.make, {
                                    payload: payload
                                  });
                      })), Belt_Option.mapWithDefault(parsed.have, null, (function (payload) {
                        return React.createElement(Component$AgdaModeVscode.LabeledItem.make, {
                                    payload: payload
                                  });
