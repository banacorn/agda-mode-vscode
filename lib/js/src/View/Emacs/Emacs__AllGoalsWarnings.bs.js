...
function parse(title, body) {
  ...
  var warnings = Belt_Option.mapWithDefault(Js_dict.get(dictionary, "warnings"), [], (function (entries) {
          return Belt_Array.keepMap(Belt_Array.map(entries, Component$AgdaModeVscode.WarningError.parseWarning), (function (x) {
                        return x;
                      }));
        }));
  var errors = Belt_Option.mapWithDefault(Js_dict.get(dictionary, "errors"), [], (function (entries) {
          return Belt_Array.keepMap(Belt_Array.map(entries, Component$AgdaModeVscode.WarningError.parseError), (function (x) {
                        return x;
                      }));
        }));
  return {
