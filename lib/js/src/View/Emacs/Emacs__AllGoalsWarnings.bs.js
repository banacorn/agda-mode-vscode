...
function Emacs__AllGoalsWarnings(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("ul", undefined, Belt_Array.mapWithIndex(match.interactionMetas, (function (i, value) {
                      ...
                      }))), React.createElement("ul", undefined, Belt_Array.mapWithIndex(match.warnings, (function (i, item) {
                        return React.createElement(Component$AgdaModeVscode.Item.make, {
                                    item: item,
                                    key: String(i)
                                  });
                      }))), React.createElement("ul", undefined, Belt_Array.mapWithIndex(match.errors, (function (i, item) {
                        return React.createElement(Component$AgdaModeVscode.Item.make, {
                                    item: item,
                                    key: String(i)
                                  });
