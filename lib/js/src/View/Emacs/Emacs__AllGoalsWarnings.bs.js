...
function Emacs__AllGoalsWarnings(Props) {
  ...
  return React.createElement(React.Fragment, undefined, React.createElement("ul", undefined, Belt_Array.mapWithIndex(match.interactionMetas, (function (i, value) {
                      ...
                      }))), React.createElement("ul", undefined, Belt_Array.mapWithIndex(match.warnings, (function (i, payload) {
                        return React.createElement(Component$AgdaModeVscode.LabeledItem.make, {
                                    payload: payload,
                                    key: String(i)
                                  });
                      }))), React.createElement("ul", undefined, Belt_Array.mapWithIndex(match.errors, (function (i, payload) {
                        return React.createElement(Component$AgdaModeVscode.LabeledItem.make, {
                                    payload: payload,
                                    key: String(i)
                                  });
