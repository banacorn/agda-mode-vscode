                      ...
                      switch (param[0]) {
                        case "goal" :
                            return Belt_Option.mapWithDefault(Component$AgdaModeVscode.Expr.parse(lines.join("\n").slice(5)), [], (function (expr) {
                                          return [/* Labeled */Caml_chrome_debugger.variant("Labeled", 0, [/* Goal */Caml_chrome_debugger.variant("Goal", 2, [expr])])];
                                        }));
                        case "have" :
                            return Belt_Option.mapWithDefault(Component$AgdaModeVscode.Expr.parse(lines.join("\n").slice(5)), [], (function (expr) {
                                          return [/* Labeled */Caml_chrome_debugger.variant("Labeled", 0, [/* Have */Caml_chrome_debugger.variant("Have", 3, [expr])])];
                                        }));
                        case "hiddenMetas" :
                            return Belt_Array.map(Belt_Array.keepMap(Belt_Array.map(lines, Component$AgdaModeVscode.Output.parseOutputWithRange), (function (x) {
                                          ...
                                          return /* Unlabeled */Caml_chrome_debugger.variant("Unlabeled", 1, [output]);
                                        }));
