...
function parseError(raw) {
  ...
  return Belt_Option.mapWithDefault(Js_dict.get(partiteWarningsOrErrors(Emacs__Parser$AgdaModeVscode.Dict.partite(lines, (function (param) {
                ...
                return Belt_Array.map(entries, (function (entry) {
                              return /* Error */Caml_chrome_debugger.variant("Error", 1, [Component$AgdaModeVscode.$$Text.parse(entry)]);
                            }));
              }));
}
                      ...
                      switch (param[0]) {
                        case "goal" :
                            return Belt_Option.mapWithDefault(Component$AgdaModeVscode.Expr.parse(lines.join("\n").slice(5)), [], (function (expr) {
                                          return [/* Goal */Caml_chrome_debugger.variant("Goal", 3, [expr])];
                                        }));
                        case "have" :
                            return Belt_Option.mapWithDefault(Component$AgdaModeVscode.Expr.parse(lines.join("\n").slice(5)), [], (function (expr) {
                                          return [/* Have */Caml_chrome_debugger.variant("Have", 4, [expr])];
                                        }));
                        case "hiddenMetas" :
                            return Belt_Array.map(Belt_Array.keepMap(Belt_Array.map(lines, Component$AgdaModeVscode.Output.parseOutputWithRange), (function (x) {
                                          ...
                                          return /* Output */Caml_chrome_debugger.variant("Output", 5, [output]);
                                        }));
                      ...
                      switch (param[0]) {
                        case "errors" :
                            return Belt_Array.map(lines, (function (line) {
                                          return /* Error */Caml_chrome_debugger.variant("Error", 1, [Component$AgdaModeVscode.$$Text.parse(line)]);
                                        }));
                        case "hiddenMetas" :
                            return Belt_Array.map(Belt_Array.keepMap(Belt_Array.map(lines, Component$AgdaModeVscode.Output.parseOutputWithRange), (function (x) {
                                              return x;
                        ...
                        case "warnings" :
                            return Belt_Array.map(lines, (function (line) {
                                          return /* Warning */Caml_chrome_debugger.variant("Warning", 2, [Component$AgdaModeVscode.$$Text.parse(line)]);
                                        }));
                        default:
                          return [];
                      }
...
function parseContextOrConstraints(raw) {
...
function parseOthers(raw) {
  return [/* PlainText */Caml_chrome_debugger.variant("PlainText", 0, [Component$AgdaModeVscode.$$Text.parse(raw)])];
}
...
function parseSearchAbout(raw) {
  ...
  if (target !== undefined) {
    if (outputs.length === 0) {
      return [/* PlainText */Caml_chrome_debugger.variant("PlainText", 0, [Component$AgdaModeVscode.$$Text.parse("There are no definitions about " + target)])];
    } else {
      return Belt_Array.concatMany([
                  [/* PlainText */Caml_chrome_debugger.variant("PlainText", 0, [Component$AgdaModeVscode.$$Text.parse("Definitions about " + (target + ":"))])],
                  outputs
                ]);
    }
  } else {
    return [/* PlainText */Caml_chrome_debugger.variant("PlainText", 0, [Component$AgdaModeVscode.$$Text.parse("Don't know what to search about")])];
  }
}
...
exports.parseContextOrConstraints = parseContextOrConstraints;
exports.parseOthers = parseOthers;
