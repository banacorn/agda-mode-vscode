                      ...
                      switch (param[0]) {
                        case "errors" :
                            return Belt_Array.map(lines, (function (line) {
                                          return /* Error */Caml_chrome_debugger.variant("Error", 0, [Component$AgdaModeVscode.$$Text.parse(line)]);
                                        }));
                        case "hiddenMetas" :
                            return Belt_Array.map(Belt_Array.keepMap(Belt_Array.map(lines, Component$AgdaModeVscode.Output.parseOutputWithRange), (function (x) {
                                              return x;
                        ...
                        case "warnings" :
                            return Belt_Array.map(lines, (function (line) {
                                          return /* Warning */Caml_chrome_debugger.variant("Warning", 1, [Component$AgdaModeVscode.$$Text.parse(line)]);
                                        }));
                        default:
                          return [];
                      }
