...
function onActivate(callback) {
  return new Vscode.Disposable(Chan$AgdaModeVscode.on(willAddChan, (function (param) {
...
function onDeactivate(callback) {
  return new Vscode.Disposable(Chan$AgdaModeVscode.on(didRemoveChan, (function (param) {
                    if (isEmpty(undefined)) {
                      return Curry._1(callback, undefined);
                    }
