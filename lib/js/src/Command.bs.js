...
function toString$1(input) {
  if (typeof input === "number") {
    ...
    switch (input.TAG | 0) {
      case /* PromptChange */0 :
          return "PromptChange '" + (input._0 + "'");
      case /* Update */1 :
          return "Update";
      case /* InsertChar */2 :
          return "InsertChar '" + (input._0 + "'");
      case /* ChooseSymbol */3 :
          return "ChooseSymbol '" + (input._0 + "'");
  ...
  if (typeof normalization === "number") {
    ...
    switch (normalization.TAG | 0) {
      case /* SolveConstraints */0 :
          return "Solve constraints " + toString(normalization._0);
      case /* SearchAbout */1 :
          return "Search about " + toString(normalization._0);
      case /* ElaborateAndGive */2 :
          return "Elaborate and give " + toString(normalization._0);
      case /* HelperFunctionType */3 :
          return "Helper function type " + toString(normalization._0);
      case /* InferType */4 :
          return "Infer type " + toString(normalization._0);
      case /* Context */5 :
          return "Context " + toString(normalization._0);
      case /* GoalType */6 :
          return "Goal type " + toString(normalization._0);
      case /* GoalTypeAndContext */7 :
          return "Goal type and context " + toString(normalization._0);
      case /* EventFromView */8 :
          return "Event from the view";
      case /* GoalTypeContextAndInferredType */9 :
          return "Goal type, context and inferred type " + toString(normalization._0);
      case /* GoalTypeContextAndCheckedType */10 :
          return "Goal type, context and checked type " + toString(normalization._0);
      case /* ModuleContents */11 :
          return "Module contents " + toString(normalization._0);
      case /* ComputeNormalForm */12 :
          switch (normalization._0) {
            case /* DefaultCompute */0 :
      ...
      case /* InputMethod */13 :
          return "Input symbol " + toString$1(normalization._0);
