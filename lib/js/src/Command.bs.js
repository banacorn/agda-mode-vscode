...
var names = [
  ...
  /* tuple */[
    /* GoalTypeContextAndInferredType */Caml_chrome_debugger.variant("GoalTypeContextAndInferredType", 4, [/* Simplified */0]),
    "goal-type-context-and-inferred-type[Simplified]"
  ],
  /* tuple */[
    /* GoalTypeContextAndInferredType */Caml_chrome_debugger.variant("GoalTypeContextAndInferredType", 4, [/* Instantiated */1]),
    "goal-type-context-and-inferred-type[Instantiated]"
  ],
  /* tuple */[
    /* GoalTypeContextAndInferredType */Caml_chrome_debugger.variant("GoalTypeContextAndInferredType", 4, [/* Normalised */2]),
    "goal-type-context-and-inferred-type[Normalised]"
  ],
  /* tuple */[
    /* GoalTypeContextAndCheckedType */Caml_chrome_debugger.variant("GoalTypeContextAndCheckedType", 5, [/* Simplified */0]),
    "goal-type-context-and-checked-type[Simplified]"
  ],
  /* tuple */[
    /* GoalTypeContextAndCheckedType */Caml_chrome_debugger.variant("GoalTypeContextAndCheckedType", 5, [/* Instantiated */1]),
    "goal-type-context-and-checked-type[Instantiated]"
  ],
  /* tuple */[
    /* GoalTypeContextAndCheckedType */Caml_chrome_debugger.variant("GoalTypeContextAndCheckedType", 5, [/* Normalised */2]),
    "goal-type-context-and-checked-type[Normalised]"
  ],
  /* tuple */[
    /* ModuleContents */Caml_chrome_debugger.variant("ModuleContents", 6, [/* Simplified */0]),
    "module-contents[Simplified]"
  ],
  /* tuple */[
    /* ModuleContents */Caml_chrome_debugger.variant("ModuleContents", 6, [/* Instantiated */1]),
    "module-contents[Instantiated]"
  ],
  /* tuple */[
    /* ModuleContents */Caml_chrome_debugger.variant("ModuleContents", 6, [/* Normalised */2]),
    "module-contents[Normalised]"
  ],
  /* tuple */[
    /* ComputeNormalForm */Caml_chrome_debugger.variant("ComputeNormalForm", 7, [/* DefaultCompute */0]),
    "compute-normal-form[DefaultCompute]"
  ],
  /* tuple */[
    /* ComputeNormalForm */Caml_chrome_debugger.variant("ComputeNormalForm", 7, [/* IgnoreAbstract */1]),
    "compute-normal-form[IgnoreAbstract]"
  ],
  /* tuple */[
    /* ComputeNormalForm */Caml_chrome_debugger.variant("ComputeNormalForm", 7, [/* UseShowInstance */2]),
  ...
  /* tuple */[
    /* InputMethod */Caml_chrome_debugger.variant("InputMethod", 8, [/* Activate */0]),
    "input-symbol[Activate]"
  ],
  /* tuple */[
    /* InputMethod */Caml_chrome_debugger.variant("InputMethod", 8, [/* MoveUp */2]),
    "input-symbol[MoveUp]"
  ],
  /* tuple */[
    /* InputMethod */Caml_chrome_debugger.variant("InputMethod", 8, [/* MoveRight */3]),
    "input-symbol[MoveRight]"
  ],
  /* tuple */[
    /* InputMethod */Caml_chrome_debugger.variant("InputMethod", 8, [/* MoveDown */4]),
    "input-symbol[MoveDown]"
  ],
  /* tuple */[
    /* InputMethod */Caml_chrome_debugger.variant("InputMethod", 8, [/* MoveLeft */5]),
