  ...
  if (typeof x !== "object") {
    ...
    switch (x.TAG) {
      case "ShowConstraints" :
          return "show-constraints[" + encode(x._0) + "]";
...
function toString$2(x) {
  if (typeof x !== "object") {
    ...
    switch (x.TAG) {
      case "ShowConstraints" :
          return "Show constraints" + toString(x._0);
      case "SolveConstraints" :
...
function requiresUpToDateLoad(x) {
  if (typeof x !== "object") {
    switch (x) {
      case "Load" :
      case "Quit" :
...
exports.requiresUpToDateLoad = requiresUpToDateLoad;
