...
function pointAtOffset(editor, offset) {
  ...
  while(true) {
    ...
    var point = editor.document.positionAt(offset$1);
    var range = new Vscode.Range(new Vscode.Position(0, 0), point);
    var textWithInRange = editor.document.getText(Caml_option.some(range));
    var realLength = graphemeWidth(textWithInRange);
    console.log("target offset " + String(offset));
    console.log("current offset " + String(offset$1));
    console.log("=======");
    if (offset === realLength) {
      return point;
    }
    _offset = offset$1 + 2 | 0;
    continue ;
  };
}
