...
function registerSemnaticTokenProvider(provideDocumentSemanticTokens, param) {
  ...
  var documentSemanticTokensProvider_provideDocumentSemanticTokensEdits = (function (textDocument, _previousResultID, _cancel) {
      ...
      return VSCode.ProviderResult.map(Curry._2(provideDocumentSemanticTokens, textDocument.fileName, pushLegend), (function (param) {
                    return {
