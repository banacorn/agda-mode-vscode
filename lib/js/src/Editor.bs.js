...
function registerDefinitionProvider(definitionProvider) {
  return Vscode.languages.registerDefinitionProvider(documentSelector, {
              provideDefinition: (function (textDocument, point, param) {
                  return VSCode.ProviderResult.map(definitionProvider(textDocument, point), (function (pairs) {
...
function make(onDidChangeSemanticTokens, provideDocumentSemanticTokens, provideDocumentSemanticTokensEdits, param) {
  return {
          onDidChangeSemanticTokens: onDidChangeSemanticTokens,
...
function registerDocumentSemanticTokensProvider(provideDocumentSemanticTokens, onDidChangeSemanticTokens, param) {
