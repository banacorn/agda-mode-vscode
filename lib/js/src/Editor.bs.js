...
function replace(editor, range, text, option) {
  return editor.edit((function (editBuilder) {
                editBuilder.replace(range, text);
              }), option);
}

function batchReplace(editor, replacements, option) {
  return editor.edit((function (editBuilder) {
...
function insert(editor, point, text, option) {
  return editor.edit((function (editBuilder) {
                editBuilder.insert(point, text);
              }), option);
}

function batchInsert(editor, points, text, option) {
  return editor.edit((function (editBuilder) {
...
function $$delete(editor, range, option) {
  return editor.edit((function (editBuilder) {
