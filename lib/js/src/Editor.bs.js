...
function highlightBackground(editor, style, range) {
  var backgroundColor = VSCode$AgdaModeVscode.ThemeColor.themeColor(new Vscode.ThemeColor("editor.selectionHighlightBackground"));
...
function overlayText(editor, style, text, range) {
  var after = {
    color: VSCode$AgdaModeVscode.ThemeColor.themeColor(new Vscode.ThemeColor("editorLightBulb.foreground")),
    contentText: text
  };
  var options = {
    after: after
