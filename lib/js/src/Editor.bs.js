...
var View = {
  ...
  recv: View__Controller$AgdaModeVscode.recv,
...
function highlightBackground(editor, style, range) {
  var backgroundColor = VSCode$Guacamole.ThemeColor.themeColor(new Vscode.ThemeColor(style));
  var rangeBehavior = VSCode$Guacamole.DecorationRangeBehavior.toEnum(/* ClosedClosed */1);
  var options = {
...
function overlayText(editor, style, text, range) {
  var after = {
    color: VSCode$Guacamole.ThemeColor.themeColor(new Vscode.ThemeColor(style)),
    contentText: text
  };
  var options = {
    after: after
