...
function highlightBackgroundPrim(editor, backgroundColor, ranges) {
  var rangeBehavior = VSCode.DecorationRangeBehavior.toEnum("ClosedClosed");
  var options = {
...
function underlineText(editor, range) {
  var rangeBehavior = VSCode.DecorationRangeBehavior.toEnum("ClosedOpen");
  var options = {
    rangeBehavior: rangeBehavior,
...
function reveal(editor, range) {
  VSCode.TextEditor.revealRange(editor, range, "InCenterIfOutsideViewport");
}
