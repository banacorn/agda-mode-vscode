...
function codeUnitEndingOffset(editor, offset) {
  ...
  var charOffsetWithLookahead = characterWidth(textWithLookahead);
  var charOffsetWithoutLookahead = characterWidth(textWithoutLookahead);
...
function toAgdaOffset(editor, offset) {
  ...
  return characterWidth(editor.document.getText(Caml_option.some(range)));
}
