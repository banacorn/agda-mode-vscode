...
function registerSemnaticTokenProvider(prodider, param) {
...
var Provider = {
  ...
  Mock: Mock,
  registerSemnaticTokenProvider: registerSemnaticTokenProvider
};

function toUTF8Offset($$document, offset) {
  var range = new Vscode.Range(new Vscode.Position(0, 0), $$document.positionAt(offset));
  return Curry._1(Common$AgdaModeVscode.Agda.OffsetConverter.characterWidth, $$document.getText(Caml_option.some(range)));
}
