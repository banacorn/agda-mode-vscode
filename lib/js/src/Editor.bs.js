...
function highlightBackground(editor, style, range) {
  var backgroundColor = VSCode$AgdaModeVscode.ThemeColor.themeColor(new Vscode.ThemeColor(style));
...
function overlayText(editor, style, text, range) {
  var after = {
    color: VSCode$AgdaModeVscode.ThemeColor.themeColor(new Vscode.ThemeColor(style)),
    contentText: text
  };
  var options = {
    after: after
