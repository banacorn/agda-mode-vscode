...
var $$Error = Caml_exceptions.create("Util-AgdaModeVscode.Error");
...
function sum(decoder) {
  return function (param) {
    return Json_decode.andThen((function (tag) {
                  ...
                  var d$2 = d._0;
                  return function (param) {
                    return Json_decode.field("contents", d$2, param);
                  };
                }), (function (param) {
...
function oneByOne$prime(x) {
  if (!x) {
    return $$Promise.resolved(/* [] */0);
  }
  var xs = x.tl;
  return $$Promise.flatMap(Curry._1(x.hd, undefined), (function (x$prime) {
