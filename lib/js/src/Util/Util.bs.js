...
function tuple6_(decodeA, decodeB, decodeC, decodeD, decodeE, decodeF) {
  return Json_Decode$JsonCombinators.custom(function (json) {
              ...
              var run = function (decoder, xs, i) {
                var x = Belt_Array.get(xs, i);
                if (x !== undefined) {
                  var x$1 = Json_Decode$JsonCombinators.decode(Caml_option.valFromOption(x), decoder);
                  if (x$1.TAG === /* Ok */0) {
                    return x$1._0;
                  }
                  throw {
...
function tuple5_(decodeA, decodeB, decodeC, decodeD, decodeE) {
  return Json_Decode$JsonCombinators.custom(function (json) {
              if (!Array.isArray(json)) {
                Json_Decode$JsonCombinators.$$Error.expected("array", json);
              }
...
function sum$1(f, x) {
  var tag = Curry._1(f, x);
  if (tag.TAG === /* Payload */0) {
    return {
            tag: tag._0,
            contents: tag._1
          };
