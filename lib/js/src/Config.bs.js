...
function setAgdaPaths(paths) {
  ...
  var paths$1 = Core__Array.filterMap(paths, Connection__URI$AgdaModeVscode.toVSCodeURI).map(function (prim) {
        return prim.fsPath;
      });
...
function addAgdaPath(path) {
  ...
  var newPaths$1 = Core__Array.filterMap(newPaths, Connection__URI$AgdaModeVscode.toVSCodeURI).map(function (prim) {
        return prim.fsPath;
      });
