...
function tempParseFromStringDirect(infos) {
  var parseToken = function (raw) {
    return Belt_Array.keepMap(Parser$AgdaModeVscode.SExpression.parse(raw), (function (result) {
                  if (result.TAG === /* Ok */0) {
                    return result._0;
                  }
  ...
  return parseDirectHighlightings(Belt_Array.concatMany(Belt_Array.map(infos, parseToken)));
}
...
exports.tempParseFromStringDirect = tempParseFromStringDirect;
