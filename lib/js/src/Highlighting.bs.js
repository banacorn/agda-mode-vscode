...
function parse$1(x) {
  ...
  switch (len) {
    case 3 :
        var start$prime = xs[0];
        if (start$prime.TAG !== /* A */0) {
          return ;
        }
        var end_$prime = xs[1];
        if (end_$prime.TAG !== /* A */0) {
          return ;
        }
        var end_$prime$1 = end_$prime._0;
        var aspects = xs[2];
        return Belt_Option.flatMap(Pervasives.int_of_string_opt(start$prime._0), (function (start) {
    ...
    case 4 :
        var start$prime$1 = xs[0];
        if (start$prime$1.TAG !== /* A */0) {
          return ;
        }
        var end_$prime$2 = xs[1];
        if (end_$prime$2.TAG !== /* A */0) {
          return ;
        }
        var end_$prime$3 = end_$prime$2._0;
        var aspects$1 = xs[2];
        return Belt_Option.flatMap(Pervasives.int_of_string_opt(start$prime$1._0), (function (start) {
    ...
    case 5 :
        return ;
    case 6 :
        var start$prime$2 = xs[0];
        if (start$prime$2.TAG !== /* A */0) {
          return ;
        }
        var end_$prime$4 = xs[1];
        if (end_$prime$4.TAG !== /* A */0) {
          return ;
        }
        ...
        return Belt_Option.flatMap(Pervasives.int_of_string_opt(start$prime$2._0), (function (start) {
...
function tempParseFromString(raw) {
...
exports.tempParseFromString = tempParseFromString;
