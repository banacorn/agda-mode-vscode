...
function parseFromString(raw) {
  var tokens = Belt_Array.keepMap(Parser$AgdaModeVscode.SExpression.parse(raw), (function (result) {
          if (result.TAG === /* Ok */0) {
            return result._0;
          }
          
        }));
  var match = Belt_Array.get(tokens, 0);
  if (match !== undefined && match.TAG !== /* A */0) {
    return parse(match._0.slice(1));
  }
...
function parseFromString$1(raw) {
...
exports.parseFromString = parseFromString$1;
