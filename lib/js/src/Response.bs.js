    ...
    switch (filepath.tag | 0) {
      case /* HighlightingInfoDirect */0 :
          return "HighlightingInfoDirect " + ((
                  ...
                  ) + (" " + (String(filepath[1].length) + " annotations")));
  ...
  switch (match[0]) {
    ...
    case "agda2-give-action" :
        ...
        if (match$1 !== undefined && !match$1.tag) {
          return Belt_Option.mapWithDefault(Belt_Option.flatMap(Pervasives.int_of_string_opt(match$1[0]), (function (i) {
    ...
    case "agda2-goals-action" :
        ...
        if (xs$1 !== undefined) {
          return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* InteractionPoints */Caml_chrome_debugger.variant("InteractionPoints", 4, [Belt_Array.keepMap(Parser$AgdaModeVscode.SExpression.flatten(xs$1), Pervasives.int_of_string_opt)])]);
        } else {
          return /* Error */Caml_chrome_debugger.variant("Error", 1, [/* Response */Caml_chrome_debugger.variant("Response", 1, [
                        5,
                        tokens
    ...
    case "agda2-maybe-goto" :
        ...
        if (index$prime.tag) {
          ...
          return Belt_Option.mapWithDefault(Belt_Option.flatMap(Pervasives.int_of_string_opt(index$prime[0]), (function (index) {
