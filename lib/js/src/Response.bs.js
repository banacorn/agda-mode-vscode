  ...
  if (typeof x !== "object") {
    ...
    switch (x.TAG) {
      ...
      case "InteractionPoints" :
          return "InteractionPoints " + Util$AgdaModeVscode.Pretty.array(x._0, (function (prim) {
                        return String(prim);
                      }));
      case "GiveAction" :
          var string = x._1;
      ...
      case "MakeCase" :
          if (x._0 === "Function") {
            return "MakeCase Function " + Util$AgdaModeVscode.Pretty.array(x._1, (function (x) {
                          return x;
                        }));
          } else {
            return "MakeCase ExtendedLambda " + Util$AgdaModeVscode.Pretty.array(x._1, (function (x) {
                          return x;
                        }));
          }
      case "SolveAll" :
          return "SolveAll " + Util$AgdaModeVscode.Pretty.array(x._0, (function (param) {
...
function parse$1(xs) {
  ...
  switch (match._0) {
        ...
        if (xs$2 !== undefined) {
          return {
                  ...
                  _0: {
                    ...
                    _0: Core__Array.filterMap(Parser$AgdaModeVscode.SExpression.flatten(xs$2), PervasivesU.int_of_string_opt)
                  }
                };
        } else {
          return {
    ...
    case "agda2-highlight-add-annotations" :
        var annotations = Token$AgdaModeVscode.parseDirectHighlightings(xs$1);
        var match$2 = xs$1[1];
        ...
        if (xs$4 !== undefined) {
          return {
                  ...
                  _0: {
                    TAG: "MakeCase",
                    _0: "ExtendedLambda",
                    _1: Parser$AgdaModeVscode.SExpression.flatten(xs$4)
                  }
                };
        } else {
          return {
    ...
    case "agda2-solveAll-action" :
        ...
        var xs$6 = Parser$AgdaModeVscode.SExpression.flatten(xs$5);
        ...
        var solutions = Core__Array.filterMap(xs$6, (function (token) {
                var solution = isEven(i.contents) ? Core__Option.flatMap(PervasivesU.int_of_string_opt(token), (function (index) {
                          return Core__Option.map(xs$6[i.contents + 1 | 0], (function (s) {
                                        return [
                                                index,
                                                s
                                              ];
            ...
            if (match$4.TAG === "A" && match$4._0 === ".") {
              ...
              if (priority.TAG === "A") {
                ...
                if (match$5.TAG === "A" && match$5._0 === ".") {
                  var xs$1 = match[2];
                  return Core__Result.map(parse$1(xs$1), (function (response) {
                                return {
                                        TAG: "Last",
