...
function toString(string) {
  ...
  switch (string.TAG | 0) {
    ...
    case /* AllGoalsWarnings */1 :
        return "AllGoalsWarnings " + string._0;
    case /* Time */2 :
        return "Time " + string._0;
    case /* Error */3 :
        return "Error " + string._0;
    case /* Intro */4 :
        return "Intro " + string._0;
    case /* Auto */5 :
        return "Auto " + string._0;
    case /* ModuleContents */6 :
        return "ModuleContents " + string._0;
    case /* SearchAbout */7 :
        return "SearchAbout " + string._0;
    case /* WhyInScope */8 :
        return "WhyInScope " + string._0;
    case /* NormalForm */9 :
        return "NormalForm " + string._0;
    case /* GoalType */10 :
        return "GoalType " + string._0;
    case /* CurrentGoal */11 :
        return "CurrentGoal " + string._0;
    case /* InferredType */12 :
        return "InferredType " + string._0;
    case /* Context */13 :
        return "Context " + string._0;
    case /* HelperFunction */14 :
        return "HelperFunction " + string._0;
    case /* Version */15 :
        return "Version " + string._0;
    ...
    switch (filepath.TAG | 0) {
      case /* HighlightingInfoDirect */0 :
          return "HighlightingInfoDirect " + ((
                    filepath._0 ? "Keep " : "Remove "
                  ) + (" " + (String(filepath._1.length) + " annotations")));
      ...
      case /* InteractionPoints */4 :
          return "InteractionPoints " + Util$AgdaModeVscode.Pretty.array(Belt_Array.map(filepath._0, (function (prim) {
                            return String(prim);
                          })));
      case /* GiveAction */5 :
      ...
      case /* MakeCase */6 :
          if (filepath._0) {
            return "MakeCase ExtendedLambda " + Util$AgdaModeVscode.Pretty.array(filepath._1);
          } else {
            return "MakeCase Function " + Util$AgdaModeVscode.Pretty.array(filepath._1);
          }
      case /* SolveAll */7 :
          return "SolveAll " + Util$AgdaModeVscode.Pretty.array(Belt_Array.map(filepath._0, (function (param) {
...
function toString$2(response) {
  if (response.TAG) {
    return "Last(" + (String(response._0) + (") " + toString$1(response._1)));
  } else {
    return "NonLast " + toString$1(response._0);
  }
}
    ...
    if (match.length === 3) {
      ...
      if (match$1.TAG) {
        ...
        if (match$2.length === 3) {
          ...
          if (!match$3.TAG && match$3._0 === "last") {
            var match$4 = match$2[1];
            if (!match$4.TAG && match$4._0 === ".") {
              var priority = match$2[2];
              if (!priority.TAG) {
                var priority$1 = priority._0;
                var match$5 = match[1];
                if (!match$5.TAG && match$5._0 === ".") {
                  var xs = match[2];
