    ...
    switch (filepath.tag | 0) {
      case /* HighlightingInfoDirect */0 :
          return "HighlightingInfoDirect " + ((
                  ...
                  ) + Util$AgdaModeVscode.Pretty.array(Belt_Array.map(filepath[1], Highlighting$AgdaModeVscode.toString)));
...
function parse$1(tokens) {
  ...
  switch (match[0]) {
    case "agda2-abort-done" :
        return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* DoneAborting */2]);
    case "agda2-exit-done" :
        return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* DoneExiting */3]);
    ...
    case "agda2-highlight-clear" :
        return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* ClearHighlighting */1]);
    ...
    if (match$8 !== undefined && !match$8.tag) {
      if (match$8[0] === "*Type-checking*") {
        ...
        if (match$9 === undefined) {
          return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* ClearRunningInfo */0]);
        }
        if (match$9.tag) {
          return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [/* ClearRunningInfo */0]);
        }
...
function toString$2(response) {
  if (response.tag) {
    return "Last(" + (String(response[0]) + (") " + toString$1(response[1])));
  } else {
    return "NonLast " + toString$1(response[0]);
  }
}
...
function parse$2(tokens) {
        ...
        if (match$2.length === 3) {
          ...
          if (!match$3.tag && match$3[0] === "last") {
            ...
            if (!match$4.tag && match$4[0] === ".") {
              ...
              if (!priority.tag) {
                var priority$1 = priority[0];
                var match$5 = match[1];
                if (!match$5.tag && match$5[0] === ".") {
                  var xs = match[2];
                  return Belt_Result.map(parse$1(xs), (function (response) {
                                return /* Last */Caml_chrome_debugger.variant("Last", 1, [
                                          Caml_format.caml_int_of_string(priority$1),
                                          response
                                        ]);
                              }));
                }
  ...
  return Belt_Result.map(parse$1(tokens), (function (response) {
                return /* NonLast */Caml_chrome_debugger.variant("NonLast", 0, [response]);
              }));
}
