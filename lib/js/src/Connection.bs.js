...
function toString$1(x) {
  if (typeof x === "number") {
    ...
    switch (x.TAG | 0) {
      ...
      case /* LSPCommandError */9 :
          return [
                  "[LSP] Cannot Send Command",
                  toString(x._0)
                ];
      case /* LSPInternalError */10 :
          return [
                  "LSP: Internal Error",
                  x._0
                ];
      case /* LSPConnection */11 :
          return [
                  "LSP: Connection Failed",
                  Util$AgdaModeVscode.JsError.toString(x._0)
                ];
      case /* LSPSendRequest */12 :
          return [
                  "LSP: Cannot Send Request",
                  Util$AgdaModeVscode.JsError.toString(x._0)
                ];
      case /* LSPClientCannotDecodeResponse */13 :
          return [
                  "LSP: Client Cannot Decode Response",
                  x._0 + "\n" + JSON.stringify(x._1)
                ];
      case /* CannotDecodeRequest */14 :
          return [
                  "LSP: Server Cannot Decode Request",
                  x._0
                ];
      case /* ResponseParseError */15 :
          return [
                        ...
                        if (error !== undefined) {
                          return $$Promise.resolved({
                                      ...
                                      _0: {
                                        TAG: 9,
                                        _0: error,
                                        [Symbol.for("name")]: "LSPCommandError"
                                      },
                                      [Symbol.for("name")]: "Error"
                                    });
                        } else {
