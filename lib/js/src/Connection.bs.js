...
function start(useLSP, viaTCP) {
  ...
  if (match.TAG === /* Emacs */0) {
    var version = Connection__Emacs$AgdaModeVscode.getVersion(match._0);
  ...
  var match$1 = Connection__LSP$AgdaModeVscode.getStatus(match._0);
  return $$Promise.resolved({
              TAG: 0,
              _0: {
                TAG: 1,
...
function sendRequest(useLSP, viaTCP, $$document, request, handler) {
  ...
  if (match.TAG === /* Emacs */0) {
    var conn = match._0;
    var version = Connection__Emacs$AgdaModeVscode.getVersion(conn);
    return Connection__Emacs$AgdaModeVscode.sendRequest(conn, encodeRequest($$document, version), handler);
  }
  var conn$1 = match._0;
