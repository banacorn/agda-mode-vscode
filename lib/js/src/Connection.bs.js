...
var decode$1 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
        case "DisplayInfoOthers1" :
            return {
                    TAG: 1,
                    _0: /* DisplayInfoOthers1 */0,
                    [Symbol.for("name")]: "TagOnly"
                  };
        case "DisplayInfoOthers2" :
            return {
                    TAG: 1,
                    _0: /* DisplayInfoOthers2 */1,
                    [Symbol.for("name")]: "TagOnly"
                  };
        case "DisplayInfoTempGeneric" :
            return {
                    TAG: 0,
                    _0: (function (param) {
                        return Json_decode.map((function (raw) {
                                      return {
                                              _0: raw,
                                              [Symbol.for("name")]: "DisplayInfoTempGeneric"
                                            };
                                    }), Json_decode.string, param);
                      }),
                    [Symbol.for("name")]: "Contents"
...
var decode$2 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
            ...
            return {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (info) {
                                      ...
                                      var info$1 = Response$AgdaModeVscode.DisplayInfo.parseFromString(info._0);
                                      if (info$1 !== undefined) {
                                        return {
                                                TAG: 0,
                                                _0: {
        ...
        case "ReactionHighlightingInfo" :
            return {
                    TAG: 0,
                    _0: (function (param) {
                        return Json_decode.map((function (raw) {
                                      var match = Highlighting$AgdaModeVscode.tempParseFromString(raw);
                                      if (match !== undefined) {
                                        if (match.TAG === /* HighlightingInfoDirect */0) {
                                          return {
                                                  TAG: 0,
                                                  _0: {
                                                    TAG: 0,
