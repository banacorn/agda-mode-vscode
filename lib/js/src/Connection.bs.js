...
var Connection__Scheduler$AgdaModeVscode = require("./Connection/Connection__Scheduler.bs.js");
            ...
            return {
                    ...
                    _0: (function (param) {
                        return Json_decode.map((function (error) {
                                      ...
                                      return Json_decode.optional(Connection__Error$AgdaModeVscode.LSP.CommandErr.decode, param);
                                    }), param);
                      }),
...
function start(tryTCP) {
  ...
  if (match) {
    ...
    return $$Promise.flatMap($$Promise.flatMapOk(probe(tryTCP, 4096, "als"), make$1), (function (result) {
                  if (result.TAG === /* Ok */0) {
