                        ...
                        return Json_decode.map((function (param) {
                                      ...
                                      return Util$AgdaModeVscode.Decode.tuple5(Json_decode.string, (function (param) {
                                                    return Json_decode.array((function (param) {
                                                                  return Json_decode.pair(Agda$AgdaModeVscode.OutputConstraint.decode, Json_decode.string, param);
                                                                }), param);
                                                  }), (function (param) {
                                                    return Json_decode.array((function (param) {
                                                                  return Json_decode.tuple3(Agda$AgdaModeVscode.OutputConstraint.decode, Json_decode.string, Common$AgdaModeVscode.AgdaRange.decode, param);
                                                                }), param);
