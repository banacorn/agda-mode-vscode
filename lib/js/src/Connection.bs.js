...
function destroy(self) {
  ...
  Chan$AgdaModeVscode.destroy(self.emitter);
...
function wire(self) {
  ...
  var pipeline = Parser$AgdaModeVscode.SExpression.makeIncr(function (x) {
        ...
        if (res) {
          return Chan$AgdaModeVscode.emit(self.emitter, {
                      TAG: 0,
                      _0: {
                        _0: res._0,
                        [Symbol.for("name")]: "Yield"
  ...
  Chan$AgdaModeVscode.on(self.process.emitter, onData);
...
function make$1(fromConfig, toConfig) {
  ...
  return $$Promise.tapOk($$Promise.mapOk($$Promise.tapOk($$Promise.flatMapOk(getPath(undefined), (function (path) {
                    ...
                    return {
                            ...
                            emitter: Chan$AgdaModeVscode.make(undefined),
