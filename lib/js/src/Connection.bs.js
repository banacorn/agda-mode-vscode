...
function find(devMode) {
  if (!devMode) {
    return $$Promise.mapError($$Promise.mapOk(Process$AgdaModeVscode.PathSearch.run("als"), (function (path) {
                      return {
                              TAG: 0,
                              _0: path.trim(),
                                  ...
                                  switch (response.TAG | 0) {
                                    ...
                                    case /* Payload */1 :
                                        return $$Promise.resolved({
                                                    ...
                                                    _0: {
                                                      TAG: 4,
                                                      _0: Js_exn.raiseError("Got payload instead"),
                                                      [Symbol.for("name")]: "LSPConnection"
                                                    },
                                                    [Symbol.for("name")]: "Error"
                                                  });
                                    case /* ServerCannotDecodeRequest */2 :
                                        return $$Promise.resolved({
                                                    TAG: 1,
                                                    _0: {
                                                      TAG: 7,
                  ...
                  switch (result.TAG | 0) {
                    case /* Initialize */0 :
                        return $$Promise.resolved({
                                    ...
                                    _0: {
                                      TAG: 3,
                                      _0: "Got Initialize when expecting Payload",
