...
var decode$1 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
        case "DisplayInfoAllGoalsWarnings" :
            var partial_arg = Agda$AgdaModeVscode.OutputConstraint.decode(Agda$AgdaModeVscode.NamedMeta.decode);
            var partial_arg$1 = function (param) {
              return Json_decode.tuple3(partial_arg, Json_decode.string, Common$AgdaModeVscode.AgdaRange.decode, param);
            };
            var partial_arg$2 = function (param) {
              return Json_decode.array(partial_arg$1, param);
            };
            var partial_arg$3 = Agda$AgdaModeVscode.OutputConstraint.decode(Agda$AgdaModeVscode.InteractionId.decode);
            var partial_arg$4 = function (param) {
              return Json_decode.pair(partial_arg$3, Json_decode.string, param);
            };
            var partial_arg$5 = function (param) {
              return Json_decode.array(partial_arg$4, param);
            };
            var partial_arg$6 = function (param) {
              return Util$AgdaModeVscode.Decode.tuple5(Json_decode.string, partial_arg$5, partial_arg$2, (function (param) {
...
var decode$2 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
        ...
        case "ReactionHighlightingInfoDirect" :
            return {
                    TAG: 0,
                    _0: (function (param) {
                        return Json_decode.map((function (param) {
        ...
        case "ReactionHighlightingInfoIndirect" :
            return {
                    TAG: 0,
                    _0: (function (param) {
        ...
        case "ReactionMakeCaseExtendedLambda" :
            return {
                    TAG: 0,
                    _0: (function (param) {
    ...
    if (msg.RE_EXN_ID === Json_decode.DecodeError) {
      return {
              ...
              _0: {
                ...
                _0: msg._1,
                _1: json,
                [Symbol.for("name")]: "CannotDecodeReaction"
              },
              [Symbol.for("name")]: "Error"
            };
    }
