...
function Impl(Editor) {
  ...
  var encode = function (editor, version, filepath, backend, libraryPath, highlightingMethod, request) {
    libraryPath.unshift(".");
    ...
    if (typeof request === "number") {
      ...
      switch (request.tag | 0) {
        ...
        case /* Give */3 :
            ...
            var content$1 = Curry._2(Goal.getContent, goal, editor);
        ...
        case /* Refine */4 :
            ...
            var content$2 = Curry._2(Goal.getContent, goal$1, editor);
        ...
        case /* Auto */6 :
            ...
            var content$4 = Curry._2(Goal.getContent, goal$2, editor);
        ...
        case /* Case */7 :
            ...
            var content$5 = Curry._2(Goal.getContent, goal$3, editor);
