  ...
  var encode = function (editor, version, filepath, libraryPath, highlightingMethod, request) {
    ...
    switch (request.tag | 0) {
      ...
      case /* GoalTypeContextAndCheckedType */8 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_check " + (String(normalization$4) + (" " + (String(index$7) + (" noRange \"" + (String(content$6) + "\" )"))))));
      case /* ModuleContents */9 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_show_module_contents " + (String(normalization$5) + (" " + (String(index$8) + (" noRange \"" + (String(content$7) + "\" )"))))));
      case /* ModuleContentsGlobal */10 :
          ...
          return commonPart(/* None */0) + ("( Cmd_show_module_contents_toplevel " + (String(normalization$6) + (" \"" + (String(content$8) + "\" )"))));
      case /* ComputeNormalForm */11 :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(computeMode$1) + (" " + (String(index$9) + (" noRange \"" + (String(content$9) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(ignoreAbstract) + (" " + (String(index$9) + (" noRange \"" + (String(content$9) + "\" )"))))));
          }
      case /* ComputeNormalFormGlobal */12 :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute_toplevel " + (String(computeMode$3) + (" \"" + (String(content$10) + "\" )"))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute_toplevel " + (String(ignoreAbstract$1) + (" \"" + (String(content$10) + "\" )"))));
          }
      case /* WhyInScope */13 :
          var index$10 = String(request[1].index);
          var content$11 = Parser$AgdaModeVscode.userInput(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_why_in_scope " + (String(index$10) + (" noRange \"" + (String(content$11) + "\" )"))));
      case /* WhyInScopeGlobal */14 :
          var content$12 = Parser$AgdaModeVscode.userInput(request[0]);
          return commonPart(/* None */0) + ("( Cmd_why_in_scope_toplevel \"" + (String(content$12) + "\" )"));
