  ...
  if (typeof request !== "object") {
    ...
    switch (request.TAG) {
      ...
      case "Give2" :
          ...
          var content$2 = Parser$AgdaModeVscode.$$escape(Goal2$AgdaModeVscode.read(goal$1, $$document));
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.3")) {
      ...
      case "Case" :
          ...
          var index$4 = String(goal$4.index);
          var content$6 = Parser$AgdaModeVscode.$$escape(Goal$AgdaModeVscode.getContent(goal$4, $$document));
          var range$4 = buildRange(goal$4);
          return commonPart("NonInteractive") + "( Cmd_make_case " + index$4 + " " + range$4 + " \"" + content$6 + "\" )";
      case "Case2" :
          var goal$5 = request._0;
          var range$5 = buildRange2(goal$5);
          var content$7 = Parser$AgdaModeVscode.$$escape(Goal2$AgdaModeVscode.read(goal$5, $$document));
          return commonPart("NonInteractive") + "( Cmd_make_case " + goal$5.indexString + " " + range$5 + " \"" + content$7 + "\" )";
      case "HelperFunctionType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_helper_function " + normalization$6 + " " + index$5 + " noRange \"" + content$8 + "\" )";
      case "InferType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_infer " + normalization$7 + " " + index$6 + " noRange \"" + content$9 + "\" )";
      case "InferTypeGlobal" :
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_infer " + normalization$12 + " " + index$10 + " noRange \"" + content$11 + "\" )";
      case "GoalTypeContextAndCheckedType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_check " + normalization$13 + " " + index$11 + " noRange \"" + content$12 + "\" )";
      case "ModuleContents" :
          ...
          return commonPart("NonInteractive") + "( Cmd_show_module_contents " + normalization$14 + " " + index$12 + " noRange \"" + content$13 + "\" )";
      case "ModuleContentsGlobal" :
          ...
          return commonPart("None") + "( Cmd_show_module_contents_toplevel " + normalization$15 + " \"" + content$14 + "\" )";
      case "ComputeNormalForm" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart("NonInteractive") + "( Cmd_compute " + computeMode$1 + " " + index$13 + " noRange \"" + content$15 + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_compute " + ignoreAbstract + " " + index$13 + " noRange \"" + content$15 + "\" )";
          }
      case "ComputeNormalFormGlobal" :
          ...
          var content$16 = Parser$AgdaModeVscode.$$escape(request._1);
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart("NonInteractive") + "( Cmd_compute_toplevel " + computeMode$3 + " \"" + content$16 + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_compute_toplevel " + ignoreAbstract$1 + " \"" + content$16 + "\" )";
          }
      case "WhyInScope" :
          var index$14 = String(request._1.index);
          var content$17 = Parser$AgdaModeVscode.$$escape(request._0);
          return commonPart("NonInteractive") + "( Cmd_why_in_scope " + index$14 + " noRange \"" + content$17 + "\" )";
      case "WhyInScopeGlobal" :
          var content$18 = Parser$AgdaModeVscode.$$escape(request._0);
          return commonPart("None") + "( Cmd_why_in_scope_toplevel \"" + content$18 + "\" )";
