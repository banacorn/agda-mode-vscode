  ...
  if (typeof request !== "object") {
    ...
    switch (request.TAG) {
      ...
      case "Give2" :
          ...
          var content$2 = Goal2$AgdaModeVscode.read(goal$1, $$document);
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.3")) {
      ...
      case "HelperFunctionType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_helper_function " + normalization$6 + " " + index$5 + " noRange \"" + content$7 + "\" )";
      case "InferType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_infer " + normalization$7 + " " + index$6 + " noRange \"" + content$8 + "\" )";
      case "InferTypeGlobal" :
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_infer " + normalization$12 + " " + index$10 + " noRange \"" + content$10 + "\" )";
      case "GoalTypeContextAndCheckedType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_check " + normalization$13 + " " + index$11 + " noRange \"" + content$11 + "\" )";
      case "ModuleContents" :
          ...
          return commonPart("NonInteractive") + "( Cmd_show_module_contents " + normalization$14 + " " + index$12 + " noRange \"" + content$12 + "\" )";
      case "ModuleContentsGlobal" :
      ...
      case "ComputeNormalForm" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart("NonInteractive") + "( Cmd_compute " + computeMode$1 + " " + index$13 + " noRange \"" + content$14 + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_compute " + ignoreAbstract + " " + index$13 + " noRange \"" + content$14 + "\" )";
          }
      case "ComputeNormalFormGlobal" :
      ...
      case "WhyInScope" :
          ...
          return commonPart("NonInteractive") + "( Cmd_why_in_scope " + index$14 + " noRange \"" + content$16 + "\" )";
      case "WhyInScopeGlobal" :
