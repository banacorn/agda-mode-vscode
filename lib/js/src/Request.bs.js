  ...
  if (typeof request !== "object") {
    ...
    switch (request.TAG) {
      ...
      case "Give" :
          ...
          var content$1 = Parser$AgdaModeVscode.$$escape(Goal2$AgdaModeVscode.getContent(goal, $$document));
      ...
      case "Auto" :
          ...
          var content$4 = Parser$AgdaModeVscode.$$escape(Goal2$AgdaModeVscode.getContent(goal$2, $$document));
