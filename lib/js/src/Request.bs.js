    ...
    switch (request.TAG) {
      ...
      case "Auto" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.7.0")) {
            return commonPart("NonInteractive") + "( Cmd_autoOne " + normalization$5 + " " + index$4 + " " + range$2 + " \"" + content$4 + "\" )";
      ...
      case "HelperFunctionType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_helper_function " + normalization$6 + " " + index$6 + " noRange \"" + content$6 + "\" )";
      case "InferType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_infer " + normalization$7 + " " + index$7 + " noRange \"" + content$7 + "\" )";
      case "InferTypeGlobal" :
      ...
      case "Context" :
          ...
          return commonPart("NonInteractive") + "( Cmd_context " + normalization$9 + " " + index$8 + " noRange \"\" )";
      case "GoalType" :
          var index$9 = String(request._1.index);
          var normalization$10 = Command$AgdaModeVscode.Normalization.encode(request._0);
          return commonPart("NonInteractive") + "( Cmd_goal_type " + normalization$10 + " " + index$9 + " noRange \"\" )";
      case "GoalTypeAndContext" :
          var index$10 = String(request._1.index);
          var normalization$11 = Command$AgdaModeVscode.Normalization.encode(request._0);
          return commonPart("NonInteractive") + "( Cmd_goal_type_context " + normalization$11 + " " + index$10 + " noRange \"\" )";
      case "GoalTypeContextAndInferredType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_infer " + normalization$12 + " " + index$11 + " noRange \"" + content$9 + "\" )";
      case "GoalTypeContextAndCheckedType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_check " + normalization$13 + " " + index$12 + " noRange \"" + content$10 + "\" )";
      case "ModuleContents" :
          ...
          return commonPart("NonInteractive") + "( Cmd_show_module_contents " + normalization$14 + " " + index$13 + " noRange \"" + content$11 + "\" )";
      case "ModuleContentsGlobal" :
