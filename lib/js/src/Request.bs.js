  ...
  var encode = function (editor, version, filepath, libraryPath, highlightingMethod, request) {
    ...
    switch (request.tag | 0) {
      ...
      case /* InferType */3 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_infer " + (String(normalization) + (" " + (String(index$3) + (" noRange \"" + (String(content$3) + "\" )"))))));
      case /* InferTypeGlobal */4 :
          ...
          return commonPart(/* None */0) + ("( Cmd_infer_toplevel " + (String(normalization$1) + (" \"" + (String(content$4) + "\" )"))));
      case /* GoalType */5 :
          var index$4 = String(request[1].index);
          var normalization$2 = Command$AgdaModeVscode.Normalization.toString(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type " + (String(normalization$2) + (" " + (String(index$4) + " noRange \"\" )"))));
