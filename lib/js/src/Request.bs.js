...
var Config__Backend$AgdaModeVscode = require("./Config/Config__Backend.bs.js");
...
function encode($$document, version, filepath, backend, libraryPath, highlightingMethod, request) {
  ...
  var backend$1 = Config__Backend$AgdaModeVscode.encode(backend);
  if (typeof request !== "object") {
    switch (request) {
      ...
      case "Compile" :
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.0")) {
            return commonPart("NonInteractive") + "( Cmd_compile " + backend$1 + " \"" + filepath + "\" [] )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_compile " + backend$1 + " \"" + filepath + "\" [" + libraryPath$1 + "] )";
          }
      case "ToggleDisplayOfImplicitArguments" :
    ...
    switch (request.TAG) {
      ...
      case "ShowGoals" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.6.2")) {
            return commonPart("NonInteractive") + "( Cmd_metas " + normalization$3 + " )";
          } else {
      ...
      case "SearchAbout" :
          ...
          return commonPart("NonInteractive") + "( Cmd_search_about_toplevel " + normalization$4 + " \"" + content + "\" )";
      case "Give" :
          var goal = request._0;
      ...
      case "ElaborateAndGive" :
          ...
          return commonPart("NonInteractive") + "( Cmd_elaborate_give " + normalization$5 + " " + index$1 + " noRange \"" + content$3 + "\" )";
      case "Auto" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.7.0")) {
            return commonPart("NonInteractive") + "( Cmd_autoOne " + normalization$6 + " " + index$2 + " " + range$2 + " \"" + content$4 + "\" )";
      ...
      case "HelperFunctionType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_helper_function " + normalization$7 + " " + index$3 + " noRange \"" + content$6 + "\" )";
      case "InferType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_infer " + normalization$8 + " " + index$4 + " noRange \"" + content$7 + "\" )";
      case "InferTypeGlobal" :
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_infer " + normalization$13 + " " + index$8 + " noRange \"" + content$9 + "\" )";
      case "GoalTypeContextAndCheckedType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_check " + normalization$14 + " " + index$9 + " noRange \"" + content$10 + "\" )";
      case "ModuleContents" :
          ...
          return commonPart("NonInteractive") + "( Cmd_show_module_contents " + normalization$15 + " " + index$10 + " noRange \"" + content$11 + "\" )";
      case "ModuleContentsGlobal" :
          var normalization$16 = Command$AgdaModeVscode.Normalization.encode(request._0);
          var content$12 = Parser$AgdaModeVscode.$$escape(request._1);
          return commonPart("None") + "( Cmd_show_module_contents_toplevel " + normalization$16 + " \"" + content$12 + "\" )";
      case "ComputeNormalForm" :
