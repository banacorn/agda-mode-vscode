...
function encode($$document, version, filepath, backend, libraryPath, highlightingMethod, request) {
  ...
  var buildRange2 = function (goal) {
    return Goals$AgdaModeVscode.makeHaskellRangeFromGoalInfo(goal, $$document, version, filepath);
  };
  if (typeof request !== "object") {
    ...
    switch (request.TAG) {
      ...
      case "Give2" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.3")) {
            return commonPart("NonInteractive") + "( Cmd_give WithoutForce " + goal$1.index + " " + range$1 + " \"" + goal$1.content + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_give " + goal$1.index + " " + range$1 + " \"" + goal$1.content + "\" )";
          }
      case "Refine" :
          ...
          return commonPart("NonInteractive") + "( Cmd_refine_or_intro False " + index$2 + " " + range$2 + " \"" + content$2 + "\" )";
      case "ElaborateAndGive" :
      ...
      case "Auto" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.7.0")) {
            return commonPart("NonInteractive") + "( Cmd_autoOne " + normalization$5 + " " + index$4 + " " + range$3 + " \"" + content$4 + "\" )";
          } else if (Util$AgdaModeVscode.Version.gte(version, "2.6.0.1")) {
            return commonPart("NonInteractive") + "( Cmd_autoOne " + index$4 + " " + range$3 + " \"" + content$4 + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_auto " + index$4 + " " + range$3 + " \"" + content$4 + "\" )";
          }
      case "Case" :
          var goal$4 = request._0;
          var index$5 = String(goal$4.index);
          var content$5 = Parser$AgdaModeVscode.$$escape(Goal$AgdaModeVscode.getContent(goal$4, $$document));
          var range$4 = buildRange(goal$4);
          return commonPart("NonInteractive") + "( Cmd_make_case " + index$5 + " " + range$4 + " \"" + content$5 + "\" )";
      case "HelperFunctionType" :
