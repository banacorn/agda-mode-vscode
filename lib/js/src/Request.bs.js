...
function Impl(Editor) {
  ...
  var encode = function ($$document, version, filepath, backend, libraryPath, highlightingMethod, request) {
    libraryPath.unshift(".");
    ...
    var buildRange = function (goal) {
      if (Util$AgdaModeVscode.Version.gte(version, "2.5.1")) {
        return Curry._4(Goal.buildHaskellRange, $$document, goal, false, filepath);
      } else {
        return Curry._4(Goal.buildHaskellRange, $$document, goal, true, filepath);
      }
    };
    if (typeof request === "number") {
      ...
      switch (request.tag | 0) {
        ...
        case /* Give */3 :
            ...
            var content$1 = Curry._2(Goal.getContent, goal, $$document);
        ...
        case /* Refine */4 :
            ...
            var content$2 = Curry._2(Goal.getContent, goal$1, $$document);
        ...
        case /* Auto */6 :
            ...
            var content$4 = Curry._2(Goal.getContent, goal$2, $$document);
        ...
        case /* Case */7 :
            ...
            var content$5 = Curry._2(Goal.getContent, goal$3, $$document);
