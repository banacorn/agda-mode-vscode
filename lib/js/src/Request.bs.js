  ...
  var encode = function (editor, version, filepath, libraryPath, highlightingMethod, request) {
    ...
    switch (request.tag | 0) {
      ...
      case /* ElaborateAndGive */2 :
          var index$2 = String(request[2].index);
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_elaborate_give " + (String(normalization) + (" " + (String(index$2) + (" noRange \"" + (String(content$2) + "\" )"))))));
      case /* Auto */3 :
          var goal$2 = request[0];
          var index$3 = String(goal$2.index);
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.6.0.1")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_autoOne " + (String(index$3) + (" " + (String(range$2) + (" \"" + (String(content$3) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_auto " + (String(index$3) + (" " + (String(range$2) + (" \"" + (String(content$3) + "\" )"))))));
          }
      case /* Case */4 :
          var goal$3 = request[0];
          var index$4 = String(goal$3.index);
          var content$4 = Curry._2(Goal.getContent, goal$3, editor);
          var range$3 = buildRange(goal$3);
          return commonPart(/* NonInteractive */1) + ("( Cmd_make_case " + (String(index$4) + (" " + (String(range$3) + (" \"" + (String(content$4) + "\" )"))))));
      case /* HelperFunctionType */5 :
          var index$5 = String(request[2].index);
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_helper_function " + (String(normalization$1) + (" " + (String(index$5) + (" noRange \"" + (String(content$5) + "\" )"))))));
      case /* InferType */6 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_infer " + (String(normalization$2) + (" " + (String(index$6) + (" noRange \"" + (String(content$6) + "\" )"))))));
      case /* InferTypeGlobal */7 :
          ...
          return commonPart(/* None */0) + ("( Cmd_infer_toplevel " + (String(normalization$3) + (" \"" + (String(content$7) + "\" )"))));
      case /* Context */8 :
          var index$7 = String(request[1].index);
          var normalization$4 = Command$AgdaModeVscode.Normalization.encode(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_context " + (String(normalization$4) + (" " + (String(index$7) + " noRange \"\" )"))));
      case /* GoalType */9 :
          var index$8 = String(request[1].index);
          var normalization$5 = Command$AgdaModeVscode.Normalization.encode(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type " + (String(normalization$5) + (" " + (String(index$8) + " noRange \"\" )"))));
      case /* GoalTypeAndContext */10 :
          var index$9 = String(request[1].index);
          var normalization$6 = Command$AgdaModeVscode.Normalization.encode(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context " + (String(normalization$6) + (" " + (String(index$9) + " noRange \"\" )"))));
      case /* GoalTypeContextAndInferredType */11 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_infer " + (String(normalization$7) + (" " + (String(index$10) + (" noRange \"" + (String(content$8) + "\" )"))))));
      case /* GoalTypeContextAndCheckedType */12 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_check " + (String(normalization$8) + (" " + (String(index$11) + (" noRange \"" + (String(content$9) + "\" )"))))));
      case /* ModuleContents */13 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_show_module_contents " + (String(normalization$9) + (" " + (String(index$12) + (" noRange \"" + (String(content$10) + "\" )"))))));
      case /* ModuleContentsGlobal */14 :
          ...
          return commonPart(/* None */0) + ("( Cmd_show_module_contents_toplevel " + (String(normalization$10) + (" \"" + (String(content$11) + "\" )"))));
      case /* ComputeNormalForm */15 :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(computeMode$1) + (" " + (String(index$13) + (" noRange \"" + (String(content$12) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(ignoreAbstract) + (" " + (String(index$13) + (" noRange \"" + (String(content$12) + "\" )"))))));
          }
      case /* ComputeNormalFormGlobal */16 :
      ...
      case /* WhyInScope */17 :
          var index$14 = String(request[1].index);
          var content$14 = Parser$AgdaModeVscode.userInput(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_why_in_scope " + (String(index$14) + (" noRange \"" + (String(content$14) + "\" )"))));
      case /* WhyInScopeGlobal */18 :
