...
function encode($$document, version, filepath, backend, libraryPath, highlightingMethod, request) {
  ...
  var buildRange2 = function (goal) {
    return Goals$AgdaModeVscode.makeHaskellRange(goal, $$document, version, filepath);
  };
  if (typeof request !== "object") {
    ...
    switch (request.TAG) {
      ...
      case "Give2" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.3")) {
            return commonPart("NonInteractive") + "( Cmd_give WithoutForce " + goal$1.indexString + " " + range$1 + " \"" + goal$1.readContent() + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_give " + goal$1.indexString + " " + range$1 + " \"" + goal$1.readContent() + "\" )";
          }
      case "Refine" :
          var goal$2 = request._0;
          var index$1 = String(goal$2.index);
          var content$2 = Parser$AgdaModeVscode.$$escape(Goal$AgdaModeVscode.getContent(goal$2, $$document));
          var range$2 = buildRange(goal$2);
          return commonPart("NonInteractive") + "( Cmd_refine_or_intro False " + index$1 + " " + range$2 + " \"" + content$2 + "\" )";
      case "ElaborateAndGive" :
          ...
          return commonPart("NonInteractive") + "( Cmd_elaborate_give " + normalization$4 + " " + index$2 + " noRange \"" + content$3 + "\" )";
      case "Auto" :
          ...
          var content$4 = Parser$AgdaModeVscode.$$escape(Goal$AgdaModeVscode.getContent(goal$3, $$document));
          var range$3 = buildRange(goal$3);
          if (Util$AgdaModeVscode.Version.gte(version, "2.7.0")) {
            return commonPart("NonInteractive") + "( Cmd_autoOne " + normalization$5 + " " + index$3 + " " + range$3 + " \"" + content$4 + "\" )";
          } else if (Util$AgdaModeVscode.Version.gte(version, "2.6.0.1")) {
            return commonPart("NonInteractive") + "( Cmd_autoOne " + index$3 + " " + range$3 + " \"" + content$4 + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_auto " + index$3 + " " + range$3 + " \"" + content$4 + "\" )";
          }
      case "Case" :
          var goal$4 = request._0;
          var index$4 = String(goal$4.index);
          var content$5 = Parser$AgdaModeVscode.$$escape(Goal$AgdaModeVscode.getContent(goal$4, $$document));
          var range$4 = buildRange(goal$4);
          return commonPart("NonInteractive") + "( Cmd_make_case " + index$4 + " " + range$4 + " \"" + content$5 + "\" )";
      case "HelperFunctionType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_helper_function " + normalization$6 + " " + index$5 + " noRange \"" + content$6 + "\" )";
      case "InferType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_infer " + normalization$7 + " " + index$6 + " noRange \"" + content$7 + "\" )";
      case "InferTypeGlobal" :
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_infer " + normalization$12 + " " + index$10 + " noRange \"" + content$9 + "\" )";
      case "GoalTypeContextAndCheckedType" :
          ...
          return commonPart("NonInteractive") + "( Cmd_goal_type_context_check " + normalization$13 + " " + index$11 + " noRange \"" + content$10 + "\" )";
      case "ModuleContents" :
          ...
          return commonPart("NonInteractive") + "( Cmd_show_module_contents " + normalization$14 + " " + index$12 + " noRange \"" + content$11 + "\" )";
      case "ModuleContentsGlobal" :
      ...
      case "ComputeNormalForm" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart("NonInteractive") + "( Cmd_compute " + computeMode$1 + " " + index$13 + " noRange \"" + content$13 + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_compute " + ignoreAbstract + " " + index$13 + " noRange \"" + content$13 + "\" )";
          }
      case "ComputeNormalFormGlobal" :
      ...
      case "WhyInScope" :
          ...
          return commonPart("NonInteractive") + "( Cmd_why_in_scope " + index$14 + " noRange \"" + content$15 + "\" )";
      case "WhyInScopeGlobal" :
