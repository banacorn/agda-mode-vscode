  ...
  var encode = function (editor, version, filepath, libraryPath, highlightingMethod, request) {
    ...
    switch (request.tag | 0) {
      ...
      case /* Context */6 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_context " + (String(normalization$2) + (" " + (String(index$5) + " noRange \"\" )"))));
      case /* GoalType */7 :
          var index$6 = String(request[1].index);
          var normalization$3 = Command$AgdaModeVscode.Normalization.encode(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type " + (String(normalization$3) + (" " + (String(index$6) + " noRange \"\" )"))));
      case /* GoalTypeAndContext */8 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context " + (String(normalization$4) + (" " + (String(index$7) + " noRange \"\" )"))));
      case /* GoalTypeContextAndInferredType */9 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_infer " + (String(normalization$5) + (" " + (String(index$8) + (" noRange \"" + (String(content$6) + "\" )"))))));
      case /* GoalTypeContextAndCheckedType */10 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_goal_type_context_check " + (String(normalization$6) + (" " + (String(index$9) + (" noRange \"" + (String(content$7) + "\" )"))))));
      case /* ModuleContents */11 :
          ...
          return commonPart(/* NonInteractive */1) + ("( Cmd_show_module_contents " + (String(normalization$7) + (" " + (String(index$10) + (" noRange \"" + (String(content$8) + "\" )"))))));
      case /* ModuleContentsGlobal */12 :
          ...
          return commonPart(/* None */0) + ("( Cmd_show_module_contents_toplevel " + (String(normalization$8) + (" \"" + (String(content$9) + "\" )"))));
      case /* ComputeNormalForm */13 :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.2")) {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(computeMode$1) + (" " + (String(index$11) + (" noRange \"" + (String(content$10) + "\" )"))))));
          } else {
            return commonPart(/* NonInteractive */1) + ("( Cmd_compute " + (String(ignoreAbstract) + (" " + (String(index$11) + (" noRange \"" + (String(content$10) + "\" )"))))));
          }
      case /* ComputeNormalFormGlobal */14 :
      ...
      case /* WhyInScope */15 :
          var index$12 = String(request[1].index);
          var content$12 = Parser$AgdaModeVscode.userInput(request[0]);
          return commonPart(/* NonInteractive */1) + ("( Cmd_why_in_scope " + (String(index$12) + (" noRange \"" + (String(content$12) + "\" )"))));
      case /* WhyInScopeGlobal */16 :
