  ...
  if (typeof request !== "object") {
    ...
    switch (request.TAG) {
      ...
      case "Give2" :
          ...
          if (Util$AgdaModeVscode.Version.gte(version, "2.5.3")) {
            return commonPart("NonInteractive") + "( Cmd_give WithoutForce " + goal$1.indexString + " " + range$1 + " \"" + goal$1.content + "\" )";
          } else {
            return commonPart("NonInteractive") + "( Cmd_give " + goal$1.indexString + " " + range$1 + " \"" + goal$1.content + "\" )";
          }
      case "Refine" :
