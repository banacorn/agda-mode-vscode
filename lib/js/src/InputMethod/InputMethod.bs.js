...
function Impl(Editor) {
  ...
  var activate = function (self, editor, offsets) {
    ...
    var cursorChangelistener = function (points) {
      ...
      console.log("CURSORS: " + Util$AgdaModeVscode.Pretty.array(Belt_Array.map(offsets, (function (prim) {
                      return String(prim);
                    }))));
      console.log("instances: " + Util$AgdaModeVscode.Pretty.array(Belt_Array.map(self.instances, (function (i) {
    ...
    editorChangeHandle.contents = Caml_option.some(Curry._1(Editor.onChange, (function (changes) {
                  ...
                  while(true) {
                    ...
                    if (match) {
                      ...
                      if (withIn(instance, change.offset)) {
                        ...
                        if (next) {
                          var text = next[1];
                          console.log("UPDATE " + (text + (" (" + (String(accum + start | 0) + ("," + (String((accum + end_ | 0) + delta | 0) + ")"))))));
                          var update = (function(accum,start,end_,delta,text){
                          return function update(param) {
                            var originalRange = Curry._2(Editor.$$Range.make, Curry._2(Editor.pointAtOffset, editor, accum + start | 0), Curry._2(Editor.pointAtOffset, editor, (accum + end_ | 0) + delta | 0));
                            return Curry._3(Editor.setText, editor, originalRange, text);
                          }
                          }(accum,start,end_,delta,text));
                          updates.push(update);
                ...
                return $$Promise.get(Util$AgdaModeVscode.oneByOne(updates), (function (prim) {
                              console.log(prim);
