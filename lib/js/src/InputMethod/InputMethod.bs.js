...
function Impl(Editor) {
  ...
  var activate = function (self, editor, offsets) {
    ...
    var checkCursorPositions = function (points) {
      ...
      if (self.instances.length === 0) {
        return Curry._1(self.onAction.emit, /* Deactivate */1);
      }
      
    };
    var applyRewrites = function (rewrites) {
    ...
    var updateInstanceOffsets = function (changes) {
      ...
      self.instances = Belt_Array.keepMap(instancesWithChanges, (function (param) {
              ...
              var next = Curry._3($$Buffer.update, instance.range[0], instance.buffer, change);
              if (typeof next === "number") {
                ...
                if (next.tag) {
                  var buffer = next[0];
                  rewrites.push({
                        start: instance.range[0],
                        end_: instance.range[1],
                        rewriteWith: next[1],
                        instance: instance
                      });
                  instance.buffer = buffer;
                  Curry._1(self.onAction.emit, /* Update */Caml_chrome_debugger.simpleVariant("Update", [Curry._1($$Buffer.toSequence, buffer)]));
                  return instance;
                }
                var buffer$1 = next[0];
                instance.buffer = buffer$1;
                Curry._1(self.onAction.emit, /* Update */Caml_chrome_debugger.simpleVariant("Update", [Curry._1($$Buffer.toSequence, buffer$1)]));
                return instance;
              }
            }));
      return rewrites;
    ...
    self.handles.push(Curry._1(Editor.onChangeCursorPosition, (function (points) {
                if (self.busy) {
                  ...
                  return checkCursorPositions(points);
                }
              })));
    self.handles.push(Curry._1(Editor.onChange, (function (changes) {
                ...
                return $$Promise.get(applyRewrites(rewrites), (function (param) {
                              self.busy = false;
