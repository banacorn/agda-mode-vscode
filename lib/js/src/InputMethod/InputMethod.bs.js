  ...
  var activate = function (self, editor, offsets) {
    ...
    var cursorChangelistener = function (points) {
      ...
      self.instances = Belt_Array.keep(self.instances, (function (instance) {
              ...
              console.log("CURSORS Instance (" + (String(instance.range[0]) + (", " + (String(instance.range[1]) + ")"))));
              if (!survived) {
                destroy(instance);
              }
              return true;
                  ...
                  while(true) {
                    ...
                    if (match) {
                      ...
                      if (withIn(instance, change.offset)) {
                        var next = Curry._3(Buffer2.update, instance.range, instance.buffer, change);
                        if (typeof next !== "number") {
                          if (next.tag) {
                            ...
                            Curry._3(Editor.setText, editor, originalRange, next[1]);
