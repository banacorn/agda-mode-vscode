  ...
  var activate = function (self, editor, offsets) {
    ...
    var applyRewrite = function (rewrites) {
      var go = function (accum, param) {
        ...
        console.log("!!! " + (rewriteWith + (" (" + (String(accum + start | 0) + ("," + (String(accum + end_ | 0) + (") => (" + (String(accum + start | 0) + ("," + (String((accum + end_ | 0) + delta | 0) + (") " + String(accum))))))))))));
        match.instance.range = /* tuple */[
          accum + start | 0,
          (accum + end_ | 0) + delta | 0
        ];
        var accum$1 = accum + delta | 0;
        return $$Promise.flatMap(Curry._3(Editor.setText, editor, range, rewriteWith), (function (param) {
