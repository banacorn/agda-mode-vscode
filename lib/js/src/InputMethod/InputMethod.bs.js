  ...
  var activate = function (self, editor, offsets) {
    ...
    var updateInstanceOffsets = function (changes) {
      ...
      self.instances = Belt_Array.keepMap(instancesWithChanges, (function (param) {
              ...
              var next = Curry._3($$Buffer.reflectEditorChange, instance.buffer, instance.range[0], change);
              Belt_Option.forEach(next.shouldRewrite, (function (text) {
                      rewrites.push({
                            range: instance.range,
                            text: text,
                            instance: next.translation.further ? instance : undefined
                          });
              ...
              if (next.translation.further) {
                ...
                Curry._1(self.onAction.emit, /* Update */Caml_chrome_debugger.variant("Update", 0, [
                        Curry._1($$Buffer.toSequence, next.buffer),
                        next.translation
                      ]));
                return instance;
              } else {
