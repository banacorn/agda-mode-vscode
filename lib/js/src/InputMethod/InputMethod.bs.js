...
function Impl(Editor) {
  ...
  var updateView = function (self) {
    return Belt_Option.forEach(Belt_Array.get(self.instances, 0), (function (instance) {
                  return Curry._1(self.onAction.emit, /* Update */Caml_chrome_debugger.variant("Update", 0, [
  ...
  var applyRewrites = function (self, editor, rewrites) {
    ...
    return $$Promise.get(go(0, Belt_List.fromArray(rewrites)), (function (param) {
                  Curry._1(self.debugEventEmitter.emit, undefined);
                  self.busy = false;
  ...
  var make$1 = function (debugEventEmitter) {
    return {
            ...
            busy: false,
            handles: [],
            debugEventEmitter: debugEventEmitter
          };
  };
  return {
          $$Buffer: $$Buffer,
