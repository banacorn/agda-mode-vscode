    ...
    var applyRewrites = function (rewrites) {
      var go = function (accum, param) {
        ...
        return $$Promise.flatMap($$Promise.flatMap(Curry._2(Editor.deleteText, editor, editorRange), (function (param) {
                          return Curry._3(Editor.insertText, editor, Curry._1(Editor.$$Range.start, editorRange), rewriteWith);
                        })), (function (param) {
              ...
              if (typeof next === "number") {
                ...
                switch (next.tag | 0) {
                  case /* Update */0 :
                      ...
                      Curry._1(self.onAction.emit, /* Update */Caml_chrome_debugger.variant("Update", 0, [
                  ...
                  case /* RewriteAndStuck */2 :
                      ...
                      instance.buffer = buffer$2;
                      Curry._1(self.onAction.emit, /* Update */Caml_chrome_debugger.variant("Update", 0, [
                              Curry._1($$Buffer.toSequence, buffer$2),
                              next[1],
                              next[2]
                            ]));
                      destroy(instance);
