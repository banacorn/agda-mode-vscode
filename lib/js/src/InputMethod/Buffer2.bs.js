...
function Impl(Editor) {
  ...
  var update = function (start, self, change) {
    ...
    console.log("REPLACE " + (String(change.offset) + (" " + (change.insertText + (" " + (String(change.replaceLength) + (" " + toSurface(self))))))));
    ...
    return /* UpdateAndReplaceText */Caml_chrome_debugger.simpleVariant("UpdateAndReplaceText", [
              newBuffer,
              newSurface
            ]);
  };
