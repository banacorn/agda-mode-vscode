...
function translate(input, state) {
  ...
  var last = Belt_Int.fromString(input.slice(-1));
  ...
  return {
          symbol: Belt_Array.get(state$1.lastTranslation.candidateSymbols, Caml.caml_int_min(index, state$1.lastTranslation.candidateSymbols.length - 1 | 0)),
          further: further,
          keySuggestions: keySuggestions,
          candidateSymbols: candidateSymbols
        };
