...
function applyRewrites(self, editor, rewrites) {
  ...
  return $$Promise.map($$Promise.flatMap(Editor$AgdaModeVscode.$$Text.batchReplace($$document, replacements), (function (param) {
                ...
                return Belt_Option.mapWithDefault(Belt_Array.get(self.instances, 0), /* Noop */0, (function (instance) {
...
function activate(self, editor, cursors) {
  self.activated = true;
  Chan$AgdaModeVscode.emit(self.chanLog, /* Activate */1);
...
function deactivate(self) {
  ...
  Chan$AgdaModeVscode.emit(self.chanLog, /* Deactivate */2);
  ...
  switch (input.TAG | 0) {
    case /* Change */0 :
        if (!(self.activated && !Belt_Option.isSome(self.semaphore.contents))) {
          return $$Promise.resolved(/* Noop */0);
        }
    ...
    case /* Select */1 :
        ...
        if (self.activated) {
          return $$Promise.map(acquire(self.semaphore), (function (param) {
                        validateCursorPositions(self, editor.document, positions);
