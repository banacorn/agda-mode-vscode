...
function Impl(Editor) {
  ...
  var applyRewrites = function (self, editor, rewrites) {
    ...
    return $$Promise.get(Util$AgdaModeVscode.oneByOne(Belt_Array.map(rewrites, (function (param, param$1) {
                          ...
                          var editorRange = Curry._2(Editor.$$Range.make, Curry._2(Editor.pointAtOffset, editor, rangeBefore[0]), Curry._2(Editor.pointAtOffset, editor, rangeBefore[1]));
                          return $$Promise.map($$Promise.flatMap(Curry._2(Editor.deleteText, editor, editorRange), (function (param) {
