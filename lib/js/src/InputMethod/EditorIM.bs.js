...
function applyRewrites(self, editor, rewrites) {
  ...
  return $$Promise.get(Editor$AgdaModeVscode.$$Text.batchReplace$prime(editor, replacements), (function (param) {
...
function changeSelection(self, editor, positions) {
  ...
  return validate(self.cursorValidator, (function (param) {
