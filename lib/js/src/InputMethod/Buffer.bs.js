...
function moveUp(self) {
  return {
          ...
          candidateIndex: Caml.caml_int_max(0, self.candidateIndex - 10 | 0)
        };
}
...
function moveRight(self) {
  return {
          ...
          tail: self.tail,
          translation: self.translation,
          candidateIndex: Caml.caml_int_min(self.translation.candidateSymbols.length - 1 | 0, self.candidateIndex + 1 | 0)
        };
}
...
function moveDown(self) {
  return {
          ...
          tail: self.tail,
          translation: self.translation,
          candidateIndex: Caml.caml_int_min(self.translation.candidateSymbols.length - 1 | 0, self.candidateIndex + 10 | 0)
        };
}
...
function moveLeft(self) {
  return {
          ...
          tail: self.tail,
          translation: self.translation,
          candidateIndex: Caml.caml_int_max(0, self.candidateIndex - 1 | 0)
        };
}
