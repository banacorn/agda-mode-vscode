...
function isUnsafePreview(symbol) {
  if (symbol.includes("\n")) {
    return true;
  } else {
...
function update(self, start, change) {
  ...
  if (translation.further) {
    if (newSequence.includes(sequence)) {
      var diff$1 = newSequence.substring(sequence.length);
      var buffer_symbol$2 = self.symbol;
      var buffer_tail$1 = self.tail + diff$1;
    ...
    var buffer_candidateIndex$4 = self.candidateIndex;
    var buffer$4 = {
      symbol: undefined,
      tail: newSequence,
      translation: translation,
      candidateIndex: buffer_candidateIndex$4
    };
    return [
            buffer$4,
            toSurface(buffer$4)
  ...
  var buffer_symbol$3 = self.symbol;
  var buffer_tail$2 = self.tail;
  var buffer_candidateIndex$5 = self.candidateIndex;
  var buffer$5 = {
    symbol: buffer_symbol$3,
    tail: buffer_tail$2,
    translation: translation,
    candidateIndex: buffer_candidateIndex$5
  };
  return [
          buffer$5,
          undefined
...
exports.isUnsafePreview = isUnsafePreview;
