...
function groupChangeWithInstances(instances, changes) {
  var changes$1 = changes.sort(function (x, y) {
        return Caml.caml_int_compare(x.offset, y.offset);
      });
...
function applyRewrites(self, editor, rewrites) {
  ...
  $$Promise.get(match[0], (function (param) {
          ...
          return Chan$AgdaModeVscode.emit(self.chanLog, [/* RewriteApplied */1]);
        }));
...
function run(self, editor, input) {
  ...
  if (typeof input === "number") {
    ...
    switch (input.TAG | 0) {
      case /* Activate */0 :
          self.activated = true;
          self.instances = Belt_Array.map(input._0.sort(function (x, y) {
                    return Caml.caml_int_compare(x[0], y[0]);
                  }), (function (param) {
                  if (editor === undefined) {
                    return {
                            interval: param,
