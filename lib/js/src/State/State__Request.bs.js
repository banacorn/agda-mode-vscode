  ...
  switch (policy) {
    ...
    case "Undecided" :
        var result = await Vscode.window.showWarningMessage("Cannot find Agda or Agda Language Server", {
            ...
            }, Config$AgdaModeVscode.Connection.Download.toString("Yes"), Config$AgdaModeVscode.Connection.Download.toString("No"));
        var newPolicy = Core__Option.mapOr(result, "Undecided", Config$AgdaModeVscode.Connection.Download.fromString);
