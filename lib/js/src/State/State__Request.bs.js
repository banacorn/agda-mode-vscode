...
async function askUserAboutDownloadPolicy() {
  ...
  var newPolicy = Core__Option.mapOr(result, "Undecided", Config$AgdaModeVscode.Connection.DownloadPolicy.fromString);
  await Config$AgdaModeVscode.Connection.DownloadPolicy.set(newPolicy);
  return newPolicy;
}
