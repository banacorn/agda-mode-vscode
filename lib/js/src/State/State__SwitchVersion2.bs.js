...
async function getItemData(self, downloadInfo) {
  ...
  console.log("getAgdaPaths2: " + Config$AgdaModeVscode.Connection.getAgdaPaths2().toString());
...
function onSelection$1(state, platformDeps, manager, updateUI, view, selectedItems) {
  ...
  ((async function () {
          ...
          var path = await Connection__Endpoint$AgdaModeVscode.getPickedRaw(state.memento, Config$AgdaModeVscode.Connection.getAgdaPaths2());
          ...
          await Connection__Endpoint$AgdaModeVscode.setPickedRaw(state.memento, path$1);
