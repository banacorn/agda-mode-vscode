...
function getItemData(self, downloadInfo) {
  var pickedPath = Memento$AgdaModeVscode.Module.PickedConnection.get(self.memento);
...
async function switchAgdaVersion(state) {
  ...
  if (match.TAG === "Ok") {
    ...
    if (match$1.TAG === "Agda") {
      ...
      await State__View$AgdaModeVscode.Panel.display(state, {
            TAG: "Plain",
            _0: State__SwitchVersion$AgdaModeVscode.VersionDisplay.formatSwitchingMessage(State__SwitchVersion$AgdaModeVscode.VersionDisplay.formatAgdaVersion(match$1._0))
          }, []);
    } else {
      await State__View$AgdaModeVscode.Panel.displayStatus(state, "");
      await State__View$AgdaModeVscode.Panel.display(state, {
            TAG: "Plain",
            _0: State__SwitchVersion$AgdaModeVscode.VersionDisplay.formatSwitchingMessage(State__SwitchVersion$AgdaModeVscode.VersionDisplay.formatALSVersion(match$1._0, match$1._1))
          }, []);
    }
  }
  ...
  if (conn.TAG === "Ok") {
    ...
    if (match$3.TAG === "Agda") {
      var formattedVersion = State__SwitchVersion$AgdaModeVscode.VersionDisplay.formatAgdaVersion(match$3._0);
    ...
    var formattedVersion$1 = State__SwitchVersion$AgdaModeVscode.VersionDisplay.formatALSVersion(match$3._0, match$3._1);
...
async function run(state, platformDeps) {
  ...
  var view = make();
  var updateUI = function (downloadInfo) {
    var itemData = getItemData(manager, downloadInfo);
    var items = fromItemDataArray(itemData, state.extensionUri);
    updateItems(view, items);
  };
  ...
  onSelection(view, (function (selectedItems) {
          ...
          ((async function () {
                  ...
                  if (original.TAG === "Ok") {
                    var selectionChanged = selectedPath !== Connection__URI$AgdaModeVscode.toString(Connection__Endpoint$AgdaModeVscode.toURI(original._0));
                    if (selectionChanged) {
