  ...
  if (typeof command !== "object") {
    switch (command) {
      ...
      case "Case" :
          ...
          if (goal$1 !== undefined) {
            Goals$AgdaModeVscode.markAsCaseSplited(state.goals2, goal$1);
            if (Goal2$AgdaModeVscode.getContent(goal$1, state.document) === "") {
              return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                          ...
                          value: undefined
                            ...
                            if (expr === "") {
                              ...
                              await Goals$AgdaModeVscode.modify(state.goals2, state.document, goal$1.index, (function (param) {
                                      return expr;
                                    }));
                              return await sendAgdaRequest({
                                          TAG: "Case",
    ...
    switch (command.TAG) {
      ...
      case "ElaborateAndGive" :
          ...
          var expr$1 = match$3[1];
          var goal$4 = match$3[0];
          if (expr$1 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "HelperFunctionType" :
          ...
          var expr$2 = match$4[1];
          var goal$6 = match$4[0];
          if (expr$2 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "InferType" :
          ...
          var expr$3 = match$5[1];
          var goal$7 = match$5[0];
          if (expr$3 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$1,
      ...
      case "EventFromView" :
          ...
          if (typeof $$event !== "object") {
            ...
            var match$9 = Connection__Error$AgdaModeVscode.toString(error._0);
            var header$1 = {
              TAG: "Error",
              _0: "Cannot destruct the view: " + match$9[0],
              [Symbol.for("name")]: "Error"
            };
            var body = [Item$AgdaModeVscode.plainText(match$9[1])];
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG === "SrcLoc") {
                    var match$10 = link._0;
                    if (typeof match$10 !== "object") {
                      return ;
                    }
                    var fileName = match$10._0;
                    ...
                    var ranges = match$10._1.map(Common$AgdaModeVscode.AgdaInterval.toVSCodeRange);
                  ...
                  var index = link._0;
                  var goal$8 = state.goals.find(function (goal) {
                        return goal.index === index;
                      });
                  if (goal$8 !== undefined) {
                    return Goal$AgdaModeVscode.setCursor(goal$8, state.editor);
                  } else {
                    return ;
                  }
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          var expr$4 = match$11[1];
          var goal$9 = match$11[0];
          if (expr$4 === "") {
            return await sendAgdaRequest({
                        TAG: "GoalTypeAndContext",
                        _0: normalization$5,
      ...
      case "GoalTypeContextAndCheckedType" :
          ...
          var expr$5 = match$12[1];
          var goal$10 = match$12[0];
          if (expr$5 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "ModuleContents" :
          ...
          var expr$6 = match$13[1];
          var goal$11 = match$13[0];
          if (expr$6 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$2,
      ...
      case "ComputeNormalForm" :
          ...
          var expr$7 = match$14[1];
          var goal$12 = match$14[0];
          if (expr$7 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$3,
