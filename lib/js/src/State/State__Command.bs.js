            ...
            return State$AgdaModeVscode.View.prompt(state, header, {
                        ...
                        value: oldAgdaVersion
                          ...
                          return $$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(Config$AgdaModeVscode.setAgdaPath(""), (function (param) {
                                                    ...
                                                    return State$AgdaModeVscode.Connection.disconnect(state);
                                                  })), (function (param) {
                                            ...
                                            return State$AgdaModeVscode.Connection.connect(state);
                                          })), (function (result) {
                                        if (result.TAG === /* Ok */0) {
                                          return State$AgdaModeVscode.View.display(state, {
                                                      TAG: 1,
                                                      ...
                                                      TAG: 0,
                                                      _0: "Found '" + newAgdaVersion + "' at: " + Config$AgdaModeVscode.getAgdaPath(undefined),
                                                      [Symbol.for("name")]: "Plain"
                                                    });
                                        }
