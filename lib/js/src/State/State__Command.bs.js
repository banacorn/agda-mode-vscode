    ...
    if (typeof command === "number") {
      switch (command) {
        ...
        case /* Refresh */3 :
            ...
            return State__View$AgdaModeVscode.DebugBuffer.restore(state);
        case /* Compile */4 :
                        ...
                        value: oldAgdaVersion
                          ...
                          return $$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(Config$AgdaModeVscode.Connection.setAgdaPath(""), (function (param) {
                                        ...
                                        if (result.TAG === /* Ok */0) {
                                          ...
                                          return $$Promise.flatMap(State__View$AgdaModeVscode.Panel.displayStatus(state, "Emacs v" + version), (function (param) {
                                                        return State__View$AgdaModeVscode.Panel.display(state, {
                                                                    TAG: 1,
