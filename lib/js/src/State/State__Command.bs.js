  ...
  if (typeof command !== "object") {
    switch (command) {
      ...
      case "Case" :
          ...
          if (goal$1 !== undefined) {
            ...
            if (Goal2$AgdaModeVscode.read(goal$1, state.document) === "") {
              return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
    ...
    switch (command.TAG) {
      ...
      case "HelperFunctionType" :
          ...
          var expr$2 = match$5[1];
          var goal$5 = match$5[0];
          if (expr$2 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "InferType" :
          ...
          var expr$3 = match$6[1];
          var goal$6 = match$6[0];
          if (expr$3 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$1,
      ...
      case "EventFromView" :
          ...
          if (typeof $$event !== "object") {
            ...
            var match$10 = Connection__Error$AgdaModeVscode.toString(error._0);
            var header$1 = {
              TAG: "Error",
              _0: "Cannot destruct the view: " + match$10[0],
              [Symbol.for("name")]: "Error"
            };
            var body = [Item$AgdaModeVscode.plainText(match$10[1])];
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG === "SrcLoc") {
                    var match$11 = link._0;
                    if (typeof match$11 !== "object") {
                      return ;
                    }
                    var fileName = match$11._0;
                    ...
                    var ranges = match$11._1.map(Common$AgdaModeVscode.AgdaInterval.toVSCodeRange);
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          var expr$4 = match$12[1];
          var goal$8 = match$12[0];
          if (expr$4 === "") {
            return await sendAgdaRequest({
                        TAG: "GoalTypeAndContext",
                        _0: normalization$5,
      ...
      case "GoalTypeContextAndCheckedType" :
          ...
          var expr$5 = match$13[1];
          var goal$9 = match$13[0];
          if (expr$5 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "ModuleContents" :
          ...
          var expr$6 = match$14[1];
          var goal$10 = match$14[0];
          if (expr$6 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$2,
      ...
      case "ComputeNormalForm" :
          ...
          var expr$7 = match$15[1];
          var goal$11 = match$15[0];
          if (expr$7 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$3,
