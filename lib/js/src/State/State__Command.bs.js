...
function dispatchCommand(state, _command) {
  while(true) {
    ...
    if (typeof command === "number") {
      switch (command) {
        case /* Load */0 :
            return $$Promise.flatMap($$Promise.flatMap(State__View$AgdaModeVscode.display(state, {
                                TAG: 0,
                                _0: "Loading ...",
                                [Symbol.for("name")]: "Plain"
                              }, []), (function (param) {
        ...
        case /* Refresh */3 :
            ...
            State__View$AgdaModeVscode.activate(state);
        ...
        case /* Give */10 :
            ...
            if (match === undefined) {
              return State__View$AgdaModeVscode.displayOutOfGoalError(state);
            }
            var goal = match[0];
            if (match[1] === "") {
              return State__View$AgdaModeVscode.prompt(state, header, {
                          body: undefined,
            ...
            return State__View$AgdaModeVscode.prompt(state, header, {
                        ...
                        value: oldAgdaVersion
                          ...
                          return $$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(Config$AgdaModeVscode.Connection.setAgdaPath(""), (function (param) {
                                                    ...
                                                    return State__View$AgdaModeVscode.display(state, {
                                                                TAG: 0,
                                                                _0: "Switching to '" + newAgdaVersion + "'",
                                                                [Symbol.for("name")]: "Plain"
                                                              }, []);
                                                  })), Connection$AgdaModeVscode.stop), (function (param) {
                                            return Connection$AgdaModeVscode.start(state.globalStoragePath, false);
                                          })), (function (result) {
                                        if (result.TAG === /* Ok */0) {
                                          var match = result._0;
                                        ...
                                        return $$Promise.flatMap(Config$AgdaModeVscode.Connection.setAgdaPath(oldAgdaPath), (function (param) {
                                                      return State__View$AgdaModeVscode.display(state, header, body);
                                                    }));
                                      }));
                        }));
        case /* Escape */16 :
            if (IM$AgdaModeVscode.isActivated(state.editorIM) || IM$AgdaModeVscode.isActivated(state.promptIM)) {
              ...
              return State__View$AgdaModeVscode.interruptPrompt(state);
            }
        case /* LookupSymbol */17 :
            ...
            if (selectedText === "") {
              State__View$AgdaModeVscode.prompt(state, {
                    TAG: 0,
            ...
            return $$Promise.flatMap(match$5[0], (function(selectedText){
                      return function (input) {
        ...
        case /* GoalTypeContextAndCheckedType */10 :
            ...
            if (expr$5 === "") {
              return State__View$AgdaModeVscode.prompt(state, header, {
                          ...
                          value: undefined
                        }, (function(normalization$6,goal$7){
                        return function (expr) {
                          return sendAgdaRequest({
                                      TAG: 15,
                                      _0: normalization$6,
        ...
        case /* ModuleContents */11 :
            ...
            if (expr$6 === "") {
              return State__View$AgdaModeVscode.prompt(state, header, {
                          ...
                          placeholder: placeholder$2,
                          value: undefined
                        }, (function(normalization$7,goal$8){
                        return function (expr) {
                          return sendAgdaRequest({
                                      TAG: 16,
                                      _0: normalization$7,
