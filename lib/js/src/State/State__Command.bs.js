        ...
        case /* SwitchAgdaVersion */15 :
            ...
            return State$AgdaModeVscode.View.prompt(state, header, {
                        ...
                        value: oldAgdaVersion
                          ...
                          Config$AgdaModeVscode.getAgdaPath(undefined);
                          var newAgdaVersion = expr.trim();
                          return $$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(Config$AgdaModeVscode.setAgdaPath(""), (function (param) {
