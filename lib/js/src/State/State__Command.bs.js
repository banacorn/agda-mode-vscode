    ...
    switch (command.TAG) {
      ...
      case "EventFromView" :
          ...
          if (typeof $$event !== "object") {
            ...
            var match$4 = Connection__Error$AgdaModeVscode.toString(error._0);
            var header$1 = {
              TAG: "Error",
              _0: "Cannot destruct the view: " + match$4[0],
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG === "SrcLoc") {
                    ...
                    var ranges = match$5._1.map(Common$AgdaModeVscode.AgdaInterval.toVSCodeRange);
                  ...
                  var index = link._0;
                  var goal$10 = state.goals.find(function (goal) {
                        return goal.index === index;
                      });
                  if (goal$10 !== undefined) {
                    return Goal$AgdaModeVscode.setCursor(goal$10, state.editor);
                  } else {
                    return ;
                  }
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          var expr$4 = match$6[1];
          var goal$11 = match$6[0];
          if (expr$4 === "") {
            return await sendAgdaRequest({
                        TAG: "GoalTypeAndContext",
                        _0: normalization$5,
      ...
      case "GoalTypeContextAndCheckedType" :
          ...
          var expr$5 = match$7[1];
          var goal$12 = match$7[0];
          if (expr$5 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "ModuleContents" :
          ...
          var expr$6 = match$8[1];
          var goal$13 = match$8[0];
          if (expr$6 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$2,
      ...
      case "ComputeNormalForm" :
          ...
          var expr$7 = match$9[1];
          var goal$14 = match$9[0];
          if (expr$7 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$3,
