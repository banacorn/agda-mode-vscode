              ...
              return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                          ...
                          value: undefined
                            ...
                            if (expr === "") {
                              ...
                              await Goals$AgdaModeVscode.modify(state.goals, state.editor, goal.index, (function (param) {
                                      return expr;
                                    }));
                              return await sendAgdaRequest({
                                          TAG: "Give",
              ...
              return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                          ...
                          value: undefined
                            ...
                            if (expr === "") {
                              ...
                              await Goals$AgdaModeVscode.modify(state.goals, state.editor, goal$2.index, (function (param) {
                                      return expr;
                                    }));
                              return await sendAgdaRequest({
                                          TAG: "Case",
            ...
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        ...
                        value: undefined
                          ...
                          if (expr === "") {
                            ...
                            await Goals$AgdaModeVscode.modify(state.goals, state.editor, goal$5.index, (function (param) {
                                    return expr;
                                  }));
                            return await sendAgdaRequest({
                                        TAG: "ElaborateAndGive",
