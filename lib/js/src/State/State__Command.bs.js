  ...
  if (typeof command !== "object") {
    ...
    switch (command.TAG) {
      ...
      case "HelperFunctionType" :
          ...
          var expr$2 = match$2[1];
          var goal$7 = match$2[0];
          if (expr$2 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "InferType" :
          ...
          var expr$3 = match$3[1];
          var goal$8 = match$3[0];
          if (expr$3 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$1,
      ...
      case "EventFromView" :
          ...
          if (typeof $$event !== "object") {
            ...
            var match$7 = Connection__Error$AgdaModeVscode.toString(error._0);
            var header$1 = {
              TAG: "Error",
              _0: "Cannot destruct the view: " + match$7[0],
              [Symbol.for("name")]: "Error"
            };
            var body = [Item$AgdaModeVscode.plainText(match$7[1])];
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG === "SrcLoc") {
                    ...
                    var ranges = match$8._1.map(Common$AgdaModeVscode.AgdaInterval.toVSCodeRange);
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          var expr$4 = match$9[1];
          var goal$10 = match$9[0];
          if (expr$4 === "") {
            return await sendAgdaRequest({
                        TAG: "GoalTypeAndContext",
                        _0: normalization$5,
      ...
      case "GoalTypeContextAndCheckedType" :
          ...
          var expr$5 = match$10[1];
          var goal$11 = match$10[0];
          if (expr$5 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "ModuleContents" :
          ...
          var expr$6 = match$11[1];
          var goal$12 = match$11[0];
          if (expr$6 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$2,
      ...
      case "ComputeNormalForm" :
          ...
          var expr$7 = match$12[1];
          var goal$13 = match$12[0];
          if (expr$7 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$3,
