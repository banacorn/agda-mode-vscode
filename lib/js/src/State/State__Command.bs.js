...
async function dispatchCommand(state, command) {
  ...
  if (typeof command !== "object") {
    switch (command) {
      ...
      case "NextGoal" :
          Goals$AgdaModeVscode.jmupToTheNextGoal(state.goals2, state.editor);
          return Chan$AgdaModeVscode.emit(state.channels.commandHandled, "NextGoal");
      case "PreviousGoal" :
          Goals$AgdaModeVscode.jmupToThePreviousGoal(state.goals2, state.editor);
      ...
      case "Give" :
          ...
          if (goal !== undefined) {
            if (Goal2$AgdaModeVscode.getContent(goal, state.document) === "") {
      ...
      case "Refine" :
          var goal$1 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$1 !== undefined) {
            return await sendAgdaRequest({
                        TAG: "Refine",
                        _0: goal$1,
      ...
      case "Case" :
          var goal$2 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$2 !== undefined) {
            Goals$AgdaModeVscode.markAsCaseSplited(state.goals2, goal$2);
            if (Goal2$AgdaModeVscode.getContent(goal$2, state.document) === "") {
              return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                          ...
                          value: undefined
                            ...
                            if (expr === "") {
                              ...
                              await Goals$AgdaModeVscode.modify(state.goals2, state.document, goal$2.index, (function (param) {
                                      return expr;
                                    }));
                              return await sendAgdaRequest({
                                          TAG: "Case",
    ...
    switch (command.TAG) {
      case "SolveConstraints" :
          ...
          var goal$4 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$4 !== undefined) {
            return await sendAgdaRequest({
      ...
      case "ElaborateAndGive" :
          ...
          var goal$5 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$5 === undefined) {
            return await State__View$AgdaModeVscode.Panel.displayOutOfGoalError(state);
          }
          var expr$1 = Goal2$AgdaModeVscode.getContent(goal$5, state.document);
          if (expr$1 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        ...
                        value: undefined
                          ...
                          if (expr === "") {
                            ...
                            await Goals$AgdaModeVscode.modify(state.goals2, state.document, goal$5.index, (function (param) {
                                    return expr;
                                  }));
                            return await sendAgdaRequest({
                                        TAG: "ElaborateAndGive",
      ...
      case "Auto" :
          var goal$6 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$6 !== undefined) {
            return await sendAgdaRequest({
                        TAG: "Auto",
                        _0: command._0,
      ...
      case "HelperFunctionType" :
          ...
          var goal$7 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$7 === undefined) {
            return await State__View$AgdaModeVscode.Panel.displayOutOfGoalError(state);
          }
          var expr$2 = Goal2$AgdaModeVscode.getContent(goal$7, state.document);
          if (expr$2 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "InferType" :
          ...
          var goal$8 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$8 === undefined) {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
          ...
          var expr$3 = Goal2$AgdaModeVscode.getContent(goal$8, state.document);
          if (expr$3 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$1,
      ...
      case "Context" :
          var goal$9 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$9 !== undefined) {
            return await sendAgdaRequest({
                        TAG: "Context",
                        _0: command._0,
      ...
      case "GoalType" :
          var goal$10 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
      ...
      case "GoalTypeAndContext" :
          var goal$11 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
      ...
      case "EventFromView" :
          ...
          if (typeof $$event !== "object") {
            ...
            var header$1 = {
              TAG: "Error",
              _0: "Cannot destruct the view: " + match$2[0],
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG === "SrcLoc") {
                    ...
                    var ranges = match$3._1.map(Common$AgdaModeVscode.AgdaInterval.toVSCodeRange);
                  ...
                  var index = link._0;
                  var goal$12 = state.goals.find(function (goal) {
                        return goal.index === index;
                      });
                  if (goal$12 !== undefined) {
                    return Goal$AgdaModeVscode.setCursor(goal$12, state.editor);
                  } else {
                    return ;
                  }
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          var goal$13 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$13 === undefined) {
            return await State__View$AgdaModeVscode.Panel.displayOutOfGoalError(state);
          }
          var expr$4 = Goal2$AgdaModeVscode.getContent(goal$13, state.document);
          if (expr$4 === "") {
            return await sendAgdaRequest({
                        TAG: "GoalTypeAndContext",
                        _0: normalization$5,
      ...
      case "GoalTypeContextAndCheckedType" :
          ...
          var goal$14 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$14 === undefined) {
            return await State__View$AgdaModeVscode.Panel.displayOutOfGoalError(state);
          }
          var expr$5 = Goal2$AgdaModeVscode.getContent(goal$14, state.document);
          if (expr$5 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "ModuleContents" :
          ...
          var goal$15 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          ...
          var expr$6 = Goal2$AgdaModeVscode.getContent(goal$15, state.document);
          if (expr$6 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$2,
      ...
      case "ComputeNormalForm" :
          ...
          var goal$16 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$16 === undefined) {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
          ...
          var expr$7 = Goal2$AgdaModeVscode.getContent(goal$16, state.document);
          if (expr$7 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$3,
