  ...
  if (typeof command !== "object") {
    ...
    switch (command.TAG) {
          ...
          if (typeof $$event !== "object") {
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG !== "SrcLoc") {
                    return Goals$AgdaModeVscode.setCursorByIndex(state.goals2, state.editor, link._0);
                  }
                  var match$2 = link._0;
      ...
      case "GoalTypeContextAndInferredType" :
          ...
          var goal$12 = Goals$AgdaModeVscode.getGoalAtCursor(state.goals2, state.editor);
          if (goal$12 === undefined) {
            return await State__View$AgdaModeVscode.Panel.displayOutOfGoalError(state);
          }
          var expr$4 = Goal2$AgdaModeVscode.getContent(goal$12, state.document);
          if (expr$4 === "") {
            return await sendAgdaRequest({
                        TAG: "GoalTypeAndContext",
                        _0: normalization$5,
      ...
      case "GoalTypeContextAndCheckedType" :
          ...
          var expr$5 = Goal2$AgdaModeVscode.getContent(goal$13, state.document);
          if (expr$5 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
      ...
      case "ModuleContents" :
          ...
          var expr$6 = Goal2$AgdaModeVscode.getContent(goal$14, state.document);
          if (expr$6 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$2,
      ...
      case "ComputeNormalForm" :
          ...
          var expr$7 = Goal2$AgdaModeVscode.getContent(goal$15, state.document);
          if (expr$7 === "") {
            return await State__View$AgdaModeVscode.Panel.prompt(state, header, {
                        body: undefined,
                        placeholder: placeholder$3,
