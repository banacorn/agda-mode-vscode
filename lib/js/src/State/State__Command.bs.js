        ...
        case /* SwitchAgdaVersion */15 :
            ...
            return State$AgdaModeVscode.View.prompt(state, header, {
                        ...
                        value: oldAgdaVersion
                          ...
                          return $$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(Config$AgdaModeVscode.setAgdaPath(""), (function (param) {
                                            ...
                                            return State$AgdaModeVscode.Connection.reconnect(state);
                                          })), (function (result) {
                                        if (result.TAG === /* Ok */0) {
                                          return State$AgdaModeVscode.View.display(state, {
                                                      TAG: 1,
                                                      _0: "Switched to '" + newAgdaVersion + "'",
                                                      [Symbol.for("name")]: "Success"
                                                    }, [Component$AgdaModeVscode.Item.plainText("Found '" + newAgdaVersion + "' at: " + Config$AgdaModeVscode.getAgdaPath(undefined))]);
                                        }
                                        var match = Connection$AgdaModeVscode.$$Error.toString(result._0);
                                        var header = {
                                          TAG: 3,
                                          _0: "Cannot switch Agda version '" + newAgdaVersion + "' : " + match[0],
                                          [Symbol.for("name")]: "Error"
                                        };
                                        var body = [Component$AgdaModeVscode.Item.plainText(match[1] + "\n\nSwitching back to " + oldAgdaPath)];
