...
function dispatchCommand(state, _command) {
  while(true) {
    ...
    if (typeof command === "number") {
      switch (command) {
        case /* Load */0 :
            return $$Promise.flatMap($$Promise.flatMap(State__View$AgdaModeVscode.Panel.display(state, {
                                TAG: 0,
                                _0: "Loading ...",
                                [Symbol.for("name")]: "Plain"
                              }, []), (function (param) {
        ...
        case /* Give */10 :
            ...
            if (match === undefined) {
              return State__View$AgdaModeVscode.Panel.displayOutOfGoalError(state);
            }
            var goal = match[0];
            if (match[1] === "") {
              return State__View$AgdaModeVscode.Panel.prompt(state, header, {
                          body: undefined,
        ...
        case /* Escape */16 :
            if (IM$AgdaModeVscode.isActivated(state.editorIM) || IM$AgdaModeVscode.isActivated(state.promptIM)) {
              ...
              return State__View$AgdaModeVscode.Panel.interruptPrompt(state);
            }
        ...
        case /* OpenDebugBuffer */18 :
            State__View$AgdaModeVscode.DebugBuffer.start(state);
            return State__View$AgdaModeVscode.DebugBuffer.reveal(state);
