...
async function dispatchCommand(state, command) {
  ...
  var sendAgdaRequest = async function (request) {
    await State$AgdaModeVscode.sendRequest(state, (function (extra) {
            ...
            switch ($$event.TAG) {
              ...
              case "JumpToTarget" :
                  ...
                  if (link.TAG === "SrcLoc") {
                    ...
                    var ranges = Belt_Array.map(match$14._1, Common$AgdaModeVscode.AgdaInterval.toVSCodeRange);
                    Editor$AgdaModeVscode.$$Selection.setMany(state.editor, ranges);
                    return Belt_Option.forEach(Belt_Array.get(ranges, 0), (function (range) {
      ...
      case "InputMethod" :
          ...
          switch ($$char$1) {
            case "Activate" :
                ...
                return Belt_Array.forEach(Editor$AgdaModeVscode.Cursor.getMany(state.editor), (function (point) {
