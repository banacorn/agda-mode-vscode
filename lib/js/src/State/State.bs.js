...
function make$1(id, platformDeps, channels, globalStorageUri, extensionUri, memento, editor, semanticTokens) {
  return {
          id: id,
...
async function destroy(state, alsoRemoveFromRegistry) {
  ...
  await Registry__Connection$AgdaModeVscode.release(state.id);
  Chan$AgdaModeVscode.emit(state.channels.log, {
        TAG: "Others",
        _0: "State.destroy: Connection released, destruction complete"
      });
  return {
          TAG: "Ok",
          _0: undefined
