...
function restore$1(state) {
  var partial_arg = state.debugBufferCache;
  return Belt_Option.forEach(state.debugBuffer, (function (param) {
                return State__Type$AgdaModeVscode.ViewCache.restore(partial_arg, param);
              }));
}

function reveal(state) {
  return Belt_Option.forEach(state.debugBuffer, WebviewPanel$AgdaModeVscode.reveal);
}
