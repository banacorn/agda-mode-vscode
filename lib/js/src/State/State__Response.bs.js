    ...
    if (typeof response !== "object") {
      switch (response) {
        ...
        case "CompleteHighlightingAndMakePromptReappear" :
            ...
            await Highlighting$AgdaModeVscode.apply(state.highlighting, state.tokens, state.editor);
            return {
                    TAG: "Ok",
                    _0: undefined,
                    [Symbol.for("name")]: "Ok"
      ...
      switch (response.TAG) {
        ...
        case "InteractionPoints" :
            await State__Goal$AgdaModeVscode.instantiate(state, response._0);
            return {
                    TAG: "Ok",
                    _0: undefined,
                    [Symbol.for("name")]: "Ok"
            ...
            if (goal !== undefined) {
              if (typeof give !== "object") {
                if (give === "GiveParen") {
                  ...
                  await State__Goal$AgdaModeVscode.removeBoundaryAndDestroy(state, goal);
                  return {
                          TAG: "Ok",
                          _0: undefined,
                          [Symbol.for("name")]: "Ok"
        ...
        case "SolveAll" :
            ...
            await Util$AgdaModeVscode.oneByOne(Belt_Array.map(solutions, solveOne));
        ...
        case "DisplayInfo" :
            await handle(state, response._0);
            return {
                    TAG: "Ok",
                    _0: undefined,
                    [Symbol.for("name")]: "Ok"
        ...
        case "RunningInfo" :
            ...
            if (verbosity !== 1) {
              ...
              await State__View$AgdaModeVscode.DebugBuffer.displayInAppendMode([[
                      verbosity,
                      message
                    ]]);
              return {
            ...
            await State__View$AgdaModeVscode.Panel.displayInAppendMode(state, {
                  TAG: "Plain",
                  _0: "Type-checking",
                  [Symbol.for("name")]: "Plain"
