  ...
  if (typeof response === "number") {
    switch (response) {
      ...
      case /* CompleteHighlightingAndMakePromptReappear */4 :
          return Decoration$AgdaModeVscode.applyAndClear(state.decoration, state.editor);
      default:
        return $$Promise.resolved(undefined);
    }
  } else {
    switch (response.TAG | 0) {
      case /* HighlightingInfoDirect */0 :
          Decoration$AgdaModeVscode.addViaPipe(state.decoration, state.editor, response._1);
          return $$Promise.resolved(undefined);
      ...
      case /* RunningInfo */10 :
          ...
          return $$Promise.flatMap(State__View$AgdaModeVscode.Panel.displayInAppendMode(state, {
                          TAG: 0,
                          _0: "Type-checking",
                          [Symbol.for("name")]: "Plain"
