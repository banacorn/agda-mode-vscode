    ...
    if (typeof response !== "object") {
      ...
      switch (response.TAG) {
        ...
        case "InteractionPoints" :
            ...
            return await Goals$AgdaModeVscode.resetGoalIndices(state.goals, state.editor, response._0);
        case "GiveAction" :
            ...
            if (typeof give !== "object") {
              if (give === "GiveParen") {
                await Goals$AgdaModeVscode.modify(state.goals, state.editor, index, (function (content) {
                        return "(" + content + ")";
                      }));
              }
              ...
              await Goals$AgdaModeVscode.modify(state.goals, state.editor, index, (function (param) {
                      return indented;
                    }));
            ...
            if (await Goals$AgdaModeVscode.removeBoundaryAndDestroy(state.goals, state.editor, index)) {
              return ;
            } else {
              return await State__View$AgdaModeVscode.Panel.display(state, {
                          TAG: "Error",
        ...
        case "MakeCase" :
            ...
            var result;
            result = response._0 === "Function" ? await Goal$AgdaModeVscode.replaceWithLines(goal$1, state.editor, lines) : await Goal$AgdaModeVscode.replaceWithLambda(goal$1, state.editor, lines);
            if (result !== undefined) {
