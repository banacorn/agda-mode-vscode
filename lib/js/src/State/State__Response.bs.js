  ...
  switch (x.TAG | 0) {
    ...
    case /* AllGoalsWarningsLSP */4 :
        var goals = Belt_Array.concatMany(Belt_Array.map(x._1, (function (param) {
                    return [{
                              TAG: 1,
                              _0: Agda$AgdaModeVscode.OutputConstraint.toText(Agda$AgdaModeVscode.InteractionId.toText, Agda$AgdaModeVscode.InteractionId.render, param[0], undefined),
                              _1: param[1],
        ...
        var metas = Belt_Array.concatMany(Belt_Array.map(x._2, (function (param) {
                    return [{
                              TAG: 1,
                              _0: Agda$AgdaModeVscode.OutputConstraint.toText(Agda$AgdaModeVscode.NamedMeta.toText, Agda$AgdaModeVscode.NamedMeta.render, param[0], undefined),
                              _1: param[1],
                              [Symbol.for("name")]: "Unlabeled"
                            }];
                  })));
