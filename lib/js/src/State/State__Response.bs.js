      ...
      switch (response.TAG) {
        ...
        case "GiveAction" :
            ...
            if (typeof give !== "object") {
              ...
              var holeOffsetsFromRefine = State__Goal$AgdaModeVscode.parseHolesFromRefineResult(indented);
        ...
        case "SolveAll" :
            ...
            var solveOne = function (param) {
              ...
              return async function () {
                var goal = Goals$AgdaModeVscode.getGoalInfoByIndex(state.goals2, index);
                if (goal !== undefined) {
