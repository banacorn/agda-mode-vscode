      ...
      switch (response.TAG) {
        ...
        case "GiveAction" :
            ...
            if (typeof give !== "object") {
              ...
              var match = Goal2$AgdaModeVscode.indentationWidth(goal, state.document);
        ...
        case "MakeCase" :
            ...
            var result;
            result = response._0 === "Function" ? await Goal2$AgdaModeVscode.replaceWithLines(goal$1, state.document, lines) : await Goal2$AgdaModeVscode.replaceWithLambda(goal$1, state.document, lines);
            if (result !== undefined) {
              Goals$AgdaModeVscode.destroyGoalByIndex(state.goals2, goal$1.index);
              Goal2$AgdaModeVscode.placeCursorAtFirstNewGoal(state.editor, result[0], result[1]);
            } else {
