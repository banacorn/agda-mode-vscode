...
function handle$1(state, dispatchCommand, response) {
  Chan$AgdaModeVscode.emit(state.channels.response, response);
  if (typeof response === "number") {
    switch (response) {
      ...
      case /* CompleteHighlightingAndMakePromptReappear */4 :
          return $$Promise.flatMap(Tokens$AgdaModeVscode.readTempFiles(state.tokens, state.editor), (function (param) {
                        console.log("FUCK", Tokens$AgdaModeVscode.toArray(state.tokens).length);
    ...
    switch (response.TAG | 0) {
      ...
      case /* InteractionPoints */5 :
          return $$Promise.map(State__Goal$AgdaModeVscode.instantiate(state, response._0), (function (param) {
                        return {
                                TAG: 0,
                                _0: undefined,
                                [Symbol.for("name")]: "Ok"
      ...
      case /* GiveAction */6 :
          ...
          if (typeof give === "number") {
            if (give !== 0) {
              return $$Promise.map(State__Goal$AgdaModeVscode.removeBoundaryAndDestroy(state, goal), (function (param) {
                            return {
                                    TAG: 0,
                                    _0: undefined,
                                    [Symbol.for("name")]: "Ok"
              ...
              return $$Promise.map($$Promise.flatMap(State__Goal$AgdaModeVscode.modify(state, goal, (function (content) {
                                    return "(" + (content + ")");
                                  })), (function (param) {
          ...
          var content = give._0;
          return $$Promise.map($$Promise.flatMap(State__Goal$AgdaModeVscode.modify(state, goal, (function (param) {
      ...
      case /* SolveAll */8 :
          ...
          return $$Promise.map($$Promise.flatMap(Util$AgdaModeVscode.oneByOne(Belt_Array.map(solutions, solveOne)), (function (param) {
      ...
      case /* DisplayInfo */9 :
          return $$Promise.map(handle(state, response._0), (function (param) {
                        return {
                                TAG: 0,
                                _0: undefined,
                                [Symbol.for("name")]: "Ok"
      ...
      case /* RunningInfo */10 :
          ...
          if (verbosity !== 1) {
            ...
            return $$Promise.map(State__View$AgdaModeVscode.DebugBuffer.displayInAppendMode([[
                              verbosity,
                              message
                            ]]), (function (param) {
                          return {
          ...
          return $$Promise.map($$Promise.flatMap(State__View$AgdaModeVscode.Panel.displayInAppendMode(state, {
                              TAG: 0,
                              _0: "Type-checking",
                              [Symbol.for("name")]: "Plain"
