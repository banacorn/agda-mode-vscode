...
function handle(x) {
  if (typeof x === "number") {
    return State$AgdaModeVscode.View.display({
                TAG: 1,
                _0: "Compilation Done!",
  ...
  switch (x.TAG | 0) {
    case /* Constraints */0 :
        var body = x._0;
        if (body !== undefined) {
          return State$AgdaModeVscode.View.displayEmacs(/* Outputs */0, {
                      TAG: 0,
                      _0: "Constraints",
    ...
    case /* AllGoalsWarnings */1 :
        ...
        if (body$1 === "nil") {
          ...
          return State$AgdaModeVscode.View.displayEmacs(/* AllGoalsWarnings */1, {
                      TAG: 0,
                      _0: header,
                      [Symbol.for("name")]: "Plain"
                    }, body$1);
    ...
    case /* Time */2 :
        return State$AgdaModeVscode.View.displayEmacs(/* Text */5, {
                    TAG: 0,
                    _0: "Time",
                    [Symbol.for("name")]: "Plain"
                  }, x._0);
    case /* Error */3 :
        return State$AgdaModeVscode.View.displayEmacs(/* Error */4, {
                    TAG: 3,
                    _0: "Error!",
    ...
    case /* SearchAbout */7 :
        return State$AgdaModeVscode.View.displayEmacs(/* SearchAbout */3, {
                    TAG: 0,
                    _0: "Search About",
                    [Symbol.for("name")]: "Plain"
                  }, x._0);
    ...
    case /* GoalType */10 :
        return State$AgdaModeVscode.View.displayEmacs(/* GoalType */2, {
                    TAG: 0,
                    _0: "Goal and Context",
                    [Symbol.for("name")]: "Plain"
                  }, x._0);
  ...
  if (typeof response === "number") {
    ...
    switch (response.TAG | 0) {
      ...
      case /* MakeCase */6 :
          ...
          if (match === undefined) {
            return State$AgdaModeVscode.View.displayOutOfGoalError(undefined);
          }
          var goal$1 = match[0];
