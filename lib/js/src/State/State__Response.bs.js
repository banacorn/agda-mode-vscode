      ...
      switch (response.TAG) {
        ...
        case "GiveAction" :
            ...
            if (typeof give !== "object") {
              ...
              var match$1 = Goal$AgdaModeVscode.indentationWidth(goal, state.document);
              var indented = indent(Parser$AgdaModeVscode.unescapeEOL(content), 2 + match$1[0] | 0);
              await Goals$AgdaModeVscode.modify(state.goals, state.document, index, (function (param) {
                      return indented;
                    }));
              var goalPositionsRelative$1 = Goals$AgdaModeVscode.parseGoalPositionsFromRefine(indented);
              var match$2 = Goals$AgdaModeVscode.getGoalPositionByIndex(state.goals, index);
              var goalPositionsAbsolute$1;
              if (match$2 !== undefined) {
                var offset$1 = match$2[0];
