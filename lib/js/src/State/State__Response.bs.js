    ...
    if (typeof response !== "object") {
      switch (response) {
        ...
        case "CompleteHighlightingAndMakePromptReappear" :
            console.log("CompleteHighlightingAndMakePromptReappear");
      ...
      switch (response.TAG) {
        ...
        case "InteractionPoints" :
            ...
            Goals$AgdaModeVscode.instantiateGoalsFromLoad(state.goals2, state.editor, indices, holePositions);
            return await State__Goal$AgdaModeVscode.instantiate(state, indices);
        case "GiveAction" :
