  ...
  switch (x.TAG | 0) {
    ...
    case /* CompilationOkLSP */1 :
        ...
        var errors = Belt_Array.map(x._1, (function (raw) {
                return Component$AgdaModeVscode.Item.error(RichText$AgdaModeVscode.string(raw), raw);
              }));
        var warnings = Belt_Array.map(x._0, (function (raw) {
                return Component$AgdaModeVscode.Item.warning(RichText$AgdaModeVscode.string(raw), raw);
              }));
        return State$AgdaModeVscode.View.display(state, {
                    TAG: 1,
                    _0: "Compilation result",
