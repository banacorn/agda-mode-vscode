...
async function openGlobalStorage(state) {
  var uri = state.globalStorageUri.with({
        authority: undefined,
        fragment: undefined,
        path: undefined,
        prompt: undefined,
...
async function switchAgdaVersionOld2(state) {
  var existingAgdaVersion = Config$AgdaModeVscode.Connection.getAgdaVersion();
...
async function handleSelection(state, selection) {
  ...
  switch (match) {
    case "Change Agda command name" :
        return await switchAgdaVersionOld2(state);
    case "Open download folder" :
        return await openGlobalStorage(state);
    default:
...
exports.openGlobalStorage = openGlobalStorage;
exports.switchAgdaVersion = switchAgdaVersion;
exports.switchAgdaVersionOld2 = switchAgdaVersionOld2;
