...
var Connection__Process__Exec$AgdaModeVscode = require("../Connection/Process/Connection__Process__Exec.bs.js");
    ...
    if (typeof url === "object") {
      switch (url.TAG) {
        ...
        case "ValidationError" :
            return {
                    description: Connection__Process__Exec$AgdaModeVscode.$$Error.toString(url._1),
                    detail: url._0,
                    label: "$(error)  Error"
                  };
        default:
