...
var Connection__Target__Agda__Process$AgdaModeVscode = require("../Connection/Target/Agda/Connection__Target__Agda__Process.bs.js");
  ...
  var targetToItem = function (target) {
    ...
    switch (path.TAG) {
      ...
      case "ValidationError" :
          return {
                  description: Connection__Target__Agda__Process$AgdaModeVscode.Validation.$$Error.toString(path._1),
                  detail: path._0,
                  label: "$(error)  Error"
                };
      default:
