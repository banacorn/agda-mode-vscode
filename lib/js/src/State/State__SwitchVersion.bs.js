...
async function switchAgdaVersion(state) {
  ...
  if (conn.TAG === "Ok") {
    ...
    var match$1 = await Connection__Target$AgdaModeVscode.getPicked(state.memento, Config$AgdaModeVscode.Connection.getAgdaPaths());
...
async function run(state) {
  ...
  var installationTargets = await Connection__Target$AgdaModeVscode.fromRawPaths(Config$AgdaModeVscode.Connection.getAgdaPaths());
