...
async function switchAgdaVersion(state) {
  ...
  await Connection$AgdaModeVscode.stop(state.connection);
  var conn = await Connection$AgdaModeVscode.start(state.memento);
  if (conn.TAG === "Ok") {
...
async function run(state) {
  ...
  var _error = await Connection$AgdaModeVscode.getALSReleaseManifest(state.memento, state.globalStorageUri);
  var latestALS;
  if (_error.TAG === "Ok") {
