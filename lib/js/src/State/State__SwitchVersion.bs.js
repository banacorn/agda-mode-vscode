...
var clearCache = "$(trash)  Clear cache";
...
function onSelection$1(state, platformDeps, manager, updateUI, view, selectedItems) {
  ...
  ((async function () {
          ...
          if (selectedItem.label === clearCache) {
            await Memento$AgdaModeVscode.Module.ALSReleaseCache.clear(state.memento);
