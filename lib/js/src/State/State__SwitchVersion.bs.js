...
async function run(state) {
  ...
  var agda = await Connection$AgdaModeVscode.findCommands(["agda"]);
  if (agda.TAG === "Ok") {
    var agda$1 = agda._0;
  ...
  var als = await Connection$AgdaModeVscode.findCommands(["als"]);
  if (als.TAG === "Ok") {
    var als$1 = als._0;
  ...
  var installedItemsFromSettings = Object.values(dict).map(targetToItem);
  var items = [
      installedSeperator,
