  ...
  switch (match) {
    case "$(cloud-download)  Download the latest Agda Language Server" :
        ...
        if (latestALS !== undefined) {
          ...
          var e = await Connection__Resolver__GitHub$AgdaModeVscode.download(latestALS, memento, globalStoragePath, onDownload);
          if (e.TAG === "Ok") {
            console.log("isCached: " + PervasivesU.string_of_bool(e._0));
            var destPath = Nodepath.join(globalStoragePath, latestALS.saveAsFileName, "als");
          ...
          console.log("No latest ALS available");
        }
        console.log("latestALS: ", latestALS);
        return ;
    ...
    default:
      ...
      if (original !== undefined) {
        ...
        var match$1 = await Connection__URI$AgdaModeVscode.parse(rawPath);
        if (match$1 !== undefined) {
          if (match$1.TAG === "Filepath") {
            var e$1 = await Connection__Target$AgdaModeVscode.fromRawPath(match$1._0);
            if (e$1.TAG === "Ok") {
          ...
          console.log("Trying to connect with: " + match$1._0.toString());
          return ;
        }
