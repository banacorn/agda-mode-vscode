...
async function getAvailableLatestDownload(state, platformDeps) {
  ...
  var versionString = Connection__Download$AgdaModeVscode.DownloadSource.toVersionString(concreteOrder._0);
  return [
          downloaded,
          versionString,
          "latest"
...
async function getAvailableDevDownload(state, platformDeps) {
  ...
  var downloaded = match !== undefined;
  var versionString = Connection__Download$AgdaModeVscode.DownloadSource.toVersionString(_error._0);
  return [
          downloaded,
          versionString,
          "dev"
