...
async function handleSelection(self, memento, globalStoragePath, selection) {
  ...
  if (original !== undefined) {
    ...
    if (isDownloadable) {
      ...
      var e = await Connection__Target$AgdaModeVscode.downloadAgdaLanguageServer(memento, globalStoragePath, onDownload);
      if (e.TAG === "Ok") {
        var match$1 = e._0;
        var target = match$1[1];
        console.log("isCached: " + PervasivesU.string_of_bool(match$1[0]));
        console.log("target: ", target);
        var destPath = Nodepath.join(globalStoragePath, target.saveAsFileName);
