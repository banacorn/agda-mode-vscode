  ...
  var handle$1 = function (kind) {
    if (typeof kind === "number") {
      if (kind === /* Activate */0) {
        ...
        return State__View$AgdaModeVscode.updateIM(state, /* Activate */0);
      }
      State__Type$AgdaModeVscode.Context.setIM(false);
      return State__View$AgdaModeVscode.updateIM(state, /* Deactivate */1);
    } else {
      if (kind.TAG === /* UpdateView */0) {
        return State__View$AgdaModeVscode.updateIM(state, {
                    _0: kind._0,
                    _1: kind._1,
                    _2: kind._2,
...
function handle$1(state, output) {
  var handle$2 = function (kind) {
    if (typeof kind === "number") {
      if (kind === /* Activate */0) {
        return $$Promise.flatMap(State__View$AgdaModeVscode.updateIM(state, /* Activate */0), (function (param) {
                      return State__View$AgdaModeVscode.updatePromptIM(state, previous.contents);
                    }));
      } else {
        return State__View$AgdaModeVscode.updateIM(state, /* Deactivate */1);
      }
    ...
    return State__View$AgdaModeVscode.updatePromptIM(state, replaced.contents);
  };
