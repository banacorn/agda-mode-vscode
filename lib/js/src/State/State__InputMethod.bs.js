  ...
  var handle$1 = function (kind) {
    if (typeof kind === "number") {
      if (kind === /* Activate */0) {
        ...
        return State$AgdaModeVscode.View.updateIM(/* Activate */0);
      }
      State$AgdaModeVscode.Context.setIM(false);
      return State$AgdaModeVscode.View.updateIM(/* Deactivate */1);
    } else {
      if (kind.TAG === /* UpdateView */0) {
        return State$AgdaModeVscode.View.updateIM({
                    _0: kind._0,
                    _1: kind._1,
                    _2: kind._2,
...
function handle$1(output) {
  var handle$2 = function (kind) {
    if (typeof kind === "number") {
      if (kind === /* Activate */0) {
        return $$Promise.flatMap(State$AgdaModeVscode.View.updateIM(/* Activate */0), (function (param) {
                      return State$AgdaModeVscode.View.updatePromptIM(previous.contents);
                    }));
      } else {
        return State$AgdaModeVscode.View.updateIM(/* Deactivate */1);
      }
    ...
    return State$AgdaModeVscode.View.updatePromptIM(replaced.contents);
  };
...
function runAndHandle$1(state, action) {
  return handle$1(IM$AgdaModeVscode.run(state.promptIM, undefined, action));
}
  ...
  switch (match) {
    case /* Editor */0 :
        if (input.endsWith("\\")) {
          ...
          return State$AgdaModeVscode.View.updatePromptIM(input);
        }
    case /* Prompt */1 :
