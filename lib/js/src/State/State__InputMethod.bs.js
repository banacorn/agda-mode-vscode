...
async function handle(state, output) {
  var handle$1 = async function (kind) {
    if (typeof kind !== "object") {
      ...
      await Editor$AgdaModeVscode.$$Text.batchReplace(state.editor, kind._0, undefined);
      return kind._1();
    }
  };
...
async function insertChar$1(state, $$char) {
  ...
  switch (match) {
    case "Editor" :
        ...
        await Editor$AgdaModeVscode.$$Text.batchInsert(state.editor, positions, $$char$1, undefined);
