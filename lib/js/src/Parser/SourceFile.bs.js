...
function lex(regex, source, target, tokens) {
  var f = function (token) {
    ...
    return Belt_Array.map(Belt_Array.keepMap(Js_string.splitByRe(regex, token.content), (function (x) {
                      return x;
                    })), (function (content) {
...
function parse$1(indices, filepath, raw) {
  ...
  var adjustGoalBracket = function (token) {
    ...
    var actualSpaces = Belt_Option.getWithDefault(Belt_Option.flatMap(Js_string.match_(/\\s*$/, content), (function (matches) {
