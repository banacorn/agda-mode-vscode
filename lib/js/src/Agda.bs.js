...
function toText$6(idToText, renderId, value, $$location) {
  ...
  switch (value.TAG | 0) {
    case /* OfType */0 :
        return Component$AgdaModeVscode.$$Text.fromRichText(RichText$AgdaModeVscode.concatMany([
                        Curry._1(renderId, value._0),
                        RichText$AgdaModeVscode.text(" : "),
                        value._1
                      ]));
    case /* JustType */1 :
        return Component$AgdaModeVscode.$$Text.concatMany([
    ...
    case /* Guard */9 :
        return Component$AgdaModeVscode.$$Text.concatMany([
                    toText$6(idToText, renderId, value._0, undefined),
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.pair(decodeID, RichText$AgdaModeVscode.decode, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
...
function toText$7(idToText, renderId, value) {
  return toText$6(idToText, renderId, value._0, value._1);
}
