...
function render(value) {
  ...
  switch (string) {
    case "" :
    case "_" :
        return RichText$AgdaModeVscode.text(String(value._1));
    default:
      return RichText$AgdaModeVscode.text("_" + string + String(value._1));
  }
}
...
function render$1(value) {
  var index = value._0;
  return RichText$AgdaModeVscode.hole("?" + String(index), index);
}
...
var decode$3 = Util$AgdaModeVscode.Decode.sum(function (x) {
      switch (x) {
        ...
        default:
          throw {
                RE_EXN_ID: Json_decode.DecodeError,
                _1: "[Agda.Comparison] Unknown constructor: " + x,
                Error: new Error()
              };
      }
    });
...
function render$2(idToText, renderId, value, $$location) {
  ...
  switch (value.TAG | 0) {
    case /* OfType */0 :
        return value._0;
    case /* JustType */1 :
        return Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.concatMany([
                        Component$AgdaModeVscode.$$Text.plainText(undefined, "Type "),
                        Curry._1(idToText, value._0)
                      ]));
    case /* JustSort */2 :
        return Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.concatMany([
    ...
    case /* CmpElim */4 :
        var polarities = Component$AgdaModeVscode.$$Text.concatMany(Belt_Array.map(value._0, toText$4));
        var names1 = Component$AgdaModeVscode.$$Text.concatMany(Belt_Array.map(value._2, idToText));
        var names2 = Component$AgdaModeVscode.$$Text.concatMany(Belt_Array.map(value._3, idToText));
        return Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.concatMany([
                        names1,
                        polarities,
                        names2,
    ...
    case /* Guard */9 :
        return RichText$AgdaModeVscode.concatMany([
                    render$2(idToText, renderId, value._0, undefined),
                    Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.concatMany([
    ...
    case /* PTSInstance */16 :
        return Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.concatMany([
                        ...
                        Curry._1(idToText, value._0),
                        Component$AgdaModeVscode.$$Text.plainText(undefined, " , "),
                        Curry._1(idToText, value._1),
                        Component$AgdaModeVscode.$$Text.plainText(undefined, ")")
                      ]));
    case /* PostponedCheckFunDef */17 :
        return Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.plainText(undefined, "Check definition of " + value._0 + " : " + value._1));
    case /* OfType' */18 :
        return Component$AgdaModeVscode.$$Text.toRichText(Component$AgdaModeVscode.$$Text.concatMany([
                        value._0,
                        Component$AgdaModeVscode.$$Text.plainText(undefined, " : "),
    ...
    default:
      return Component$AgdaModeVscode.$$Text.toRichText(cmpToText(value._0, value._1, value._2));
  }
}

function decode$4(decodeID) {
  return Util$AgdaModeVscode.Decode.sum(function (x) {
              switch (x) {
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.pair(decodeID, Json_decode.string, param);
                                            }), param);
                              }),
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple4((function (param) {
                                                            ...
                                                            return Json_decode.array(decodeID, param);
                                                          }), (function (param) {
                                                            return Json_decode.array(decodeID, param);
                                                          }), param);
                                            }), param);
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple4(decode$3, Json_decode.string, decodeID, decodeID, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple3(decode$3, decodeID, decodeID, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple3(decodeID, Json_decode.string, (function (param) {
                ...
                case "Guard" :
                    var partial_arg = decode$4(decodeID);
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (text) {
                                            ...
                                            }), RichText$AgdaModeVscode.decode, param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
                case "PTSInstance" :
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.pair(decodeID, decodeID, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple4(decodeID, (function (param) {
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple3(decodeID, Json_decode.string, Json_decode.string, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
...
function render$3(idToText, renderId, value) {
  return render$2(idToText, renderId, value._0, value._1);
}
...
exports.Term = Term;
exports.Expr = Expr;
exports.NamedMeta = NamedMeta;
exports.InteractionId = InteractionId;
