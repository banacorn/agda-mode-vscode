...
function toText$6(idToText, value, $$location) {
  ...
  switch (value.TAG | 0) {
    case /* OfType */0 :
        return Component$AgdaModeVscode.$$Text.concatMany([
                    ...
                    RichText$AgdaModeVscode.toText(value._1)
                  ]);
    case /* JustType */1 :
        return Component$AgdaModeVscode.$$Text.concatMany([
    ...
    case /* Guard */9 :
        return Component$AgdaModeVscode.$$Text.concatMany([
                    toText$6(idToText, value._0, undefined),
...
function toText$7(idToText, value) {
  return toText$6(idToText, value._0, value._1);
}
