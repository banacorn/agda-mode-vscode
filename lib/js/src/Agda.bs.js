...
function toText$2(value) {
  if (value.TAG !== /* NamedMeta */0) {
    return Component$AgdaModeVscode.$$Text.plainText(undefined, "?" + String(value._0));
  }
  var string = value._0;
  switch (string) {
    case "" :
    ...
    default:
      return Component$AgdaModeVscode.$$Text.plainText(undefined, string + String(value._1));
  }
}
