...
function computeUTF16SurrogatePairIndices(text) {
  ...
  console.log("=== computeUTF16SurrogatePairIndices DEBUG START ===");
  console.log("Text to process:");
  console.log(text);
  console.log("Text length in code units: " + lengthInCodeUnits.toString());
  var i = 0;
  while(i < lengthInCodeUnits) {
    ...
    if (charCode >= 55296 && charCode <= 56319 && notFinal) {
      ...
      console.log("High surrogate found at index " + i.toString() + ": charCode=" + charCode.toString() + ", nextCharCode=" + nextCharCode.toString());
      if (nextCharCode >= 56320 && nextCharCode <= 57343) {
        surrogatePairs.push(i);
        console.log("Valid surrogate pair found at index " + i.toString());
      } else {
        console.log("Invalid low surrogate: nextCharCode=" + nextCharCode.toString() + " (expected 0xDC00-0xDFFF)");
      }
      i = i + 2 | 0;
    } else {
      i = i + 1 | 0;
  ...
  console.log("Final surrogate pairs array:");
  console.log(surrogatePairs);
  console.log("=== computeUTF16SurrogatePairIndices DEBUG END ===");
...
function make$1(text) {
  ...
  console.log("=== OffsetConverter.make DEBUG ===");
  console.log("Creating OffsetConverter for text:");
  console.log(text);
  console.log("Surrogate pair indices:");
  console.log(surrogatePairIndices);
  console.log("CRLF indices:");
  console.log(crlfIndices);
  var result_utf16indices = make(surrogatePairIndices);
  var result_eolIndices = make(crlfIndices);
  var result = {
    utf16indices: result_utf16indices,
    eolIndices: result_eolIndices
  };
  console.log("Created OffsetConverter");
  return result;
}

function convert$1(self, offset) {
  console.log("=== OffsetConverter.convert DEBUG ===");
  console.log("Input offset: " + offset.toString());
  var offset$1 = convert(self.utf16indices, offset);
  console.log("After UTF-16 conversion: " + offset$1.toString());
  var finalOffset = convert(self.eolIndices, offset$1);
  console.log("After CRLF conversion: " + finalOffset.toString());
  return finalOffset;
}
