...
var decode = Util$AgdaModeVscode.Decode.sum(function (x) {
      ...
      throw {
            ...
            _1: "[Agda.NamedMeta] Unknown constructor: " + x,
            Error: new Error()
          };
    });
...
var decode$1 = Util$AgdaModeVscode.Decode.sum(function (x) {
      ...
      throw {
            RE_EXN_ID: Json_decode.DecodeError,
            _1: "[Agda.InteractionId] Unknown constructor: " + x,
            Error: new Error()
          };
    });
...
function toText$5(idToText, value, $$location) {
  ...
  switch (value.TAG | 0) {
    ...
    case /* Guard */9 :
        return Component$AgdaModeVscode.$$Text.concatMany([
                    toText$5(idToText, value._0, undefined),
...
function decode$3(decodeID) {
  return Util$AgdaModeVscode.Decode.sum(function (x) {
              switch (x) {
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple4(Json_decode.bool, Json_decode.string, decodeID, decodeID, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
                    ...
                    return {
                            ...
                            _0: (function (param) {
                                return Json_decode.map((function (param) {
                                              ...
                                              return Json_decode.tuple3(Json_decode.bool, decodeID, decodeID, param);
                                            }), param);
                              }),
                            [Symbol.for("name")]: "Contents"
                          };
                ...
                case "Guard" :
                    var partial_arg = decode$3(decodeID);
...
function toText$6(idToText, value) {
  return toText$5(idToText, value._0, value._1);
}
