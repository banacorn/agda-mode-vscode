...
function Impl(Editor) {
  ...
  var makeMany = function (editor, indices) {
    ...
    console.time(">>> Instantiating goals");
    var delta = {
      contents: 0
    };
    var replacements = Belt_Array.map(diffs, (function (diff) {
            var range = Curry._2(Editor.$$Range.make, Curry._2(Editor.pointAtOffset, editor, diff.originalRange[0] - delta.contents | 0), Curry._2(Editor.pointAtOffset, editor, diff.originalRange[1] - delta.contents | 0));
    ...
    return $$Promise.map(Curry._2(Editor.replaceTextBatch, editor, replacements), (function (param) {
                  console.timeEnd(">>> Instantiating goals");
