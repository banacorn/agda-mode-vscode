...
function Impl(Editor) {
  ...
  var getInnerRange = function (self) {
    return Curry._2(Editor.$$Range.make, Curry._3(Editor.Point.translate, Curry._1(Editor.$$Range.start, self.range), 0, 2), Curry._3(Editor.Point.translate, Curry._1(Editor.$$Range.end_, self.range), 0, -2));
  };
  var getContent = function (self, editor) {
    var innerRange = getInnerRange(self);
