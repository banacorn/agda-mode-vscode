...
function Impl(Editor) {
  ...
  var generateDiffs = function ($$document, indices) {
    var filePath = Belt_Option.getWithDefault(Curry._1(Editor.getFileName, $$document), "unnamed.agda");
    var source = Curry._1(Editor.getText, $$document);
  ...
  var makeMany = function (editor, indices) {
    ...
    var replacements = Belt_Array.map(Belt_Array.keep(diffs, (function (diff) {
            ...
            var range = Curry._2(Editor.$$Range.make, Curry._2(Editor.pointAtOffset, $$document, diff.originalRange[0] - delta.contents | 0), Curry._2(Editor.pointAtOffset, $$document, diff.originalRange[1] - delta.contents | 0));
    ...
    return $$Promise.map(Curry._2(Editor.replaceTextBatch, $$document, replacements), (function (param) {
  ...
  var updateRanges = function (goals, $$document) {
  ...
  var setCursor = function (self, editor) {
    ...
    var point = Curry._2(Editor.pointAtOffset, Curry._1(Editor.getDocument, editor), match[0] + 3 | 0);
  ...
  var refreshDecoration = function (self, editor) {
    var range = getOuterRange(self, Curry._1(Editor.getDocument, editor));
