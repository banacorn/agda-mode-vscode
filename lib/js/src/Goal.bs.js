...
function Impl(Editor) {
  ...
  var getInnerRange = function (self, editor) {
    return Curry._2(Editor.$$Range.make, Curry._3(Editor.Point.translate, Curry._1(Editor.$$Range.start, self.range), 0, 2), Curry._2(Editor.pointAtOffset, editor, Curry._2(Editor.offsetAtPoint, editor, Curry._1(Editor.$$Range.end_, self.range)) - 2 | 0));
  };
