...
async function replaceWithLines(goal, editor, lines) {
  ...
  if (await Editor$AgdaModeVscode.$$Text.replace(editor, rangeToBeReplaced, indentedLines)) {
    return [
            rangeToBeReplaced,
            indentedLines
          ];
...
async function replaceWithLambda(goal, editor, lines) {
  ...
  if (await Editor$AgdaModeVscode.$$Text.replace(editor, rewriteRange, rewriteText)) {
    return [
            rewriteRange,
            rewriteText
          ];
