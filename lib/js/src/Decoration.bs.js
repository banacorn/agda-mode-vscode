...
function offsetToPoint($$document, intervals, offset) {
  var offset$1 = Editor$AgdaModeVscode.fromUTF8Offset(intervals, offset);
...
function offsetToPointSlow($$document, offset) {
  ...
  var intervals = Editor$AgdaModeVscode.OffsetIntervals.compile(text);
  var offset$1 = Editor$AgdaModeVscode.fromUTF8Offset(intervals, offset);
  var point = $$document.positionAt(offset$1);
  return normalize($$document, point);
}
