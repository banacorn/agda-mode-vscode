...
function lookupSrcLoc(self, offset) {
  ...
  var matched = AVLTree$AgdaModeVscode.find(Highlighting__Agda$AgdaModeVscode.Infos.get(self.infos), offset);
  console.log("lookupSrcLoc", matched, Highlighting__Agda$AgdaModeVscode.Infos.get(self.infos).count());
  return Belt_Option.map(Belt_Option.flatMap(matched, (function (param) {
                    var range = param[1];
