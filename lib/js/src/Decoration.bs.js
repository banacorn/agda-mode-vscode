...
function convertToSemanticTokens(self, editor) {
  var $$document = editor.document;
  var text = Editor$AgdaModeVscode.$$Text.getAll($$document);
  var offsetConverter = Agda$AgdaModeVscode.OffsetConverter.make(text);
  var intervalTree = new IntervalTree();
  console.log("Number of highlightings: ", self.highlightings.length);
  ...
  return Belt_Array.keepMap(Belt_Array.concatMany(Belt_Array.map(intervalTree.items, (function (item) {
                        ...
                        console.log(item.key, [
                              ...
                              range.end.line,
                              range.end.character
                            ], Belt_Array.map(aspects, Highlighting$AgdaModeVscode.Aspect.toString));
                        var ranges = lines(editor.document, range);
                ...
                return Belt_Option.map(Belt_Array.get(tokenTypeAccum, 0), (function (tokenType) {
                              return [
                                      range,
                                      tokenType,
                                      tokenModifiersAccum
...
var Module = {
  ...
  convertToSemanticTokens: convertToSemanticTokens
};
...
exports.convertToSemanticTokens = convertToSemanticTokens;
