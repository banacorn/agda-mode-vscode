...
function Impl(Editor) {
  ...
  var decorateHighlightings = function (editor, highlightings) {
    ...
    Belt_Array.forEach(highlightings, (function (highlighting) {
            ...
            return Belt_Array.forEach(Belt_Array.keepMap(Belt_Array.map(highlighting.aspects, Highlighting$AgdaModeVscode.Aspect.toStyle), (function (param) {
                              if (param) {
                                if (Curry._1(Editor.colorThemeIsDark, undefined)) {
                                  return /* tuple */[
                                          param[1],
                          ...
                          if (color.tag) {
                            var color$1 = color[0];
                            var range = param[1];
                            var ranges = Js_dict.get(foregroundColorDict, color$1);
                            if (ranges !== undefined) {
                              ranges.push(range);
                              return ;
                            } else {
                            ...
                            var color$2 = color[0];
                            var range$1 = param[1];
                            var ranges$1 = Js_dict.get(backgroundColorDict, color$2);
                            if (ranges$1 !== undefined) {
                              ranges$1.push(range$1);
                              return ;
                            } else {
                              backgroundColorDict[color$2] = [range$1];
                              return ;
                            }
                          }
                        }));
