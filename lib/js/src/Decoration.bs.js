...
function Impl(Editor) {
  ...
  var decorateHighlighting = function (editor, highlighting) {
    var start = Curry._2(Editor.pointAtOffset, editor, highlighting.start);
    console.log("offset: " + String(highlighting.start));
    console.log("point: ", start);
    console.log("offset2:  ", Curry._2(Editor.offsetAtPoint, editor, start));
    var end_ = Curry._2(Editor.pointAtOffset, editor, highlighting.end_);
    ...
    var range = Curry._2(Editor.$$Range.make, normalize(start), normalize(end_));
