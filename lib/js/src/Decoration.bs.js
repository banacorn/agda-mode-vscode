...
function Impl(Editor) {
  ...
  var offsetToPointSlow = function (editor, file, offset) {
  ...
  var decorateHighlightings = function (editor, highlightings) {
    ...
    var srcLocs = Belt_Array.keepMap(highlightings$1, (function (param) {
            var refRange = param[0];
            return Belt_Option.map(param[2], (function (param) {
                          var srcFile = param[0];
                          return {
                                  refRange: refRange,
                                  srcFile: srcFile,
                                  srcPoint: offsetToPointSlow(editor, srcFile, param[1])
                                };
                        }));
          }));
  ...
  var lookupSrcLoc = function (self, point) {
    return Belt_Option.map(Caml_option.undefined_to_opt(self.srcLocs.find((function (srcLoc) {
                          return Curry._2(Editor.$$Range.contains, srcLoc.refRange, point);
                        }))), (function (srcLoc) {
                  console.log(srcLoc);
                  return /* tuple */[
                          srcLoc.srcFile,
