...
function make(path, args) {
  var emitter = Chan$AgdaModeVscode.make(undefined);
  var stderr = {
    contents: ""
  };
  ...
  $$process.stdout.on("data", (function (chunk) {
          Chan$AgdaModeVscode.emit(emitter, {
                TAG: 0,
                _0: chunk.toString(),
  ...
  var disconnect = function (param) {
    ...
    Chan$AgdaModeVscode.on(emitter, (function (x) {
            switch (x.TAG | 0) {
              case /* Stdout */0 :
              case /* Stderr */1 :
                  return ;
              case /* Error */2 :
                  ...
                  Chan$AgdaModeVscode.destroy(emitter);
