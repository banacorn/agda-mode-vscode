...
function make(path, args) {
  ...
  $$process.stdout.on("data", (function (chunk) {
          Curry._1(emitter.emit, /* Ok */Caml_chrome_debugger.variant("Ok", 0, [chunk.toString()]));
  ...
  $$process.stdin.on("close", (function (param) {
          Curry._1(emitter.emit, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ClosedByProcess */Caml_chrome_debugger.variant("ClosedByProcess", 0, [
                      0,
                      ""
                    ])]));
  ...
  $$process.on("close", (function (code, signal) {
              ...
              Curry._1(emitter.emit, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* DisconnectedByUser */0]));
              
            })).on("error", (function (exn) {
            Curry._1(emitter.emit, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ShellError */Caml_chrome_debugger.variant("ShellError", 1, [exn])]));
            
          })).on("exit", (function (code, signal) {
          if (code !== 0) {
            Curry._1(emitter.emit, /* Error */Caml_chrome_debugger.variant("Error", 1, [/* ExitedByProcess */Caml_chrome_debugger.variant("ExitedByProcess", 2, [
                        code,
                        signal,
                        stderr.contents
                      ])]));
