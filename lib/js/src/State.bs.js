...
function Impl(Editor) {
  ...
  var onKillMePlz = function (state) {
    return Curry._1(state.onKillMePlzEmitter.once, undefined);
  };
  var emitKillMePlz = function (state) {
    return Curry._1(state.onKillMePlzEmitter.emit, undefined);
  };
  ...
  var destroy = function (state) {
    ...
    Curry._1(state.onKillMePlzEmitter.destroy, undefined);
  ...
  var make = function (extentionPath, editor) {
    ...
    return {
            ...
            decorations: [],
            cursor: undefined,
            onKillMePlzEmitter: Event$AgdaModeVscode.make(undefined),
  ...
  return {
          ...
          $$Request: $$Request,
          getEditor: getEditor,
          onKillMePlz: onKillMePlz,
          emitKillMePlz: emitKillMePlz,
          connect: connect,
