...
function restoreCachedView(state, cachedView) {
  return Belt_Option.forEach(cachedView, (function (content) {
                if (content.TAG === /* Display */0) {
                  ViewController$AgdaModeVscode.sendEvent(state.view, {
                        TAG: 0,
                        _0: content._0,
                        _1: content._1,
                        [Symbol.for("name")]: "Display"
                ...
                ViewController$AgdaModeVscode.sendRequest(state.view, {
                      _0: content._0,
                      _1: content._1,
...
function activate(state) {
  return restoreCachedView(state, state.viewCache);
}
...
function prompt(state, header, prompt$1, callbackOnPromptSuccess) {
  ...
  var previouslyCachedView = state.viewCache;
  var request = {
    _0: header,
    _1: prompt$1,
    [Symbol.for("name")]: "Prompt"
