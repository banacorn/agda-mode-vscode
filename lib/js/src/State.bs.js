  ...
  return push(state.agdaRequestQueue, (function (param) {
                ...
                switch (match.TAG | 0) {
                  case /* Emacs */0 :
                      ...
                      Connection$AgdaModeVscode.Emacs.sendRequest(conn, encodeRequest(match._1));
                      return promise;
                  case /* LSP */1 :
                      return $$Promise.flatMap(Connection$AgdaModeVscode.LSP.sendRequest(encodeRequest(match._0), handleResult), (function (result) {
                                    if (result.TAG !== /* Ok */0) {
