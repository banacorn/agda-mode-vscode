  ...
  if (connection !== undefined) {
    ...
    return $$Promise.flatMap(LSP$AgdaModeVscode.find(undefined), (function (result) {
                  if (result.TAG === /* Ok */0) {
                    ...
                    return $$Promise.flatMap(LSP$AgdaModeVscode.start(false), (function (param) {
                  ...
                  console.log(Connection$AgdaModeVscode.$$Error.toString(result._0));
                  return $$Promise.tapOk(Connection$AgdaModeVscode.make(undefined), (function (conn) {
                                state.connection = Caml_option.some(conn);
...
function make$1(chan, editor, view) {
  return {
          editor: editor,
