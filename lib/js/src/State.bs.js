...
function display(header, body) {
  return ViewController$AgdaModeVscode.sendEvent({
              TAG: 0,
              _0: header,
              _1: body,
...
function displayOutOfGoalError(param) {
  return ViewController$AgdaModeVscode.sendEvent({
              TAG: 0,
              _0: {
                TAG: 3,
...
function updatePromptIM(content) {
  return ViewController$AgdaModeVscode.sendEvent({
              TAG: 1,
              _0: content,
...
function prompt(state, header, prompt$1, callbackOnPromptSuccess) {
  ...
  return ViewController$AgdaModeVscode.sendRequest({
              _0: header,
              _1: prompt$1,
...
function interruptPrompt(param) {
  return ViewController$AgdaModeVscode.sendEvent(/* PromptInterrupt */0);
}
                ...
                var agdaResponseListener = function (x) {
                  if (x.TAG === /* Ok */0) {
                    ...
                    if (match) {
                      ...
                      ViewController$AgdaModeVscode.sendEvent({
                            TAG: 0,
                            _0: {
                              TAG: 3,
...
function make$1(extentionPath, chan, editor) {
  Vscode.commands.executeCommand("setContext", "agdaMode", true);
  ViewController$AgdaModeVscode.activate(extentionPath);
  return {
          editor: editor,
