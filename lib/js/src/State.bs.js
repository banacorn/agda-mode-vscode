...
function disconnect(state) {
  var connection = state.connection;
  if (connection !== undefined) {
    Connection$AgdaModeVscode.destroy(Caml_option.valFromOption(connection));
    return $$Promise.resolved(undefined);
  } else {
    return $$Promise.resolved(undefined);
  }
...
function sendRequest(state, handleResponse, request) {
  return push(state.agdaRequestQueue, (function (param) {
                ...
                var afterNonLastsDone = function (param) {
                ...
                return $$Promise.tap($$Promise.flatMap(connect(state), (function (x) {
                                  ...
                                  var connection = x._0;
                                  var promise = Connection$AgdaModeVscode.onResponse(connection, handleResult, afterNonLastsDone);
