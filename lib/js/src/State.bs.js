...
function reconnect(state) {
  ...
  switch (match.TAG | 0) {
    case /* Emacs */0 :
        ...
        return $$Promise.flatMapOk($$Promise.flatMap(Connection$AgdaModeVscode.Emacs.destroy(match._0), Connection$AgdaModeVscode.Emacs.make), (function (conn) {
                      state.connection = {
                        TAG: 0,
                        _0: conn,
                        _1: version,
  ...
  return push(state.agdaRequestQueue, (function (param) {
                ...
                switch (error.TAG | 0) {
                  case /* Emacs */0 :
                      ...
                      Connection$AgdaModeVscode.Emacs.sendRequest(conn, encodeRequest(error._1));
                      return promise;
                  case /* LSP */1 :
                      return $$Promise.flatMap(Connection$AgdaModeVscode.LSP.sendRequest(encodeRequest(error._0), handleResult), (function (result) {
                                    if (result.TAG === /* Ok */0) {
                                      return $$Promise.resolved(undefined);
                                    } else {
