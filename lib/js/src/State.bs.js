...
var QueryInputMethod$AgdaModeVscode = require("./InputMethod/QueryInputMethod.bs.js");

function Impl(Editor) {
  var Goal = Goal$AgdaModeVscode.Impl(Editor);
  var InputMethod = InputMethod$AgdaModeVscode.Impl(Editor);
  var QueryInputMethod = QueryInputMethod$AgdaModeVscode.Impl(Editor);
  ...
  var make = function (extentionPath, eventEmitter, editor) {
    ...
    return {
            ...
            queryInputMethod: Curry._1(QueryInputMethod.make, undefined),
            subscriptions: [],
  ...
  return {
          ...
          QueryInputMethod: QueryInputMethod,
          $$Request: $$Request,
          getEditor: getEditor,
