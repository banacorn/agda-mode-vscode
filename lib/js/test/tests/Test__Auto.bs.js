...
describe.skip("agda-mode.auto[AsIs]", (function () {
        run("AsIs");
      }));

describe.skip("agda-mode.auto[Simplified]", (function () {
        run("Simplified");
      }));

describe.skip("agda-mode.auto[Normalised]", (function () {
        run("Normalised");
      }));

describe.skip("agda-mode.auto[HeadNormal]", (function () {
        run("HeadNormal");
      }));
