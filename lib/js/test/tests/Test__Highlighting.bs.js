...
describe("Highlighting", (function () {
        ...
        it("should work after deleting an empty line", (async function () {
                var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Issue180.agda");
                await Editor$AgdaModeVscode.$$Text.$$delete(ctx.state.editor, new Vscode.Range(new Vscode.Position(5, 0), new Vscode.Position(6, 0)), undefined);
                var expected = [
                  "(5:0-3) function",
                  "(5:6-7) type",
                  "(5:10-11) type",
        ...
        it("should work after deleting an existing line", (async function () {
                var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Issue180.agda");
                await Editor$AgdaModeVscode.$$Text.$$delete(ctx.state.editor, new Vscode.Range(new Vscode.Position(5, 0), new Vscode.Position(7, 0)), undefined);
                var expected = [
                  "(5:0-1) variable",
                  "(5:2-3) function",
                  "(5:4-5) variable"
