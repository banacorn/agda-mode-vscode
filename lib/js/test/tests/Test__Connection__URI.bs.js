...
describe("Connection__URI", (function () {
        describe("parse", (function () {
                ...
                it("should parse relative file paths and absolute file paths the same way", (function () {
                        var actual = Connection__URI$AgdaModeVscode.parse("relative/path/to/file");
                        var expected = Connection__URI$AgdaModeVscode.parse(Nodepath.resolve("relative/path/to/file"));
