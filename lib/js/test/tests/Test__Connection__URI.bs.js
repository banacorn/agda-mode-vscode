...
describe("Connection__URI", (function () {
        ...
        describe("toString", (function () {
                ...
                it("should convert payload of LspURI with `URL.toString`", (function () {
                        var url = new URL("lsp://localhost:8080");
        ...
        describe("equal", (function () {
                ...
                it("should return true for equal LSP URIs", (function () {
                        var url1 = new URL("lsp://localhost:8080");
                        var url2 = new URL("lsp://localhost:8080");
                        var uri1 = {
                          TAG: "LspURI",
                          _0: "lsp://localhost:8080",
                          _1: url1
                ...
                it("should return false for different LSP URIs", (function () {
                        var url1 = new URL("lsp://localhost:8080");
                        var url2 = new URL("lsp://localhost:9090");
                        var uri1 = {
                          TAG: "LspURI",
                          _0: "lsp://localhost:8080",
                          _1: url1
