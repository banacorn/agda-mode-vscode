...
describe("Tokens", (function () {
        ...
        var contains = function (text, pattern) {
          return text.indexOf(pattern) >= 0;
        };
        describe.only("properties", (function () {
                it("should always contain itself", (function () {
                        FastCheck.assert(FastCheck.property(FastCheck.string(), (function (text) {
                                    return contains(text, text);
                                  })));
                      }));
                it("should always contain its substrings", (function () {
                        FastCheck.assert(FastCheck.property(FastCheck.string(), FastCheck.string(), FastCheck.string(), (function (a, b, c) {
