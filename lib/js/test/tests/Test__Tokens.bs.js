...
describe.only("WIP", (function () {
        var genBeforeReplaced = function () {
          return FastCheck.integer(0, 10).chain(Tokens$AgdaModeVscode.Change.arbitrary).chain(function (change1) {
                      var start = change1.offset;
                      var end = change1.offset + change1.removed | 0;
                      return Tokens$AgdaModeVscode.Change.arbitraryBatch(undefined).filter(function (batch) {
                                    var change2 = batch[0];
                                    if (change2 === undefined) {
                                      return true;
                                    }
                                    var start2 = change2.offset;
                                    var end2 = change2.offset + change2.removed | 0;
        ...
        it.skip("main", (function () {
                FastCheck.assert(FastCheck.property(genBeforeReplaced(), (function (param) {
                            var batch2 = param[1];
                            var batch1 = param[0];
                            var batches = [
                              batch1,
