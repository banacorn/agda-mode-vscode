...
describe("Tokens", (function () {
        ...
        describe("GotoDefinition.agda", (function () {
                it("should produce 28 tokens", (async function () {
                        var ctx = await Test__Util$AgdaModeVscode.AgdaMode.make(undefined, "GotoDefinition.agda");
                        var state = await Test__Util$AgdaModeVscode.AgdaMode.load(ctx);
                        var tokens = Tokens$AgdaModeVscode.toArray(state.tokens).map(function (param) {
