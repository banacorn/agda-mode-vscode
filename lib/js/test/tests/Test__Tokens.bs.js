...
Mocha$BsMocha.describe("Tokens")(10000, undefined, undefined, (function (param) {
        return Test__Util$AgdaModeVscode.Q.it_only("should receive tokens from Agda", (function (param) {
                      var filepath = Test__Util$AgdaModeVscode.Path.asset("GotoDefinition.agda");
                      var match = $$Promise.pending(undefined);
                      var resolve = match[1];
                      var promise = match[0];
                      return $$Promise.flatMap(activateExtension(filepath), (function (param) {
                                    var subscription = {
                                      contents: undefined
                                    };
                                    subscription.contents = Chan$AgdaModeVscode.on(param[1].response, (function (response) {
                                            if (typeof response === "number" && response >= 4) {
                                              Belt_Option.forEach(subscription.contents, (function (x) {
                                    ...
                                    return $$Promise.flatMapOk($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.load"), (function (state) {
                                                      if (state !== undefined) {
                                                        return $$Promise.mapOk(promise, (function (param) {
                                                                      return Belt_Array.map(Tokens$AgdaModeVscode.toArray(state.tokens), (function (param) {
