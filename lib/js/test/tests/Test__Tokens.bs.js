...
describe("Tokens", (function () {
        ...
        describe.only("Intervals", (function () {
                it("`empty` should have delta of 0", (function () {
                        Curry._3(Assert.deepStrictEqual, Tokens$AgdaModeVscode.Intervals.totalDelta(Tokens$AgdaModeVscode.Intervals.empty), 0, undefined);
                      }));
                it("`applyChange` should result in correct delta", (function () {
                        FastCheck.assert(FastCheck.property(Tokens$AgdaModeVscode.Change.arbitrary(0), (function (change) {
                                    return Tokens$AgdaModeVscode.Intervals.totalDelta(Tokens$AgdaModeVscode.Intervals.applyChange(Tokens$AgdaModeVscode.Intervals.empty, change)) === Tokens$AgdaModeVscode.Change.delta(change);
                                  })));
                      }));
                it("`removedIntervals` should result in correct array", (function () {
                        FastCheck.assert(FastCheck.property(Tokens$AgdaModeVscode.Change.arbitrary(0), (function (change) {
                                    console.log("change:     " + Tokens$AgdaModeVscode.Change.toString(change));
                                    console.log("intervals:  " + Tokens$AgdaModeVscode.Intervals.toString(Tokens$AgdaModeVscode.Intervals.applyChange(Tokens$AgdaModeVscode.Intervals.empty, change)));
                                    console.log("change d    " + Util$AgdaModeVscode.Pretty.array(Core__Array.filterMap([change], Tokens$AgdaModeVscode.Change.removedInterval).map(function (param) {
                                                  return "[" + param[0].toString() + "-" + param[1].toString() + "]";
                                                })));
                                    console.log("intervals d " + Util$AgdaModeVscode.Pretty.array(Tokens$AgdaModeVscode.Intervals.removedIntervals(Tokens$AgdaModeVscode.Intervals.applyChange(Tokens$AgdaModeVscode.Intervals.empty, change)).map(function (param) {
                                                  return "[" + param[0].toString() + "-" + param[1].toString() + "]";
                                                })));
                                    return Caml_obj.equal(Tokens$AgdaModeVscode.Intervals.removedIntervals(Tokens$AgdaModeVscode.Intervals.applyChange(Tokens$AgdaModeVscode.Intervals.empty, change)), Core__Array.filterMap([change], Tokens$AgdaModeVscode.Change.removedInterval));
                                  })));
                      }));
              }));
      }));
