...
describe.only("WIP", (function () {
        ...
        it.skip("insertion / insertion", (function () {
                FastCheck.assert(FastCheck.property(Tokens$AgdaModeVscode.Change.arbitraryBatch(2, "Mixed"), Tokens$AgdaModeVscode.Change.arbitraryBatch(1, "Mixed"), (function (batch1, batch2) {
                            var batches = [
                              batch1,
                              batch2
                            ];
