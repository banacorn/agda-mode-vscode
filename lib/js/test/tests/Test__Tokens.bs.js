...
function run(command) {
  return $$Promise.flatMapError($$Promise.flatMapOk($$Promise.flatMap(Source$LanguageServerMule.Module.searchUntilSuccess([{
                            TAG: 1,
                            _0: command,
                        ...
                        if (result !== undefined) {
                          ...
                          return $$Promise.resolved({
                                      ...
                                      _0: {
                                        TAG: 0,
                                        _0: param[1],
                                        [Symbol.for("name")]: "LanguageServerMuleErrors"
                                      },
                    ...
                    return $$Promise.mapError(Connection__Emacs$AgdaModeVscode.make(method), (function (error) {
                                  return {
                                          TAG: 1,
                                          _0: error,
                                          [Symbol.for("name")]: "EmacsConnectionError"
                                        };
                                }));
                  })), (function (error) {
                return Test__Util$AgdaModeVscode.A.fail("Unable to acquire \"Agda\" for testing: " + toString(error));
              }));
}
...
Mocha$BsMocha.describe("Tokens")(10000, undefined, undefined, (function (param) {
        ...
        Test__Util$AgdaModeVscode.Q.before(function (param) {
              ...
              return $$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMap($$Promise.flatMap(Config$AgdaModeVscode.Connection.setAgdaVersion("agda"), (function (param) {
                                ...
                                subscription.contents = Chan$AgdaModeVscode.on(param[1].response, (function (response) {
                                        if (typeof response === "number" && response >= 4) {
                                          Belt_Option.forEach(subscription.contents, (function (f) {
                                ...
                                return $$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.load"), (function (state) {
