        ...
        describe("Core Integration Tests", (function () {
                describe("entriesToItemData", (function () {
                        it("should return no installations item when no entries", (function () {
                                var entries = {};
                                var itemData = State__SwitchVersion$AgdaModeVscode.ItemData.entriesToItemData(entries, undefined, undefined, "/test/global/storage");
        ...
        describe("Selection Logic", (function () {
                describe("Selection Parsing (inline logic)", (function () {
                        it("should identify open folder action by label", (function () {
                                Curry._3(Assert.strictEqual, State__SwitchVersion$AgdaModeVscode.Constants.openDownloadFolder, "$(folder-opened)  Open download folder", undefined);
                              }));
