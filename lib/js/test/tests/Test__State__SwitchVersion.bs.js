...
describe("State__SwitchVersion", (function () {
        ...
        document: { fileName: "test.agda" }
                ...
                it("should preserve connection.paths and PreferredCandidate on Delete Downloads (spec L62)", (async function () {
                ...
                it("should restore a valid persisted channel on activation (spec L40)", (async function () {
                        var state = createTestState();
                ...
                it("should NOT clear PreferredCandidate when Delete Downloads is invoked and picked path is under download directory (spec L62)", (async function () {
                ...
                it("should NOT clear PreferredCandidate when Delete Downloads is invoked and picked path is NOT under download directory (spec L62)", (async function () {
