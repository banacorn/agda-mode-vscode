...
describe("State__SwitchVersion", (function () {
        ...
        document: { fileName: "test.agda" }
                ...
                it("should preserve connection.paths on Delete Downloads", (async function () {
                ...
                it("should set picked connection to downloaded path when downloading via handler (spec L54)", (async function () {
                        var testCases = [
                          [
                            "/usr/bin/agda",
                            "Native",
                ...
                it("should set picked connection to downloaded path when user clicks download action (spec L54)", (async function () {
                        var cases = [
                ...
                it("should persist channel selection in memento across UI activations (spec L40)", (async function () {
                        var state = createTestState();
                        var platform = Mock$AgdaModeVscode.Platform.makeWithAgda();
                        var manager = State__SwitchVersion$AgdaModeVscode.SwitchVersionManager.make(state);
                        var selectedChannel = {
                        ...
                        var mementoBefore = Memento$AgdaModeVscode.toString(state.memento);
                        Curry._3(Assert.deepStrictEqual, mementoBefore.includes("selectedChannel"), false, undefined);
                        ...
                        var mementoAfter = Memento$AgdaModeVscode.toString(state.memento);
                        return Curry._3(Assert.deepStrictEqual, mementoAfter.includes("selectedChannel"), true, undefined);
                      }));
                it("should preserve connection.paths when switching channels (spec L46)", (async function () {
                        var state = createTestState();
                        var platform = Mock$AgdaModeVscode.Platform.makeWithAgda();
                ...
                it("should default to Hardcoded channel on fresh activation (spec L37)", (async function () {
                        var state = createTestState();
                ...
                it("should default to Hardcoded channel when memento contains invalid channel label (spec L37)", (async function () {
                        var state = createTestState();
                ...
                it("should clear PreferredCandidate when Delete Downloads is invoked and picked path is under download directory (spec L56)", (async function () {
                        ...
                        var onConfigChanged = Log$AgdaModeVscode.on(state.channels.log, (function (log) {
                                if (log.TAG === "Config") {
                                  return true;
                                } else {
                                  return false;
                ...
                it("should NOT clear PreferredCandidate when Delete Downloads is invoked and picked path is NOT under download directory (spec L56)", (async function () {
