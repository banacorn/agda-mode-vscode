...
describe("State__SwitchVersion2", (function () {
        ...
        describe("QuickPick", (function () {
                ...
                describe("no installations item", (function () {
                        it("should create placeholder item", (function () {
                                var item = State__SwitchVersion2$AgdaModeVscode.Item.fromItemData("NoInstallations", extensionUri);
        ...
        describe("View", (function () {
                it("should create quickpick with correct initial state", (function () {
                        var qp = State__SwitchVersion2$AgdaModeVscode.View.make(Chan$AgdaModeVscode.make());
                ...
                it("should update items correctly", (function () {
                        var qp = State__SwitchVersion2$AgdaModeVscode.View.make(Chan$AgdaModeVscode.make());
                        var items = [State__SwitchVersion2$AgdaModeVscode.Item.fromItemData("NoInstallations", Vscode.Uri.file("/test/extension"))];
                ...
                describe("entriesToItemData", (function () {
                        ...
                        it("should include download section when download info is provided", (function () {
                                ...
                                var downloadAction = itemData.find(function (data) {
                                      if (typeof data !== "object" || !(data.TAG === "DownloadAction" && !(data._0 || data._1 !== "ALS v1.0.0"))) {
                                        return false;
                                      } else {
                                        return true;
                                      }
        ...
        document: { fileName: "test.agda" }
                  ...
                  return State$AgdaModeVscode.make(Mock$AgdaModeVscode.Platform.makeWithAgda(), channels, mockUri, mockUri, undefined, mockEditor, undefined);
                };
                it("should have an endpoint marked as selected onActivation", (async function () {
                        ...
                        await State__SwitchVersion2$AgdaModeVscode.Handler.onActivate(state, Mock$AgdaModeVscode.Platform.makeWithAgda());
        ...
        describe("VersionDisplay", (function () {
                describe("formatAgdaVersion", (function () {
                        it("should format Agda version correctly", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatAgdaVersion("2.6.4");
                                Curry._3(Assert.strictEqual, actual, "Agda v2.6.4", undefined);
                              }));
                        it("should handle version with patch numbers", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatAgdaVersion("2.6.4.1");
                                Curry._3(Assert.strictEqual, actual, "Agda v2.6.4.1", undefined);
                              }));
                        it("should handle development versions", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatAgdaVersion("2.7.0-dev");
                ...
                describe("formatALSVersion", (function () {
                        it("should format ALS version correctly", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatALSVersion("1.2.3", "2.6.4");
                        ...
                        it("should handle different version formats", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatALSVersion("0.3.16", "2.6.4.1");
                ...
                describe("formatSwitchingMessage", (function () {
                        it("should format switching message correctly", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatSwitchingMessage("Agda v2.6.4");
                                Curry._3(Assert.strictEqual, actual, "Switching to Agda v2.6.4", undefined);
                              }));
                        it("should work with ALS versions", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatSwitchingMessage("Agda v2.6.4 Language Server v1.2.3");
                ...
                describe("formatSwitchedMessage", (function () {
                        it("should format switched message correctly", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatSwitchedMessage("Agda v2.6.4");
                                Curry._3(Assert.strictEqual, actual, "Switched to Agda v2.6.4", undefined);
                              }));
                        it("should work with ALS versions", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.VersionDisplay.formatSwitchedMessage("Agda v2.6.4 Language Server v1.2.3");
        ...
        describe("ItemCreation", (function () {
                describe("fromItemData - Separator", (function () {
                        it("should create separator item correctly", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.Item.fromItemData({
                                      TAG: "Separator",
                                      _0: "Installed"
                ...
                describe("fromItemData - OpenFolder", (function () {
                        it("should create folder item correctly", (function () {
                                ...
                                if (desc !== undefined) {
                                  Curry._3(Assert.strictEqual, desc, "Where the language servers are downloaded to", undefined);
                                } else {
                                  Assert.fail("Expected description to be set");
                                }
                                var detail = actual.detail;
                                if (detail !== undefined) {
                                  return Curry._3(Assert.strictEqual, detail, "/test/global/storage", undefined);
                                } else {
                ...
                describe("fromItemData - NoInstallations", (function () {
                        it("should create no installations item correctly", (function () {
                                var actual = State__SwitchVersion2$AgdaModeVscode.Item.fromItemData("NoInstallations", Vscode.Uri.file("/extension/path"));
                ...
                describe("fromItemData - Endpoint (Agda)", (function () {
                        it("should create Agda item for non-selected version", (function () {
                                ...
                                var actual = State__SwitchVersion2$AgdaModeVscode.Item.fromItemData(itemData, Vscode.Uri.file("/extension/path"));
        ...
        describe("Selection Logic", (function () {
                describe("Selection Parsing (inline logic)", (function () {
                        it("should identify open folder action by label", (function () {
                                Curry._3(Assert.strictEqual, State__SwitchVersion2$AgdaModeVscode.Constants.openDownloadFolder, "$(folder-opened)  Open download folder", undefined);
                              }));
                        it("should identify download ALS action by label", (function () {
                                Curry._3(Assert.strictEqual, State__SwitchVersion2$AgdaModeVscode.Constants.downloadLatestALS, "$(cloud-download)  Download the latest Agda Language Server", undefined);
                              }));
                        it("should verify other UI constants", (function () {
                                Curry._3(Assert.strictEqual, State__SwitchVersion2$AgdaModeVscode.Constants.agdaVersionPrefix, "Agda v", undefined);
                                Curry._3(Assert.strictEqual, State__SwitchVersion2$AgdaModeVscode.Constants.alsWithSquirrel, "$(squirrel)  ALS v", undefined);
                                Curry._3(Assert.strictEqual, State__SwitchVersion2$AgdaModeVscode.Constants.downloadedAndInstalled, "Downloaded and installed", undefined);
                              }));
                      }));
              }));
      }));
