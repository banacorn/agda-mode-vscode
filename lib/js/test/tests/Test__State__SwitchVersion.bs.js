...
describe("State__SwitchVersion", (function () {
        ...
        document: { fileName: "test.agda" }
                  ...
                  return State$AgdaModeVscode.make(Mock$AgdaModeVscode.Platform.makeWithAgda(), channels, mockStorageUri, mockExtensionUri, Memento$AgdaModeVscode.make(undefined), mockEditor, undefined);
                };
