        ...
        describe("ItemCreation", (function () {
                ...
                describe("createAgdaItem", (function () {
                        it("should create Agda item for non-selected version", (function () {
                                var actual = State__SwitchVersion$AgdaModeVscode.ItemCreation.createAgdaItem("2.6.4", "/usr/bin/agda", false, Vscode.Uri.file("/extension/path"));
                        ...
                        it("should create Agda item for selected version", (function () {
                                var actual = State__SwitchVersion$AgdaModeVscode.ItemCreation.createAgdaItem("2.6.4", "/usr/bin/agda", true, Vscode.Uri.file("/extension/path"));
                                Curry._3(Assert.strictEqual, actual.label, "Agda v2.6.4", undefined);
                                var desc = actual.description;
                                if (desc !== undefined) {
                ...
                describe("createErrorItem", (function () {
                        it("should create error item correctly", (function () {
                                var actual = State__SwitchVersion$AgdaModeVscode.ItemCreation.createErrorItem({
                                      TAG: "NotAgdaOrALS",
                                      _0: "invalid output"
                                    });
                                ...
                                var detail = actual.detail;
                                if (detail !== undefined) {
                                  return Curry._3(Assert.deepStrictEqual, detail, "doesn't seem to be an Agda executable or an Agda Language Server. Output received: 'invalid output'", undefined);
                                } else {
                                  Assert.fail("Expected detail to be set");
                                  return ;
                                }
