...
describe("State__SwitchVersion", (function () {
        ...
        document: { fileName: "test.agda" }
                ...
                it("should keep main quickpick open when selecting channel-switch button", (async function () {
                        ...
                        State__SwitchVersion$AgdaModeVscode.Handler.onSelection(state, Mock$AgdaModeVscode.Platform.makeWithAgda(), manager, (function (_downloadInfo) {
                                return Promise.resolve();
                              }), view, [selectedItem]);
                ...
                it("should keep endpoint version keys as raw bare commands after endpoint selection", (async function () {
                        ...
                        var runSelectionAndAssert = async function (selectedPath) {
                          ...
                          State__SwitchVersion$AgdaModeVscode.Handler.onSelection(state, platform, manager, (function (_downloadInfo) {
                                  return Promise.resolve();
                                }), view, [selectedItem]);
