...
function makeMockConnection(path, version) {
  return ({
      TAG: "Agda",
      _0: {
...
describe("State__SwitchVersion", (function () {
        ...
        document: { fileName: "test.agda" }
                  ...
                  return State$AgdaModeVscode.make("test-id", Mock$AgdaModeVscode.Platform.makeWithAgda(), channels, mockStorageUri, mockExtensionUri, Memento$AgdaModeVscode.make(undefined), mockEditor, undefined);
                };
                it("should keep existing shared connection when switch target cannot be established", (async function () {
                        ...
                        var missingUri = Connection__URI$AgdaModeVscode.parse("/__agda_mode_vscode_nonexistent__/binary_should_not_exist_280");
                        var completion = State__SwitchVersion$AgdaModeVscode.switchAgdaVersion(state, missingUri).then(function () {
                              return "done";
                            });
