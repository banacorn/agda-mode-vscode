...
describe("State__SwitchVersion", (function () {
        ...
        document: { fileName: "test.agda" }
                ...
                it("should remove download-managed paths even when file URI contains unescaped spaces", (async function () {
                ...
                it("should not overwrite existing picked connection when downloading via handler", (async function () {
                        var testCases = [
                          [
                            "/usr/bin/agda",
                            "Native",
                        ...
                        var runCase = async function (initialPicked, variant, downloaded) {
                          ...
                          Curry._3(Assert.deepStrictEqual, pickedAfter, initialPicked, undefined);
                          ...
                          var expectedSelected = initialPicked !== undefined ? [initialPicked] : [activePath];
                          Curry._3(Assert.deepStrictEqual, selectedEndpoints, expectedSelected, undefined);
                        ...
                        await Promise.all(testCases.map(function (param) {
                                  return runCase(param[0], param[1], param[2]);
                                }));
                      }));
                it("should not switch selected endpoint when user clicks download action", (async function () {
                        var cases = [
                        ...
                        var runCase = async function (label) {
                          ...
                          await Memento$AgdaModeVscode.Module.PickedConnection.set(state.memento, previouslyPicked);
                          Registry__Connection$AgdaModeVscode.status.contents = {
                            TAG: "Active",
                            _0: {
                          ...
                          await Test__Util$AgdaModeVscode.wait(250);
                          State__SwitchVersion$AgdaModeVscode.SwitchVersionManager.refreshFromMemento(manager);
                          Curry._3(Assert.deepStrictEqual, Memento$AgdaModeVscode.Module.PickedConnection.get(state.memento), previouslyPicked, undefined);
                          ...
                          Curry._3(Assert.deepStrictEqual, selectedEndpoints, ["/usr/bin/agda"], undefined);
