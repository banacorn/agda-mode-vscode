...
function run(normalization) {
  ...
  it("should copy type to the pasteboard", (async function () {
          var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad(filename);
          await Test__Util$AgdaModeVscode.AgdaMode.helperFunctionType(ctx, normalization, Caml_option.some(new Vscode.Position(15, 3)), undefined);
