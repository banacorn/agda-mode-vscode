...
describe("TokenChange", (function () {
        ...
        describe("FastCheck Properties", (function () {
                describe("Composition Associativity", (function () {
                        it("delta composition should be associative", (function () {
                                FastCheck.assert(FastCheck.property(TokenChange$AgdaModeVscode.arbitrary(0, undefined), TokenChange$AgdaModeVscode.arbitrary(50, undefined), TokenChange$AgdaModeVscode.arbitrary(100, undefined), (function (a, b, c) {
                                            var leftAssoc = (TokenChange$AgdaModeVscode.delta(a) + TokenChange$AgdaModeVscode.delta(b) | 0) + TokenChange$AgdaModeVscode.delta(c) | 0;
                                            var rightAssoc = TokenChange$AgdaModeVscode.delta(a) + (TokenChange$AgdaModeVscode.delta(b) + TokenChange$AgdaModeVscode.delta(c) | 0) | 0;
                                            var totalDelta = TokenChange$AgdaModeVscode.totalDelta([
                                                  a,
                                                  b,
                                                  c
                                                ]);
                                            if (leftAssoc === rightAssoc) {
                                              return leftAssoc === totalDelta;
                                            } else {
                                              return false;
                                            }
                                          })));
                              }));
                        it("batch composition should be associative", (function () {
                                FastCheck.assert(FastCheck.property(TokenChange$AgdaModeVscode.arbitraryBatch(2, undefined), TokenChange$AgdaModeVscode.arbitraryBatch(2, undefined), TokenChange$AgdaModeVscode.arbitraryBatch(2, undefined), (function (batch1, batch2, batch3) {
                                            var leftGroup = Belt_Array.concatMany([
                                                  batch1,
                                                  batch2
                                                ]);
                                            var leftTotal = TokenChange$AgdaModeVscode.totalDelta(leftGroup) + TokenChange$AgdaModeVscode.totalDelta(batch3) | 0;
                                            var rightGroup = Belt_Array.concatMany([
                                                  batch2,
                                                  batch3
                                                ]);
                                            var rightTotal = TokenChange$AgdaModeVscode.totalDelta(batch1) + TokenChange$AgdaModeVscode.totalDelta(rightGroup) | 0;
                                            var allBatches = TokenChange$AgdaModeVscode.totalDelta(Belt_Array.concatMany([
                                                      batch1,
                                                      batch2,
                                                      batch3
                                                    ]));
                                            if (leftTotal === rightTotal) {
                                              return leftTotal === allBatches;
                                            } else {
                                              return false;
                                            }
                                          })));
                              }));
                        it("translation composition should be associative", (function () {
                                FastCheck.assert(FastCheck.property(TokenChange$AgdaModeVscode.arbitrary(0, undefined), FastCheck.integer(-50, 50), FastCheck.integer(-50, 50), FastCheck.integer(-50, 50), (function (change, delta1, delta2, delta3) {
                                            var stepByStep = TokenChange$AgdaModeVscode.translate(TokenChange$AgdaModeVscode.translate(TokenChange$AgdaModeVscode.translate(change, delta1), delta2), delta3);
                                            var allAtOnce = TokenChange$AgdaModeVscode.translate(change, (delta1 + delta2 | 0) + delta3 | 0);
                                            if (stepByStep.offset === allAtOnce.offset && stepByStep.removed === allAtOnce.removed) {
                                              return stepByStep.inserted === allAtOnce.inserted;
                                            } else {
                                              return false;
                                            }
                                          })));
