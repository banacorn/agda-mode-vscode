...
function getInstalledEndpoints(_globalStorageUri) {
  return Promise.resolve({});
}
...
function getInstalledEndpoints$1(_globalStorageUri) {
  var endpoints = {};
...
var WithAgda = {
  ...
  getInstalledEndpoints: getInstalledEndpoints$1,
...
async function getInstalledEndpoints$2(_globalStorageUri) {
  var endpoints = {};
...
var WithAgdaInPath = {
  ...
  getInstalledEndpoints: getInstalledEndpoints$2
};
