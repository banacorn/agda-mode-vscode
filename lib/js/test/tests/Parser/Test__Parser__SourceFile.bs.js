  ...
  describe("when parsing source files (Unix only)", (function () {
          describe("Regex.comment", (function () {
                  it("should work", (function () {
                          ...
                          Curry._3(Assert.equal, "{- comment -}".search(SourceFile$AgdaModeVscode.Regex.comment), 0, undefined);
                          Curry._3(Assert.equal, "{- {- -} {!   !} -}".search(SourceFile$AgdaModeVscode.Regex.comment), 0, undefined);
          ...
          describe("Regex.goalBracket", (function () {
                  it("should work", (function () {
                          Curry._3(Assert.equal, "{!!}".search(SourceFile$AgdaModeVscode.Regex.goalBracket), 0, undefined);
                          Curry._3(Assert.equal, "{!     !}".search(SourceFile$AgdaModeVscode.Regex.goalBracket), 0, undefined);
                          Curry._3(Assert.equal, "{!     !}\n".search(SourceFile$AgdaModeVscode.Regex.goalBracket), 0, undefined);
                          Curry._3(Assert.equal, "{!   \n  !}\n".search(SourceFile$AgdaModeVscode.Regex.goalBracket), 0, undefined);
                          Curry._3(Assert.equal, "no goal brackets".search(SourceFile$AgdaModeVscode.Regex.goalBracket), -1, undefined);
                          Curry._3(Assert.equal, "no goal brackets\n".search(SourceFile$AgdaModeVscode.Regex.goalBracket), -1, undefined);
                        }));
                }));
