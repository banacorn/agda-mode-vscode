...
describe("when running Emacs__Parser2.parseGoalType and Emacs__Parser2.render together", (function () {
        it("should collapse an Agda-wrapped goal type into a single line", (function () {
                var actual = Emacs__Parser2$AgdaModeVscode.render(Emacs__Parser2$AgdaModeVscode.parseGoalType("Goal: A ->\n      B -> C\n————————————————————————————————————————————————————————————"));
                var expected = [{
                    TAG: "Labeled",
                    _0: "Goal",
                    _1: "special",
                    _2: RichText$AgdaModeVscode.string("A -> B -> C"),
                    _3: undefined,
                    _4: undefined
                  }];
                Curry._3(Assert.deepStrictEqual, actual, expected, undefined);
        ...
        it("should collapse an Agda-wrapped \"Have\" type into a single line", (function () {
                var actual = Emacs__Parser2$AgdaModeVscode.render(Emacs__Parser2$AgdaModeVscode.parseGoalType("Goal: ℕ\nHave: A ->\n      B -> C\n————————————————————————————————————————————————————————————"));
                var expected = [
                  {
                    TAG: "Labeled",
                    _0: "Goal",
