...
describe("when running Emacs__Parser2.parseGoalType and Emacs__Parser2.render together", (function () {
        it("should collapse an Agda-wrapped goal type into a single line", (function () {
                var actual = Emacs__Parser2$AgdaModeVscode.render(Emacs__Parser2$AgdaModeVscode.parseGoalType("Goal: Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat\n————————————————————————————————————————————————————————————"));
                var expected = [{
                    TAG: "Labeled",
                    _0: "Goal",
                    _1: "special",
                    _2: RichText$AgdaModeVscode.string("Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat"),
                    _3: undefined,
                    _4: undefined
                  }];
                Curry._3(Assert.deepStrictEqual, actual, expected, undefined);
              }));
        it("should collapse an Agda-wrapped \"Have\" type into a single line", (function () {
                var actual = Emacs__Parser2$AgdaModeVscode.render(Emacs__Parser2$AgdaModeVscode.parseGoalType("Goal: Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat\nHave: Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat →\n      Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat\n————————————————————————————————————————————————————————————"));
                var chain = "Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat → Nat";
                var expected = [
                  {
                    TAG: "Labeled",
                    _0: "Goal",
                    _1: "special",
                    _2: RichText$AgdaModeVscode.string(chain),
                    _3: undefined,
                    _4: undefined
                  },
                  {
        ...
        it("should not touch an intentional double space inside a string literal", (function () {
                var actual = Emacs__Parser2$AgdaModeVscode.render(Emacs__Parser2$AgdaModeVscode.parseGoalType("Goal: \"a  b\" ≡ \"a  b\"\n————————————————————————————————————————————————————————————"));
                var expected = [{
                    TAG: "Labeled",
                    _0: "Goal",
                    _1: "special",
                    _2: RichText$AgdaModeVscode.string("\"a  b\" ≡ \"a  b\""),
                    _3: undefined,
                    _4: undefined
                  }];
                Curry._3(Assert.deepStrictEqual, actual, expected, undefined);
