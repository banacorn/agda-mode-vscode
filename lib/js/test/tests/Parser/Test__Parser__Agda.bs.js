...
Mocha$BsMocha.describe("when running Agda.OutputConstraint.parse")(undefined, undefined, undefined, (function (param) {
        ...
        Mocha$BsMocha.it("should should parse JustSort on Windows")(undefined, undefined, undefined, (function (param) {
                var expected = {
                  TAG: 2,
                  _0: RichText$AgdaModeVscode.string("ℕ\r\n  ℕ"),
        ...
        Mocha$BsMocha.it("should should parse JustSort on Unix")(undefined, undefined, undefined, (function (param) {
                var expected = {
                  TAG: 2,
                  _0: RichText$AgdaModeVscode.string("ℕ\n  ℕ"),
                  [Symbol.for("name")]: "JustSort"
