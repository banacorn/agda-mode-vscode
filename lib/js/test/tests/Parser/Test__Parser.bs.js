...
describe("Parser.Filepath", (function () {
        ...
        if (OS$AgdaModeVscode.onUnix) {
          it("should not remove roots on Unix", (function () {
                  var actual = Parser$AgdaModeVscode.Filepath.toString(Parser$AgdaModeVscode.Filepath.make("/path/dir/file.txt"));
                  Curry._3(Assert.deepStrictEqual, actual, "/path/dir/file.txt", undefined);
                }));
        } else {
