...
describe("Token Bookkeeping\n", (function () {
        ...
        it.only("should update Tokens after Command.Load", (async function () {
                ...
                var decorationRanges = Tokens$AgdaModeVscode.toDecorationArray(ctx.state.tokens).map(function (prim) {
                        return prim[1];
                      }).flat();
                ...
                var decorationRanges$1 = Tokens$AgdaModeVscode.toDecorationArray(ctx.state.tokens).map(function (prim) {
                        return prim[1];
                      }).flat();
                ...
                var decorationRanges$2 = Tokens$AgdaModeVscode.toDecorationArray(ctx.state.tokens).map(function (prim) {
                        return prim[1];
                      }).flat();
