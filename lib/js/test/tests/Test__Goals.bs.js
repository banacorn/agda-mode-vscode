...
describe.only("Goals", (function () {
        ...
        it.only("should restore a goal after it has been partially damaged (type A)", (async function () {
                var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Goals.agda");
                await Editor$AgdaModeVscode.$$Text.$$delete(ctx.state.document, new Vscode.Range(new Vscode.Position(9, 18), new Vscode.Position(9, 20)));
                ...
                return Curry._3(Assert.deepStrictEqual, actual, "{!   !}", undefined);
              }));
      }));
