...
describe("Goals", (function () {
        ...
        describe("Handle `onDidChangeTextDocument`", (function () {
                ...
                it("should destroy a goal after it has been completely replaced 1", (async function () {
                        var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Goals.agda");
                        await Editor$AgdaModeVscode.$$Text.replace(ctx.state.editor, new Vscode.Range(new Vscode.Position(9, 19), new Vscode.Position(9, 26)), "       ");
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), [
                              "#0 [8:12-19)",
                              "#1 [9:19-26)",
                              "#3 [11:19-26)",
                ...
                it("should destroy a goal after it has been completely replaced 2", (async function () {
                        var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Goals.agda");
                        await Editor$AgdaModeVscode.$$Text.replace(ctx.state.editor, new Vscode.Range(new Vscode.Position(10, 17), new Vscode.Position(10, 26)), "::DD");
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), [
                              "#0 [8:12-19)",
                              "#1 [9:19-26)",
                              "#2 [10:20-27)",
                ...
                it("should only resize a goal after its content has been edited", (async function () {
                        var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Goals.agda");
                        await Editor$AgdaModeVscode.$$Text.replace(ctx.state.editor, new Vscode.Range(new Vscode.Position(9, 22), new Vscode.Position(9, 23)), ":D");
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), [
                              "#0 [8:12-19)",
                              "#1 [9:19-26)",
                              "#2 [10:20-28)",
