...
describe("Goals", (function () {
        ...
        describe("On document change", (function () {
                ...
                it.only("should calculate the effects of document changes on the goals", (function () {
                        FastCheck.assert(FastCheck.property(Goal2$AgdaModeVscode.arbitraryBatch(undefined, undefined), Tokens$AgdaModeVscode.Change.arbitraryBatch(undefined, undefined), (function (goals, changes) {
                                    console.log("\nchanges:    " + Util$AgdaModeVscode.Pretty.array(changes.map(Tokens$AgdaModeVscode.Change.toString)));
                                    console.log("goals:      " + Util$AgdaModeVscode.Pretty.array(goals.map(Goal2$AgdaModeVscode.toString)));
                                    return true;
                                  })));
                      }));
              }));
        ...
        it("should destroy a goal after it has been completely replaced", (async function () {
                var ctx = await Test__Util$AgdaModeVscode.AgdaMode.makeAndLoad("Goals.agda");
        ...
        describe("Restore hole damanged boundaries", (function () {
