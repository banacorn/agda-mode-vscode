...
function arbitraryMoveWithGoals() {
  return Goal$AgdaModeVscode.arbitraryBatch(undefined, undefined).chain(function (goals) {
...
describe("Goals", (function () {
        ...
        describe("Issue #157", (function () {
                it("should handle nested holes correctly", (async function () {
                        ...
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), ["#0 [86-107)"], undefined);
                        return await Test__Util$AgdaModeVscode.AgdaMode.quit(ctx);
                      }));
              }));
        describe("Issue #159", (function () {
                it("should create holes in literate agda files", (async function () {
                        ...
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), ["#0 [99-105)"], undefined);
                        return await Test__Util$AgdaModeVscode.AgdaMode.quit(ctx);
                      }));
              }));
        describe("Issue #211", (function () {
                it("should create a hole on the second line instead of the first line", (async function () {
                        ...
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), ["#0 [106-113)"], undefined);
                        return await Test__Util$AgdaModeVscode.AgdaMode.quit(ctx);
                      }));
              }));
        describe("Issue #214", (function () {
                it("should not create a hole in non-Agda code blocks", (async function () {
                        ...
                        Curry._3(Assert.deepStrictEqual, Goals$AgdaModeVscode.serialize(ctx.state.goals), ["#0 [121-127)"], undefined);
                        return await Test__Util$AgdaModeVscode.AgdaMode.quit(ctx);
                      }));
              }));
