...
Mocha$BsMocha.describe("Conversion of offsets between LF and CRLF line endings")(undefined, undefined, undefined, (function (param) {
        Mocha$BsMocha.describe("Editor.computeCRLFIndices")(undefined, undefined, undefined, (function (param) {
                Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                        ...
                        Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.OffsetConverter.computeCRLFIndices("12\r\n56\r\n90"), [
                              2,
                              6
                            ]);
                      }));
        ...
        Mocha$BsMocha.describe("Editor.Indices.make")(undefined, undefined, undefined, (function (param) {
                Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                        Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(Agda$AgdaModeVscode.Indices.make(Agda$AgdaModeVscode.OffsetConverter.computeCRLFIndices("12\r\n56\r\n90")))[0], [
                              [
                                0,
                                2
                              ],
