...
Mocha$BsMocha.describe("Conversion of offsets between LF and CRLF line endings")(undefined, undefined, undefined, (function (param) {
        Mocha$BsMocha.describe("Editor.computeCRLFIndices")(undefined, undefined, undefined, (function (param) {
                return Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                              Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.OffsetConverter.computeCRLFIndices("1234\r\n78"), [4]);
                              return Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.OffsetConverter.computeCRLFIndices("12\r\n56\r\n90"), [
                                          2,
                                          6
                                        ]);
                            }));
        ...
        Mocha$BsMocha.describe("Editor.Indices.make")(undefined, undefined, undefined, (function (param) {
                return Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                              return Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(Agda$AgdaModeVscode.Indices.make(Agda$AgdaModeVscode.OffsetConverter.computeCRLFIndices("12\r\n56\r\n90")))[0], [
                                          [
                                            0,
                                            2
                                          ],
        ...
        return Mocha$BsMocha.describe("Editor.Indices.convert")(undefined, undefined, undefined, (function (param) {
                      return Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                                    ...
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 1), 1);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 0);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 2), 2);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 0);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 3), 4);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 1);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 4), 5);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 1);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 5), 6);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 1);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 6), 8);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 2);
                                    Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.convert(a, 7), 9);
                                    return Assert$BsMocha.deep_equal(undefined, Agda$AgdaModeVscode.Indices.expose(a)[1], 2);
                                  }));
                    }));
      }));
