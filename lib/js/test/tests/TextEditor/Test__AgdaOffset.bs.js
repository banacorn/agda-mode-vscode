...
Mocha$BsMocha.describe("Conversion between Agda Offsets and Editor Offsets")(undefined, undefined, undefined, (function (param) {
        ...
        Mocha$BsMocha.describe("Common.Indices.make")(undefined, undefined, undefined, (function (param) {
                return Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(Common$AgdaModeVscode.Indices.make(Curry._1(Common$AgdaModeVscode.Agda.OffsetConverter.computeUTF16SurrogatePairIndices, "𝐀𝐀𝐀𝐀\n𝐀𝐀𝐀𝐀")))[0], [
                                    [
                                      0,
                                      0
                                    ],
                              ...
                              return Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(Common$AgdaModeVscode.Indices.make(Curry._1(Common$AgdaModeVscode.Agda.OffsetConverter.computeUTF16SurrogatePairIndices, "𝐀a𝐁bb𝐂c𝐃dd𝐄e𝐅𝐆𝐇\na")))[0], [
                                          [
                                            0,
                                            0
                                          ],
        ...
        Mocha$BsMocha.describe("Common.Indices.convert")(undefined, undefined, undefined, (function (param) {
                Mocha$BsMocha.it("should work")(undefined, undefined, undefined, (function (param) {
                        var a = Common$AgdaModeVscode.Indices.make(Curry._1(Common$AgdaModeVscode.Agda.OffsetConverter.computeUTF16SurrogatePairIndices, "𝐀𝐀𝐀𝐀\n𝐀𝐀𝐀𝐀"));
                        ...
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 1), 2);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 1);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 2), 4);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 2);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 3), 6);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 3);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 0), 0);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 0);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 4), 8);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 5), 9);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 6), 11);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 7), 13);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 8), 15);
                        Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 9), 17);
                        return Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 8);
                      }));
                return Mocha$BsMocha.it("issue #7")(undefined, undefined, undefined, (function (param) {
                              var a = Common$AgdaModeVscode.Indices.make(Curry._1(Common$AgdaModeVscode.Agda.OffsetConverter.computeUTF16SurrogatePairIndices, issue7));
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 0), 0);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 6), 6);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 14), 14);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 19), 19);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 20), 20);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 0);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 24), 25);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 1);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 27), 28);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 28), 29);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 29), 30);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 36), 37);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 1);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 0), 0);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 0);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 6), 6);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 7), 7);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 14), 14);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 19), 19);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 20), 20);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 0);
                              ...
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 1);
                              Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.convert(a, 0), 0);
                              return Assert$BsMocha.deep_equal(undefined, Common$AgdaModeVscode.Indices.expose(a)[1], 0);
                            }));
              }));
        return Mocha$BsMocha.describe("Editor.toUTF8Offset")(undefined, undefined, undefined, (function (param) {
                      ...
                      Promise$BsMocha.it("should be a left inverse of Editor.fromUTF8Offset")(undefined, undefined, undefined, (function (param) {
                              return $$Promise.Js.toBsPromise($$Promise.map(openEditorWithContent("𝐀a𝐁bb𝐂c\na"), (function (textEditor) {
                                                var g = function (n) {
                                                  return Common$AgdaModeVscode.Indices.convert(Common$AgdaModeVscode.Indices.make(Curry._1(Common$AgdaModeVscode.Agda.OffsetConverter.computeUTF16SurrogatePairIndices, "𝐀a𝐁bb𝐂c\na")), n);
                                                };
                                                var n = g(0);
