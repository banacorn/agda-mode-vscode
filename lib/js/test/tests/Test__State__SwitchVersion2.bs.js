        ...
        describe("ItemFormatting", (function () {
                describe("formatEndpointInfo", (function () {
                        it("should format Agda endpoint with version", (function () {
                                ...
                                Curry._3(Assert.deepStrictEqual, match[0], "Agda", undefined);
                                Curry._3(Assert.deepStrictEqual, match[1], "v2.6.4", undefined);
                              }));
                        it("should format Agda endpoint without version", (function () {
                                ...
                                Curry._3(Assert.deepStrictEqual, match[0], "Agda", undefined);
                                Curry._3(Assert.deepStrictEqual, match[1], "version unknown", undefined);
                              }));
                        it("should format ALS endpoint with versions", (function () {
                                ...
                                Curry._3(Assert.deepStrictEqual, match[0], "$(squirrel)  ALS", undefined);
                                Curry._3(Assert.deepStrictEqual, match[1], "v4.0.0, Agda v2.6.4", undefined);
                              }));
                        it("should add (Selected) suffix when picked", (function () {
                                var match = State__SwitchVersion2$AgdaModeVscode.ItemFormatting.formatEndpointInfo("agda", agdaEndpointInfo, true);
                                Curry._3(Assert.deepStrictEqual, match[0], "Agda", undefined);
                                Curry._3(Assert.deepStrictEqual, match[1], "v2.6.4 (Selected)", undefined);
                              }));
        ...
        describe("ItemCreation", (function () {
                ...
                describe("createEndpointItem", (function () {
                        it("should create quickpick item with correct properties", (function () {
                                ...
                                Curry._3(Assert.deepStrictEqual, item.label, "Agda", undefined);
                                Curry._3(Assert.deepStrictEqual, item.description, "v2.6.4", undefined);
                ...
                describe("createOpenFolderItem", (function () {
                        it("should create open folder item", (function () {
                                var item = State__SwitchVersion2$AgdaModeVscode.ItemCreation.createOpenFolderItem();
                                ...
                                Curry._3(Assert.deepStrictEqual, item.detail, "Open global storage directory", undefined);
                              }));
                      }));
        ...
        describe("EndpointLogic", (function () {
                ...
                describe("entriesToItems", (function () {
                        ...
                        it("should return no installations item and misc section when no entries", (function () {
                                var entries = {};
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointLogic.entriesToItems(entries, extensionUri, undefined, undefined, undefined);
                        ...
                        it("should mark picked connection correctly", (function () {
                                ...
                                entries["/usr/bin/agda"] = agdaEntry;
                                entries["/usr/bin/als"] = alsEntry;
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointLogic.entriesToItems(entries, extensionUri, "/usr/bin/agda", undefined, undefined);
                        ...
                        it("should include download section when download item is provided", (function () {
                                ...
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointLogic.entriesToItems(entries, extensionUri, undefined, downloadItem, undefined);
        ...
        describe("EndpointManager Integration", (function () {
                describe("toItems", (function () {
                        it("should delegate to EndpointLogic.entriesToItems", (async function () {
                                ...
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointManager.toItems(manager, memento, undefined, undefined);
