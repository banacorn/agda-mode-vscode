        ...
        fsPath: "/test/path"
                ...
                it("onHide should properly destroy view", (function () {
                        ...
                        Curry._3(Assert.deepStrictEqual, events, [
                              "Handler.onHide called",
                              "View.destroy completed"
                            ], undefined);
                      }));
                it.only("onActivate should ???", (async function () {
                        var state = createTestState();
                        var events = [];
                        Chan$AgdaModeVscode.on(state.channels.log, (function (logEvent) {
                                if (logEvent.TAG !== "SwitchVersionUI") {
                        ...
                        return Curry._3(Assert.deepStrictEqual, events, ["QuickPick shown"], undefined);
                      }));
              }));
      }));
