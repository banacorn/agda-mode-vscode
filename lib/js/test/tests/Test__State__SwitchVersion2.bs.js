...
describe("State__SwitchVersion2", (function () {
        ...
        describe("SwitchVersionManager Integration", (function () {
                describe("getItemData", (function () {
                        it("should create item data with correct selection marking", (async function () {
                                ...
                                var itemData = await State__SwitchVersion2$AgdaModeVscode.SwitchVersionManager.getItemData(manager, undefined);
        ...
        document: { fileName: "test.agda" }
                ...
                it("onHide should properly destroy view", (function () {
                        ...
                        Chan$AgdaModeVscode.on(state.channels.log, (function (logEvent) {
                                ...
                                events.push(logEvent._0);
                              }));
                        var view = State__SwitchVersion2$AgdaModeVscode.View.make();
                        State__SwitchVersion2$AgdaModeVscode.Handler.onHide(state, view);
                ...
                it.only("onActivate should have an endpoint marked as selected", (async function () {
                        var state = createTestState();
                        var events = [];
                        await Memento$AgdaModeVscode.Module.PickedConnection.set(state.memento, "/usr/bin/agda");
                        await Memento$AgdaModeVscode.Module.Endpoints.setVersion(state.memento, "/usr/bin/agda", {
                              TAG: "Agda",
                              _0: "2.6.4"
                            });
                        Chan$AgdaModeVscode.on(state.channels.log, (function (logEvent) {
                ...
                it.only("should expose real-world selection problem: empty initial state", (async function () {
                        var state = createTestState();
                        var events = [];
                        await Memento$AgdaModeVscode.Module.PickedConnection.set(state.memento, "/usr/bin/agda");
                        Chan$AgdaModeVscode.on(state.channels.log, (function (logEvent) {
                        ...
                        await State__SwitchVersion2$AgdaModeVscode.Handler.onActivate(state, makeMockPlatform());
                        var hasSelectedEndpoint = events.some(function ($$event) {
                              if ($$event.TAG === "UpdateEndpoints") {
                                return $$event._0.some(function (param) {
                                            return param[3];
                                          });
                              } else {
                                return false;
