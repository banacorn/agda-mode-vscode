...
describe("State__SwitchVersion2", (function () {
        ...
        describe("SwitchVersionManager Integration", (function () {
              ...
              globalStorageUri: globalStorageUri
                                ...
                                var itemData = await State__SwitchVersion2$AgdaModeVscode.SwitchVersionManager.getItemData(manager, mockState, undefined);
        ...
        document: { fileName: "test.agda" }
                ...
                it.only("should have an endpoint marked as selected onActivation", (async function () {
                        var state = createTestState();
                        var loggedEvents = [];
                        Chan$AgdaModeVscode.on(state.channels.log, (function (logEvent) {
                                if (logEvent.TAG !== "SwitchVersionUI") {
                ...
                it.only("should prefer memento selection over active connection inference", (async function () {
                        var state = createTestState();
                        var loggedEvents = [];
                        Chan$AgdaModeVscode.on(state.channels.log, (function (logEvent) {
                                if (logEvent.TAG !== "SwitchVersionUI") {
