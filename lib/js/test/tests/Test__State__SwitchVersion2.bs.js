        ...
        describe("EndpointLogic", (function () {
                ...
                describe("entriesToItems", (function () {
                        ...
                        it("should return no installations item when no entries", (function () {
                                var entries = {};
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointLogic.entriesToItems(entries, extensionUri, undefined);
                                Curry._3(Assert.deepStrictEqual, items.length, 1, undefined);
                        ...
                        it("should mark picked connection correctly", (function () {
                                ...
                                entries["/usr/bin/agda"] = agdaEntry;
                                entries["/usr/bin/als"] = alsEntry;
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointLogic.entriesToItems(entries, extensionUri, "/usr/bin/agda");
        ...
        describe("EndpointManager Integration", (function () {
                describe("toItems", (function () {
                        it("should delegate to EndpointLogic.entriesToItems", (async function () {
                                ...
                                var items = State__SwitchVersion2$AgdaModeVscode.EndpointManager.toItems(manager, memento);
                                Curry._3(Assert.deepStrictEqual, items.length, 2, undefined);
                                var agdaItem = items.find(function (item) {
                                      var match = item.detail;
                                      if (match === "/usr/bin/agda") {
                                        return true;
