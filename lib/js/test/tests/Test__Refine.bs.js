...
describe("agda-mode.refine", (function () {
        ...
        describe("On GiveString 1 (Issue #158)", (function () {
                ...
                it("should result in the correct refinement", (async function () {
                        ...
                        var expected = await Test__Util$AgdaModeVscode.$$File.read(Test__Util$AgdaModeVscode.Path.asset(Test__Util$AgdaModeVscode.ExpectedFiles.getExpectedFilename(filename + ".GiveString1")));
        ...
        describe("On GiveString 2", (function () {
                ...
                it("should result in the correct refinement", (async function () {
                        ...
                        var expected = await Test__Util$AgdaModeVscode.$$File.read(Test__Util$AgdaModeVscode.Path.asset(Test__Util$AgdaModeVscode.ExpectedFiles.getExpectedFilename(filename + ".GiveString2")));
