...
describe("Input Method — deltas growth regression", (function () {
        var setup = {
          contents: undefined
        };
        before(async function () {
        ...
        it("deltas length should not grow across IM uses", (async function () {
                var setup$1 = acquire(setup);
                var imActivatePromise = waitMany(setup$1, 1);
                var stateResult = await Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]");
                var state;
                if (stateResult !== undefined) {
                  if (stateResult.TAG === "Ok") {
                    state = stateResult._0;
                  } else {
                    throw Js_exn.raiseError("Could not get State.t from activate command");
                  }
                } else {
                  throw Js_exn.raiseError("Could not get State.t from activate command");
                }
                await imActivatePromise;
                await insertChar(setup$1, "b");
                await insertChar(setup$1, "n");
                var l1 = Tokens$AgdaModeVscode.deltasLength(state.tokens);
                await activate(setup$1, undefined, undefined);
                await insertChar(setup$1, "b");
                await insertChar(setup$1, "n");
                var l2 = Tokens$AgdaModeVscode.deltasLength(state.tokens);
                await activate(setup$1, undefined, undefined);
                await insertChar(setup$1, "b");
                await insertChar(setup$1, "n");
                var l3 = Tokens$AgdaModeVscode.deltasLength(state.tokens);
                await activate(setup$1, undefined, undefined);
                await insertChar(setup$1, "b");
                await insertChar(setup$1, "n");
                var l4 = Tokens$AgdaModeVscode.deltasLength(state.tokens);
                await activate(setup$1, undefined, undefined);
                await insertChar(setup$1, "b");
                await insertChar(setup$1, "n");
                var l5 = Tokens$AgdaModeVscode.deltasLength(state.tokens);
