...
Mocha$BsMocha.describe("Input Method (Editor)")(undefined, undefined, undefined, (function (param) {
        ...
        Test__Util$AgdaModeVscode.Q.before(function (param) {
              var channels = Test__Util$AgdaModeVscode.Temp.activateExtension(undefined);
              return $$Promise.map(Test__Util$AgdaModeVscode.Temp.openFile(Test__Util$AgdaModeVscode.Path.asset("InputMethod.agda")), (function (editor) {
                            setup.contents = {
                              editor: editor,
                              channels: channels
                            };
        ...
        Mocha$BsMocha.describe("Insertion")(undefined, undefined, undefined, (function (param) {
                ...
                return Test__Util$AgdaModeVscode.Q.it("Issue #55, should not deactivate when size of candidate symbols > 1", (function (param) {
                              return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                            var $$document = setup.editor.document;
                                            var partial_arg = [/* Activate */2];
                                            var partial_arg$1 = [
