        ...
        describe("Connection", (function () {
                describe("Paths", (function () {
                        ...
                        it("`parseAgdaPaths` should be able to handle corrupted data (Issue #233)", (async function () {
                                ...
                                Curry._3(Assert.deepStrictEqual, Config$AgdaModeVscode.Connection.parseAgdaPaths("[\"/Users/banacorn/.local/bin/agda\", \"/Users/banacorn/Library/Application Support/Code/User/globalStorage/banacorn.agda-mode/latest-als/als\"]"), [
                                ...
                                return Curry._3(Assert.deepStrictEqual, Config$AgdaModeVscode.Connection.parseAgdaPaths("{\"enabled\": true}"), [], undefined);
                              }));
                      }));
              }));
      }));
