...
function testQueryIMUpdate(self, input, output, command, param) {
  ...
  if (result !== undefined) {
    ...
    return Assert$BsMocha.fail("shouldn't stop after \"" + (input + "\""));
  }
}

Mocha$BsMocha.describe_only("Input Method (Query)")(undefined, undefined, undefined, (function (param) {
        Mocha$BsMocha.describe_only("Insertion")(undefined, undefined, undefined, (function (param) {
        ...
        return Mocha$BsMocha.describe_only("Backspace")(undefined, undefined, undefined, (function (param) {
