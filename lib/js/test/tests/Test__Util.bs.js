...
async function $$case(self, cursor, payload) {
  ...
  self.state.middlewares.push(function (handler) {
        return async function (response) {
          if (typeof response === "object" && response.TAG === "MakeCase") {
  ...
  var destructor = Chan$AgdaModeVscode.on(self.state.channels.commandHandled, (function (command) {
          if (typeof command !== "object" && command === "Load" && sawMakeCase.contents) {
            return resolve();
          }
