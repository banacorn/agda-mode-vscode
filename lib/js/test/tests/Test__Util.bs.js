...
async function activateExtension(candidate) {
  ...
  await Memento$AgdaModeVscode.Module.PreferredCandidate.set(memento, candidate);
  var channels$1 = Main$AgdaModeVscode.activateWithoutContext(platformDeps, disposables, extensionUri, globalStorageUri, memento, undefined);
