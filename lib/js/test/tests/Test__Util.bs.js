...
async function versionGTE(command, expectedVersion) {
  ...
  if (match.TAG === "Agda") {
    ...
    return Util$AgdaModeVscode.Version.gte(match._3, expectedVersion);
  }
}
...
async function commandExists(command) {
  ...
  throw {
        RE_EXN_ID: "Failure",
        _1: Connection__Error$AgdaModeVscode.Construction.toString(errors._0),
        Error: new Error()
      };
}
...
async function destroy(target) {
  var path = Connection__URI$AgdaModeVscode.toString(Connection__Endpoint$AgdaModeVscode.toURI(target));
  try {
