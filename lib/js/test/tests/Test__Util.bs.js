...
function it(s, f) {
  return Promise$BsMocha.it(s)(undefined, undefined, undefined, (function (param) {
                return $$Promise.Js.toBsPromise($$Promise.map(Curry._1(f, undefined), (function (error) {
                                  if (error.tag) {
                                    return Assert$BsMocha.fail(error[0]);
                                  }
...
function it_only(s, f) {
  return Promise$BsMocha.it_only(s)(undefined, undefined, undefined, (function (param) {
                return $$Promise.Js.toBsPromise(Curry._1(f, undefined));
              }));
}
