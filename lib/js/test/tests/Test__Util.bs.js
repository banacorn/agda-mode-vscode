...
function equal(expected, actual) {
  return runner(function (param) {
              return Assert$BsMocha.equal(undefined, actual, expected);
            });
}

function deep_equal(expected, actual) {
  return runner(function (param) {
              return Assert$BsMocha.deep_equal(undefined, actual, expected);
            });
}

function deep_strict_equal(expected, actual) {
  return runner(function (param) {
              return Assert$BsMocha.deep_strict_equal(undefined, actual, expected);
            });
}

function fail(value) {
  return runner(function (param) {
              return Assert$BsMocha.fail(value);
            });
}
...
function load(self) {
  ...
  return $$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.load"), (function (result) {
                if (result !== undefined) {
                  if (result.TAG === /* Ok */0) {
                    var state = result._0;
                ...
                return runner(function (param) {
                            return Assert$BsMocha.fail(value$1);
                          });
              }));
}
...
function $$case(param) {
  var self = param[0];
  return $$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.case"), (function (result) {
                if (result !== undefined) {
                  if (result.TAG === /* Ok */0) {
                    return $$Promise.resolved({
                                TAG: 0,
