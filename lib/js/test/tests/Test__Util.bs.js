...
function activateExtension() {
  ...
  var disposables = [];
  var channels$1 = Main$AgdaModeVscode.activateWithoutContext(platformDeps, disposables, extensionPath, globalStorageUri, undefined);
...
async function makeAndLoad(filepath) {
  var rawFilepath = Nodepath.join(extensionPath, "test/tests/assets", filepath);
