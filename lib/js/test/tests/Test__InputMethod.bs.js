        ...
        Mocha$BsMocha.describe("Insertion")(undefined, undefined, undefined, (function (param) {
                Test__Util$AgdaModeVscode.Q.it("should translate \"lambda\" to \"λ\"", (function (param) {
                        return Belt_Option.mapWithDefault(env.contents, $$Promise.resolved(undefined), (function (param) {
                                      var emitter = param[1];
                                      var editor = param[0];
                                      return $$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.map($$Promise.map($$Promise.flatMap($$Promise.map($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                                                                return result;
                                                                                                                              })), (function (param) {
                ...
                return Test__Util$AgdaModeVscode.Q.it("should translate \"bn\" to \"𝕟\"", (function (param) {
                              return Belt_Option.mapWithDefault(env.contents, $$Promise.resolved(undefined), (function (param) {
                                            var emitter = param[1];
                                            var editor = param[0];
                                            return $$Promise.flatMap($$Promise.map($$Promise.map($$Promise.flatMap($$Promise.map($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                  return result;
                                                                                })), (function (param) {
                                                                              return insertChar(emitter, editor, undefined, "b");
                                                                            })), (function (param) {
        ...
        return Mocha$BsMocha.describe("Backspace")(undefined, undefined, undefined, (function (param) {
                      return Test__Util$AgdaModeVscode.Q.it("should work just fine", (function (param) {
                                    return Belt_Option.mapWithDefault(env.contents, $$Promise.resolved(undefined), (function (param) {
                                                  var emitter = param[1];
                                                  var editor = param[0];
                                                  return $$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                                                                                        return result;
                                                                                                                                                      })), (function (param) {
                                                                                                                                                    return insertChar(emitter, editor, undefined, "l");
                                                                                                                                                  })), (function (param) {
