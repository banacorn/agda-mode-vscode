...
function insertChar(setup, $$char) {
  ...
  var positions = Belt_Array.map(setup.editor.selections, (function (prim) {
          return prim.end;
        }));
...
function backspace(setup) {
  var promise = Curry._1(setup.emitter.once, undefined);
  var end_ = setup.editor.selection.end;
...
function activate(setup, positions, param) {
  var promise = Curry._1(setup.emitter.once, undefined);
  var positions$1 = Belt_Option.getWithDefault(positions, [setup.editor.selection.end]);
  setup.editor.selections = Belt_Array.map(positions$1, (function (point) {
