...
function acquire(setup) {
  ...
  if (setup$1 !== undefined) {
    ...
    return $$Promise.resolved(/* Error */Caml_chrome_debugger.variant("Error", 1, ["Cannot acquire the setup"]));
  }
}
...
function insertChar(setup, positions, $$char) {
  var promise = Curry._1(setup.emitter.once, undefined);
  if (positions !== undefined) {
    return $$Promise.flatMap(Editor$AgdaModeVscode.insertTexts(setup.editor, positions, $$char), (function (param) {
                  return promise;
                }));
  }
  var pos = Editor$AgdaModeVscode.getCursorPosition(setup.editor);
  return $$Promise.flatMap(Editor$AgdaModeVscode.insertText(setup.editor, pos, $$char), (function (param) {
                return promise;
              }));
}
...
function backspace(setup) {
  ...
  return $$Promise.flatMap(Editor$AgdaModeVscode.deleteText(setup.editor, range), (function (param) {
                return promise;
              }));
}
...
function activateInputhMethod2(setup) {
  return $$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                return result;
              }));
}
...
Mocha$BsMocha.describe("InputMethod")(undefined, undefined, undefined, (function (param) {
        var setup = {
          contents: undefined
        };
        ...
        Test__Util$AgdaModeVscode.Q.after_each((function (param) {
                return Belt_Option.mapWithDefault(setup.contents, $$Promise.resolved(undefined), cleanup);
              }));
        Mocha$BsMocha.describe("Insertion")(undefined, undefined, undefined, (function (param) {
                Test__Util$AgdaModeVscode.Q.it("should translate \"lambda\" to \"λ\"", (function (param) {
                        return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                      return $$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.map($$Promise.map($$Promise.flatMap($$Promise.map($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                                                                ...
                                                                                                                                return insertChar(setup, undefined, "l");
                                                                                                                              })), (function (param) {
                                                                                                                            return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                                                                          })), (function (param) {
                                                                                                                        return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "←");
                                                                                                                      })), (function (param) {
                                                                                                                    return insertChar(setup, undefined, "a");
                                                                                                                  })), (function (param) {
                                                                                                                return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                                                              })), (function (param) {
                                                                                                            return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "←a");
                                                                                                          })), (function (param) {
                                                                                                        return insertChar(setup, undefined, "m");
                                                                                                      })), (function (param) {
                                                                                                    return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                                                  })), (function (param) {
                                                                                                return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "←am");
                                                                                              })), (function (param) {
                                                                                            return insertChar(setup, undefined, "b");
                                                                                          })), (function (param) {
                                                                                        return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                                      })), (function (param) {
                                                                                    return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "←amb");
                                                                                  })), (function (param) {
                                                                                return insertChar(setup, undefined, "d");
                                                                              })), (function (param) {
                                                                            return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                          })), (function (param) {
                                                                        return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "←ambd");
                                                                      })), (function (param) {
                                                                    return insertChar(setup, undefined, "a");
                                                                  })), (function (param) {
                                                                return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                              })), (function (param) {
                                                            return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "λ");
                ...
                return Test__Util$AgdaModeVscode.Q.it("should translate \"bn\" to \"𝕟\"", (function (param) {
                              return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                            return $$Promise.map($$Promise.flatMap($$Promise.map($$Promise.map($$Promise.flatMap($$Promise.map($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                      return result;
                                                                                    })), (function (param) {
                                                                                  return insertChar(setup, undefined, "b");
                                                                                })), (function (param) {
                                                                          ...
                                                                          return insertChar(setup, undefined, "n");
                                                                        })), (function (param) {
                                                                      return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                    })), (function (param) {
                                                                  return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "𝕟");
                                                                })), deactivateInputhMethod), (function (x) {
                                                          return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [x]);
                                                        }));
                                          }));
        ...
        return Mocha$BsMocha.describe("Backspace")(undefined, undefined, undefined, (function (param) {
                      return Test__Util$AgdaModeVscode.Q.it("should work just fine", (function (param) {
                                    return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                                  return $$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.tap($$Promise.map($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                                                                                            return result;
                                                                                                                                                          })), (function (param) {
                                                                                                                                                        return insertChar(setup, undefined, "l");
                                                                                                                                                      })), (function (param) {
                                                                        ...
                                                                        return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(setup.editor), "lambd");
                                                                      })), deactivateInputhMethod), (function (x) {
                                                                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [x]);
                                                              }));
                                                }));
...
exports.activateInputhMethod2 = activateInputhMethod2;
