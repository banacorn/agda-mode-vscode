...
function deactivateInputhMethod(emitter, editor) {
  return insertChar(emitter, editor, " ");
}
...
Mocha$BsMocha.describe_only("InputMethod")(undefined, undefined, undefined, (function (param) {
        ...
        return Promise$BsMocha.it("should translate \"lambda\" to \"λ\"")(undefined, undefined, undefined, (function (param) {
                      return Belt_Option.mapWithDefault(prep.contents, $$Promise.Js.toBsPromise($$Promise.resolved(undefined)), (function (param) {
                                    var emitter = param[1];
                                    var editor = param[0];
                                    return $$Promise.Js.toBsPromise($$Promise.flatMap($$Promise.tap($$Promise.flatMap($$Promise.tap($$Promise.flatMap($$Promise.tap($$Promise.flatMap($$Promise.tap($$Promise.flatMap($$Promise.tap($$Promise.flatMap($$Promise.tap($$Promise.flatMap($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                                                                                                          return result;
                                                                                                        })), (function (param) {
