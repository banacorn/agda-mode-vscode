        ...
        return Promise$BsMocha.it("should should fail")(undefined, undefined, undefined, (function (param) {
                      ...
                      if (extension !== undefined) {
                        ...
                        tmp = $$Promise.flatMap(openTextEditor(Test__Util$AgdaModeVscode.Path.asset("InputMethod.agda")), (function (editor) {
                                return $$Promise.map($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap($$Promise.flatMap(extension$1.activate(), (function (param) {
                                                              return Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]");
                                                            })), (function (result) {
                                                          return result;
                                                        })), (function (param) {
