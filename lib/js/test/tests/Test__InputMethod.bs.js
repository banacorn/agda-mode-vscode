...
function activateInputhMethod(param) {
  return $$Promise.map($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.input-symbol[Activate]"), (function (result) {
                    return result;
                  })), (function (x) {
                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [x]);
              }));
...
function activateInputhMethod2(setup, points) {
  var promise = Curry._1(setup.emitter.once, undefined);
  Editor$AgdaModeVscode.setCursorPositions(setup.editor, points);
...
function deactivateInputhMethod(param) {
  return $$Promise.map($$Promise.flatMap(Vscode.commands.executeCommand("agda-mode.escape"), (function (result) {
                    return result;
                  })), (function (x) {
                return /* Ok */Caml_chrome_debugger.variant("Ok", 0, [x]);
              }));
...
Mocha$BsMocha.describe_only("InputMethod")(undefined, undefined, undefined, (function (param) {
        ...
        Mocha$BsMocha.describe("Insertion")(undefined, undefined, undefined, (function (param) {
                Test__Util$AgdaModeVscode.Q.it("should translate \"lambdabar\" to \"λ\"", (function (param) {
                        return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                      return $$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(activateInputhMethod(undefined), (function (param) {
                ...
                return Test__Util$AgdaModeVscode.Q.it("should translate \"bn\" to \"𝕟\"", (function (param) {
                              return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                            return $$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(activateInputhMethod(undefined), (function (param) {
                                                                              return insertChar(setup, "b");
                                                                            })), (function (param) {
                                                                          return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                        })), (function (param) {
        ...
        Mocha$BsMocha.describe("Backspace")(undefined, undefined, undefined, (function (param) {
                return Test__Util$AgdaModeVscode.Q.it("should work just fine", (function (param) {
                              return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                            return $$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(activateInputhMethod(undefined), (function (param) {
                                                                                                                                              return insertChar(setup, "l");
                                                                                                                                            })), (function (param) {
                                                                                                                                          return Test__Util$AgdaModeVscode.A.equal(/* Change */0, param);
                                                                                                                                        })), (function (param) {
        ...
        return Mocha$BsMocha.describe("Multiple cursors at once")(undefined, undefined, undefined, (function (param) {
                      ...
                      return Test__Util$AgdaModeVscode.Q.it("should work just fine", (function (param) {
                                    return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                                  return $$Promise.flatMapOk($$Promise.tapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMap(Editor$AgdaModeVscode.insertText(setup.editor, Editor$AgdaModeVscode.Point.make(0, 0), "\n\n\n"), (function (param) {
                                                                                        return activateInputhMethod2(setup, positions);
                                                                                      })), (function (param) {
                                                                    ...
                                                                    console.info(Editor$AgdaModeVscode.getText(setup.editor));
