...
function insertChar(setup, $$char) {
  var promise = Chan$AgdaModeVscode.once(setup.chan);
  var positions = Editor$AgdaModeVscode.Cursor.getMany(setup.editor);
  return $$Promise.flatMap(Editor$AgdaModeVscode.$$Text.batchInsert(setup.editor.document, positions, $$char), (function (succeed) {
                if (succeed) {
                  return $$Promise.map(promise, (function (x) {
                                return {
                                        TAG: 0,
                                        _0: x,
                                        [Symbol.for("name")]: "Ok"
...
function backspace(setup) {
  ...
  return $$Promise.flatMap(Editor$AgdaModeVscode.$$Text.$$delete(setup.editor.document, range), (function (succeed) {
                if (succeed) {
                  return $$Promise.map(promise, (function (x) {
                                return {
                                        TAG: 0,
...
function updated(output) {
  var tmp;
  tmp = typeof output === "number" ? (
      output === /* Activate */0 ? ({
            TAG: 1,
            _0: Js_exn.raiseError("Expecting UpdateView, got Activate"),
            [Symbol.for("name")]: "Error"
          }) : ({
            TAG: 1,
            _0: Js_exn.raiseError("Expecting UpdateView, got Deactivate"),
            [Symbol.for("name")]: "Error"
          })
    ) : (
      output.TAG ? ({
            TAG: 1,
            _0: Js_exn.raiseError("Expecting UpdateView, got Rewrite"),
            [Symbol.for("name")]: "Error"
          }) : ({
            TAG: 0,
            _0: undefined,
...
var IM = {
  Semaphore: IM$AgdaModeVscode.Semaphore,
                ...
                Test__Util$AgdaModeVscode.Q.it("should translate \"lambdabar\" to \"λ\"", (function (param) {
                        return $$Promise.flatMapOk(acquire(setup), (function (setup) {
                                      ...
                                      return $$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk($$Promise.flatMapOk(activate(setup, undefined, undefined), (function (param) {
                                                                                                                                                                return Test__Util$AgdaModeVscode.A.equal(/* Activate */0, param);
                                                                                                                                                              })), (function (param) {
                                                        ...
                                                        return Test__Util$AgdaModeVscode.A.equal(/* Deactivate */1, param);
                                                      })), (function (param) {
