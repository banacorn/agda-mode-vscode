...
function Impl(Editor) {
  var AgdaMode = States$AgdaModeVscode.Impl(Editor);
  ...
  Mocha$BsMocha.describe_only("Case split")(undefined, undefined, undefined, (function (param) {
          return Promise$BsMocha.it("should load the source")(undefined, undefined, undefined, (function (param) {
                        return $$Promise.Js.toBsPromise($$Promise.map(openTextEditor(source), (function (textEditor) {
                                          var context = {
                                            subscriptions: []
                                          };
                                          Curry._1(AgdaMode.activate, context);
                                          return $$Promise.get(Vscode.commands.executeCommand("agda-mode:load"), (function (param) {
