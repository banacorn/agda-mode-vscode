...
function Impl(Editor) {
  ...
  Mocha$BsMocha.describe("Handle__Goal.caseSplitAux")(undefined, undefined, undefined, (function (param) {
          return Promise$BsMocha.it("should calculate the infomation needed for case splitting correctly")(undefined, undefined, undefined, (function (param) {
                        return $$Promise.Js.toBsPromise($$Promise.map(Curry._1(Editor.openEditor, Curry._1(Test__Util.Path.asset, "CaseSplit.agda")), (function (editor) {
                                          ...
                                          return $$Promise.map($$Promise.map(Curry._2(Goal.makeMany, editor, [
                                                            ...
                                                            return Belt_Array.map(goals, (function (goal) {
                                                                          var match = Curry._2(GoalHandler.caseSplitAux, $$document, goal);
                                                                          var rewriteRange = Curry._2(Editor.$$Range.fromOffset, $$document, match[2]);
                                                                          return /* tuple */[
                                                                                  match[0],
                                                                                  match[1],
                                                                                  Curry._2(Editor.getTextInRange, $$document, rewriteRange)
                                                                                ];
                                                                        }));
                                                          })), (function (results) {
...
Mocha$BsMocha.describe("Handle__Goal.caseSplitAux")(undefined, undefined, undefined, (function (param) {
        return Promise$BsMocha.it("should calculate the infomation needed for case splitting correctly")(undefined, undefined, undefined, (function (param) {
                      return $$Promise.Js.toBsPromise($$Promise.map(SigImpl$AgdaModeVscode.openEditor(Curry._1(Test__Util.Path.asset, "CaseSplit.agda")), (function (editor) {
                                        var $$document = SigImpl$AgdaModeVscode.getDocument(editor);
                                        return $$Promise.map($$Promise.map(Curry._2(Goal.makeMany, editor, [
                                                            0,
                                                            1,
                                                            2,
                                                          ...
                                                          return Belt_Array.map(goals, (function (goal) {
                                                                        var match = Curry._2(GoalHandler.caseSplitAux, $$document, goal);
                                                                        var rewriteRange = SigImpl$AgdaModeVscode.$$Range.fromOffset($$document, match[2]);
                                                                        return /* tuple */[
                                                                                match[0],
                                                                                match[1],
                                                                                SigImpl$AgdaModeVscode.getTextInRange($$document, rewriteRange)
                                                                              ];
                                                                      }));
                                                        })), (function (results) {
                                                      return Assert$BsMocha.deep_equal(undefined, results, [
