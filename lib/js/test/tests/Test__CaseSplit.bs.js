...
describe("State__Goal.caseSplitAux dry run", (function () {
        it("should calculate the infomation needed for case splitting correctly", (async function () {
...
describe("agda-mode:case", (function () {
        ...
        before(function () {
              return Test__Util$AgdaModeVscode.readFile(Test__Util$AgdaModeVscode.Path.asset("CaseSplit.agda"), fileContent);
            });
        after(function () {
              return Test__Util$AgdaModeVscode.restoreFile(Test__Util$AgdaModeVscode.Path.asset("CaseSplit.agda"), fileContent);
            });
        it("should have more goals after splitting", (async function () {
                var ctx = await Test__Util$AgdaModeVscode.AgdaMode.make(undefined, "CaseSplit.agda");
                var state = await Test__Util$AgdaModeVscode.AgdaMode.load(ctx);
                var state$1 = await Test__Util$AgdaModeVscode.AgdaMode.$$case(ctx, [
                      new Vscode.Position(7, 16),
                      "x"
                    ], state);
                return Curry._3(Assert.deepEqual, state$1.goals.length, 10, undefined);
              }));
      }));
