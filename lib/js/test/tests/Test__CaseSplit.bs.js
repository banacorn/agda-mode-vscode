...
Mocha$BsMocha.describe("Case split")(undefined, undefined, undefined, (function (param) {
        return Promise$BsMocha.it("without indentation")(undefined, undefined, undefined, (function (param) {
                      ...
                      return $$Promise.Js.toBsPromise($$Promise.flatMap(makeTextEditor("\n_+_ : ℕ → ℕ → ℕ\nx + y = {!   !}\n"), (function (editor) {
                                        var dispatcher = Curry._3(Dispatcher.make, Test__Util$AgdaModeVscode.Path.extensionPath(undefined), editor, (function (param) {
                                                
                                              }));
                                        return $$Promise.flatMap(Curry._2(Goal.makeMany, editor, [0]), (function (goals) {
                                                      ...
                                                      if (goal !== undefined) {
                                                        ...
                                                        return $$Promise.map(Curry._2(Dispatcher.addToTheBackCritical, dispatcher, tasks), (function (param) {
                                                                      return Assert$BsMocha.equal(undefined, Editor$AgdaModeVscode.getText(editor), "\n_+_ : ℕ → ℕ → ℕ\nZ + y = ?\nS x + y = ?\n");
                                                                    }));
                                                      }
                                                      Assert$BsMocha.fail("failed to instantiate any goals");
