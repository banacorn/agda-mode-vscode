...
Mocha$BsMocha.describe("Integration test")(undefined, undefined, undefined, (function (param) {
        var context = Test__Util$AgdaModeVscode.Agda.make(undefined, "CaseSplit.agda");
        return Test__Util$AgdaModeVscode.Q.it("should calculate the infomation needed for case splitting correctly", (function (param) {
                      return $$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMap(context, Test__Util$AgdaModeVscode.Agda.load), Test__Util$AgdaModeVscode.Agda.$$case), (function (param) {
                                    var state = param[1];
