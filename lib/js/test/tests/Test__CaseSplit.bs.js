...
Mocha$BsMocha.describe_only("Handle__Goal.caseSplitAux")(undefined, undefined, undefined, (function (param) {
        return Promise$BsMocha.it("should calculate the infomation needed for case splitting correctly")(undefined, undefined, undefined, (function (param) {
                      return $$Promise.Js.toBsPromise($$Promise.flatMap(openTextEditor(Test__Util$AgdaModeVscode.Path.asset("CaseSplit.agda")), (function (editor) {
                                        return $$Promise.map($$Promise.map(Curry._2(Goal.makeMany, editor, [
                                                          ...
                                                          return Belt_Array.map(goals, Curry._1(GoalHandler.caseSplitAux, editor));
                                                        })), (function (results) {
