...
Mocha$BsMocha.describe_skip("Integration test")(undefined, undefined, undefined, (function (param) {
        ...
        return Test__Util$AgdaModeVscode.Q.it("should have more goals after splitting", (function (param) {
                      var partial_arg = [
                      ...
                      return $$Promise.mapOk($$Promise.flatMapOk($$Promise.flatMap(context, Test__Util$AgdaModeVscode.Agda.load), (function (param) {
                                    ...
                                    return Assert$BsMocha.deep_equal(undefined, param[1].goals.length, 10);
                                  }));
                    }));
      }));
