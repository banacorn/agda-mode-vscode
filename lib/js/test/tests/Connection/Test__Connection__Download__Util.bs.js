...
describe("Connection__Download__Util", (function () {
        ...
        describe("asJson (integration)", (function () {
                it("should successfully parse valid JSON response", (async function () {
                        ...
                        var result = await Connection__Download__Util$AgdaModeVscode.asJson(testOptions);
                        if (result.TAG === "Ok") {
                          Assert.ok(typeof result._0 === "object");
                          return ;
                        }
                        console.warn("Network test failed (this may be expected): " + Connection__Download__Util$AgdaModeVscode.$$Error.toString(result._0));
                        Assert.ok(true);
                      }));
                it("should handle invalid JSON gracefully", (async function () {
                        ...
                        var error = result._0;
                        if (typeof error === "object" && error.TAG === "JsonParseError") {
                          Assert.ok(true);
                          return ;
                        }
        ...
        describe("asFile (integration)", (function () {
                it("should successfully download and save small file", (async function () {
                        ...
                        var result = await Connection__Download__Util$AgdaModeVscode.asFile(smallHttpOptions, destUri, onDownload);
                        if (result.TAG === "Ok") {
