...
describe("Memento.PickedConnection", (function () {
        ...
        var platform_getInstalledEndpoints = Desktop$AgdaModeVscode.Desktop.getInstalledEndpoints;
        ...
        var platform = {
          ...
          getInstalledEndpoints: platform_getInstalledEndpoints,
        ...
        var makeConnection = async function (previouslySelectedPath, configPaths) {
          ...
          return await Connection$AgdaModeVscode.make(platform, memento, Vscode.Uri.file("/tmp/test"), configPaths, ["whatever"], logChannel);
        };
        ...
        describe("Memento always updated", (function () {
                it("should set memento to working connection path from config", (async function () {
                        ...
                        var result = await Connection$AgdaModeVscode.make(platform, memento, Vscode.Uri.file("/tmp/test"), [userAgda.contents], ["whatever"], logChannel);
                        if (result.TAG === "Ok") {
                          var actualPath = Connection$AgdaModeVscode.getPath(result._0);
                ...
                it("should set memento to working connection path from auto discovery", (async function () {
                        ...
                        var result = await Connection$AgdaModeVscode.make(platform, memento, Vscode.Uri.file("/tmp/test"), [], ["whatever"], logChannel);
                        if (result.TAG === "Ok") {
                          var actualPath = Connection$AgdaModeVscode.getPath(result._0);
                          var mementoPath = Memento$AgdaModeVscode.Module.PickedConnection.get(memento);
