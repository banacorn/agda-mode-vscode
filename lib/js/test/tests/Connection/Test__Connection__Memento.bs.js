...
describe("Memento.PreferredCandidate", (function () {
        ...
        var makeConnection = async function (previouslySelectedPath, configPaths) {
          ...
          return await Connection$AgdaModeVscode.makeWithFallback(platform, memento, Vscode.Uri.file("/tmp/test"), configPaths, logChannel);
        };
        ...
        describe("Memento update behavior", (function () {
                it("should not set memento to working connection path from config", (async function () {
                        ...
                        var result = await Connection$AgdaModeVscode.makeWithFallback(platform, memento, Vscode.Uri.file("/tmp/test"), [userAgda.contents], logChannel);
                        if (result.TAG === "Ok") {
                          var actualPath = Connection$AgdaModeVscode.getPath(result._0);
