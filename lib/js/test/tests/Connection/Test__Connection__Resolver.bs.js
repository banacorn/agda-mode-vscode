...
describe("Path Searching", (function () {
        ...
        describe("`Source.search` with `FromTCP`", (function () {
                ...
                it("for TCP server that exists", (async function () {
                        var err = await Connection__Resolver$AgdaModeVscode.search({
                              TAG: "FromTCP",
                              _0: new Nodeurl.URL("lsp://localhost:23456"),
                        ...
                        var url = match._0;
                        Curry._3(Assert.deepEqual, url.port, 23456, undefined);
                        Curry._3(Assert.deepEqual, url.hostname, "localhost", undefined);
                        return Curry._3(Assert.deepEqual, match._1, {
                                    TAG: "FromTCP",
                                    _0: new Nodeurl.URL("lsp://localhost:23456"),
                                    [Symbol.for("name")]: "FromTCP"
                                  }, undefined);
                ...
                it("for local TCP server that doesn't exist", (async function () {
                        var match = await Connection__Resolver$AgdaModeVscode.search({
                              TAG: "FromTCP",
                              _0: new Nodeurl.URL("lsp://localhost:23457"),
                              [Symbol.for("name")]: "FromTCP"
                            }, 5000);
                        if (match.TAG === "Ok") {
                        ...
                        if (match$1.TAG === "TCP") {
                          var url = match$1._0;
                          Curry._3(Assert.deepEqual, url.port, 23457, undefined);
                          Curry._3(Assert.deepEqual, url.hostname, "localhost", undefined);
                          return Curry._3(Assert.deepEqual, Connection__Resolver__TCP$AgdaModeVscode.$$Error.toString(match$1._1), "AggregateError", undefined);
                        }
                        throw {
                              RE_EXN_ID: "Failure",
                ...
                it("for remote TCP server that doesn't exist", (async function () {
                        var match = await Connection__Resolver$AgdaModeVscode.search({
                              TAG: "FromTCP",
                              _0: new Nodeurl.URL("lsp://remotehost:23458"),
                              [Symbol.for("name")]: "FromTCP"
                            }, 5000);
                        if (match.TAG === "Ok") {
                          return Js_exn.raiseError("Expecting Error");
                        ...
                        var match$1 = match._0;
                        if (match$1.TAG === "TCP") {
                          var error = match$1._1;
                          var url = match$1._0;
                          Curry._3(Assert.deepEqual, url.port, 23458, undefined);
                          Curry._3(Assert.deepEqual, url.hostname, "remotehost", undefined);
