...
describe("Config.Connection paths", (function () {
        ...
        before(async function () {
              ...
              downloadedALS.contents = await Test__Util$AgdaModeVscode.Endpoint.ALS.mock("1.3.1", "2.6.3", "als-makeWithRawPath-mock");
            });
        ...
        var platformWithDiscovery_getFetchSpec = Desktop$AgdaModeVscode.Desktop.getFetchSpec;
        ...
        var platformWithDiscovery = {
          ...
          getFetchSpec: platformWithDiscovery_getFetchSpec,
        ...
        var platformNoDiscovery_getFetchSpec = Desktop$AgdaModeVscode.Desktop.getFetchSpec;
        ...
        var downloadLatestALS = function (_logChannel, _memento, _globalStorageUri) {
          return function (_platform) {
            return Promise.resolve({
                        TAG: "Ok",
                        _0: downloadedALS.contents
                      });
          };
        };
        var platformWithMockDownload_getFetchSpec = Desktop$AgdaModeVscode.Desktop.getFetchSpec;
        var platformWithMockDownload_askUserAboutDownloadPolicy = Desktop$AgdaModeVscode.Desktop.askUserAboutDownloadPolicy;
        var platformWithMockDownload_openFolder = Desktop$AgdaModeVscode.Desktop.openFolder;
        var platformWithMockDownload = {
          determinePlatform: determinePlatform,
          findCommand: findCommand$2,
          alreadyDownloaded: alreadyDownloaded,
          downloadLatestALS: downloadLatestALS,
          getFetchSpec: platformWithMockDownload_getFetchSpec,
          askUserAboutDownloadPolicy: platformWithMockDownload_askUserAboutDownloadPolicy,
          openFolder: platformWithMockDownload_openFolder
        };
        ...
        document: { fileName: "test.agda" }
                ...
                var simulateUISelection = async function (initialConfig, selectedPath, description) {
                ...
                var simulateDownloadAction = async function (initialConfig, isAlreadyDownloaded) {
                  await Config$AgdaModeVscode.Connection.setAgdaPaths(logChannel, initialConfig);
                  var listener = Log$AgdaModeVscode.collect(logChannel);
                  var mockState = createTestState();
                  ...
                  State__SwitchVersion$AgdaModeVscode.Handler.onSelection(mockState, platformWithMockDownload, manager, (function (_downloadInfo) {
                          return Promise.resolve();
                        }), view, [mockSelectedItem]);
                  await onOperationComplete;
                  State__SwitchVersion$AgdaModeVscode.View.destroy(view);
                ...
                var simulateOpenFolderAction = async function (initialConfig) {
                  ...
                  State__SwitchVersion$AgdaModeVscode.Handler.onSelection(mockState, Mock$AgdaModeVscode.Platform.makeBasic(), manager, (function (_downloadInfo) {
                          return Promise.resolve();
                        }), view, [{
                ...
                describe("Switch version UI selection", (function () {
                        it("should add path to config when user selects existing path not in config", (async function () {
                                ...
                                var match = await simulateUISelection(initialConfig, selectedPath, "");
                        ...
                        it("should not modify config when user selects path already in config", (async function () {
                                ...
                                var match = await simulateUISelection(initialConfig, selectedPath, "Selected");
                                Curry._3(Assert.deepStrictEqual, match[0], [], undefined);
                ...
                describe("Download action selection", (function () {
                        ...
                        it("should show already downloaded message when user selects already downloaded ALS", (async function () {
                                var initialConfig = [userAgda.contents];
