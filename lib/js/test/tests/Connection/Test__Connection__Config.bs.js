...
describe("Config.Connection paths", (function () {
        ...
        describe("Default value (spec L17)", (function () {
        ...
        describe("Duplicate candidates (spec L15)", (function () {
                ...
                it("setAgdaPaths should deduplicate paths (spec L15)", (async function () {
