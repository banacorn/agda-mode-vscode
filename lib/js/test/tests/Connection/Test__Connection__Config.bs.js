...
describe("Config.Connection paths", (function () {
        ...
        document: { fileName: "test.agda" }
                ...
                var simulatePathSelection = async function (initialConfig, selectedPath) {
                  ...
                  var pickedConnection = Memento$AgdaModeVscode.Module.PickedConnection.get(mockState.memento);
                  return [
                          logs,
                          finalConfig,
                          pickedConnection
                ...
                describe("Switch version UI selection", (function () {
                        it("should update PickedConnection without modifying config when user selects existing path not in config", (async function () {
                                this.retries(2);
                        ...
                        it("should update PickedConnection without modifying config when user selects path already in config", (async function () {
                                var initialConfig = [
                                  userAgda.contents,
                                  alternativeAgda.contents
                                ];
                        ...
                        it("should update PickedConnection when user selects different path", (async function () {
                                var initialConfig = [userAgda.contents];
                                var selectedPath = alternativeAgda.contents;
                                var match = await simulatePathSelection(initialConfig, selectedPath);
                                Curry._3(Assert.deepStrictEqual, match[0], [], undefined);
                        ...
                        it("should preserve bare agda command in PickedConnection without modifying config", (async function () {
                        ...
                        it("should preserve bare als command in PickedConnection without modifying config", (async function () {
