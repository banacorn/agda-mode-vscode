...
describe("Config.Connection paths", (function () {
        ...
        var platformWithDiscovery_getInstalledEndpoints = Desktop$AgdaModeVscode.Desktop.getInstalledEndpoints;
        ...
        var platformWithDiscovery = {
          ...
          getInstalledEndpoints: platformWithDiscovery_getInstalledEndpoints,
        ...
        var platformNoDiscovery_getInstalledEndpoints = Desktop$AgdaModeVscode.Desktop.getInstalledEndpoints;
        ...
        var platformNoDiscovery = {
          ...
          getInstalledEndpoints: platformNoDiscovery_getInstalledEndpoints,
        ...
        var getInstalledEndpoints = function (_globalStorageUri) {
          return Promise.resolve({});
        };
        ...
        document: { fileName: "test.agda" }
                ...
                describe("Non-endpoint selections", (function () {
                        it.skip("should not modify config when user selects open folder action", (async function () {
                                var initialConfig = [userAgda.contents];
