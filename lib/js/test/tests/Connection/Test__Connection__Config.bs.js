...
describe("Config.Connection paths", (function () {
        ...
        describe("Bare command in config paths", (function () {
                it("should resolve bare command 'agda' in connection.paths via PATH lookup", (async function () {
                        var result = await Connection$AgdaModeVscode.fromPaths(platformWithDiscovery, [[
                                "agda",
                                "FromConfig"
                              ]]);
                        if (result.TAG === "Ok") {
