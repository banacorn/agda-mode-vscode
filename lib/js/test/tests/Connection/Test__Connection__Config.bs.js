...
describe("Config.Connection paths", (function () {
        ...
        document: { fileName: "test.agda" }
                ...
                var simulateDownloadAction = async function (initialConfig, isAlreadyDownloadedOpt) {
                  ...
                  var mockSelectedItem_label = State__SwitchVersion$AgdaModeVscode.Constants.downloadNativeALS;
                  var mockSelectedItem = {
                    description: mockSelectedItem_description,
                    detail: mockSelectedItem_detail,
                    label: mockSelectedItem_label
                  };
                ...
                describe("Switch version UI selection", (function () {
                        ...
                        it("should preserve bare agda command in PickedConnection without modifying config", (async function () {
                                ...
                                var match = await simulatePathSelection(initialConfig, "agda", "Selected");
                                Curry._3(Assert.deepStrictEqual, match[0], [], undefined);
                                Curry._3(Assert.deepStrictEqual, match[1], initialConfig, undefined);
                        ...
                        it("should preserve bare als command in PickedConnection without modifying config", (async function () {
                                ...
                                var match = await simulatePathSelection(initialConfig, "als", "Selected");
                                Curry._3(Assert.deepStrictEqual, match[0], [], undefined);
                                Curry._3(Assert.deepStrictEqual, match[1], initialConfig, undefined);
                ...
                describe("Download action selection", (function () {
                        it("should add downloaded path to config when user downloads new ALS", (async function () {
                                ...
                                return Curry._3(Assert.deepStrictEqual, match[2], downloadedALS.contents, undefined);
                              }));
