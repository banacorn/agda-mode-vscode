...
describe("Config.Connection paths", (function () {
        ...
        document: { fileName: "test.agda" }
                  ...
                  return State$AgdaModeVscode.make(platformWithDiscovery, channels, mockStorageUri, mockExtensionUri, Memento$AgdaModeVscode.make(undefined), mockEditor, undefined);
                };
