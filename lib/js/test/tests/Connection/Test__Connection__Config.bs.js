                ...
                var executeUITest = async function (mockState, platform, mockSelectedItem) {
                  ...
                  Connection__UI__Handlers$AgdaModeVscode.onSelection(mockState, platform, {
                        contents: "DevALS"
                          ...
                          return Connection__Switch$AgdaModeVscode.Download.getAllAvailableDownloads(mockState, platform, channel);
                        }), undefined, undefined);
                ...
                var simulateEmptySelection = async function (initialConfig) {
                  ...
                  Connection__UI__Handlers$AgdaModeVscode.onSelection(mockState, platformWithDiscovery, {
                        contents: "DevALS"
                          ...
                          return Connection__Switch$AgdaModeVscode.Download.getAllAvailableDownloads(mockState, platformWithDiscovery, channel);
                        }), undefined, undefined);
                  await onOperationComplete;
