...
describe.only("Connection DevALS", (function () {
        this.timeout(10000);
        describe("makeAgdaLanguageServerRepo", (function () {
                it("should create repo config targeting banacorn/agda-language-server", (function () {
                        ...
                        var repo = Connection__DevALS$AgdaModeVscode.makeAgdaLanguageServerRepo(mockMemento, mockGlobalStorageUri);
        ...
        describe("getALSReleaseManifest integration", (function () {
                it("should fetch ALS release manifest from GitHub API", (async function () {
                        ...
                        var releaseResult = await Connection__DevALS$AgdaModeVscode.getALSReleaseManifest(memento, globalStorageUri);
        ...
        describe("getFetchSpec integration", (function () {
                it("should fetch dev release spec from GitHub API", (async function () {
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var globalStorageUri = Vscode.Uri.file("/tmp/test-dev-als");
                        var result = await Connection__DevALS$AgdaModeVscode.getFetchSpec(memento, globalStorageUri, "Ubuntu");
                        if (result.TAG === "Ok") {
                          var fetchSpec = result._0;
                          logFetchSpec(fetchSpec);
                          Curry._3(Assert.deepStrictEqual, fetchSpec.release.tag_name, "dev", undefined);
                          Curry._3(Assert.deepStrictEqual, fetchSpec.saveAsFileName, "dev-als", undefined);
                          Assert.ok(fetchSpec.asset.name.includes("als-dev-Agda"));
                          return ;
                        }
                        var error = result._0;
                        logError(error);
                        Assert.fail("Expected success but got error: " + Connection__Download$AgdaModeVscode.$$Error.toString(error));
                      }));
              }));
      }));
...
exports.logReleases = logReleases;
exports.logAssets = logAssets;
exports.logFetchSpec = logFetchSpec;
