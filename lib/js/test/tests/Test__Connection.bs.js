...
describe("Connection", (function () {
        ...
        describe("Connection contract coverage", (function () {
                ...
                it("should update both connection.paths and PickedConnection after successful download", (async function () {
                        var logChannel = Chan$AgdaModeVscode.make();
                        ...
                        if (result.TAG === "Ok") {
                          ...
                          return Curry._3(Assert.deepStrictEqual, Memento$AgdaModeVscode.Module.PickedConnection.get(memento), downloadedAgda.contents, undefined);
                        }
