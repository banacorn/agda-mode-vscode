...
describe("Connection", (function () {
        ...
        describe("Target", (function () {
                ...
                before(async function () {
                      ...
                      var errorMessage = Connection__Target$AgdaModeVscode.$$Error.toString(target._0);
                ...
                after(async function () {
                      var target = agdaMockTarget.contents;
                      if (target !== undefined) {
                        await Test__Util$AgdaModeVscode.Target.Agda.destroy(target);
        ...
        describe("checkForPrebuiltDataDirectory", (function () {
                it("should return asset path when data directory exists", (async function () {
                        ...
                        var result = await Connection__Target$AgdaModeVscode.checkForPrebuiltDataDirectory(execPath);
