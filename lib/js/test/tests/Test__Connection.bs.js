...
describe("Connection", (function () {
        ...
        describe("`makeWithRawPath`", (function () {
                ...
                it("should handle error construction correctly for endpoint errors", (async function () {
                        ...
                        Curry._3(Assert.deepStrictEqual, Object.entries(errors.endpoints).length, 1, undefined);
                        ...
                        var match = errors.endpoints[invalidPath];
                        if (match !== undefined) {
        ...
        describe("`fromPaths`", (function () {
                ...
                it("should return Construction error when all paths are invalid", (async function () {
                        ...
                        var errors = result._0;
                        var endpointErrors = Object.entries(errors.endpoints);
