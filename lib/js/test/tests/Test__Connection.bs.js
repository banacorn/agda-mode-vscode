...
describe("Connection", (function () {
        ...
        describe("Connection contract coverage", (function () {
                ...
                it("download(FromGitHub) and downloadFromURL should return consistent WASM paths", (async function () {
                        ...
                        var fromURLResult = await Connection__Download$AgdaModeVscode.downloadFromURL(globalStorageUri, "https://example.com/als.wasm", "hardcoded-als", "test", undefined, undefined);
                        var fromGitHubPath;
