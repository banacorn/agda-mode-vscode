...
describe("Connection", (function () {
        ...
        describe("`fromDownloads`", (function () {
                ...
                it("should retry Hardcoded download with WASM source when native download fails", (async function () {
                        await Config$AgdaModeVscode.Connection.DownloadPolicy.set("Undecided");
                        var nativeUrl = "https://example.test/hardcoded-native.zip";
                        var attemptedUrls = {
                          contents: []
                        };
                        var resolveCount = {
                        ...
                        var resolveDownloadChannel = function (_channel, _useCache) {
                          return async function (_memento, _globalStorageUri, _platform) {
                            resolveCount.contents = resolveCount.contents + 1 | 0;
                            return {
                                    TAG: "Ok",
                                    _0: {
                                      TAG: "FromURL",
                        ...
                        var download = function (_globalStorageUri, source) {
                          ...
                          switch (source._0) {
                            ...
                            case "Hardcoded" :
                                var url = source._1;
                                attemptedUrls.contents = Belt_Array.concatMany([
                                      attemptedUrls.contents,
                                      [url]
                                    ]);
                                if (url === nativeUrl || url !== Connection__Hardcoded$AgdaModeVscode.wasmUrl) {
                                  return Promise.resolve({
                                              TAG: "Error",
                                              _0: "CannotFindCompatibleALSRelease"
                                            });
                        ...
                        Curry._3(Assert.deepStrictEqual, resolveCount.contents, 1, undefined);
                        return Curry._3(Assert.deepStrictEqual, attemptedUrls.contents, [
                                    nativeUrl,
                                    Connection__Hardcoded$AgdaModeVscode.wasmUrl
                                  ], undefined);
                      }));
              }));
