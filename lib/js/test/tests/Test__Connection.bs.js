...
describe("Connection", (function () {
        ...
        describe("`fromDownloads`", (function () {
                ...
                it("should check if the latest ALS is already downloaded when the download policy is `Yes`", (async function () {
                        ...
                        var paths = Config$AgdaModeVscode.Connection.getAgdaPaths2();
                        Assert.ok(paths.includes(mockEndpoint._1));
                      }));
                it("should proceed to download the latest ALS when the download policy is `Yes` and the cached latest ALS is not found", (async function () {
                        var endpoint = agdaMockEndpoint.contents;
                        var mockEndpoint = endpoint !== undefined ? endpoint : PervasivesU.failwith("Unable to access the Agda mock endpoint");
                        var mockPath = Connection__URI$AgdaModeVscode.toString(Connection__Endpoint$AgdaModeVscode.toURI(mockEndpoint));
                        await Config$AgdaModeVscode.Connection.DownloadPolicy.set("Undecided");
                        var checkedCache = {
                          contents: false
                        };
                        ...
                        var mockPlatformDeps = Mock$AgdaModeVscode.Platform.makeWithSuccessfulDownload2AndFlags(mockPath, checkedCache, checkedDownload);
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var globalStorageUri = Vscode.Uri.file("/tmp/test-storage");
                        var result = await Connection$AgdaModeVscode.fromDownloads(mockPlatformDeps, memento, globalStorageUri, constructionError);
                        Curry._3(Assert.deepStrictEqual, checkedCache.contents, true, undefined);
        ...
        describe("`fromPathsAndCommands`", (function () {
                ...
                before(async function () {
                      try {
                        var path = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.7.0.1", "agda-mock-3");
                        var target = await Connection__Endpoint$AgdaModeVscode.fromRawPath(path);
                        if (target.TAG === "Ok") {
                          agdaMockEndpoint.contents = target._0;
                          return ;
                ...
                it("should find commands when no paths are given", (async function () {
                        ...
                        var platformDeps = Desktop$AgdaModeVscode.make();
                        var expectedConnection = await getAgdaTarget();
                        var result = await Connection$AgdaModeVscode.fromPathsAndCommands(platformDeps, memento, paths, commands);
                        if (result.TAG === "Ok") {
                          var connection = result._0;
                          if (connection.TAG === "Agda") {
                            if (expectedConnection.TAG === "Agda") {
                              Curry._3(Assert.deepStrictEqual, connection._2, expectedConnection._0, undefined);
                              return Curry._3(Assert.deepStrictEqual, connection._1, expectedConnection._1, undefined);
                            }
                            Assert.fail("Connection type mismatch with expected connection");
                            return ;
                          }
                          if (expectedConnection.TAG === "Agda") {
                            Assert.fail("Connection type mismatch with expected connection");
                          ...
                          var match = expectedConnection._2;
                          if (match.TAG === "ViaPipe") {
                            Curry._3(Assert.deepStrictEqual, connection._2, expectedConnection._0, undefined);
                            Curry._3(Assert.deepStrictEqual, connection._3, expectedConnection._1, undefined);
                            return Curry._3(Assert.deepStrictEqual, connection._1, match._0, undefined);
                          }
                          Assert.fail("Connection type mismatch with expected connection");
                          return ;
                        }
                ...
                it("should find the connection with its path given", (async function () {
                        var endpoint = agdaMockEndpoint.contents;
                        var mockEndpoint = endpoint !== undefined ? endpoint : PervasivesU.failwith("Unable to access the Agda mock endpoint");
                        var mockURI = Connection__Endpoint$AgdaModeVscode.toURI(mockEndpoint);
                        var mockPath = Connection__URI$AgdaModeVscode.toString(mockURI);
                        var mockFsPath;
                        mockFsPath = mockURI.TAG === "FileURI" ? mockURI._1.fsPath : PervasivesU.failwith("Expected FileURI for mock");
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var paths = [
                          mockPath,
                          "some/other/paths"
                        ...
                        if (result.TAG === "Ok") {
                          var connection = result._0;
                          if (connection.TAG === "Agda") {
                            Curry._3(Assert.deepStrictEqual, connection._1, mockFsPath, undefined);
                            return Curry._3(Assert.deepStrictEqual, connection._2, "2.7.0.1", undefined);
                          }
                          Assert.fail("Expected Agda connection");
                          return ;
                        }
                        Assert.fail("Expected connection to mock path");
                      }));
                it("should prioritize memento picked path over other paths", (async function () {
                        var endpoint = agdaMockEndpoint.contents;
                        var mockEndpoint = endpoint !== undefined ? endpoint : PervasivesU.failwith("Unable to access the Agda mock endpoint");
                        var mockURI = Connection__Endpoint$AgdaModeVscode.toURI(mockEndpoint);
                        var mockPath = Connection__URI$AgdaModeVscode.toString(mockURI);
                        ...
                        mockFsPath = mockURI.TAG === "FileURI" ? mockURI._1.fsPath : PervasivesU.failwith("Expected FileURI for mock");
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        await Memento$AgdaModeVscode.Module.PickedConnection.set(memento, mockFsPath);
                        var paths = [
                          "some/other/path",
                          mockPath
                        ];
                        ...
                        Assert.fail("Expected connection to picked path");
                      }));
                it("should return error when no valid paths or commands found", (async function () {
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var paths = ["non/existent/path"];
                        var commands = ["non-existent-command"];
                        var platformDeps = Desktop$AgdaModeVscode.make();
                        var result = await Connection$AgdaModeVscode.fromPathsAndCommands(platformDeps, memento, paths, commands);
                        if (result.TAG === "Ok") {
                          Assert.fail("Expected error when no valid paths or commands");
                          return ;
                        }
                        var constructionError = result._0;
                        var endpointErrors = Object.entries(constructionError.endpoints);
                        Curry._3(Assert.deepStrictEqual, endpointErrors.length, 1, undefined);
                        var match = endpointErrors[0];
                        if (match !== undefined) {
                          Curry._3(Assert.deepStrictEqual, match[0], "non/existent/path", undefined);
                        } else {
                          Assert.fail("Expected endpoint error");
                        }
                        var commandErrors = Object.entries(constructionError.commands);
                        Curry._3(Assert.deepStrictEqual, commandErrors.length, 1, undefined);
                        var match$1 = commandErrors[0];
                        if (match$1 !== undefined) {
                          return Curry._3(Assert.deepStrictEqual, match$1[0], "non-existent-command", undefined);
                        } else {
                          Assert.fail("Expected command error");
                          return ;
                        }
                      }));
              }));
        ...
        describe("make fromDownloads scenarios", (function () {
                ...
                it("should handle cached ALS download with logging", (async function () {
                        ...
                        var target = await Connection__Endpoint$AgdaModeVscode.fromRawPath(agdaMockPath);
                        var mockEndpoint;
                        mockEndpoint = target.TAG === "Ok" ? target._0 : PervasivesU.failwith("Expected valid endpoint from mock");
                        await Config$AgdaModeVscode.Connection.DownloadPolicy.set("Undecided");
                        var checkedCache = {
                          contents: false
                        };
                ...
                it("should handle fresh ALS download with logging", (async function () {
                        ...
                        var mockPlatformDeps = Mock$AgdaModeVscode.Platform.makeWithSuccessfulDownloadAndFlags(mockEndpoint, checkedCache, checkedDownload);
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var globalStorageUri = Vscode.Uri.file("/tmp/test-storage");
                        var connection = await Connection$AgdaModeVscode.make(mockPlatformDeps, memento, globalStorageUri, ["/invalid/path"], ["invalid-command"], logChannel);
                        if (connection.TAG === "Ok") {
