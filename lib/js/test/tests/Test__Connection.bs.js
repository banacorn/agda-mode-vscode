...
describe("Connection", (function () {
        ...
        describe("make", (function () {
                ...
                describe("No local installation", (function () {
                        ...
                        it("should throw the `NoDownloadALS` error when the download policy is `No`", (async function () {
                                var getDownloadPolicy = async function () {
                                  return "No";
                                };
                                var downloadLatestALS = async function (param) {
                        ...
                        it("should throw the `DownloadALS` error when the download policy is `Yes` and the download fails", (async function () {
                                var getDownloadPolicy = async function () {
                                  return "Yes";
                                };
                                var downloadLatestALS = async function (param) {
