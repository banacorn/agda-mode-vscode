                        ...
                        if (OS$AgdaModeVscode.onUnix) {
                          var expected = {
                            ...
                            _0: [
                              {
                                TAG: "SomethingWentWrong",
                                _0: Core__Option.getExn(paths[0], undefined),
                                _1: {
                                  TAG: "NotFound",
                                  _0: Nodepath.resolve("path/to/agda")
                                }
                              },
                              {
                                TAG: "SomethingWentWrong",
                                _0: Core__Option.getExn(paths[1], undefined),
                                _1: {
                                  TAG: "NotFound",
                                  _0: Nodepath.resolve("path/to/als")
                                }
                              }
                            ]
                          };
                        ...
                        if (OS$AgdaModeVscode.onUnix) {
                          var expected_endpoints = [{
                              ...
                              _1: OS$AgdaModeVscode.onUnix ? ({
                                    TAG: "NotFound",
                                    _0: Nodepath.resolve("some/other/paths")
                                  }) : ({
                                    TAG: "NotFound",
                                    _0: Nodepath.resolve("some\\other\\paths")
                                  })
