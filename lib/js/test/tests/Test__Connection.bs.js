...
describe("Connection", (function () {
        ...
        describe("make", (function () {
                it("should return a connection and add it to the Memento when the command is found", (async function () {
                        ...
                        Curry._3(Assert.deepEqual, Config$AgdaModeVscode.Connection.getAgdaPaths(), [path$1], undefined);
                        var pathIsNowInConfig = Config$AgdaModeVscode.Connection.getAgdaPaths().includes(path$1);
                        ...
                        if (picked !== undefined) {
                          return Curry._3(Assert.deepStrictEqual, Connection__URI$AgdaModeVscode.toString(Connection__Target$AgdaModeVscode.toURI(picked)), path$1, undefined);
                        } else {
                ...
                it("should return a connection and add it to the Memento when the command is found", (async function () {
                        ...
                        var path$1;
                        path$1 = path.TAG === "Ok" ? Connection__URI$AgdaModeVscode.toString(Connection__Target$AgdaModeVscode.toURI(path._0)) : PervasivesU.failwith("expected to find `agda`");
                        await Config$AgdaModeVscode.Connection.setAgdaPaths(["some/other/path"]);
                        var paths = Config$AgdaModeVscode.Connection.getAgdaPaths();
                        var memento = State__Memento$AgdaModeVscode.make(undefined);
                        var commands = [
                          "agda",
