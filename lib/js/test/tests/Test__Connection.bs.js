...
describe("Connection", (function () {
                ...
                it("should return nothing when there's no previously picked connection", (async function () {
                        ...
                        var expected = OS$AgdaModeVscode.onUnix ? ({
                              ...
                              _0: [
                                {
                                  TAG: "SomethingWentWrong",
                                  _0: Connection__URI$AgdaModeVscode.parse("path\\to\\agda"),
                                  _1: {
                                    TAG: "NotFound",
                                    _0: "path\\to\\agda",
                                    [Symbol.for("name")]: "NotFound"
                                ...
                                {
                                  TAG: "SomethingWentWrong",
                                  _0: Connection__URI$AgdaModeVscode.parse("path\\to\\als"),
                                  _1: {
                                    TAG: "NotFound",
                                    _0: "path\\to\\als",
                                    [Symbol.for("name")]: "NotFound"
        ...
        describe("`fromDownloads`", (function () {
                ...
                after(async function () {
                      ...
                      return await Connection__Target$AgdaModeVscode.setPicked(State__Memento$AgdaModeVscode.make(undefined), undefined);
                    });
                ...
                it("should check if the latest ALS is already downloaded when the download policy is `Yes`", (async function () {
                        ...
                        Curry._3(Assert.deepEqual, checkedCache.contents, true, undefined);
                        Curry._3(Assert.deepEqual, result, {
                              TAG: "Ok",
                              _0: target$1,
                              [Symbol.for("name")]: "Ok"
                ...
                it("should proceed to download the latest ALS when the download policy is `Yes` and the cached latest ALS is not found", (async function () {
                        ...
                        var downloadLatestALS = async function (param) {
                          ...
                          return {
                                  TAG: "Ok",
                                  _0: Connection__Target$AgdaModeVscode.toURI(target$1),
                                  [Symbol.for("name")]: "Ok"
                                };
                        };
                        var result = await Connection$AgdaModeVscode.fromDownloads(attempts, {
                        ...
                        Curry._3(Assert.deepEqual, checkedCache.contents, true, undefined);
                        Curry._3(Assert.deepEqual, checkedDownload.contents, true, undefined);
                        Curry._3(Assert.deepEqual, result, {
                              TAG: "Ok",
                              _0: target$1,
                              [Symbol.for("name")]: "Ok"
                        ...
                        var policy = Config$AgdaModeVscode.Connection.DownloadPolicy.get();
                        Curry._3(Assert.deepEqual, policy, "Yes", undefined);
