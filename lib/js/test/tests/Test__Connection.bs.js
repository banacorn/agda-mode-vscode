...
describe("Connection", (function () {
        ...
        describe("Connection contract coverage", (function () {
                ...
                it("should skip agda/als command probes when already present in connection.paths", (async function () {
                        await Config$AgdaModeVscode.Connection.DownloadPolicy.set("No");
                        var agdaCount = {
                          contents: 0
                        };
                ...
                it("should skip agda command probe in step 2 when PickedConnection is bare agda", (async function () {
                        await Config$AgdaModeVscode.Connection.DownloadPolicy.set("No");
                        var agdaCount = {
                          contents: 0
                        };
                        ...
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        await Memento$AgdaModeVscode.Module.PickedConnection.set(memento, "agda");
                        var result = await Connection$AgdaModeVscode.makeWithFallback(platform, memento, Vscode.Uri.file("/tmp/test-storage"), [], [
                              "agda",
                              "als"
                            ], Chan$AgdaModeVscode.make());
                        if (result.TAG === "Ok") {
                ...
                it("should update connection.paths but not PickedConnection after automatic fallback download", (async function () {
                        ...
                        if (result.TAG === "Ok") {
                          ...
                          Curry._3(Assert.deepStrictEqual, Config$AgdaModeVscode.Connection.getAgdaPaths(), [downloadedAgda.contents], undefined);
                ...
                it("should NOT set PreferredCandidate when connection succeeds via command discovery", (async function () {
                        var logChannel = Chan$AgdaModeVscode.make();
                        await Config$AgdaModeVscode.Connection.setAgdaPaths(logChannel, ["/nonexistent/path"]);
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var findCommand = function (command, _timeoutOpt) {
                ...
                it("should NOT overwrite existing PreferredCandidate when connection succeeds via command discovery", (async function () {
                        var logChannel = Chan$AgdaModeVscode.make();
                        await Config$AgdaModeVscode.Connection.setAgdaPaths(logChannel, ["/nonexistent/path"]);
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var existingPicked = "/usr/local/bin/agda";
                ...
                it("should only accept Filepath, bare command, and file:// URI as valid candidates", (function () {
                        var lspResult = Connection__URI$AgdaModeVscode.parse("lsp://localhost:8080");
                        if (lspResult.TAG === "FileURI") {
                          Assert.ok(true);
                          return ;
                        }
                        Assert.fail("lsp:// URI should not be accepted as a valid candidate per spec");
                      }));
                it("should not accept vscode-* URI schemes as valid candidates", (function () {
                        var vscodeResult = Connection__URI$AgdaModeVscode.parse("vscode-userdata:/some/path");
                        if (vscodeResult.TAG === "FileURI") {
                          var scheme = vscodeResult._1.scheme;
                          return Curry._3(Assert.deepStrictEqual, scheme, "file", undefined);
                        }
