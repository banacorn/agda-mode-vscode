...
describe("Connection", (function () {
        ...
        describe("`probeFilepath`", (function () {
                ...
                it("should correctly identify ALS executable", (async function () {
                        ...
                        if (result.TAG === "Ok") {
                          ...
                          Curry._3(Assert.deepStrictEqual, match$2[0], "1.2.3", undefined);
                          Curry._3(Assert.deepStrictEqual, match$2[1], "2.6.4", undefined);
                          return Curry._3(Assert.deepStrictEqual, match$2[2], undefined, undefined);
                        }
                ...
                it("should detect prebuilt data directory for ALS with LSP options", (async function () {
                        ...
                        if (result.TAG === "Ok") {
                          ...
                          if (match$2.TAG === "Ok") {
                            ...
                            var lspOptions = match$3[2];
                            if (lspOptions !== undefined) {
                              Curry._3(Assert.deepStrictEqual, match$1[0], fileName, undefined);
                              Curry._3(Assert.deepStrictEqual, match$3[0], "1.2.3", undefined);
                              Curry._3(Assert.deepStrictEqual, match$3[1], "2.6.4", undefined);
        ...
        describe("`makeWithRawPath`", (function () {
                var agdaMockPath = {
                  contents: ""
                };
                var alsMockPath = {
                ...
                before(async function () {
                      agdaMockPath.contents = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.6.3", "agda-makeWithRawPath-mock");
                      alsMockPath.contents = await Test__Util$AgdaModeVscode.Endpoint.ALS.mock("1.3.1", "2.6.3", "als-makeWithRawPath-mock");
                    });
                after(async function () {
                      if (agdaMockPath.contents !== "") {
                        await Test__Util$AgdaModeVscode.Endpoint.Agda.destroy(agdaMockPath.contents);
                ...
                it("should successfully create Agda connection from valid Agda path", (async function () {
                        var result = await Connection$AgdaModeVscode.makeWithRawPath(agdaMockPath.contents);
                        if (result.TAG === "Ok") {
                ...
                it("should handle ALS executable probing (without full connection)", (async function () {
                        ...
                        if (result.TAG === "Ok") {
                          ...
                          var match$2 = match$1._0;
                          Curry._3(Assert.deepStrictEqual, match[0], alsMockPath.contents, undefined);
                          Curry._3(Assert.deepStrictEqual, match$2[0], "1.3.1", undefined);
                          Curry._3(Assert.deepStrictEqual, match$2[1], "2.6.3", undefined);
                          return Curry._3(Assert.deepStrictEqual, match$2[2], undefined, undefined);
                        }
                        Assert.fail("Expected successful probe");
                      }));
                it("should return Construction error for non-existent path", (async function () {
                        var nonExistentPath = "/path/that/does/not/exist/agda";
                        var result = await Connection$AgdaModeVscode.makeWithRawPath(nonExistentPath);
                        if (result.TAG === "Ok") {
                          Assert.fail("Expected error for non-existent path");
                          return ;
                        }
                        var error = result._0.endpoints[nonExistentPath];
                        if (error !== undefined) {
                          ...
                          Assert.fail("Expected endpoint error for non-existent path");
                          return ;
                        }
                      }));
                it("should return Construction error for unrecognized executable", (async function () {
                        var mockOutput = "Unknown Program v1.0.0";
                        var mockPath;
                        if (OS$AgdaModeVscode.onUnix) {
                          var content = "#!/bin/sh\necho '" + mockOutput + "'\nexit 0";
                          var tempFile = Nodepath.join(Nodeos.tmpdir(), "unrecognized-makeWithRawPath-mock");
                          Nodefs.writeFileSync(tempFile, Buffer.from(content));
                          await Nodefs.promises.chmod(tempFile, 493);
                          mockPath = tempFile;
                        } else {
                          var content$1 = "@echo " + mockOutput;
                          var tempFile$1 = Nodepath.join(Nodeos.tmpdir(), "unrecognized-makeWithRawPath-mock.bat");
                          Nodefs.writeFileSync(tempFile$1, Buffer.from(content$1));
                          mockPath = tempFile$1;
                        }
                        var result = await Connection$AgdaModeVscode.makeWithRawPath(mockPath);
                        if (result.TAG === "Ok") {
                          Assert.fail("Expected error for unrecognized executable");
                        } else {
                          var error = result._0.endpoints[mockPath];
                          if (error !== undefined) {
                            ...
                            Assert.fail("Expected endpoint error for unrecognized executable");
                          }
                        }
                        try {
                          Nodefs.unlinkSync(mockPath);
                ...
                it("should detect prebuilt data directory correctly in probing phase", (async function () {
                        ...
                        if (result.TAG === "Ok") {
                          ...
                          if (match$2.TAG === "Ok") {
                            ...
                            if (lspOptions !== undefined) {
                              Curry._3(Assert.deepStrictEqual, match$1[0], fileName, undefined);
                              Curry._3(Assert.deepStrictEqual, match$3[0], "1.3.1", undefined);
                              Curry._3(Assert.deepStrictEqual, match$3[1], "2.6.3", undefined);
                              var dataDirPath = Core__Option.flatMap(lspOptions.env, (function (__x) {
                                      return Js_dict.get(__x, "Agda_datadir");
                                    }));
                              if (dataDirPath !== undefined) {
                ...
                it("should handle error construction correctly for endpoint errors", (async function () {
                        var invalidPath = "/definitely/does/not/exist/agda";
                        var result = await Connection$AgdaModeVscode.makeWithRawPath(invalidPath);
                        if (result.TAG === "Ok") {
                          Assert.fail("Expected construction error");
                          return ;
                        }
                        var constructionError = result._0;
                        Curry._3(Assert.deepStrictEqual, Object.entries(constructionError.endpoints).length, 1, undefined);
                        Curry._3(Assert.deepStrictEqual, Object.entries(constructionError.commands).length, 0, undefined);
                        Curry._3(Assert.deepStrictEqual, constructionError.download, undefined, undefined);
                        var match = constructionError.endpoints[invalidPath];
                        if (match !== undefined) {
                          ...
                          Assert.fail("Expected endpoint error to be present");
                          return ;
                        }
                      }));
              }));
