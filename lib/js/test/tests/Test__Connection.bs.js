...
describe("Connection", (function () {
        ...
        describe("`fromDownloads`", (function () {
                ...
                it("should throw the `PlatformNotSupported` error when the platform is not supported", (async function () {
                        ...
                        var actual = await Connection$AgdaModeVscode.fromDownloads(MockPlatform, memento, globalStorageUri, constructionError);
                ...
                it("should throw the `NoDownloadALS` error when the initial download policy is `No`", (async function () {
                        ...
                        var memento = Memento$AgdaModeVscode.make(undefined);
                        var globalStorageUri = Vscode.Uri.file("/tmp/test-storage");
                        var result = await Connection$AgdaModeVscode.fromDownloads(MockPlatform, memento, globalStorageUri, constructionError);
                ...
                it("should check if the latest ALS is already downloaded when the download policy is `Yes`", (async function () {
                        ...
                        var alreadyDownloaded2 = function (_globalStorageUri) {
                          return function () {
                            checkedCache.contents = true;
                            return Promise.resolve(Connection__URI$AgdaModeVscode.toString(Connection__Endpoint$AgdaModeVscode.toURI(target$1)));
                          };
                        };
                        var downloadLatestALS = function (_memento, _globalStorageUri) {
                          return function (_platform) {
                ...
                it("should proceed to download the latest ALS when the download policy is `Yes` and the cached latest ALS is not found", (async function () {
                        ...
                        var downloadLatestALS2 = function (_memento, _globalStorageUri) {
                          return function (_platform) {
                            ...
                            return Promise.resolve({
                                        TAG: "Ok",
                                        _0: Connection__URI$AgdaModeVscode.toString(Connection__Endpoint$AgdaModeVscode.toURI(target$1))
                                      });
                          };
                        };
                        var getInstalledEndpointsAndPersistThem = function (_globalStorageUri) {
        ...
        describe("make2 with logging", (function () {
                ...
                it.skip("should not log connection events when connection fails", (async function () {
                        var loggedEvents = [];
                        var logChannel = Chan$AgdaModeVscode.make();
                        Chan$AgdaModeVscode.on(logChannel, (function (logEvent) {
