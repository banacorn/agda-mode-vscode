...
describe("Connection", (function () {
                ...
                it("State__Connection.sendRequest should log ActivationFlow for fresh establish failure", (async function () {
                        ...
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var state = State$AgdaModeVscode.make("activation-failure-" + String(Date.now() | 0), {
                                            ...
                                            download: download,
                                            askUserAboutDownloadPolicy: askUserAboutDownloadPolicy
                                          }, channels, globalStorageUri, Test__Util$AgdaModeVscode.Path.extensionUri, Memento$AgdaModeVscode.make(undefined), editor, undefined);
                                      try {
        ...
        describe("Connection contract coverage", (function () {
                ...
                it("should try PreferredCandidate first even when it is not in connection.paths", (async function () {
                        ...
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(Mock$AgdaModeVscode.Platform.makeBasic(), memento, globalStorageUri, [configAgda.contents], Chan$AgdaModeVscode.make());
                                      if (result.TAG === "Ok") {
                ...
                it("should not re-probe PreferredCandidate in the paths step", (async function () {
                        ...
                        await Memento$AgdaModeVscode.Module.PreferredCandidate.set(memento, pickedPath);
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(Mock$AgdaModeVscode.Platform.makeBasic(), memento, globalStorageUri, [
                                            pickedPath,
                                            configAgda.contents,
                                            pickedPath
                ...
                it("should resolve bare command names in connection.paths via findCommand", (async function () {
                        ...
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(platform, Memento$AgdaModeVscode.make(undefined), globalStorageUri, [
                                            "agda",
                                            "als"
                                          ], Chan$AgdaModeVscode.make());
                                      if (result.TAG === "Ok") {
                ...
                it("should not persist resolved absolute command paths back into connection.paths", (async function () {
                        ...
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(platform, Memento$AgdaModeVscode.make(undefined), globalStorageUri, ["agda"], logChannel);
                                      if (result.TAG === "Ok") {
                                        Curry._3(Assert.deepStrictEqual, Connection$AgdaModeVscode.getPath(result._0), configAgda.contents, undefined);
                ...
                it("should update connection.paths but not PreferredCandidate after automatic fallback download", (async function () {
                        ...
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(platform, memento, globalStorageUri, ["/invalid/path"], logChannel);
                                      if (result.TAG === "Ok") {
                                        var establishFlowEvents = collectEstablishFlow(listener);
                                        Curry._3(Assert.deepStrictEqual, establishFlowEvents, [
                                              "ConfigCandidatesPlanned:1",
                ...
                it("should prepend downloaded path to connection.paths on automatic fallback", (async function () {
                        ...
                        var platform = Mock$AgdaModeVscode.Platform.makeWithSuccessfulDownload(downloadedAgda.contents);
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(platform, memento, globalStorageUri, existingPaths, logChannel);
                                      if (result.TAG === "Ok") {
                                        Curry._3(Assert.deepStrictEqual, Connection$AgdaModeVscode.getPath(result._0), downloadedAgda.contents, undefined);
                ...
                it("should use selected channel for automatic fallback downloads", (async function () {
                        ...
                        return await Test__Util$AgdaModeVscode.withStorage(undefined, (async function (globalStorageUri) {
                                      var result = await Connection$AgdaModeVscode.makeWithFallback(platform, memento, globalStorageUri, ["/nonexistent/path"], logChannel);
                                      if (result.TAG === "Ok") {
