...
describe("Connection", (function () {
        ...
        describe("`fromDownloads`", (function () {
                ...
                it("should retry Hardcoded download with WASM source when native download fails", (async function () {
                        ...
                        var downloadedMock = path !== undefined ? path : PervasivesU.failwith("Unable to access Agda mock endpoint");
                        var checkedCache = {
                          contents: false
                        };
        ...
        describe("`fromPathsOrCommands`", (function () {
                describe("paths", (function () {
                        ...
                        before(async function () {
                              try {
                                var path = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.7.0.1", "agda-mock-paths-or-commands");
                                agdaMockEndpoint.contents = path;
                                return ;
                              }
                              catch (raw_error){
        ...
        describe("make fromDownloads scenarios", (function () {
                ...
                it("should fall back to WASM when Hardcoded native download fails", (async function () {
                        var logChannel = Chan$AgdaModeVscode.make();
                        var listener = Log$AgdaModeVscode.collect(logChannel);
                        var agdaMockPath = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.7.0.1", "agda-mock-hardcoded-wasm-fallback");
                        await Config$AgdaModeVscode.Connection.DownloadPolicy.set("Undecided");
                        var checkedCache = {
                          contents: false
                        };
        ...
        describe("Connection contract coverage", (function () {
                ...
                before(async function () {
                      configAgda.contents = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.7.0.1", "agda-spec-config");
                      pickedAgda.contents = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.7.0.2", "agda-spec-picked");
                      downloadedAgda.contents = await Test__Util$AgdaModeVscode.Endpoint.Agda.mock("2.7.0.3", "agda-spec-downloaded");
                    });
                after(async function () {
                      try {
                        await Test__Util$AgdaModeVscode.Endpoint.Agda.destroy(configAgda.contents);
                      }
                      catch (exn){
                        
                      }
                      try {
                        await Test__Util$AgdaModeVscode.Endpoint.Agda.destroy(pickedAgda.contents);
                      }
                      catch (exn$1){
                        
                      }
                      try {
                        return await Test__Util$AgdaModeVscode.Endpoint.Agda.destroy(downloadedAgda.contents);
                      }
                      catch (exn$2){
                        return ;
                      }
