...
Mocha$BsMocha.describe("Extention Activation")(undefined, undefined, undefined, (function (param) {
        return Mocha$BsMocha.it("should be able to acquire \"banacorn.agda-mode\"")(undefined, undefined, undefined, (function (param) {
                      var extension = Vscode.extensions.getExtension("banacorn.agda-mode");
                      return Assert$BsMocha.equal("extension shouldn't be undefined", Belt_Option.isSome(extension), true);
                    }));
      }));
